// MasteryQuiz — Day 5 placeholder
export default function MasteryQuiz({ screen, accent }) {
  const count = screen?.questions?.length || 5;
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '32px 24px', gap: 16, textAlign: 'center' }}>
      ...
      <div style={{ fontSize: '1.3rem', fontWeight: 800, color: '#fff' }}>Mastery Quiz</div>
      <div style={{ fontSize: '0.9rem', color: 'rgba(255,255,255,0.45)', maxWidth: 280, lineHeight: 1.6 }}>
        {count} questions to test your knowledge. Coming in Day 5!
      </div>
