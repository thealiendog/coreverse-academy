...
const EXPLORER_DATA = {
  ...
  'math': {
    ...
    subjectId: 'math',
    guide:     'Remi',
    lessons:   [...MATH_L01.lessons, ...MATH_L02.lessons, ...MATH_L03.lessons, ...MATH_L04.lessons, ...MATH_L05.lessons, ...MATH_L06.lessons, ...MATH_L07.lessons, ...MATH_L08.lessons, ...MATH_L09.lessons, ...MATH_L10.lessons, ...MATH_L11.lessons],
  },
};
