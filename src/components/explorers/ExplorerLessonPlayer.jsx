...
const EXPLORER_DATA = {
  'inner-world': {
    ...INNERWORLD_SCREENS,
    lessons: [...INNERWORLD_SCREENS.lessons, ...INNERWORLD_L02.lessons, ...INNERWORLD_L03.lessons, ...INNERWORLD_L04.lessons, ...INNERWORLD_L05.lessons, ...INNERWORLD_L06.lessons, ...INNERWORLD_L07.lessons, ...INNERWORLD_L08.lessons, ...INNERWORLD_L09.lessons, ...INNERWORLD_L10.lessons],
  },
};
