...
const EXPLORER_DATA = {
  ...
  'social_studies': {
    ...
    guide:     'Atlas',
    lessons:   [...SOCIAL_STUDIES_L01.lessons, ...SOCIAL_STUDIES_L02.lessons, ...SOCIAL_STUDIES_L03.lessons, ...SOCIAL_STUDIES_L04.lessons, ...SOCIAL_STUDIES_L05.lessons, ...SOCIAL_STUDIES_L06.lessons, ...SOCIAL_STUDIES_L07.lessons, ...SOCIAL_STUDIES_L08.lessons, ...SOCIAL_STUDIES_L09.lessons, ...SOCIAL_STUDIES_L10.lessons, ...SOCIAL_STUDIES_L11.lessons, ...SOCIAL_STUDIES_L12.lessons, ...SOCIAL_STUDIES_L13.lessons, ...SOCIAL_STUDIES_L14.lessons, ...SOCIAL_STUDIES_L15.lessons, ...SOCIAL_STUDIES_L16.lessons],
  },
};
