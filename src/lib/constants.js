...
export const ORIGINALS = [
  { id: 'inner-world',   label: 'Inner World & Consciousness', icon: '🌿', color: '#10B981', guide: 'Sage',  guideAnimal: 'Deer',      lessonCount: 20 },
  { id: 'cosmos',        label: 'Cosmos & Science',            icon: '🔭', color: '#6366F1', guide: 'Nova',  guideAnimal: 'Owl',       lessonCount: 20 },
  { id: 'history',       label: 'History & World',             icon: '🗺️', color: '#D97706', guide: 'Lyra',  guideAnimal: 'Elephant',  lessonCount: 20 },
  { id: 'future-skills', label: 'Future Skills',               icon: '🚀', color: '#3B82F6', guide: 'Byte',  guideAnimal: 'Fox',       lessonCount: 20 },
  { id: 'money',         label: 'Money & Business',            icon: '💡', color: '#FCD34D', guide: 'Ace',   guideAnimal: 'Eagle',     lessonCount: 20 },
  { id: 'creative-arts', label: 'Creative Arts',               icon: '🎨', color: '#E879F9', guide: 'Muse',  guideAnimal: 'Butterfly', lessonCount: 20 },
  { id: 'wellness',      label: 'Life & Wellness',             icon: '🌱', color: '#86EFAC', guide: 'Terra', guideAnimal: 'Wolf',      lessonCount: 20 },
  { id: 'leadership',    label: 'Social & Leadership',         icon: '🤝', color: '#FCA5A5', guide: 'Valor', guideAnimal: 'Lion',      lessonCount: 20 },
  { id: 'languages',     label: 'Languages (Spanish)',         icon: '🌎', color: '#34D399', guide: 'Luna',  guideAnimal: 'Parrot',    lessonCount: 20 },
  { id: 'frontier',      label: 'Frontier & Philosophy',       icon: '✨', color: '#A78BFA', guide: 'Orion', guideAnimal: 'Phoenix',   lessonCount: 20 },
];
