      ...
      screens: [
        {
          id: `l19-welcome`,
          type: `welcome`,
          guideText: `{name}, you are being shaped by media every day — not in some abstract, theoretical sense, but in the most concrete ways: what events you know about, what stories feel important, which people you see as insiders and which as outsiders, what the normal range of political opinion looks like, what emotions attach to which issues, and what you take for granted as obvious or neutral. Media is not a window onto the world. It is one of the primary mechanisms through which your understanding of the world is constructed. This is true even when the journalism is excellent and the journalists are honest. Every media organization makes thousands of choices every day about what to cover, how to frame it, whose voice to include, which images to use, how much weight to give competing claims. Those choices reflect the organization's owners, audiences, advertisers, cultural assumptions, and editorial traditions. They are not neutral. And that is before we get to the vast landscape of partisan media, algorithmic social media, disinformation campaigns, and content designed specifically to manipulate rather than inform. The concept of media literacy is the capacity to analyze, evaluate, and navigate this landscape — not to dismiss all media as fake or untrustworthy, but to engage with it as a critical reader who understands how it works and how it shapes perception. This lesson takes media literacy seriously as a social studies skill. We'll examine how news media works and why it frames stories the way it does, how social media algorithms shape information environments, how to distinguish journalism from advocacy and both from disinformation, how to read political media across ideological lines, and what media literacy looks like as an active civic practice. The five source exercises will put these concepts to work on real media examples. Onward.`,
...

        {
          ...
          vocab: [
            ...
            { word: `disinformation vs. misinformation`,
