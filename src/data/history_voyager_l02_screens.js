  ...
  lessons: [
    {
      ...
      screens: [
...

        {
          ...
          paragraphs: [
            `The source evaluation that follows tests whether you can identify which tier different historical sources belong to. The skill builds directly from Lesson 14 in Life Wellness on source evaluation; today you apply it specifically to history.`,
