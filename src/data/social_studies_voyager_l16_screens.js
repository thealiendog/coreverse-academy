      ...
      screens: [
        {
          id: `l16-welcome`,
          type: `welcome`,
          guideText: `{name}, geography is not just memorizing capitals and rivers. At its heart, geography asks one of the most fundamental questions in all of human experience: how do humans relate to the physical world they inhabit, and how does that physical world shape them in return? This two-way relationship, between human societies and their physical environments, is what geographers call human-environment interaction, and it runs through almost every significant event in human history. Why did ancient civilizations emerge where they did? Why are some regions wealthy and others poor? Why are wars fought where they are? Why do some countries face existential threats from climate change while others are barely affected? The answer almost always involves geography. The places where humans have chosen to build cities, grow food, and organize societies have not been random: they have followed the logic of geography, where rivers flow, where soil is fertile, where coasts are accessible, where resources are available, where mountains create barriers or corridors. And humans, in turn, have reshaped those physical environments dramatically: damming rivers, deforesting mountains, warming the atmosphere, draining wetlands, and creating entirely new landscapes through agriculture, urbanization, and industry. This lesson focuses on one of geography's most important themes: human-environment interaction. We'll examine how physical geography shapes where and how humans live, how humans transform the environments they inhabit, and what happens when that transformation creates unintended consequences. We'll look at the geography of resources, disasters, and climate change, and trace how geographic forces connect places across the globe in ways that aren't always visible in daily life. Five case studies will ground the concepts in real history and present-day reality. By the end, you'll see the physical world as an active participant in human history and the current moment, not just a backdrop. Onward.`,
