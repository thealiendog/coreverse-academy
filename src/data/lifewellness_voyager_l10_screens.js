      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `The condition of lacking meaningful social connections, associated in research with substantially increased mortality risk comparable to or exceeding traditional risk factors like obesity. Julianne Holt-Lunstad's meta-analyses established that lacking social connection has health effects comparable to smoking 15 cigarettes a day.`,
              audioPrompt: `Social isolation is the condition of lacking meaningful social connections, and research has established that its health effects are serious and measurable, {name}. Julianne Holt-Lunstad at Brigham Young University conducted meta-analyses — studies synthesizing many studies — that found lacking social connection has health effects comparable to smoking 15 cigarettes a day. The effects show up in cardiovascular disease, immune function, mental health, cognitive decline, and overall mortality. Loneliness is associated with substantially increased mortality risk, comparable to or exceeding traditional health risk factors like obesity. In 2023, US Surgeon General Vivek Murthy released an advisory declaring loneliness and social isolation a public health epidemic. The framing matters: treating social isolation as a serious health issue rather than just a personal feeling changes how it gets addressed — at the level of community design, school structure, workplace practices, and healthcare, not just individual effort. For eleven and twelve year olds specifically, adolescent loneliness has increased dramatically since approximately 2012, coinciding with widespread smartphone adoption. Adults with strong social connections in adolescence are far more likely to have them in adulthood; patterns established now compound across decades.`,
            },
            {
              word: `weak ties`,
              definition: `Mark Granovetter's research finding that distant social connections — not just close friends — provide substantial career and information benefits. The casual acquaintance network turns out to matter significantly for opportunity, supplementing the emotional and support benefits provided by close friendships.`,
              audioPrompt: `Weak ties are distant social connections — casual acquaintances, friendly contacts in different circles — and research by Mark Granovetter has shown they provide substantial benefits beyond what close friendships alone provide, {name}. Granovetter's strength of weak ties research, published in 1973, found that the casual acquaintance network matters significantly for career and information benefits. New job opportunities, introductions to useful people, access to information outside one's immediate circles — these flow largely through weak ties rather than through close friends, who often already know the same things you do. The instrumental view of friendship takes this research seriously: maintaining a broad network across varying levels of intimacy (close friends, casual friends, weak ties, community connections) serves different functions. Close friendships provide emotional support, deep knowing, identity formation. Weak ties provide access to opportunity and information that wouldn't flow through the close network. Activities that involve regular contact across varying intimacy levels — community involvement, shared activities with broader groups, civic participation — build and maintain the weak tie network that the research shows matters substantially for life outcomes.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `social support`,
              definition: `One of the core benefits friendship provides in the instrumental framework: the presence of people who provide help, care, and presence during difficult times. Research has established that social support buffers stress, depression, and many other negative health outcomes, and that its absence is a direct contributor to the health risks associated with loneliness.`,
              audioPrompt: `Social support is one of the core benefits friendship provides in the instrumental view of friendship, {name}. Research has established that having people who provide help, care, and presence during difficult times buffers stress, depression, and many other negative health outcomes. The health effects work through multiple mechanisms: social support reduces physiological stress responses, provides practical help that reduces burden, and provides emotional co-regulation through being with people who care about you. Family and friendship support has been documented across many studies as buffering the health effects of difficult circumstances. The instrumental view treats this as a primary reason friendship matters: it's biologically protective in measurable ways. Holt-Lunstad's loneliness research shows the other side of this — when social support is absent, the health consequences are comparable to smoking fifteen cigarettes a day. Social support during difficulty is not a luxury; it is a functional component of health maintenance that operates through specific documented mechanisms. The practical implication is that maintaining friendships across circumstances — including difficult circumstances when friends are hardest to reach and easiest to withdraw from — is a health behavior in the same way that exercise or sleep are health behaviors.`,
            },
            {
              word: `calculating friendships`,
              definition: `A failure mode of the purely instrumental view of friendship, where relationships become transactional and replaceable when a better-providing alternative appears. The philosophical tradition, especially Aristotle, argued that friendships valued only for what they provide lack the depth and durability of friendships of virtue, which are valued for who the other person is rather than what they do.`,
              audioPrompt: `Calculating friendships are a failure mode the philosophical tradition identified with the purely instrumental view of friendship, {name}. When friendship is framed solely through what it provides, the logical implication is that a friendship can be replaced when something better-providing comes along — just as a tool can be replaced by a better tool. The relationship becomes transactional: maintained while it delivers value, dropped when it stops. Aristotle in his "Nicomachean Ethics" identified this as a real limit of friendships of utility. Such friendships are real — they provide genuine benefits — but they are limited and dissolve when the utility goes away. The instrumental view's strength is that it engages with real evidence on what friendship does for people. Its limit is that treating friendship only as means to ends can produce relationships that are calculating rather than freely given, and that don't survive when one party stops being useful to the other. The intrinsic view argues that friendships of virtue — where people are friends because of who the other person is and shared commitment to flourishing — capture something that instrumental framings miss. These friendships are valued in themselves, not as means to other ends, which is why they're the deepest form and the most durable.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `friendship of virtue`,
              definition: `Aristotle's term for the deepest type of friendship, grounded in who the other person is and a shared commitment to flourishing, rather than in mutual benefit or enjoyment alone. These friendships are the slowest to develop, the most durable, and according to Aristotle, most people only have a few across an entire life.`,
              audioPrompt: `Friendship of virtue is Aristotle's term for the deepest type of friendship, {name}. In his "Nicomachean Ethics," Aristotle identified three types of friendship. Friendships of utility are grounded in mutual benefit; real but limited and dissolve when the utility goes away. Friendships of pleasure are grounded in enjoyment together; also real but limited and fade when the pleasure does. Friendships of virtue or character are grounded in who the other person is and shared commitment to flourishing. These are the deepest form, the slowest to develop, and the most durable. Aristotle thought most people only had a few friendships of the third kind across an entire life. The intrinsic view of friendship argues this type is what friendship is most essentially, and that friendships of utility and pleasure, while real, are incomplete versions. What the distinction implies practically: cultivating friendships not as means to ends but as ends in themselves; investing deeply in a small number of relationships rather than maintaining many shallow ones; recognizing that friendships of virtue require years, shared experiences, mutual investment, and genuine knowledge of each other. The slow development is not inefficiency — it's what the depth requires.`,
            },
            {
              word: `constitutive element`,
              definition: `The philosophical position that friendship is one of the constitutive elements of a flourishing human life — not a means to other ends like health or happiness, but part of what flourishing actually consists of. This is the intrinsic view's core claim, grounded in Aristotle and continued in the philosophical tradition.`,
              audioPrompt: `A constitutive element is something that makes up what a good life is, rather than being a means to it, {name}. The intrinsic view of friendship makes this claim: friendship, particularly friendship of virtue, is one of the constitutive elements of a flourishing human life. Not a tool for achieving happiness, health, or other ends — though it may produce those — but part of what a flourishing life actually consists of. Aristotle and the philosophical tradition argued this position. The Stoic tradition, contemporary philosophers writing on friendship, and many religious and wisdom traditions across cultures share the core commitment: genuine friendship has value in itself, not merely for what it provides. The practical implication differs from the instrumental view. The instrumental view says maintain friendships because they're valuable for what they provide; adjust investment when they stop providing. The intrinsic view says invest in deep friendship because it is one of the most important things in a human life, not as a means to something else. The position honors the philosophical tradition's accumulated wisdom on human flourishing, and it suggests that the modern tendency to frame all relationships in terms of what they do for you misses something real about what deep friendship actually is.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `third places`,
              definition: `Ray Oldenburg's term for places that are neither home nor work where people gather casually — cafes, parks, barbershops, community centers, religious gathering spaces. Third places historically served as friendship-supporting infrastructure; their decline is one structural factor making friendship formation harder in modern life.`,
              audioPrompt: `Third places are Ray Oldenburg's term for places that are neither home nor work where people gather casually, {name}. Cafes, parks, barbershops, community centers, religious gathering spaces, public squares. These places historically served as friendship-supporting infrastructure: they provided the repeated casual contact across varying levels of acquaintance that builds social ties over time. The structural view of friendship takes the decline of third places seriously as a structural factor making friendship formation harder in modern life. Robert Putnam's research on social capital decline documented overlapping changes: suburbanization that separates residential areas from gathering places, car-dependent design that removes casual walking contact, decline in civic organization membership, longer work hours that reduce time available for community spaces. Together these changes have made the incidental repeated contact that builds friendships across varying intimacy levels harder to access. Jeffrey Hall's hours-required research — fifty hours for a casual friend, ninety for a friend, two hundred plus for a close friend — highlights why third places matter: they are one of the few environments where those hours can accumulate organically without requiring intentional scheduling of every interaction. Their decline is a structural condition, not an individual failure.`,
            },
            {
              word: `friendship hours`,
              definition: `Jeffrey Hall's research finding that friendship formation requires substantial in-person time: roughly 50 hours to become a casual friend, 90 hours to become a friend, and over 200 hours to become a close friend. Modern conditions — work patterns, screen absorption, geographic spread — often don't provide these hours easily.`,
              audioPrompt: `Friendship hours refers to Jeffrey Hall's research finding at the University of Kansas that friendship formation requires substantial in-person time, {name}. Specifically: roughly fifty hours of together-time to become a casual friend, ninety hours to become a friend, and over two hundred hours to become a close friend. These findings are important for understanding why modern conditions are structurally hostile to friendship in specific ways. The hours can't be easily replaced by phone-mediated contact. Modern conditions often don't provide them easily: work and homework loads absorb time, suburban geography requires scheduling rather than incidental contact, and screens absorb hours that previously went to in-person interaction. For adolescents today, the lesson notes that screen time absorbs friendship hours that once went to in-person contact. Hall's research gives specificity to this: it's not just that less in-person time is happening, it's that the hours required for the different levels of friendship are not being accumulated. Someone spending fifty hours in incidental casual contact with peers develops casual friendships. Someone whose social time is largely phone-mediated may not accumulate those in-person hours at all. The structural view uses this research to argue that friendship difficulty is often about conditions, not individual failure.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `screen displacement`,
              definition: `The structural pattern in which screen time — particularly phone and social media use — absorbs hours that previously went to in-person friendship and community contact. The lesson argues this is particularly significant for the current adolescent generation given Hall's research on hours required for friendship formation.`,
              audioPrompt: `Screen displacement refers to the structural pattern in which screen time absorbs hours that previously went to in-person friendship and community contact, {name}. The lesson makes a specific argument about why this matters for the current adolescent generation. Adolescents in the US spend an average of eight to nine hours per day on screens for entertainment — the same research documented in the attention lesson. Jeffrey Hall's research on friendship formation requires fifty hours of in-person time for a casual friend, ninety for a friend, over two hundred for a close friend. When attention-economy companies deliberately design products to capture interaction time that previously went to in-person contact, they are absorbing the hours that friendship formation actually requires. This isn't a coincidence of timing; the products are engineered to maximize engagement using techniques from gambling and persuasion psychology. For adolescents specifically, the lesson notes that this is the most common error among adults applying older frameworks: underweighting the structural dimension because older frameworks were developed before conditions changed at this scale. Building deliberate framework that takes the structural dimension seriously — recognizing that in-person hours matter, protecting them from screen displacement, and not blaming yourself for friendship difficulty that is largely structural — is one of the most important adaptations your generation specifically needs to make.`,
            },
            {
              word: `primary framing`,
              definition: `The single friendship framework a person defaults to first when navigating friendship decisions or difficulties. The lesson argues that committing to a primary framing is useful because each position implies different responses to friendship difficulty: the instrumental position asks what the friendship provides, the intrinsic position asks what kind of friendship it is, and the structural position asks what conditions are affecting it.`,
              audioPrompt: `Primary framing is the single friendship framework a person defaults to first when navigating friendship decisions or difficulties, {name}. The three frameworks — instrumental, intrinsic, and structural — are not mutually exclusive. Most mature understanding integrates all three. But the argument-building exercise has a forcing function: commit to a primary framing. The reason is practical. Each position implies different responses when friendship feels difficult. Instrumental framing asks: what specific benefits is this friendship providing or not providing, and how should investment adjust accordingly? Intrinsic framing asks: what kind of friendship is this — utility, pleasure, virtue — and what depth is appropriate for what this is? Structural framing asks: what conditions are making this friendship easier or harder, and what could change at the level of environment and structure? The right response to friendship difficulty often depends on which factor is most actionable in a specific situation. Choosing a primary framing doesn't mean dismissing the others; it means knowing where to look first. For your generation specifically, the lesson argues that the structural factor is unprecedented and that underweighting it is the most common error. Building deliberate awareness of conditions, not just individual investment, is the specifically new literacy your generation needs.`,
            },
          ],
        },
