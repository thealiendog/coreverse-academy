      ...
      screens: [
        {
          id: `l15-welcome`,
          type: `welcome`,
          guideText: `{name}, poetry compresses language to maximum density — every word, line break, and sound choice carries weight. This lesson isn't about identifying literary devices. It's about learning to read slowly, to sit with difficulty, and to understand why compression produces effects that prose can't. You'll read poems that reward that kind of attention.`,
