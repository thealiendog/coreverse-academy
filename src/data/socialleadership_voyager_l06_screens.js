      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            {
              word: `collaborating`,
              definition: `Thomas-Kilmann conflict mode: high assertive, high cooperative. Both sides work together to find a solution that fully satisfies both — a "we both win" outcome. Useful for important issues where both parties' concerns matter, for continuing relationships, when there is enough time and trust. Limit: requires significant time and trust; not always possible; can be overused for trivial issues.`,
              audioPrompt: `Collaborating is the Thomas-Kilmann conflict mode rated high on both assertiveness and cooperativeness, {name}. Both sides work together to find a solution that fully satisfies both — a "we both win" outcome, in contrast to compromise where both partially lose. The text describes it as useful for important issues where both parties' concerns genuinely matter, for relationships that will continue, and when there is enough time and sufficient trust between the parties. It is often the ideal mode when it is actually achievable. But the text is explicit about the limits. Collaborating requires significant time and trust that aren't always present. Not every conflict has a fully satisfying solution for both sides. And it can be overused on trivial issues that would be better resolved through a faster approach. Understanding when collaborating is genuinely available versus when it would be ideal but isn't realistic is one of the key judgment calls in mature conflict navigation. Most people underuse this mode because it demands more from both sides — but when the conditions are right, it produces the most durable outcomes.`,
            },
            {
              word: `avoiding`,
              definition: `Thomas-Kilmann conflict mode: low assertive, low cooperative. Sidestepping, postponing, or withdrawing from conflict — a "we both lose" outcome. Useful when the issue is not important, when emotions are too high for productive engagement, or when the cost of confrontation exceeds the benefit. Limit: unaddressed conflicts often grow; chronic avoidance damages relationships and personal development.`,
              audioPrompt: `Avoiding is the Thomas-Kilmann conflict mode rated low on both assertiveness and cooperativeness, {name}. You sidestep the conflict, postpone it, or withdraw — and because neither side engages, neither side's concerns are addressed. The text describes it as a "we both lose" outcome. But avoiding is not simply wrong; the text identifies real situations where it is the most useful mode. When the issue is not important enough to be worth a confrontation, avoiding is efficient. When emotions are too high for productive engagement, postponing gives both sides time to settle. When the cost of confrontation genuinely exceeds the benefit of resolving the issue, avoiding is the right call. The limits are equally clear. Unaddressed conflicts often grow rather than disappear. Chronic avoidance damages relationships over time because real concerns never get surfaced or resolved. It can also limit your own development by keeping you away from the productive discomfort of navigating genuine disagreement. The skill is distinguishing strategic avoiding — a deliberate choice not to engage — from habitual avoidance driven by discomfort.`,
            },
          ],
        },

        {
          ...
          paragraphs: [
            ...
            `Chris Voss's "Never Split the Difference" (2016) takes a different angle. Voss, a former FBI hostage negotiator, argues compromise often produces worse outcomes than fully understanding the other side. His core techniques: tactical empathy (labeling the emotion you observe — see Lesson 4), calibrated questions (open questions starting with "how" or "what" that lead the other person to think), mirroring (repeating back the last few words of what someone said to invite elaboration), and accusation audits (preemptively naming the negative things the other side might be thinking).`,
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `Technique from Chris Voss's "Never Split the Difference" (2016). Labeling the emotion you observe in the other party — naming what they appear to feel — to demonstrate understanding and reduce defensive reactions. Part of a broader framework developed from FBI hostage negotiation experience. Most useful in adversarial conflicts where the other side is not acting in good faith.`,
              audioPrompt: `Tactical empathy is a technique from Chris Voss's 2016 book "Never Split the Difference," {name}. Voss was a former FBI hostage negotiator before becoming a negotiation researcher, and his framework is built from experience in adversarial high-stakes situations. Tactical empathy means labeling the emotion you observe in the other party — naming what they appear to feel — to demonstrate understanding and reduce defensive reactions. Examples include "It sounds like you're frustrated with how this has been handled" or "It seems like this decision really matters to you." The label itself often releases pressure from the conversation, because people feel heard rather than opposed. The text places it alongside other Voss techniques: calibrated questions (open questions starting with "how" or "what"), mirroring (repeating the last few words of what someone said to invite elaboration), and accusation audits (preemptively naming the negative things the other side might be thinking). Tactical empathy is most useful in adversarial conflicts where the other side is not acting in good faith. For conflicts where both sides are genuinely willing to engage, the Fisher-Ury interests framework usually applies better.`,
            },
            {
              word: `calibrated questions`,
              definition: `Technique from Chris Voss's "Never Split the Difference" (2016). Open questions starting with "how" or "what" that lead the other person to think through the problem without triggering defensive reactions. Distinct from yes/no questions, which can feel like interrogation. Produces information and collaborative engagement simultaneously.`,
              audioPrompt: `Calibrated questions are a technique from Chris Voss's 2016 negotiation book "Never Split the Difference," {name}. These are open questions starting with "how" or "what" — rather than "why" or yes/no formats — that lead the other person to think through the problem without triggering defensive reactions. Examples: "How do you think we should handle this?" or "What would need to be true for this to work for you?" or "How am I supposed to do that?" The "why" phrasing tends to make people feel accused or interrogated; "how" and "what" framings invite genuine engagement. Yes/no questions close down thinking; calibrated questions open it up. The technique produces two things simultaneously: information about what the other side actually needs or believes, and collaborative engagement where the other person works on the problem alongside you rather than against you. The text presents calibrated questions as part of Voss's broader framework that includes tactical empathy, mirroring, and accusation audits. Together these techniques are designed for situations where the other side may not be engaging in good faith — making them different from but complementary to the Fisher-Ury framework.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `making it personal`,
              definition: `Conflict pattern identified as consistently making conflicts worse. Attacking the person rather than addressing the issue. Examples: "You're being stubborn" instead of "I see this differently"; "You always do this" instead of "I noticed this happened." Personal attacks trigger defensive reactions that prevent any progress on the actual issue. Fisher and Ury's instruction to "separate the people from the problem" directly addresses this pattern.`,
              audioPrompt: `Making it personal is the first conflict pattern identified in the text as consistently making conflicts worse, {name}. It means attacking the person rather than addressing the issue. The text gives direct examples: "You're being stubborn" rather than "I see this differently." "You always do this" rather than "I noticed this happened." The difference is that the first version of each targets the person's character or pattern; the second targets the specific behavior or situation. Personal attacks trigger defensive reactions that prevent any progress on the actual issue. When you tell someone they are being stubborn, they become focused on defending their character rather than engaging with the substance. When you say you see things differently, there's room to actually discuss the substance. This is the same problem that Roger Fisher and William Ury address in "Getting to Yes" with their instruction to separate the people from the problem. The people are not the problem; the specific issue is the problem. Keeping that distinction clear in how you speak is one of the most consistently powerful moves in any conflict situation.`,
            },
            {
              word: `old grievances`,
              definition: `Conflict pattern of adding past complaints to a current conflict. Expands the conflict beyond what can be addressed in one conversation and usually signals an attempt to win generally rather than address the specific current issue. Conflicts get harder to resolve as they accumulate scope. Resist adding every related past thing; focus on the specific current issue.`,
              audioPrompt: `Bringing in old grievances is one of the conflict patterns identified in the text as consistently making conflicts worse, {name}. It means adding past complaints to a current conflict rather than addressing only the specific current issue. When a conflict starts over one specific thing and then accumulates references to everything else that has ever gone wrong between the same two people, it expands scope beyond what can possibly be addressed in one conversation. The text identifies this as a signal: adding old grievances usually indicates you're trying to win generally — to establish that you have been consistently right and the other person has been consistently wrong — rather than actually resolve the current issue. Conflicts get harder to resolve as their scope grows. Each additional grievance is another negotiating point, another piece of disputed history, another thing that needs to be processed before reaching resolution. The practical instruction is direct: resist the urge to mention every related thing the other side has done. Focus on the specific current issue. Once the current issue is resolved, there may be time and space to address recurring patterns — but that is a different conversation that works better when the current conflict isn't also happening simultaneously.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `mediating explicitly`,
              definition: `The practice of mediating conflict structurally rather than informally. Involves meeting each side separately first, identifying interests and areas of common ground, then facilitating a structured conversation where each side speaks and is heard. Distinguished from informal mediation, which often pretends to objectivity it lacks. Works only when both sides want help and the mediator is willing to be transparent about their own perspective.`,
              audioPrompt: `Mediating explicitly means mediating conflict structurally rather than informally, {name}. The text describes it as one of the things that works when you find yourself in the middle of other people's conflict — but only when both sides actually want help and you are willing to provide it. The explicit structural version involves meeting with each side separately first to understand their interests, looking for areas of common ground, facilitating a structured conversation where each side speaks and is actually heard, not pretending to neutrality you don't actually have, and naming your own perspective if it is relevant. This is distinguished from informal mediation, which often pretends to objectivity it doesn't have. Informal mediation — where you just sit two people down and try to help them work it out — is often worse than no mediation at all because it imports bias without acknowledging it. Both sides are likely to feel the informal mediator favors the other, even when that isn't the intention. The text also notes that if you are a friend to both parties, you are rarely in a structural position to mediate properly. The right move is often to support both individually, hold to your boundary about not being in the middle, and let them navigate the conflict themselves.`,
            },
            {
              word: `limits of being in the middle`,
              definition: `Recognition that even skilled mediators have less power than people expect. The actual resolution happens between the parties in conflict; the mediator's role is at most to create conditions where they can navigate. Many people in the middle exhaust themselves trying to fix things they cannot fix. The real work has to happen between the people in the actual conflict.`,
              audioPrompt: `The limits of being in the middle is a recognition the text makes explicit, {name}. Even when you are skilled at navigating other people's conflicts, you have less power than people in the middle often expect. The actual resolution happens between the parties. Your role, as the person in the middle, is at most to create conditions where they can navigate. You cannot make them trust each other. You cannot make them acknowledge what they have wrong. You cannot force the resolution. The text identifies a common and exhausting pattern: people in the middle work harder and harder trying to fix something they genuinely cannot fix, because the real work has to happen between the people in the actual conflict themselves. This limit is not a failure — it is a structural reality. Knowing it lets you protect your own energy and avoid taking on responsibility that isn't yours to carry. The most useful thing a person in the middle can often do is make it easier for the actual parties to have the direct conversation they need to have, and then step back. Trying to substitute for that conversation rarely works.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `conflict frameworks compound`,
              definition: `Recognition that building explicit conflict skills early produces returns across thousands of situations over a lifetime. Most people develop conflict navigation through trial and error over decades, often picking up bad patterns alongside good ones. Building explicit frameworks at 12 skips much of the painful learning. The three positions covered (friend conflict, authority conflict, group conflict) transfer directly to school, family, friendships, and future work.`,
              audioPrompt: `Conflict frameworks compounding is a recognition made explicitly in the text, {name}. Most people develop their conflict navigation through trial and error over decades — slowly figuring out through painful experience what works and what doesn't, often picking up bad patterns alongside good ones in the process. Building explicit conflict skills earlier skips much of that slow painful learning. The text identifies three common conflict types covered in the lesson — conflict where friends pull you to take sides, conflict with an authority figure you think is wrong, and conflict within a group you are part of — and notes that these are patterns you will face throughout school, family life, friendships, and any future work. The frameworks transfer directly because the underlying conflict dynamics recur across contexts. Every time you navigate one of these situations better than you would have without the frameworks, you produce a better outcome than you otherwise would have. Across thousands of conflicts over a lifetime, the compounding effect of consistently better navigation is substantial. Skill in conflict is not a nice-to-have; it shapes which relationships survive, which teams function, and which difficult situations get resolved versus dragged on.`,
            },
            {
              word: `primary commitment`,
              definition: `In the context of the case studies: what you are actually committed to when you decide how to respond in a conflict situation. Competing prioritizes winning; accommodating prioritizes the other's concerns; avoiding prioritizes avoiding discomfort; collaborating prioritizes finding a solution that works for both. Being clear about your primary commitment shapes which conflict mode actually fits.`,
              audioPrompt: `Primary commitment in conflict refers to what you are actually prioritizing when you decide how to respond, {name}. The text frames the case studies as opportunities to apply conflict frameworks, and each case reveals an implicit primary commitment behind the intuitive options versus the research-informed ones. When someone confronts a coach publicly, their primary commitment is to being heard or asserting themselves, even at the cost of the relationship and useful information. When someone approaches the same coach privately with curiosity, their primary commitment is to understanding what is actually happening — which serves their longer-term interests better. When someone takes sides in a friend conflict, their primary commitment is to the specific friendship or the feeling of being helpful, which costs them both friendships. When someone refuses triangulation and listens without taking sides, their primary commitment is to protecting the genuine relationships with both friends over time. Making your primary commitment explicit before engaging in conflict helps you choose the mode that actually serves what you care most about. Many people default to modes that feel right in the moment but conflict directly with what they actually care about when they think it through.`,
            },
          ],
        },
