      ...
      screens: [
...

        {
          ...
          paragraphs: [
            ...
            `In the argument builder you will pick one of these and build a case for it using real evidence. Note that this is harder than the source evaluation in Lesson 13 because the heart-brain question genuinely has uncertainty. Real cardiologists, neuroscientists, and researchers disagree about the right interpretation of the same evidence. You aren't being asked to spot fraud; you're being asked to weigh evidence on a contested scientific question.`,
