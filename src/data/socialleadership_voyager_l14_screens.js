      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            {
              word: `two layers of power`,
              definition: `The distinction between formal structure and informal power in any group. Formal layer: titles, roles, official processes — stated and documented. Informal layer: actual influence, relationships, where decisions really get made. The two layers usually overlap partially but not entirely. Confusing them produces predictable mistakes: working through channels that don't move things, or ignoring when formal authority actually matters.`,
              audioPrompt: `Two layers of power is the foundational distinction for reading group dynamics accurately, {name}. Most groups operate with both layers simultaneously. The formal layer consists of titles, roles, and official processes: the CEO has formal authority, the committee has formal approval power, the principal has formal authority over school operations. The informal layer consists of actual influence, relationships, and where decisions really get made: the specific employee the CEO always consults, the committee member whose opinion actually determines outcomes, the teacher whose informal influence among colleagues exceeds the principal's. The two layers usually overlap partially but not entirely. People who confuse the two produce predictable mistakes in both directions. Seeing only formal structure means missing where real influence operates and trying to work through channels that don't actually move things. Seeing only informal influence means underestimating when formal authority actually matters — legal questions, financial sign-off, public representation — and being caught off guard when it exercises itself. Skilled operators see both layers and choose which to engage based on the specific situation. The text identifies this as the core skill underlying all three categories of power dynamics covered in the lesson.`,
            },
            {
              word: `Pfeffer`,
              definition: `Jeffrey Pfeffer, professor at Stanford, has spent decades studying power dynamics in organizations. His book "Power: Why Some People Have It and Others Don't" (2010) argues that academic and professional success often depends as much on understanding power dynamics as on technical capability. The empirical finding is that people who can read power dynamics accurately advance and accomplish more than equally talented people who cannot.`,
              audioPrompt: `Pfeffer refers to Jeffrey Pfeffer, a professor at Stanford who has spent decades studying power dynamics in organizations, {name}. His book "Power: Why Some People Have It and Others Don't," published in 2010, is one of the core sources for the framework in this lesson. Pfeffer's central argument: academic and professional success often depends as much on understanding power dynamics as on technical capability. The framing is uncomfortable for many people who prefer to believe organizations are pure meritocracies — that the best ideas win and the most skilled people advance. The empirical pattern Pfeffer documents is more complicated. People who can read power dynamics accurately — who understand where influence flows, how coalitions form, what formal authority actually means in practice — advance and accomplish more than equally talented people who cannot. This is not an argument for manipulation. Pfeffer's framework is descriptive: this is how groups actually work. The implication for ethical operators is that power literacy makes you more effective at advancing good ideas, working through the right channels, and building coalitions for things that matter — not just at personal advancement.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `Feature of formal power: formal authority typically applies to specific domains rather than generally. The principal has authority over school operations but not over what families do at home. The judge has authority on legal questions but not on what the parties think privately. Authority is bounded by the domain the role covers. People who act as if formal authority in one domain transfers to others are usually wrong and often damage the informal influence they do have.`,
              audioPrompt: `Bounded authority is a key feature of formal power described in this lesson, {name}. Formal authority typically applies to specific domains rather than generally. The principal has authority over school operations but not over what families do at home. The committee has authority to approve certain proposals but not to override decisions outside its mandate. The CEO has authority to make certain business decisions but the legal department limits what those decisions can be on legal questions. The boundedness of formal authority is one of the things that distinguishes it from informal influence, which can sometimes span domains if the underlying trust and expertise are broad. When people with formal authority act as if their authority in one domain transfers automatically to others, they are usually wrong — and the overreach often damages the informal influence they do have. A principal who starts giving advice to families about their home lives has overstepped the bounded authority that comes with the role. Part of reading formal power accurately is understanding where specific formal authority actually ends.`,
            },
            {
              word: `subverted compliance`,
              definition: `Pattern where formal authority produces nominal compliance but not actual action. People nominally follow orders or formally agree to decisions while informally subverting them through slow execution, selective implementation, or quiet undermining. Common when formal authority is insufficiently backed by informal influence. Formal leaders who give orders that get subverted often don't realize it; the nominal compliance makes it invisible.`,
              audioPrompt: `Subverted compliance is the pattern where formal authority produces nominal agreement but not actual change, {name}. The text names it directly: people with formal authority often discover they have less actual influence than the role suggested. They give orders that get nominally followed but slowly subverted. They make decisions that get formally accepted but informally undermined. The nominal compliance makes the problem invisible — on paper everything is moving forward, in practice little has changed. This is why formal authority alone is rarely sufficient for actual action. The formal layer authorizes a decision; the informal layer determines whether the decision actually gets implemented with energy and fidelity. A new manager who directs experienced employees through formal authority alone, without building informal influence, often finds that their directions are technically followed while actually ignored. The employees know twenty ways to comply technically while preventing the outcome the manager intended. Building enough informal influence alongside formal authority — through relationships, demonstrated competence, earned trust — is what prevents subverted compliance from being the default response.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `social capital`,
              definition: `One source of informal influence: the accumulated trust, goodwill, and relationship networks a person has built within a group. People with high social capital are known and trusted by many; others consult them, defer to their judgment, and support their initiatives. Social capital is earned through consistent reliability, fairness, and genuine helpfulness. It is one of the most durable sources of informal influence and often persists through changes in formal structure.`,
              audioPrompt: `Social capital is one of the sources of informal influence described in this lesson, {name}. It refers to the accumulated trust, goodwill, and relationship networks a person has built within a group or organization. People with high social capital know many people in a group and are trusted by most of them. Others consult them informally before decisions, defer to their judgment on questions outside any specific expertise, and support their initiatives because the relationship history gives them confidence. Social capital is different from expertise: expertise is domain-specific knowledge and competence, while social capital is more about the relational trust that spans domains. A person can have high social capital without being the top expert in any specific area. Social capital is earned through consistent reliability — doing what you say you'll do — combined with genuine helpfulness and perceived fairness. It builds slowly over time and is one of the most durable sources of informal influence. Unlike formal authority, which transfers when the role changes, social capital is held by the individual and persists through organizational changes. The civil rights movement and many other significant historical changes were driven by people who had accumulated social capital far beyond any formal authority they held.`,
            },
            {
              word: `influence from expertise`,
              definition: `One source of informal influence: people known for genuine competence in relevant areas gain influence beyond what their formal role might suggest. Expertise-based influence is domain-specific — it applies where the expertise is relevant. Can operate alongside, above, or even against formal authority. Often more durable than formal authority because it's based on actual demonstrated capability rather than just a role assignment.`,
              audioPrompt: `Influence from expertise is one of the named sources of informal influence in groups, {name}. People known for genuine competence in areas relevant to the group's work gain informal influence beyond what their formal role might suggest. The text gives a clear example: the most experienced employee on the marketing team who has no management title but whose opinion new employees and even managers defer to because her expertise is evident. Expertise-based influence is domain-specific: it applies where the expertise is relevant and does not automatically transfer to other areas. An expert in one technical domain does not automatically gain informal influence on organizational culture questions, for example. This is one way it differs from social capital, which can span domains. Expertise-based influence can operate alongside, above, or even against formal authority. A formally designated project manager might defer to a technically expert team member on technical questions even though the org chart points the other way. The expert has informal influence from demonstrated capability; the manager has formal authority from the role. Both are real. Reading which is primary in a given situation is part of what power literacy requires.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `issue-based alignment`,
              definition: `The pattern by which coalitions form and dissolve based on specific issues rather than reflecting permanent alliances. A coalition that aligns around one question may dissolve or even reverse on the next question. People who appear to be enemies on one issue may be allies on another. Reading specific coalitions on specific issues matters more than assuming permanent alliances. "Politics makes strange bedfellows" recognizes this pattern.`,
              audioPrompt: `Issue-based alignment is the pattern by which coalitions form and dissolve around specific questions rather than reflecting permanent alliances, {name}. The text states it directly: coalitions form and dissolve based on issues. A coalition that aligns around one question may dissolve or even reverse on the next question. People you thought were enemies on one issue may be allies on another. This is one of the important patterns for reading coalition power accurately. People who analyze groups by looking for permanent factions — the always-aligned group A against the always-aligned group B — miss a lot of what's actually happening. Real coalition patterns are more fluid. Marketing and sales often share interests against operations on budget questions, but may split on marketing strategy questions where their interests diverge. Senior students may align on one year's project decision but split on another. The "politics makes strange bedfellows" phrase in the text recognizes that political history is full of examples of apparent enemies aligning around shared specific interests. The skill for reading coalition power is watching which specific issues produce which specific alignments — and not assuming that any coalition will hold across all questions.`,
            },
            {
              word: `collective resource pooling`,
              definition: `One source of coalition power: aligned actors can pool budget, time, attention, expertise, and reputation in ways that uncoordinated individuals cannot. Coalition members can vouch for each other, divide labor strategically, and present a coordinated front that multiplies each member's individual capacity. Numbers, pooled resources, and coordination together explain why coalitions can produce outcomes that no individual member could achieve acting alone.`,
              audioPrompt: `Collective resource pooling is one of the mechanisms through which coalition power operates, {name}. The text identifies several sources of coalition power: numbers, pooled resources, coordination, and reputation reinforcement. Collective resource pooling refers specifically to the ability of aligned actors to combine budget, time, attention, and expertise in ways that uncoordinated individuals cannot match. A single teacher advocating for lab equipment funding has her individual time, attention, and credibility to spend. Three teachers who have coordinated their advocacy can pool all of these: they divide which meetings each attends, which parents they communicate with, which messages they emphasize to the principal, and they vouch for each other's positions. The coordination multiplies the effective resources beyond what any individual could bring. Coalition members can also pool reputation: each member's credibility reinforces the others, and together they represent a broader constituency than any one member alone does. The three-teacher coalition represents the science department; the individual teacher represents herself. This is why the text identifies resource pooling as one of the key sources of coalition power, alongside numbers and coordination — together, these three explain why coalitions consistently produce outcomes that individual actors cannot achieve acting alone.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `behavior over stated structure`,
              definition: `Principle for reading power dynamics accurately: when stated organizational charts diverge from actual behavior, behavior is usually the more reliable signal. Who actually consults whom, who actually defers to whom, what actually gets done versus what's nominally agreed — these behavioral patterns reveal the real power structure underneath the stated one. The stated chart shows who is supposed to have influence; behavior shows who actually does.`,
              audioPrompt: `Behavior over stated structure is the principle the text identifies for reading power dynamics accurately, {name}. Stated organizational charts are one source of information. Actual behavior is another. When the two diverge, behavior is usually the more reliable signal. Pay attention to who consults whom, who defers to whom, who supports whom, what gets done versus what's nominally agreed. The stated chart tells you who is formally supposed to have influence; the behavioral patterns reveal who actually does. Consider a sports team: the coach has formal authority over lineup decisions, but if the coach consistently asks one player's opinion before deciding, that player's behavioral influence is real regardless of what the formal structure shows. Or a company: the CEO has formal authority, but if every significant decision requires the CFO's informal approval first, the CFO's real influence exceeds what the org chart shows. Reading the behavioral signals rather than just the stated structure is how power literacy becomes practically useful. The gap between stated structure and behavioral reality is often where the most important dynamics operate — and where naive actors consistently get surprised.`,
            },
            {
              word: `power literacy compounds`,
              definition: `The principle that skill in reading power dynamics compounds across thousands of group situations over a lifetime. Most adults read power dynamics partially but not systematically, picking up some patterns through experience while missing others. Building explicit literacy at 12 puts a person ahead of most working professionals on a skill that shapes effectiveness in nearly every group role — team, school, family, organization, professional environment.`,
              audioPrompt: `Power literacy compounds is the compounding-skill principle applied specifically to reading group dynamics, {name}. The text states it directly: this skill compounds across thousands of group situations over a lifetime. Most adults read power dynamics partially but not systematically. They pick up some patterns through experience — often after being burned by misreading a situation — while missing others. Building explicit literacy at twelve means starting with a working framework rather than having to discover it through accumulated costly mistakes. The compounding happens because the skill applies to every group situation: family dynamics, school teams, sports teams, friend groups, religious or community organizations, and eventually every professional setting. Each group you read accurately adds to the pattern library. Each correct identification of where influence actually flows gives you a data point for reading the next situation faster. Most working adults have gaps in their power literacy that limit their effectiveness without their realizing it. They work through channels that don't move things. They miss coalition dynamics that are determining outcomes. They treat formal authority as more determinative than it is, or less. Explicit literacy built early closes those gaps systematically rather than leaving them to be discovered through years of confusion.`,
            },
          ],
        },
