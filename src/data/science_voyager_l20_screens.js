      ...
      screens: [
        {
          id: `l20-welcome`,
          type: `welcome`,
          guideText: `{name}, this is it, the final lesson of your entire journey through science. Across twenty lessons, you've traveled from the inside of a cell to the edge of the cosmos, from the laws of motion to the nature of knowledge itself. Now, in this last lesson, we step back and ask the biggest question of all: what does science mean for us, for human society, for the world, and for the future you'll help shape? Science is not done in a sealed laboratory, separate from life. It is one of the most powerful forces in human history, and it flows out into society, transforming how we live, what's possible, and what we must decide together. This lesson is about that relationship between science and society. We'll see how science and technology have utterly transformed human life, in medicine, communication, energy, food, transport, lifting billions out of darkness, disease, and ignorance, while also creating new powers and new dangers. We'll grasp the double-edged nature of scientific knowledge: the very same discoveries that heal can harm, that connect can divide, that empower can endanger, because knowledge itself is neutral, but how we use it is not. We'll explore why, in a scientific age, science is everyone's business: that the biggest decisions, about climate, technology, health, the future of life, aren't for scientists alone, but for all of us, as citizens, which means scientific literacy is a form of power and responsibility. And we'll think about you, your generation, and the future, the discoveries yet to come, the problems yet to solve, and the role you might play. Then, fittingly, we'll close not with a single answer but with a debate among five voices on the role science should play in shaping our future, so you can form your own view. This is your world, and your future. Let's finish the journey. Onward.`,
