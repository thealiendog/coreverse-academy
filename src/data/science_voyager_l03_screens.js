      ...
      screens: [
        {
          id: `l03-welcome`,
          type: `welcome`,
          guideText: `{name}, last lesson you learned to read the code of life. Now we reach something staggering: humans can edit it. CRISPR is a molecular tool that lets scientists cut and rewrite DNA with precision. It is already curing genetic diseases, revolutionizing medicine, and raising the hardest ethical questions in modern biology. Understanding how it works — and what it should and shouldn't do — is part of being an informed citizen in the twenty-first century.`,
