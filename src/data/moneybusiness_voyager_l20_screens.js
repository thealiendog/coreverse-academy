      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `The tendency to increase spending as income rises, preventing wealth accumulation. A major obstacle to Philosophy 1 (financial independence): earning more but also spending more leaves the savings rate unchanged and compounding never accelerates.`,
              audioPrompt: `Lifestyle inflation is the tendency to increase spending as income rises, preventing wealth accumulation, {name}. When income grows from $50,000 to $80,000 and spending also grows to match, the savings rate stays the same and wealth accumulation doesn't accelerate. Lifestyle inflation is one of the main reasons people with high incomes can still struggle to build wealth. Philosophy 1, financial independence, specifically addresses this by emphasizing saving a fixed high percentage of income and keeping lifestyle spending restrained even as income grows. Each raise, if captured as additional savings rather than additional spending, dramatically accelerates compounding. Recognizing lifestyle inflation as a pattern helps you make deliberate choices about it rather than drifting into it by default.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `Questions where evidence clearly resolves the matter regardless of values. Compound interest math, MLM income distributions, SPIVA data on active management. These deserve confident answers, not continued debate.`,
              audioPrompt: `Settled empirical questions are questions where evidence clearly resolves the matter regardless of values, {name}. The math of compound interest doesn't depend on your values. Five hundred dollars per month at 8% over 40 years really does produce about 1.5 million dollars, and no value framework changes that number. The SPIVA data showing that 80 to 90% of active managers underperform their index benchmarks over 10-year periods is settled. MLM income distributions showing 99% of participants lose money or earn below minimum wage are documented across decades. These questions deserve confident answers based on the evidence. Treating settled empirical questions as if they're contested is itself a thinking error that produces worse decisions.`,
            },
            {
              word: `contested normative questions`,
              definition: `Questions where values drive disagreement even with all the evidence available. Whether to pursue ESG investing, what tax level is right, whether to prioritize security or meaning. Evidence informs these but can't fully resolve them.`,
              audioPrompt: `Contested normative questions are questions where values drive disagreement even with all the evidence available, {name}. Should investors screen for ESG? Should taxes be higher or lower? Should you prioritize financial security or meaningful work? Real philosophers, economists, and thoughtful citizens disagree about these questions. Evidence informs the debate: we know something about ESG returns, something about tax and growth relationships, something about well-being research. But the right answers for your life also depend on your values about freedom, fairness, and what you owe others. Treating contested normative questions as if they had obvious empirically correct answers is the mirror error to treating settled questions as contested. Both errors produce worse thinking.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `tax-advantaged accounts`,
              definition: `Investment accounts with special tax benefits: 401(k) and IRA contributions reduce taxable income now or grow tax-free. Maximizing these accounts is one of the highest-return actions available for wealth building across any philosophy.`,
              audioPrompt: `Tax-advantaged accounts are investment accounts with special tax benefits, {name}. A 401(k) or traditional IRA allows you to contribute pre-tax money, reducing your taxable income now and letting the investment grow tax-deferred until withdrawal. A Roth IRA takes after-tax money but lets the investment grow and be withdrawn tax-free. Maximizing contributions to these accounts is one of the highest-return actions available for long-term wealth building, regardless of which of the three philosophies you hold. The tax savings compound alongside the investment returns. Most financial advisors prioritize maxing tax-advantaged accounts before taxable investing. Understanding these accounts is foundational to any serious wealth-building strategy.`,
            },
            {
              word: `financial independence`,
              definition: `A state where investment income or accumulated wealth is sufficient to cover living expenses without requiring paid employment. Not the same as being rich. A person with modest expenses and adequate savings can reach financial independence at lower net worth than someone with higher expenses.`,
              audioPrompt: `Financial independence is a state where investment income or accumulated wealth is sufficient to cover living expenses without requiring paid employment, {name}. It is not the same as being rich. A person with modest expenses of $40,000 per year who has accumulated $1 million in investments may be financially independent if their investments produce $40,000 or more in annual returns. The amount of wealth needed for financial independence depends on your expenses, not on an absolute dollar threshold. This insight is central to Philosophy 1 and the FIRE movement: by keeping expenses low, financial independence becomes achievable sooner. The combination of aggressive saving, index investing, and expense management is what makes the math work.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `deliberate choices`,
              definition: `Conscious, informed decisions made with awareness of alternatives and tradeoffs. Contrasted with defaults — the financial life shaped by employer 401(k) options, social media influence, and inertia. Deliberate choices compound differently than defaults.`,
              audioPrompt: `Deliberate choices are conscious, informed decisions made with awareness of alternatives and tradeoffs, {name}. Most adults' financial lives are shaped by defaults: whatever their employer offers in their 401(k), what their friends do, what social media suggests, and what they remember from one article they read once. Defaults produce drifting financial lives that often don't align with what people actually value. Deliberate choices require more effort upfront but compound differently over time. The person who explicitly chooses their savings rate, their investment approach, their insurance coverage, and their ethical framework for spending is building a different life than the person who accepts whatever is easiest. That difference compounds across decades.`,
            },
            {
              word: `financial mistakes`,
              definition: `Poor financial decisions. Everyone makes them. The frameworks from 20 lessons protect against the worst categories — catastrophic debt, scheme losses, predatory insurance — while leaving room to learn from smaller ones.`,
              audioPrompt: `Financial mistakes are poor financial decisions, and everyone makes them, {name}. The frameworks built across these 20 lessons protect against the worst categories: catastrophic debt from predatory lending, scheme losses from MLMs and day trading, predatory insurance products, manipulated purchases. Beyond those major protections, you have permission to experiment, learn, and grow from smaller mistakes. Financial wisdom is not built by avoiding all mistakes but by not making the catastrophic ones while learning from the manageable ones. The pattern recognition built across these lessons means you're unlikely to make the same type of mistake twice once you've seen the pattern. That's the goal: not perfection, but continuous improvement from a protected foundation.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `drifting`,
              definition: `Allowing your financial life to be shaped by defaults — employer plans, social influence, inertia — rather than by deliberate choices. Most adults drift financially. Designing your financial life is the alternative.`,
              audioPrompt: `Drifting is allowing your financial life to be shaped by defaults rather than by deliberate choices, {name}. Most adults drift: they accept whatever their employer offers in their 401(k), follow what their peers do with money, avoid thinking hard about insurance or taxes, and react to financial pitches without frameworks for evaluation. The cumulative result of drifting is a financial life that may not align with what they actually value. Designing your financial life is the alternative: making conscious, informed choices about savings rate, investment approach, insurance, career, and ethics. The gap between drifting and designing compounds enormously across decades. You're explicitly choosing not to drift. That choice, made consistently, builds a different life.`,
            },
            {
              word: `personal financial philosophy`,
              definition: `An explicit statement of what you value about money, how you want to earn and spend it, and what kind of financial life you're building. Rare among adults. The capstone project is to build one at 12.`,
              audioPrompt: `A personal financial philosophy is an explicit statement of what you value about money, how you want to earn and spend it, and what kind of financial life you're building, {name}. It is rare among adults. Most people have implicit assumptions about money that were formed by their parents, their culture, and their experiences without ever being examined. An explicit personal financial philosophy is different: it names your values, your strategy, your ethical framework, and your relationship to money. The capstone project in this band asks you to build one. Many adults never do this exercise. Doing it at 12 gives you a foundation you can refine across decades. Re-reading it at 20, 30, and 50 will show you how your thinking has evolved. That evolution is the point.`,
            },
          ],
        },
