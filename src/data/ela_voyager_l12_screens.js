      ...
      screens: [
        {
          id: `l12-welcome`,
          type: `welcome`,
          guideText: `{name}, imagine you've gathered six different articles on a complicated question, each saying something a little different, some agreeing, some clashing, some looking at the problem from angles the others never considered. A weak writer would just summarize them one after another: this article says X, that article says Y, this third one says Z. That's a book report, not a real essay. Synthesis is the higher skill, and it's one of the most important you'll ever learn: weaving multiple sources together into a single, coherent argument that is entirely your own. In synthesis, you're not a reporter listing what others said; you're a conductor, bringing many voices together to play a piece of music you composed. You find where sources agree and build on it, where they clash and explain why, where one fills a gap another left open. And through it all, your own original thesis stays in command, using the sources as evidence rather than letting them run the show. This is how real thinkers handle a complex world: not by parroting one source, but by reading many and forging something new. Today you learn to conduct that orchestra. Onward.`,
