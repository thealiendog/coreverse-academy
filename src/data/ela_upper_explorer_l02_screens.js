// ─────────────────────────────────────────────────────────────────────────────
// ELA UE  |  L02 — Author's Purpose and Perspective
      ...
      screens: [
        ...
        // ── SECTION 1 — WHY AUTHORS WRITE ─────────────────────────────────────
        {
          ...
          vocab: [
            ...
            },
            {
              ...
              audioPrompt: `To inform means to teach, {name}. When an author's purpose is to inform, they use facts, numbers, and neutral language — nothing pulling on your feelings, just the information. Textbooks, encyclopedias, news reports, and how-to guides are all written primarily to inform. The tone stays calm and even, and the goal is knowledge, not emotion.`,
            },
          ],
        },
        ...
        // ── SECTION 4 — WHAT'S LEFT OUT ──────────────────────────────────────
        {
          ...
          paragraphs: [
            ...
            `Strong readers ask three questions: What's included? What's NOT included? Whose voice is missing from this story? You don't have to throw out every text that has some bias — almost every text has some. You just have to know it's there, so you can read smart instead of swallowing whatever you're handed.`,
          ],
          ...
          vocab: [
            {
              ...
              audioPrompt: `Bias is a one-sided slant, {name}. It shows up when an author leaves out important information that would weaken their case. An ad for a candy bar that doesn't mention sugar — that's bias. A history book that only tells one country's version of events — that's bias. Bias doesn't always mean the writing is bad. It just means the writer had a side. Strong readers spot it and read accordingly.`,
            },
            {
              word: `omission`,
        ...
        // ── INTERACTIVE GAME — Investigation: Four Texts, One Question ────────
        {
          ...
          guideText: `Investigation time, {name}. Four short text samples coming up. For each one, your job: figure out the author's purpose — inform, persuade, or entertain? Watch the signals. Watch the tone. Watch what's included and what's not.\n\nOne of these is trickier than it looks. Stay sharp.`,
          options: [
          ...
          cases: [
            ...
            },
            {
              ...
              explanation: `The first sentence sounds informational ("Studies show..."). But notice the rest — a specific brand name, "many parents are switching," and "Order today" with a free-shipping offer. That last line is the giveaway: information doesn't ask you to buy. This is an ad in disguise. One of the most important skills you can learn: spotting persuasion that's pretending to be information.`,
            },
          ],
        },
          ...
          questions: [
            ...
            { id: `l02-q3`, format: `multiple-choice`,
              ...
              options: [
                ...
                `The attitude or feeling of the writing — calm, urgent, funny, serious, etc.`,
        ...
        // ── REAL-WORLD ────────────────────────────────────────────────────────
        {
          ...
          creativePrompt: {
            ...
            stretch: `Write 8–10 sentences. Cover the purpose, the signals, the perspective, AND what the author left out. Use specific examples from the text or video.`,
...
if (import.meta.env?.DEV) {
  ...
  console.log(`[LESSON-ELA-UE-L02 v1] Loaded with ${mags} magazine sections, ${totalVocab} vocab terms, ${game} game cases, ${quiz} quiz Qs, ${refl} reflection prompts`);
}
