      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            {
              word: `Guernica`,
              definition: `Picasso's enormous 1937 painting made after warplanes bombed a Spanish town, which became one of history's most powerful anti-war images: a tangle of screaming figures that says more about the horror of war than a thousand news reports. It did not stop the war, but it shaped how generations understood it and still travels the world as a symbol. An artwork can become the memory a society keeps.`,
              audioPrompt: `Guernica is Picasso's enormous 1937 painting made after warplanes bombed a Spanish town, {name}. It became one of history's most powerful anti-war images: a tangle of screaming figures that says more about the horror of war than a thousand news reports could. It did not stop the war. It could not do that. But it shaped how generations understood the war, and it still travels the world today as a symbol. That is the thing about a great artwork, it can become the memory a society keeps. Long after the news moves on, long after the immediate fight is over, the image remains and keeps saying what it said. Picasso made "Guernica" in 1937, and people are still standing in front of it, being stopped by it, being changed by it. A painting cannot pass a law or end a conflict. But it can burn an event into the conscience of the world in a way that dry reporting often cannot. That is a real form of power, slow and deep rather than fast and direct, but no less real. When a single image becomes the symbol that a whole struggle is remembered through, the person who made that image has done something that matters.`,
            },
            {
              word: `Víctor Jara`,
              definition: `Chilean musician whose story became a global symbol. Across Latin America, the "Nueva Canción" (new song) movement used folk music to carry messages of justice and resistance under harsh governments, and Víctor Jara became a global symbol when he was killed during the 1973 coup. Music does something posters and paintings cannot: it is sung by many mouths at once, turning a crowd into a single voice.`,
              audioPrompt: `Víctor Jara is a Chilean musician who became a global symbol, {name}. Across Latin America, the movement called "Nueva Canción," which means "new song," used folk music to carry messages of justice and resistance under harsh governments. Jara was one of its most important voices. When he was killed during the 1973 coup in Chile, he became something larger than a single musician: a symbol of what happens when a government fears the power of a song. His story matters here because it shows what music can do that posters and paintings cannot. Music is sung by many mouths at once. When a crowd sings the same song together, something changes: they stop being scattered individuals and start feeling like one voice, one body. That is part of why movements reach for music in particular. It does not just carry a message from one person to another the way a poster does. It turns the act of receiving the message into a shared act, and sharing changes how it feels, makes it something you hold together rather than alone. Jara understood that. Powerful people understood it too, which is why they feared him.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `propaganda`,
              definition: `Art used to push a one-sided message designed to control how people think, especially by a government or a powerful group. Propaganda uses the same tools as protest art — striking images, stirring music, powerful symbols — but aims them at making people obey, hate, or stop questioning, rather than at opening their eyes. The skill is not to love all moving art and fear none; it is to notice what the moving art is trying to do to you.`,
              audioPrompt: `Propaganda is art used to push a one-sided message designed to control how people think, {name}, especially when it comes from a government or a powerful group. That is the definition worth keeping. What makes it hard is that propaganda uses the exact same tools as protest art: striking images, stirring music, powerful symbols. The difference is not in the craft. The difference is in the aim. Protest art uses those tools to open your eyes. Propaganda uses them to make you obey, to make you hate, or to make you stop questioning. Tyrannical governments across the 20th century poured enormous resources into films, posters, parades, and music designed to glorify a leader, dehumanize a chosen enemy, and make citizens feel that questioning was betrayal. These works were often technically brilliant. And that is exactly what made them dangerous. We sometimes imagine propaganda as crude and obvious, easy to spot and resist. But the most effective propaganda is gorgeous and emotionally overwhelming, because beauty lowers your guard. A clumsy lie is easy to reject. A beautiful one slips past your thinking and goes straight to your feelings. So the skill you need is not to distrust everything beautiful. It is to notice what the beautiful thing is trying to do to you.`,
            },
            {
              word: `beauty lowers guard`,
              definition: `Why the most effective propaganda is gorgeous and emotionally overwhelming: beauty lowers your guard. A clumsy lie is easy to reject; a beautiful one slips past your thinking and goes straight to your feelings. Tyrannical governments poured resources into technically brilliant films, posters, parades, and music — and their craft is exactly what made them dangerous.`,
              audioPrompt: `Beauty lowers your guard is one of the most important warnings in this lesson, {name}. Here is what it means. We sometimes imagine propaganda as crude and obvious, easy to spot and dismiss. But that is not how the most dangerous propaganda works. Tyrannical governments across the 20th century poured enormous resources into technically brilliant films, posters, parades, and music. These works were gorgeously made: beautifully shot, stirringly scored, designed with real craft and skill. And that craft is exactly what made them dangerous. Because beauty lowers your guard. When something is clumsy and obvious, your thinking mind stays alert and skeptical. A crude lie is easy to reject. But a beautiful lie is different. It slips past your thinking and goes straight to your feelings. You are moved before you have reasoned about it. And once you are moved, it is much harder to step back and ask: wait, what is this actually telling me to do? Is this true? Is this fair? That is why being moved by something is not proof that the something is good or true. Being moved is a feeling. Truth is a separate question. And beautiful things can be very, very wrong.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `emotion argument`,
              definition: `The first mechanism by which art moves people: art bypasses the slow, careful part of your mind and hits the fast, feeling part first; you feel the image or the song before you have reasoned about it. That is why a photograph of a single suffering child can move a nation more than accurate statistics about millions — a fact that is both the beautiful power of art and its most dangerous lever.`,
              audioPrompt: `Emotion before argument is the first mechanism by which art moves people, {name}. It works like this: art bypasses the slow, careful part of your mind and hits the fast, feeling part first. You feel the image or the song before you have reasoned about it. You do not decide to be moved and then get moved. You are moved first, and thinking comes after, if it comes at all. That is why a photograph of a single suffering child can move a nation more than accurate statistics about millions. The statistics are more informative. They tell you more about the scale of the problem. But the photograph of the one child makes you feel something in a way the numbers cannot, because it bypasses reasoning and goes straight to your gut. The lesson here is both beautiful and a little scary. Beautiful, because the ability of art to make abstract suffering feel personal and real is genuinely important: it is how invisible pain gets seen. Scary, because the exact same bypass works for any feeling, not just compassion. Anger, fear, hatred, all of them can be triggered the same way. Emotion before argument is a lever. It can lift people toward justice or push them toward cruelty. That is why knowing it is the beginning of using it wisely.`,
            },
            {
              word: `the symbol`,
              definition: `The second mechanism by which art moves people: a simple image or object that comes to stand for a whole complicated idea, so that seeing it instantly summons the feeling. A raised fist, a particular color, a specific flag or face — these let a movement be recognized and felt in an instant, and let people show belonging by displaying them. The same mechanism serves protest art and propaganda alike.`,
              audioPrompt: `The symbol is the second mechanism by which art moves people, {name}. A symbol is a simple image or object that comes to stand for a whole complicated idea, so that seeing it instantly summons the feeling associated with that idea. A raised fist. A particular color. A specific flag or face. Each of these can carry enormous meaning in a single glance, meaning that would take paragraphs to explain in words. That compression is what makes symbols so powerful in movements. They let a cause be recognized and felt instantly, across languages, across distances. They let people show belonging just by displaying them: wearing a color, raising a hand. And they create that experience of shared feeling that a movement needs to hold together. But notice: the symbol does not make an argument. It does not reason with you. It reaches past reasoning and summons the feeling directly. That is its power. It is also exactly why symbols work just as well for propaganda as for protest. A symbol can summon solidarity or summon hatred. The question is never "is this a powerful symbol?" The question is always "what is this symbol asking me to feel, and is that feeling pointing me somewhere true?"`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `slacktivism`,
              definition: `Critics' word for when making or sharing political art becomes a substitute for harder action: you post the image, feel righteous, and do nothing else. Feeling like you helped is not the same as helping. A protest song does not pass a law; a powerful mural does not feed anyone. The worry is real, though the hopeful view pushes back: movements are made of people who act on what they feel and imagine, and art often creates the caring that makes organizing possible.`,
              audioPrompt: `Slacktivism is the word critics use when making or sharing political art becomes a substitute for harder action, {name}. Here is what that looks like: you see a powerful image about an injustice, you share it, you feel righteous about having done something, and then you go to bed and do nothing else. The image circulates. You feel good. But the law did not change. The hungry were not fed. Critics say: feeling like you helped is not the same as helping. A protest song does not pass a law. A powerful mural does not feed anyone. That worry is real. It names something you can actually watch happen online every day: endless powerful images about real suffering, circulated constantly, while the problems continue. And yet the hopeful view pushes back on this too. Movements are made of people. People act on what they feel and what they can imagine, not just on facts. Anything that changes hearts and minds changes what people are willing to do. Art has shifted what whole societies find acceptable, made invisible suffering visible, given courage to the frightened, and preserved the memory of people whom the powerful tried to erase. Laws often change only after feelings change first, and art is frequently what changes the feelings. So slacktivism is a real trap worth naming. And treating a repost as a substitute for real action is a genuine failure. But dismissing all of it because feeling is not the same as doing misses what feelings are actually for.`,
            },
            {
              word: `hearts minds`,
              definition: `From the paragraph: "anything that changes hearts and minds changes what people are willing to do." Movements are made of people, and people act on what they feel and imagine, not just on facts. Art has demonstrably shifted what whole societies find acceptable, made invisible suffering visible, given courage to the frightened, and preserved memory and identity. Laws often change only after feelings change first.`,
              audioPrompt: `Hearts and minds is the phrase that captures what art is actually doing when it works, {name}. Movements are made of people. And people do not act purely on facts and logic. They act on what they feel and what they can imagine. So anything that changes hearts and minds, that changes what people care about and what future they can picture, changes what those people are willing to do. That is the hopeful case for art's power, stated as precisely as possible. It is not that a song passes a law or a painting wins an election. It is that art does something upstream of those things: it makes invisible suffering visible, gives courage to people who are frightened, shifts what a whole society finds acceptable, and preserves the memory and identity of people whom the powerful tried to erase. And laws often change only after feelings change first. The civil rights movement had the music before it had the legislation. Nueva Canción carried resistance before the political changes came. Art's job in a movement is frequently not to win the argument but to make people care enough to have the argument, and to keep caring through the years of unglamorous work required to actually change things. Changing hearts and minds is the upstream work. Without it, the organizing often cannot find its wind.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `art as fuel`,
              definition: `Art is not usually the engine of change — the way a law or an election is — but it is often the fuel: it changes how people feel and what they can imagine, gives a scattered group a shared symbol and a shared voice, makes an abstract cause feel personal and urgent, and preserves the memory of a struggle long after the news cycle moves on. A movement still needs organizing, strategy, and often years of unglamorous work, but art is frequently what makes people care enough to do that work and keeps them going.`,
              audioPrompt: `Art as fuel is the careful distinction this lesson makes, {name}, and it is worth keeping precisely. Art is not usually the engine of change in the way a law or an election is. It does not, by itself, pass legislation, win a vote, or force a government to act. Asking art to single-handedly do those things is the wrong test. But art is often the fuel that makes change possible. Here is what that means. Art changes how people feel and what they can imagine. It gives a scattered group a shared symbol and a shared voice. It makes an abstract cause feel personal and urgent. It preserves the memory of a struggle long after the news cycle has moved on to something else. A movement still needs organizing. It needs strategy. It often needs years of unglamorous work that has nothing to do with art. But art is frequently what makes people care enough to do that work, and what keeps them going when the work is hard and slow and discouraging. That is what "Guernica" did. That is what the songs of the civil rights movement did. That is what Nueva Canción did across Latin America. Not the engine. The fuel. The distinction matters, because it lets you take art seriously without overclaiming what it does, and it protects you from the cynical dismissal that says "art does nothing" just because it did not pass a law.`,
            },
            {
              word: `switch off`,
              definition: `From the paragraph: "art that is trying to switch off your thinking." The goal of learning how art moves people is freedom: to be genuinely moved by art that deserves it, to make art that moves others toward good, and to recognize and resist art that is trying to switch off your thinking. In a world flooded with images and music designed to make you feel and act in particular ways, that freedom may be one of the most important skills there is.`,
              audioPrompt: `Switch off your thinking is the phrase that describes what the worst art is actually trying to do to you, {name}. Not every powerful, moving, beautiful piece of art is trying to help you think more clearly. Some of it is trying to do the opposite. It wants to make you feel something so fast and so overwhelmingly that your thinking never gets a turn. It wants you moved before you are reasoning, swept along before you have asked: what is this asking me to do, and is that the right thing? That is what "switch off your thinking" means. And recognizing it is the whole point of this lesson. The point is not to make you cold or suspicious of everything beautiful. Being moved by art is part of being human and is often exactly right. The goal is freedom: free to be genuinely moved by art that deserves it, free to make art that moves others toward good, and free to recognize and resist art that is trying to switch off your thinking. In a world absolutely flooded with images and music designed to make you feel and act in particular ways, that freedom, to be moved with your eyes open, is not a small thing. It may be one of the most important skills this whole band gives you. Use it.`,
            },
          ],
        },
