  ...
  lessons: [
    {
      ...
      screens: [
...

        {
          ...
          vocab: [
            {
              word: `art as the fuel of movements`,
...

        {
          ...
          vocab: [
            {
              word: `propaganda: the same power turned dark`,
...

        {
          ...
          vocab: [
            {
              word: `how art moves people: emotion, symbol, shared experience`,
...

        {
          ...
          vocab: [
            {
              word: `does art change anything? powerful and partial`,
...

        {
          ...
          vocab: [
            {
              word: `being moved with your eyes open`,
          ...
          questions: [
            {
              ...
              question: `In what way has art genuinely fueled social movements, and in what way has it NOT?`,
              options: [
                `Random`,
                `Art has genuinely fueled movements as the fuel that makes people care and keeps them going, not usually as the engine of change the way a law or election is. Concrete examples: Picasso's 1937 "Guernica" became one of history's most powerful anti-war images and shaped how generations understood war, even though it did not stop the war; songs gave the United States civil rights movement of the 1950s and 60s a shared voice and steadied protesters facing danger; and Latin America's Nueva Canción carried justice and resistance under harsh governments, with Víctor Jara becoming a global symbol after he was killed in the 1973 Chilean coup. What art does is change how people feel and what they can imagine, give a scattered group a shared symbol and voice, make an abstract cause feel personal, and preserve memory. What it does NOT usually do is directly pass laws or feed people by itself; a movement still needs organizing, strategy, and years of unglamorous work, but art is often what makes people care enough to do that work.`,
                `Just makes posters`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Art is usually the fuel, not the engine: it changes feeling, imagination, shared identity, and memory ("Guernica," civil rights songs, Nueva Canción), but the organizing and laws still take separate, unglamorous work.`,
            },
            {
              id: `q2`,
              type: `multiple-choice`,
              question: `What is propaganda, and why is the most effective propaganda often beautiful?`,
              options: [
                `Random`,
                `Propaganda is art used to push a one-sided message designed to control how people think, especially by a government or a powerful group; it uses the same tools as protest art, striking images, stirring music, powerful symbols, but aims them at making people obey, hate, or stop questioning rather than at opening their eyes. The most effective propaganda is often beautiful and technically brilliant precisely because beauty lowers your guard: we imagine propaganda as crude and obvious, but a clumsy lie is easy to reject, while a gorgeous, emotionally overwhelming one slips past your thinking and goes straight to your feelings. This is why twentieth-century tyrannies poured resources into beautifully made films, posters, parades, and music, their craft is exactly what made them dangerous. The key insight is that being moved by a work is not proof that the work is good or true; you have to ask what the moving work is actually trying to do to you.`,
                `Just ugly lies`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Propaganda is art aimed at making people obey, hate, or stop questioning. The most effective kind is beautiful because beauty lowers your guard, so being moved is never proof a work is good or true.`,
            },
            {
              id: `q3`,
              type: `multiple-choice`,
              question: `What honest questions help you tell protest art from propaganda when they use the same tools?`,
              options: [
                `Random`,
                `Because protest art and propaganda use identical tools, you cannot tell them apart by craft, so you ask about purpose and effect instead. Does the work invite you to think, or pressure you to stop thinking? Does it show its opponents as full human beings who happen to be wrong, or as monsters who are barely human? Does it admit any complexity, or is everything pure good versus pure evil? Is it asking you to feel something so you will understand, or so you will obey? None of these is a perfect test, and the line is genuinely blurry, since one person's "propaganda" can be another's "movement art" depending partly on where they stand. But the questions move you from being swept along to seeing clearly, which is the whole point: they shift you from reacting to the craft to examining the intent, which is where protest art and propaganda actually differ.`,
                `Just check the side`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Since the craft is identical, you ask about purpose and effect: does it invite thinking or forbid it, show opponents as humans or monsters, admit complexity, and make you feel so you understand or so you obey? Imperfect tests, but they shift you to seeing clearly.`,
            },
            {
              id: `q4`,
              type: `multiple-choice`,
              question: `What are the three main mechanisms by which art moves people, and why does knowing them matter?`,
              options: [
                `Random`,
                `First, emotion before argument: art bypasses the slow, careful part of your mind and hits the fast, feeling part first, which is why a photograph of a single suffering child can move a nation more than statistics about millions, art's beautiful power and its most dangerous lever at once. Second, the symbol: a simple image or object that comes to stand for a whole complicated idea (a raised fist, a color, a flag or face), so seeing it instantly summons the feeling and lets people show belonging. Third, shared experience, especially music and ritual: when people sing, march, or chant together, individuals start to feel like one body, building courage and commitment, which can bond people for justice or weld them into a mob. Knowing these mechanisms matters because it turns you from a target into a thoughtful participant, letting you be moved with your eyes open, feeling the emotion while noticing that you are feeling it. The most manipulated people are the ones who do not know how the manipulation works.`,
                `Just feelings`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Emotion before argument, the symbol, and shared experience; the same three serve protest art and propaganda. Knowing them lets you be moved with your eyes open, because the most manipulated people are those who do not know how manipulation works.`,
            },
            {
              id: `q5`,
              type: `multiple-choice`,
              question: `What is the strongest version of the SKEPTICAL view that art does not really change anything?`,
              options: [
                `Random`,
                `The strongest skeptical case: a song passes no law and a mural feeds no one, so art does not directly produce the concrete changes that actually matter, those come from organizing, money, votes, and law. Worse, making and sharing political art can become a substitute for harder action, you post the powerful image, feel righteous, and do nothing else, a trap critics call "slacktivism," where the good feeling of helping replaces actually helping. The evidence the skeptic points to is real: plenty of movements had stirring art and still lost, plenty of dull, artless organizing won real victories, and endless powerful protest images circulate online every day while the problems they depict continue. The skeptic's genuine strength is naming a real trap and insisting on real action. Its limit is that it underrates the upstream work art does, since the caring, courage, and imagination that fuel the organizing often come from exactly the art it dismisses, so "feeling" is often the beginning of change, not its opposite.`,
                `Just art is useless`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `The strong skeptical case: songs pass no laws, real change comes from organizing and votes, and political art can become slacktivism that replaces action. Its limit: it underrates how art creates the caring and courage that fuel the organizing in the first place.`,
            },
            {
              id: `q6`,
              type: `multiple-choice`,
              question: `What is the "powerful and partial" position on whether art changes the world?`,
              options: [
                `Random`,
                `The "powerful and partial" position holds both truths at once instead of picking a slogan. It accepts that art alone rarely changes the world, and that treating a repost or a shared image as if it were real action is a genuine trap worth avoiding. And it accepts that art is often an essential part of how change actually happens, the part that makes people care, gives them courage, and helps them imagine something different, without which the organizing and the laws would never get the wind behind them. So art is neither all-powerful ("art changes everything") nor useless ("art changes nothing"); it is one real force among several, capable of enormous good and enormous harm. The practical upshot is to use art well, pair it with real action rather than letting it replace action, and stay clear-eyed about both what it can do (shift hearts, imagination, courage, memory) and what it cannot do by itself (pass the law, feed the hungry, win the fight alone).`,
                `Just sometimes works`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `"Powerful and partial" holds both: art rarely changes things alone and reposting is not action, AND art creates the caring and courage change needs. It is one real force among several; use it well and pair it with real action.`,
            },
            {
              id: `q7`,
              type: `multiple-choice`,
              question: `What does the "who wields it?" view add to the debate about art and power?`,
              options: [
                `Random`,
                `The "who wields it?" view points out that protest art and propaganda use the same mechanisms, emotion, symbol, shared experience, so what separates them is never the craft but the purpose and honesty behind it. By this view, the mature question is not "is art good or bad?" (art is just a powerful tool, like a hammer that can build a house or break a skull) but "who is using it, toward what end, and does it open or close the audience's ability to think?" Its strength is cutting through the other debates by focusing on the actually-decisive questions: purpose, honesty, and whether the work invites thinking or forbids it, treats opponents as humans or monsters. Its limit is that "it depends who wields it" can become a way to dodge judgment entirely, because at some point you still have to decide whether a specific work in front of you is opening minds or manipulating them, and the tool framing alone will not make that call for you, you have to.`,
                `Just blame people`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `It reframes the question from "is art good or bad?" to "who wields it, why, and does it open or close thinking?", since the craft is identical. Its limit: that framing can dodge judgment, because you still must decide about the specific work in front of you.`,
            },
            {
              id: `q8`,
              type: `multiple-choice`,
              question: `Why does the lesson say its goal is to make you "free" rather than either cynical or naive?`,
              options: [
                `Random`,
                `Because the two failure modes are opposite and both are traps. Naivety means being swept up by whatever moves you most, trusting a work simply because it stirred you, which is exactly how beautiful propaganda succeeds. Cynicism means becoming suspicious of every beautiful thing, distrusting all moving art so completely that genuinely good art can no longer reach you, which is its own kind of loss. The freedom the lesson aims at is the middle: being free to be genuinely moved by art that deserves it, free to make art that moves others toward good, and free to recognize and resist art that is trying to switch off your thinking. This is "being moved with your eyes open", feeling the emotion while also noticing that you are feeling it, enjoying a symbol's pull while still asking what it stands for. In a world flooded with images and music engineered to make you feel and act in particular ways, that clear-eyed freedom is one of the most protective and important capacities a person can have.`,
                `Just be careful`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Naivety gets swept up by anything moving (how propaganda wins); cynicism distrusts all moving art (so good art can't reach you). Freedom is the middle: moved with your eyes open, able to be reached by good art and to resist manipulation.`,
            },
            {
              id: `q9`,
              type: `true-false`,
              ...
              correctAnswer: false,
              explanation: `False, and this is one of the most protective ideas in the whole lesson. Being moved by a work is not evidence that the work is true or its message trustworthy, because beauty and emotional power are exactly the tools that the most dangerous propaganda uses. The most effective propaganda is gorgeous and emotionally overwhelming precisely because beauty lowers your guard: a clumsy, ugly lie is easy to reject, but a beautiful one slips past your thinking and goes straight to your feelings. Twentieth-century tyrannies produced technically brilliant, deeply moving films, posters, and music whose craft is exactly what made them dangerous. Protest art that opens minds and propaganda that closes them use the identical mechanisms, emotion before argument, powerful symbols, the bonding force of shared experience, so the feeling a work produces in you cannot tell them apart. What can help tell them apart are questions about purpose and effect: does the work invite you to think or pressure you to stop, show opponents as full humans or as monsters, admit complexity or insist on pure good versus pure evil, ask you to feel so you understand or so you obey? The whole point of learning the mechanisms is to be able to feel a work's power and still keep your own ability to judge it, to be moved with your eyes open rather than trusting a message just because it stirred you.`,
            },
            {
              id: `q10`,
              type: `inference`,
              question: `Imagine you are 14 and a video spreads through your school: it is beautifully made, with stirring music and powerful images, and it pushes everyone to be furious at a particular group of people, showing them as barely human while showing "our side" as pure heroes. Your friends are sharing it and getting angry, and you feel the pull of it too. Using this whole lesson, what should you actually think and do?`,
              options: [
                `"Just share it"`,
                `Several things, held together, because this is the exact situation the whole lesson was built to prepare you for, and feeling the pull does not mean you have to obey it. First, notice that you are being moved, and name that out loud to yourself: the lesson's core skill is being moved with your eyes open, feeling the emotion while also noticing that you are feeling it, so the very fact that the video is stirring up strong, fast feeling is your cue to slow down and look harder, not to share faster. Second, run the propaganda-versus-protest-art questions on it deliberately, because they were built for exactly this: does this video invite you to think, or pressure you to stop thinking and just be angry? Does it show the group it targets as full human beings who might be wrong about something, or as monsters who are barely human? Does it admit any complexity, or is it pure good versus pure evil, with "our side" as flawless heroes and "their side" as villains? Is it asking you to feel something so you will understand the situation, or so you will obey and hate on command? A video that dehumanizes a whole group of people and paints one side as pure heroes fails these questions badly, and dehumanizing an entire group is one of the most reliable signatures of dangerous propaganda throughout history. Third, separate the craft from the truth, using the lesson's key warning: the fact that it is beautifully made, with stirring music and powerful images, is not evidence that its message is true, it is actually a reason for more caution, because the most effective and dangerous propaganda is the most beautiful, since beauty lowers your guard and slips past your thinking. So "it's really well made and it moved me and everyone's sharing it" is not a reason to trust it; it is the mechanism by which untrue, hateful messages spread. Fourth, recognize the shared-experience pull for what it is: your friends sharing it and getting angry together creates that "one body" feeling the lesson described, the bonding force of a crowd moving as one, which is powerful and double-edged, and right now it is welding people into shared fury at a dehumanized group, which is closer to a mob than a movement. Feeling that pull is normal and human; following it without thinking is the trap. Fifth, decide what to actually do: do not share it, because spreading something that dehumanizes a group of people does real harm regardless of how moving it is; and consider, gently and without being preachy, raising the questions with a friend you trust, not "you're all being manipulated," which just makes people defensive, but something like "it's really well made, but did you notice it makes that whole group look barely human and makes our side look perfect? That's kind of how propaganda works." Sixth, hold the deepest takeaway of the lesson: the goal is not to become cynical and distrust everything that moves you, nor naive and share whatever stirs you, but to be free, free to be moved by art that deserves it and free to recognize and resist art that is trying to switch off your thinking. A beautiful video built to make a crowd hate a dehumanized group is exactly the kind of thing this freedom is for resisting, and the most powerful, mature thing you can do in that moment is to feel its pull, see clearly what it is doing, and refuse to pass it on.`,
                `"Random"`,
                `"Just maybe"`,
              ],
              correctIndex: 1,
              explanation: `Applied art-and-power literacy on a real, high-stakes case. The move is to treat the strong fast feeling as a cue to slow down (be moved with your eyes open), run the propaganda questions (it dehumanizes a group and paints one side as pure heroes, failing them badly), recognize that its beauty is a reason for more caution not trust (the most dangerous propaganda is the most beautiful), see the crowd-bonding pull as mob-like here, and refuse to share it, ideally raising the questions with friends without being preachy. Dehumanizing a whole group is a classic propaganda signature, and resisting exactly this is what "being moved with your eyes open" is for.`,
            },
          ],
        },
