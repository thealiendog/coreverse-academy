      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            {
              word: `multiple income streams`,
              definition: `Multiple income streams is the term for the normal shape of a working creative career: stacking several small sources of money rather than relying on one big one. A working musician might combine streaming income, live shows, teaching lessons, merchandise, licensing a song to a commercial, and a part-time job. No single piece is large, but together they add up to a living. The lesson names this stacking pattern to protect you from the false belief that you either become famous or you fail. The same logic runs through every creative field: illustrators combine commissions, prints, workshops, and book deals; writers combine royalties, freelance articles, teaching, and speaking fees.`,
              audioPrompt: `Multiple income streams is the term for the normal shape of a working creative career, {name}. Rather than relying on one big source of money, most working creatives stack several small ones. A working musician might combine a little streaming income, plus playing live shows, plus teaching lessons, plus selling merchandise, plus licensing a song to a commercial, plus a part-time job. No single piece is large. Together they add up to a living. People call this stacking, or having multiple income streams. The lesson names it because knowing the shape protects you. It protects you from the false belief that you either become famous or you fail. The stacking pattern is not a sign of failure; it is the normal shape, the shape that most happy, stable creative careers actually take. The same logic runs through every field: illustrators combine commissions, prints, workshops, and book deals; writers combine royalties, freelance articles, teaching jobs, and speaking fees; filmmakers combine commercial work that pays the bills with passion projects that may never pay at all.`,
            },
            {
              word: `streaming math`,
              definition: `Streaming math is the term for the shocking numbers behind how little music streaming actually pays per play. The rate lands in the rough neighborhood of a third of a cent to half a cent per stream, meaning a song needs very roughly two hundred thousand to three hundred thousand plays just to earn a few hundred dollars, and that small sum is then often split among the songwriter, the performer, the record label, and others. A song with a million streams, which sounds like fame, might earn its creators only a few thousand dollars, divided several ways. This is why live shows, merchandise, and teaching matter so much: the streaming number alone almost never supports a creative living.`,
              audioPrompt: `Streaming math is the shorthand for one of the most shocking numbers in the lesson, {name}. Music streaming pays the artist astonishingly little per play. The rate lands in the rough neighborhood of a third of a cent to half a cent per stream. The exact rate shifts by platform and deal, but the ballpark holds. That means a song needs very roughly two hundred thousand to three hundred thousand plays just to earn a few hundred dollars. And that small sum is then often split among the songwriter, the performer, the record label, and others, who each take their share. So a song with a million streams, which sounds like fame, might earn its creators only a few thousand dollars, divided several ways. A million streams. A few thousand dollars. Split. That is the streaming math, and once you understand it, a lot of things about how modern music careers work start to make sense. It explains why the live show, the t-shirt, the teaching, and the licensing deal matter so much. For almost all working musicians, streaming is promotion and a small income stream, not the main living.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `copyright`,
              definition: `Copyright is the legal right to control who copies, sells, or uses your creative work. When you make a creative work, you usually own a copyright automatically. That ownership can earn you a royalty, a small payment every time your work gets used. If you keep your copyright, you can keep earning from one piece of work for decades. If you sell your copyright for a one-time payment, you lose all future earnings from that work. The lesson uses this as the foundation of the most important money idea in the creative world: understanding what your copyright is worth before you trade it away.`,
              audioPrompt: `Copyright is the legal right to control who copies, sells, or uses your creative work, {name}. When you make something, a song, a drawing, a book, you usually own the copyright to it automatically, without having to register anything or do anything special. That ownership matters because it can earn you a royalty, a small payment every time your work gets used. A songwriter's copyright earns a royalty each time the song is streamed, played on the radio, or used in a movie. An author's copyright earns a royalty on each book sold. The crucial point about copyright is what happens when you keep it versus when you sell it. If you keep your copyright, you can keep earning from that one piece of work for decades. If you sell your copyright for a one-time payment, you give up all of those future earnings. The lesson uses a concrete example: a songwriter is offered five thousand dollars to sign away the copyright to a song forever. If that song later earns fifty thousand dollars in royalties over ten years, the songwriter who sold the copyright gets none of it. The company that bought the copyright gets all of it. Understanding copyright is the foundation of the lesson's most important money idea.`,
            },
            {
              word: `royalty`,
              definition: `A royalty is a small payment a creator earns every time their copyrighted work is used. A songwriter earns a royalty each time their song is streamed, played on the radio, or used in a movie or commercial. An author earns a royalty on each copy of their book sold. The key feature of a royalty is that it keeps paying over time, as long as the work keeps being used. This is the difference between getting paid once (selling your rights for a lump sum) and getting paid forever (keeping your rights and collecting royalties). The lesson names royalties as the reason keeping your rights can protect you financially for decades.`,
              audioPrompt: `A royalty is a small payment that a creator earns every time their copyrighted work is used, {name}. A songwriter earns a royalty each time their song is streamed, played on the radio, or used in a movie or a television show. An author earns a royalty on each copy of their book that gets sold. The key feature of a royalty is that it keeps paying over time, every time the work gets used, as long as people keep streaming, buying, or licensing it. That is what makes royalties so valuable and why understanding them is the most important money idea in the creative world. A royalty is the mechanism behind getting paid forever, as opposed to getting paid once. If you keep your copyright, you keep collecting royalties. If you sell your copyright for a one-time payment, you give up every future royalty the work would have earned. A song with a royalty stream can support a creator for years or even decades from a single piece of work. That is the power of the royalty, and the reason the lesson says: understand what your rights are worth before you trade them away.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `power law`,
              definition: `A power law is the name for the chart shape that appears in almost every creative industry: a tiny number of works earn most of the money, while a huge number of works each earn a little. Picture a chart like a slide that drops steeply on the left and then flattens into a very long, low tail on the right. The steep part on the left is the few superstars; the long flat tail is millions of working creatives. This is not a glitch or unfairness in the usual sense; it is the natural shape of attention when a few things get shared, recommended, and copied far more than the rest. The lesson names it so you can plan for it: the most likely outcome of making creative work is the long tail, not the superstar peak, and planning for that is wisdom.`,
              audioPrompt: `A power law is the name for the shape that appears in nearly every creative industry, {name}. Picture a chart like a slide: it drops steeply on the left and then flattens into a very long, low tail stretching out to the right. The steep part on the left is the tiny number of works, and the tiny number of creators, who earn most of the money. The long flat tail to the right is the huge number of working creatives who each earn something real but modest. In music, film, books, and online video, a tiny number of works earn most of the total money. A huge number of works each earn a little. That is the power law. It is not a glitch in the system or unfairness in the usual sense. It is the natural shape of attention when a few things get shared, recommended, and copied far more than the rest. The lesson names it because knowing this shape helps you plan honestly. The most likely outcome of making creative work is not the superstar peak on the left. It is somewhere in the long flat tail, earning something real but modest. The lesson says: planning for that is wisdom, not pessimism.`,
            },
            {
              word: `long tail`,
              definition: `The long tail is the term for the large middle of the creative economy: the huge number of working creatives who each earn something real but modest, rather than the tiny superstar peak. In a power-law chart of any creative industry, the long tail is the part that drops steeply from the few superstars on the left and then flattens into a very long, low stretch to the right. The lesson says the most likely outcome of making creative work is to be somewhere in the long tail, earning something real but modest, which is the normal case. The happiest, most stable creatives usually built a life that works in the long tail, with a stack of income, a real if small audience, and control of their rights, rather than betting everything on the rare superstar outcome.`,
              audioPrompt: `The long tail is the term for the large middle of the creative economy, {name}. In the power-law chart that shapes every creative industry, the long tail is the part that drops steeply from the few superstars at the top and then stretches out flat and low to the right, representing the huge number of working creatives who each earn something real but modest. The lesson says: if you make creative work, the most likely outcome is somewhere in the long tail. Not total failure, but not the superstar peak either. Something real and modest. And the lesson says: that is the normal case, and planning for it is wisdom, not pessimism. The creatives who are happiest and most stable are usually the ones who built a life that works in the long tail: a stack of income, a real if small audience, control of their rights, a sustainable structure. Not the ones who bet everything on becoming the rare superstar and treated it as failure when they did not. The internet made the long tail much longer, since almost anyone can now publish to the whole world, while also making the superstar peak taller. Both are true at once.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `exposure trap`,
              definition: `The exposure trap is the situation where someone asks you to make creative work for free, in exchange for "exposure," promising the attention will be worth more than payment. The lesson names it a trap because very often the "exposure" offer is simply a way to get valuable work for free from someone who knows your work has value and hopes you do not. The honest test: would the person asking you to work for exposure also ask their plumber or their dentist to work for exposure? If not, they know your work has real value. The lesson notes that exposure can occasionally be worth it, when a real chance to be seen by the right audience can genuinely launch a career, but a profitable company getting a full set of professional work for free is usually the trap version.`,
              audioPrompt: `The exposure trap is the situation the lesson says you will personally face, maybe soon, {name}. When you are young and skilled, people will ask you to make creative work for free, in exchange for "exposure," promising that the attention will be worth more than payment. Sometimes that is genuinely true. A real chance to be seen by the right audience can launch a career. But very often the exposure offer is a way to get valuable work for free from someone who does not yet know what their work is worth, or more precisely, from someone who does know and is hoping you do not. The honest test is simple. Would the person asking you to work for exposure also ask their plumber to work for exposure? Would they ask their dentist to fill a cavity for free in exchange for telling people the dentist is good? If not, they know your work has real value. They just hope you do not. The lesson says: learning to say "I would love to, and here is what I charge" without apology is one of the most practical and protective skills in this entire lesson.`,
            },
            {
              word: `plumber test`,
              definition: `The plumber test is the honest check the lesson gives you for whether an "exposure" offer is a trap. When someone asks you to make creative work for free in exchange for "exposure," ask yourself: would they also ask their plumber or their dentist to work for exposure? If not, it means they know your work has real value and are hoping you do not. The test works because everyone recognizes that a skilled trade like plumbing or dentistry has real monetary value; creative work is real work the same way, and if the person asking would not use the exposure argument with any other skilled professional, they are counting on the fact that creative people often undervalue themselves.`,
              audioPrompt: `The plumber test is the honest check the lesson gives you for whether an exposure offer is a trap, {name}. It works like this. When someone asks you to make creative work for free in exchange for exposure, pause and ask: would this person also ask their plumber to fix the pipes for free in exchange for exposure? Would they ask their dentist to work on their teeth for free in exchange for mentioning them to friends? If the answer is no, then they know your work has real value. They just hope you do not. The test cuts through the flattery and the "be grateful for the opportunity" framing that often comes with exposure offers. It reminds you that creative work is real work. The skill that lets you draw, play, write, or edit took years to build, the same way a carpenter's or an electrician's skill took years. That skill is worth something. If you would not expect a plumber to work for free, you should not expect yourself to either. The plumber test is the fastest way to see through the exposure trap and remember what your work is actually worth.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `income stack`,
              definition: `An income stack is the combination of several small income sources that together make up a creative living. Most working creatives do not earn from one big source; they stack several small ones. A musician might stack streaming income, live shows, teaching lessons, merchandise, and licensing. An illustrator might stack commissions, print sales, workshops, and a book deal. No single piece in the stack is large, but together they add up to a living. The lesson names the income stack as the normal, healthy shape of a creative career, not a sign of failure, and understanding it protects you from the false belief that you either become famous or you fail.`,
              audioPrompt: `An income stack is the combination of several small income sources that together make up a creative living, {name}. Most working creatives do not earn from one big source. They stack several small ones. A working musician might stack streaming income, plus live shows, plus teaching lessons, plus selling merchandise, plus licensing a song to a commercial, plus a part-time job. No single piece is large. Together they add up to a living. An illustrator might stack client commissions, print sales, teaching workshops, and a book deal. A writer might stack book royalties, freelance articles, a teaching position, and speaking fees. The lesson names the income stack as the normal, healthy shape of a creative career. Not a sign of failure. Not a consolation prize for not becoming famous. The actual normal case for most working creatives. Understanding the income stack protects you from the false belief that you either become famous or you fail, and it helps you plan a real, sustainable creative life rather than waiting for one big break that may never come.`,
            },
            {
              word: `fine print`,
              definition: `Fine print refers to the detailed terms of a creative contract, which the lesson says is where the money actually lives. Who owns the work? Who gets what percentage? For how long? Can you get the rights back later? Real creative careers are made and broken on these details, not on talent alone. Plenty of hugely talented people have been poor because they signed bad contracts, and plenty of moderately talented people have done fine because they understood the business. The lesson's rule: you do not have to become a lawyer, but you do have to learn enough to know when to slow down, ask questions, and get help before you sign.`,
              audioPrompt: `Fine print refers to the detailed terms of a creative contract, and the lesson says it is where the money actually lives, {name}. Fine print is the boring-looking part people are often told to skip or sign quickly. But careers are made and broken on exactly the details in that fine print, not on talent alone. Who owns the work? That is the fine print. Who gets what percentage of earnings? That is the fine print. For how long does the deal last? Fine print. Can you ever get your rights back? Fine print. The lesson points out something important: plenty of hugely talented people have been poor because they signed bad contracts without reading the fine print carefully. And plenty of moderately talented people have done well because they understood the business side well enough to protect themselves. You do not have to become a lawyer. But you do have to learn enough to know when to slow down, ask questions, and get help before you sign. A contract full of words you do not understand, delivered under pressure to sign today, is not an opportunity. It is the moment to slow down. The fine print is where the lesson's most important money ideas all land in practice.`,
            },
          ],
        },
          ...
          questions: [
            {
              ...
              question: `How do most working creatives actually make a living, according to the lesson?`,
              options: [
                `From one single big steady paycheck, much like a normal salaried office job would pay.`,
                `By becoming famous first, since you can't earn until you're a star.`,
                `By stacking multiple small income streams — the normal, non-failure shape of a career.`,
                `From a single viral hit that pays for the rest of their life.`,
              ],
              correctIndex: 2,
              explanation: `Working creatives stack multiple small income streams; that's the normal, healthy shape of a career, not a sign of failure. The "one big source" and "famous or failed" pictures are myths. The distractors are exactly those myths — the single salary, the fame-first gate, and the one viral hit.`,
            },
            {
              id: `q2`,
              type: `multiple-choice`,
              question: `A song gets a million streams but earns its creators only a few thousand dollars. Why?`,
              options: [
                `Streaming services secretly refuse to pay artists anything at all.`,
                `A million streams isn't actually very many plays in the first place.`,
                `The artist simply forgot to register the song properly, so all of the money quietly disappeared.`,
                `Streaming pays a fraction of a cent per play and splits it several ways, so shows and merch carry the income.`,
              ],
              correctIndex: 3,
              explanation: `Streaming pays a fraction of a cent per play and is then split among several rights-holders, so even a million streams yields only a few thousand dollars — which is why live shows, merch, and teaching carry the real income. The distractors invent total non-payment, downplay a million plays, or blame a registration error.`,
            },
            {
              id: `q3`,
              type: `multiple-choice`,
              question: `The lesson contrasts "getting paid once" with "getting paid forever." What's the difference, and why does it matter?`,
              options: [
                `Keeping your rights lets you earn royalties for years; a one-time buyout can cost you far more later.`,
                `Getting paid once is always smarter because money now beats money later.`,
                `There's no real difference — both pay the same total over time.`,
                `Royalties only exist for superstars, so ordinary creators should always take the buyout.`,
              ],
              correctIndex: 0,
              explanation: `Keeping your rights lets you earn royalties from one work for years; a one-time buyout can cost you far more down the line. The skill is knowing what your rights are worth before trading them away. The distractors dismiss future value, deny the difference, or wrongly claim royalties are only for stars.`,
            },
            {
              id: `q4`,
              type: `multiple-choice`,
              question: `The "long tail" / power law describes most creative markets. What does it mean for someone making creative work?`,
              options: [
                `Everyone earns roughly the same amount, so income is basically equal.`,
                `A few works take most of the money while a long tail of creators each earns a little.`,
                `Only the very top earns anything, so there's no point trying at all.`,
                `The longer that you keep working at it, the more fully guaranteed your earnings will become.`,
              ],
              correctIndex: 1,
              explanation: `A power law means a few works capture most of the money while a long tail of creators each earns a little — and the likely, normal outcome is the long tail, so planning for it is wisdom rather than failure. The distractors flatten the curve to equality, exaggerate it to hopelessness, or promise guaranteed growth.`,
            },
            {
              id: `q5`,
              type: `multiple-choice`,
              question: `Someone offers you "exposure" instead of pay. What's the lesson's honest test for whether that's a trap?`,
              options: [
                `Whether the project sounds fun enough to be worth doing for free.`,
                `Whether they have a lot of followers who might see your work.`,
                `Whether they'd ask their plumber or dentist to work for exposure — if not, they know your work has value.`,
                `Whether you happen to have enough spare time that particular week to take the project on.`,
              ],
              correctIndex: 2,
              explanation: `Ask whether they'd ask their plumber or dentist to work for exposure. If not, they know your work has value and are hoping you don't. Creative work is real work; name your value without apology. The distractors substitute fun, follower count, or free time for the actual test.`,
            },
            {
              id: `q6`,
              type: `multiple-choice`,
              question: `Why does the lesson say the fine print of a contract matters as much as talent — and what are the warning signs?`,
              options: [
                `It doesn't really; talent always wins out over paperwork in the end.`,
                `Because the contract is where the money lives — and "sign fast" or "everybody signs these" are red flags.`,
                `Because long, detailed contracts prove that a company is serious, careful, and fully trustworthy.`,
                `Because the only thing that matters in a contract is the total dollar amount on page one.`,
              ],
              correctIndex: 1,
              explanation: `The contract is where the money lives; careers turn on who owns what, for how long, and at what percentage. Pressure to sign fast or "everybody signs these" are warning signs to slow down. The distractors dismiss the paperwork, treat length as trust, or fixate on a single headline number while ignoring the terms.`,
            },
            {
              id: `q7`,
              type: `multiple-choice`,
              question: `The internet reshaped the creative economy. Why does the lesson call its effect "double-edged"?`,
              options: [
                `Because it helped musicians but hurt every other kind of creator.`,
                `Because it basically made everything free, which means no one earns anything from creative work now.`,
                `Because it briefly helped creators and then stopped mattering.`,
                `It made the tail longer (anyone can publish) and the superstar peak taller, both at once.`,
              ],
              correctIndex: 3,
              explanation: `The internet made the tail longer (anyone can publish) and the superstar peak taller (recommendation engines amplify a few) at the same time, so the world is both more open and more winner-take-most — both halves are true. The distractors pick one medium, claim total free-ness, or deny lasting impact.`,
            },
            {
              id: `q8`,
              type: `multiple-choice`,
              question: `If money isn't the point of art, why does the lesson insist on understanding the economics anyway?`,
              options: [
                `Understanding the money protects the part that isn't about money: it prevents exploitation and burnout.`,
                `Because the real, secret goal of making art is actually to get as rich as possible after all.`,
                `Because artists who ignore money are more authentic and admirable.`,
                `Because economics is the only serious part of a creative career.`,
              ],
              correctIndex: 0,
              explanation: `Understanding the money protects the part that isn't about money: it keeps you from being exploited, burning out, or going broke, so you can keep making the work you love. The unromantic skill protects the romantic thing. The distractors flip the point (get rich), romanticize ignorance, or overclaim that only economics matters.`,
            },
            {
              id: `q9`,
              type: `true-false`,
              ...
              correctAnswer: false,
              explanation: `False, and this is one of the most important reframes in the lesson. The long-tail power law shows that in any creative field a tiny number become famous stars (the tall part of the curve) while a huge number of genuinely successful, working creatives make their living in the long tail through steady freelance, commercial, and stacked income. The long tail isn't where failures end up; it's where the normal, stable, often happiest creative lives actually happen. Betting everything on stardom is statistically like buying a lottery ticket — thrilling but very unlikely to pay — and treating "I didn't become a superstar" as "I failed" is exactly the misread that makes people miserable or makes them quit. The wise path is usually a blend: building steady skill-based income that pays the bills and keeps you making work, while still taking real, non-all-or-nothing shots at bigger things. Choosing a sustainable creative life isn't a consolation prize; for almost everyone, it's the actual success, and planning for it is wisdom rather than a confession of failure.`,
            },
            {
              id: `q10`,
              type: `inference`,
              question: `You're 15 and genuinely talented at music. A self-described "manager" messages you: they'll make you a star, but you must sign today giving them 50% of everything you ever earn, forever, and pay a $2,000 "starter fee" up front. They say real artists move fast and hesitating means you're not serious. Using the whole lesson, what do you think and do?`,
              options: [
                `Sign immediately — a real manager wouldn't offer this if it weren't a great deal.`,
                `Pay the $2,000 to show you're serious, then negotiate the percentage later.`,
                `Refuse to be rushed, never pay an up-front fee, get a trusted adult and ideally someone who knows contracts to review it, and recognize that slowing down is the skill.`,
                `Counter-offer 40% forever and the fee paid in installments.`,
              ],
              correctIndex: 2,
              explanation: `Applied creative-economy self-protection. Every warning sign is present: pressure to sign immediately, an enormous permanent cut (50% forever), and money flowing FROM the artist TO the "manager" — a red flag, since real managers earn when you earn. The move is to refuse to be rushed, never pay an up-front fee, get a trusted adult and ideally someone who knows contracts to review it, and recognize that slowing down is the skill, not a sign of being unserious. The distractors all accept the manipulation in some form — signing, paying, or haggling over a deal that should be walked away from.`,
            },
          ]
        },
