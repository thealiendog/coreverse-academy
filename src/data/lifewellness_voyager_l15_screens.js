      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            {
              word: `beauty sickness`,
              definition: `Renee Engeln's term for the cognitive, emotional, and behavioral cost of constantly evaluating and being evaluated for appearance. Symptoms include body monitoring, body shame, body dissatisfaction, and disordered eating, all of which increase measurably with exposure to beauty-evaluation environments. Engeln's research at Northwestern treats beauty sickness as a documented condition with structural causes, not just a matter of individual self-esteem.`,
              audioPrompt: `Beauty sickness is Renee Engeln's term for the cognitive, emotional, and behavioral cost of constantly evaluating and being evaluated for appearance, {name}. Engeln's research at Northwestern documents consistent findings: body monitoring, body shame, body dissatisfaction, and disordered eating all increase with exposure to beauty-evaluation environments. The term "beauty sickness" frames what happens not as a personal failing or a matter of individual self-esteem but as a condition produced by structural conditions — specifically, by the volume of beauty-evaluation content that people are exposed to in current media environments. Engeln's book "Beauty Sick" from 2017 synthesizes decades of research on this condition in girls, women, and increasingly boys and men. The practical implications of the beauty sickness framework are important: reducing exposure to beauty-evaluation content produces measurable improvements in body satisfaction, and the intervention is at the environment level (what you're exposed to) rather than just the individual attitude level (how you think about your body). This is one reason the critical and structural position argues that media literacy and exposure management are as important as individual cognitive work.`,
            },
            {
              word: `body dysmorphic disorder`,
              definition: `A clinical condition involving preoccupation with perceived appearance flaws that significantly impairs functioning. Distinct from ordinary body dissatisfaction in that the preoccupation is severe, persistent, and interferes with daily life. Adolescent rates of body dysmorphic disorder and disordered eating have risen substantially over the past 15-20 years, correlating with image-based media expansion. Significant appearance distress affecting functioning warrants professional support, not just frameworks.`,
              audioPrompt: `Body dysmorphic disorder is a clinical condition involving preoccupation with perceived appearance flaws that significantly impairs functioning, {name}. The lesson distinguishes it from ordinary body dissatisfaction: body dysmorphic disorder involves preoccupation that is severe, persistent, and disrupts daily life in measurable ways. It is one of two clinical conditions the lesson highlights — the other being disordered eating, which exists on a spectrum from occasional restrictive eating to clinical eating disorders including anorexia nervosa, bulimia nervosa, and binge eating disorder. Adolescent rates of both conditions have risen substantially over the past 15 to 20 years, correlating with image-based media expansion. The lesson distinguishes carefully between functional body image concerns (what frameworks and media literacy address) and clinical distress (what professional support addresses). If appearance concerns are significantly affecting functioning — eating has become complicated, mood is substantially affected, body monitoring is interrupting daily activities, or symptoms of clinical conditions are present — that is beyond what the frameworks in this lesson can address. Professional support resources include the National Alliance for Eating Disorders helpline at 1-866-662-1235, school counselors, and pediatricians.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `object-subject shift`,
              definition: `The cognitive reorientation body neutrality proposes: moving from relating to your body as an object being evaluated (how does it look?) to relating to it as the subject living through experience (what is it doing? what can it do?). The shift removes the appearance-evaluation frame rather than trying to improve performance within it, which research suggests produces more durable reductions in beauty sickness.`,
              audioPrompt: `The object to subject shift is the core cognitive move that body neutrality proposes, {name}. Centering function rather than appearance shifts the relationship with the body from object-being-evaluated to subject-living-through. When your body is an object, the relevant questions are about how it looks from the outside — does it meet standards, how is it being perceived, does it measure up. When your body is the subject, the relevant questions are about what it does and experiences — what can it move through, what does it feel, what does it make possible. The lesson notes that this shift reduces beauty sickness measurably, because it removes the appearance-evaluation frame entirely rather than trying to feel better within that frame. Body neutrality's practical suggestions follow directly from this shift: when you catch yourself evaluating your appearance, redirect to what your body is doing or capable of; develop language for what your body is doing rather than how it looks ("I'm tired," "I felt strong climbing those stairs"); build identity sources that don't require body evaluation at all. The shift is more achievable than "love how you look" and more stable because it doesn't depend on meeting any particular standard.`,
            },
            {
              word: `comparison loop`,
              definition: `The self-reinforcing pattern in which appearance evaluation triggers comparison to images or standards, which produces dissatisfaction, which triggers more evaluation. Body neutrality's strategy for breaking the comparison loop is to exit the appearance-evaluation frame entirely rather than trying to win within it. Research on social media and body image (Tiggemann, Fardouly) shows the loop is particularly strong with image-based content.`,
              audioPrompt: `The comparison loop is the self-reinforcing pattern in which appearance evaluation triggers comparison to standards or images, which produces dissatisfaction, which triggers more evaluation and monitoring, {name}. Body neutrality's strategy for breaking the loop is to exit the appearance-evaluation frame entirely rather than trying to win within it. The lesson notes this as one of the position's strengths: rather than competing with or trying to feel better about comparisons, body neutrality removes the comparison frame as the reference point for self-evaluation. Research from Marika Tiggemann, Jasmine Fardouly, and others shows that the comparison loop is particularly strong with image-based social media content. Even brief exposure to image-based platforms produces measurable decreases in body satisfaction in adolescents, and the effect is strongest for people who are already prone to comparing themselves to images they see. Reducing exposure to the images that trigger comparisons — auditing your media diet for body-evaluation content — is a structural approach to weakening the comparison loop, complementary to the cognitive body neutrality reorientation.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `fat acceptance`,
              definition: `A political movement with roots in the 1960s arguing that fat people deserve equal dignity, respect, and freedom from discrimination regardless of health status or appearance. One of the foundational influences on contemporary body positivity. The fat acceptance movement predates the broader body positivity movement and is more explicitly political: it argues against weight discrimination in employment, healthcare, and other domains where fat people face documented disadvantage.`,
              audioPrompt: `Fat acceptance is a political movement with roots in the 1960s arguing that fat people deserve equal dignity, respect, and freedom from discrimination regardless of health status or appearance, {name}. It is one of the foundational influences on contemporary body positivity, and it predates the broader body positivity movement. The fat acceptance movement is more explicitly political than the popular body positivity framing: it argues against weight discrimination in employment, healthcare, housing, and other domains where fat people face documented disadvantage. The lesson notes that fat people experience documented discrimination in employment, healthcare, and many other domains. Fat acceptance and disability rights are two of the movements whose political critiques have most shaped the body positivity framework at its most substantive. When the lesson describes body positivity as having real political dimensions beyond just "feel good about yourself," fat acceptance is a significant part of what gives it that depth. The movement's political critique — that larger bodies have been subjected to systemic discrimination while being told the solution is to change the body rather than challenge the discrimination — is distinct from the individual-wellbeing framing that often dominates popular body positivity content.`,
            },
            {
              word: `industry co-optation`,
              definition: `The process by which industries that originally created a problem adopt the language of the movement responding to that problem, using it to sell products that reproduce the original harm. Body positivity is the lesson's example: companies use "body positive" marketing to sell the same beauty, diet, and appearance products that produce body dissatisfaction. Co-optation narrows a political critique into a consumer product.`,
              audioPrompt: `Industry co-optation is the process by which industries that originally created a problem adopt the language of the movement responding to it, using that language to sell products that reproduce the original harm, {name}. Body positivity is the lesson's primary example of this pattern. The body positivity movement emerged as a political critique of beauty industries profiting from body dissatisfaction. Those same industries subsequently adopted "body positive" marketing language to sell beauty products, diet supplements, fitness programs, and clothing — the same categories of products that produce body dissatisfaction in the first place. A company that sells makeup, for example, may run advertising with "body positive" messaging while its products still exist on the premise that appearance enhancement has value. A fitness brand may use diverse body representation in marketing while still selling programs based on appearance transformation as the goal. The lesson identifies co-optation as one of the limits of body positivity as a framework: the language has been sufficiently absorbed by industries that "body positive" now appears in marketing from companies whose business model depends on body insecurity. This is why the critical and structural position argues for targeting the industry mechanics themselves rather than just changing the marketing language.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `body monitoring`,
              definition: `One of the three layers in Lindsay and Lexie Kite's "More Than a Body" framework: constantly checking how your body looks, treating it as an object to be observed and evaluated. Body monitoring is distinct from awareness of your body's sensations and functions. High levels of body monitoring are associated with reduced performance on cognitive tasks, interrupted engagement in other activities (body image disruption), and increased body dissatisfaction.`,
              audioPrompt: `Body monitoring is one of the three layers in Lindsay and Lexie Kite's framework from "More Than a Body," {name}. It means constantly checking how your body looks — treating your body as an object to be observed and evaluated from the outside, rather than as the subject you inhabit from the inside. The Kite framework identifies three layers: body objectification, which is treating your body as an object to be evaluated; body monitoring, which is the practice of constantly checking how it looks; and body image disruption, which is what happens when body monitoring interrupts other activities you're trying to do. The lesson notes that the Kite intervention isn't loving your body or being neutral about it but building "body image resilience" through media literacy, awareness of objectification, and identity development from sources that aren't about appearance. Reducing body monitoring specifically — catching the moments when you're checking your appearance and redirecting to what your body is doing — is one of the practical applications of the critical and structural framework. High levels of body monitoring are associated with reduced performance on cognitive tasks, because cognitive resources that could go to the task are being used on appearance evaluation instead.`,
            },
            {
              word: `manufactured insecurity`,
              definition: `The process by which advertising and marketing create dissatisfaction with aspects of appearance that previously were not considered problems, in order to sell products that address the newly created concern. The lesson describes beauty, diet, fitness-as-appearance, and advertising industries as having direct financial interest in body dissatisfaction because their products solve problems they helped create. Recognizing manufactured insecurity is a key media literacy skill in the critical/structural framework.`,
              audioPrompt: `Manufactured insecurity describes the process by which advertising and marketing create dissatisfaction with aspects of appearance that previously were not considered problems, in order to sell products that address the newly created concern, {name}. The lesson describes beauty, diet, cosmetic surgery, fitness-as-appearance, and advertising industries as having direct financial interest in your body dissatisfaction, because their products solve problems they helped create. This is the critical and structural position's central argument about why beauty standards exist in their current form: not because human beings naturally feel bad about their bodies, but because industries have invested substantially in creating and sustaining body dissatisfaction as the condition that makes their products necessary. Naomi Wolf's "The Beauty Myth," Susie Orbach's "Bodies," and Renee Engeln's research all engage with this pattern from different angles. Recognizing manufactured insecurity as a specific process — identifying when a new "problem" has been introduced by marketing rather than arising naturally — is one of the media literacy skills the critical and structural position equips you with. The practical question to ask when encountering beauty or body content is: who benefits financially if I feel bad about this aspect of my body?`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `media diet audit`,
              definition: `A deliberate review of the accounts, content, and platforms you regularly consume, examining which ones trigger body monitoring or appearance evaluation and deciding whether to reduce or eliminate that exposure. The lesson recommends auditing your media diet for beauty-evaluation content as a practical application of the critical/structural framework. Research on social media and body image shows that reducing exposure to image-based beauty content produces measurable improvements in body satisfaction.`,
              audioPrompt: `A media diet audit is a deliberate review of the accounts, content, and platforms you regularly consume, examining which ones trigger body monitoring or appearance evaluation, {name}. The lesson recommends this as a practical application of the critical and structural framework. What it involves: going through the accounts you follow and the content you regularly see, noticing which ones consistently prompt you to evaluate your appearance or compare your body to images, and making deliberate decisions about whether to continue that exposure. The research from Tiggemann, Fardouly, and others shows that even brief exposure to image-based social media produces measurable decreases in body satisfaction, and that reducing exposure produces measurable improvements. The media diet audit operationalizes this: it is a specific action that reduces the structural conditions producing beauty sickness, rather than just trying to think differently about your body while continuing to consume the same content. The lesson's practical implications include reducing exposure to content that triggers body monitoring; reducing exposure to "fitspiration" and beauty content specifically, which research shows has the strongest negative effects on body satisfaction; and building awareness of which specific accounts and content consistently produce body-evaluation patterns.`,
            },
            {
              word: `identity beyond appearance`,
              definition: `The practice of building and reinforcing sources of self-worth and identity that don't require appearance evaluation. The lesson identifies this as a key practical intervention recommended across all three positions, and as one of the best-supported approaches for reducing body image vulnerability. Identity sources beyond appearance include skills, relationships, contributions, values, and interests — any dimension of self-concept that isn't contingent on how the body looks.`,
              audioPrompt: `Identity beyond appearance refers to the practice of building and reinforcing sources of self-worth and identity that don't require appearance evaluation, {name}. The lesson identifies this as a key practical intervention recommended across all three body image positions. Body neutrality recommends building identity sources that don't require body evaluation at all. Body positivity at its most substantive argues for identity not reducible to any appearance standard. The critical and structural position, particularly the Kite and Kite framework, names "more than a body" identity development as one of the core components of body image resilience. What this looks like in practice: deliberate investment in aspects of self-concept that aren't contingent on how the body looks — skills, relationships, contributions, values, curiosity, creative work, athletic capability (distinct from athletic appearance). The practical significance is that identity sources beyond appearance buffer against beauty sickness. When your sense of self isn't primarily located in appearance, exposure to beauty-evaluation content has less power to undermine your self-concept. Building these identity sources at 12 shapes what your relationship with your body looks like across decades.`,
            },
          ],
        },
