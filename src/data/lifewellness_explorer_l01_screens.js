  ...
  lessons: [
    {
      ...
      screens: [
        ...
        // ── 6. INTERACTIVE — Drag-match ─────────────────────────────────────
        {
          ...
          config: {
            buckets: [
              { id: 'everyday',  label: `🌱 Everyday Nourishing Foods`, color: '#34D399' },
              { id: 'sometimes', label: `🎉 Sometimes Foods`,           color: '#F59E0B' },
            ],
            items: [
              {
                id:            'l01-g1',
        ...
        // ── 7. QUIZ ──────────────────────────────────────────────────────────
        {
          ...
          questions: [
            ...
            // Q5 — Fill-blank (fresh)
            {
              ...
              options:      ['macronutrients', 'micronutrients', 'vitamins', 'minerals'],
              correctIndex: 0,
        ...
        // ── 8. REAL-WORLD ────────────────────────────────────────────────────
        {
          ...
          type: 'real-world',
          content: {
            scenario:    `Food Noticing Day`,
            description: `Pay attention to how different foods make you feel today — not just how they taste, but your energy and focus an hour later. That noticing is the beginning of understanding your own body.`,
            ...
            realWorldConnection: `Every athlete, every growing child, and every person who wants to feel their best is working with the same question: what does my body need today? Nutrition is how you answer it.`,
          },
        },
