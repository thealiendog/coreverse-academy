  ...
  lessons: [
    {
      ...
      screens: [
...

        {
          ...
          ,
            {
              word: `empirical method`,
              definition: `The approach to knowledge based on observation, measurement, controlled tests, and peer review. Has produced results including the age and size of the observable universe, the composition of cosmic energy, the life cycles of stars, and the basic laws of motion and gravity. Does not directly answer questions about what cosmic facts mean for human existence.`,
              audioPrompt: `The empirical method is the approach to knowledge based on observation, measurement, controlled tests, and peer review, {name}. Across this band, the empirical method has produced spectacular results: we know the age and size of the observable universe, the composition of cosmic energy, the life cycles of stars, and the basic laws of motion and gravity. These are real achievements. But none of this directly tells us what those cosmic facts mean for human existence. That question lives in a different intellectual domain. The empirical method is the right tool for answering questions about how the universe works. Questions about what it means to live inside that universe are engaged through a different kind of intellectual work — philosophy, reflection, and frameworks for thinking about meaning.`,
            },
            {
              word: `cosmic purpose`,
              definition: `The idea that the universe has a purpose or direction imposed by some external or transcendent source. Scientific naturalism argues meaning is constructed by humans rather than given by cosmic purpose. Religious cosmologies locate meaning in transcendent sources. Philosophical nihilism confronts the absence of cosmic purpose directly. The three traditions interpret this concept differently.`,
              audioPrompt: `Cosmic purpose is the idea that the universe has a purpose or direction imposed by some external or transcendent source, {name}. Different traditions engage with this idea very differently. Scientific naturalism, in the tradition of Carl Sagan and Sean Carroll, argues that meaning is something humans construct, and cosmic purpose imposed from outside is not required for a life to be deeply meaningful. Religious cosmologies locate meaning at least partly in transcendent sources beyond what science can investigate. Philosophical nihilism confronts the absence of cosmic purpose directly, arguing that the authentic response is to live fully in the face of it. The word "meaning" itself can refer to many things: what makes a human life worth living, what humans should care about, or how to orient one's existence in a vast universe. Part of evaluating these traditions is noticing which interpretation of meaning each one uses.`,
            }
          ],
        },

        {
          ...
          ,
            {
              word: `Carl Sagan`,
              definition: `American astronomer and science communicator who articulated the scientific naturalist case for cosmic meaning in his 1980 series "Cosmos" and his 1994 book "Pale Blue Dot." Core idea: we are matter that has become aware of itself. The cosmic story does not need supernatural supplementation to be profoundly meaningful.`,
              audioPrompt: `Carl Sagan was an American astronomer and science communicator who articulated the scientific naturalist case for cosmic meaning, {name}. In his 1980 series "Cosmos" and his 1994 book "Pale Blue Dot," Sagan developed a central idea: we are matter that has become aware of itself. We are the way the universe knows itself. The same atoms forged in stellar explosions billions of years ago have, through immense improbability and time, organized themselves into beings that can reflect on their own origin. The cosmic story does not need to be supplemented by anything supernatural to be profoundly meaningful. Sagan was an explicit scientific naturalist who would not have endorsed cosmic-consciousness or manifestation framings. His "we are the universe knowing itself" was about consciousness being a natural feature of evolved matter, not about a conscious universe responding to human intentions.`,
            },
            {
              word: `Pale Blue Dot`,
              definition: `Carl Sagan's 1994 book developing the scientific naturalist case for cosmic meaning. The title refers to the photograph of Earth taken by Voyager 1 in 1990 from 6 billion kilometers away, showing Earth as a tiny point of light. Used by Sagan to argue that cosmic scale generates humility and meaning rather than insignificance.`,
              audioPrompt: `Pale Blue Dot is Carl Sagan's 1994 book developing the scientific naturalist case for cosmic meaning, {name}. The title refers to a photograph of Earth taken by the Voyager 1 spacecraft in 1990 from approximately 6 billion kilometers away, in which Earth appears as a tiny point of light — a pale blue dot — suspended in a sunbeam against the darkness of space. Sagan used this image as the basis for an extended meditation on what cosmic scale implies for how we should treat each other and our planet. The book argues that cosmic facts, properly understood, generate humility, wonder, and meaning. We don't need to invent a special cosmic status for humanity to find our situation deeply significant. The sheer improbability of conscious beings existing at all is, in Sagan's framing, meaning enough.`,
            }
          ],
        },

        {
          ...
          ,
            {
              word: `Georges Lemaître`,
              definition: `Belgian astronomer and Catholic priest who proposed the first version of what became the Big Bang theory in 1927. His work demonstrates that serious scientific cosmology and religious commitment have coexisted in the same person. Most religious traditions in their mainstream forms accept the cosmological timeline Lemaître helped establish.`,
              audioPrompt: `Georges Lemaître was a Belgian astronomer and Catholic priest who proposed the first version of what became the Big Bang theory in 1927, {name}. His work is significant for the science-and-religion conversation because it demonstrates that serious scientific cosmology and deep religious commitment have coexisted in the same person. Lemaître did not experience his religious faith and his cosmological work as being in conflict. Most religious traditions, including most Christian denominations and most Jewish, Muslim, Hindu, and Buddhist traditions, accept the standard cosmological timeline that Lemaître helped establish: 13.8 billion years of cosmic history. Mainstream religious cosmologies provide frameworks for interpreting the scientific facts about the universe, not for replacing them.`,
            },
            {
              word: `John Polkinghorne`,
              definition: `British physicist and Anglican priest who developed a serious theological engagement with contemporary scientific cosmology. Formerly Professor of Mathematical Physics at Cambridge. Author of "Belief in God in an Age of Science" (1998). Distinguishes his views from young-earth creationism and other positions he considers untenable while defending serious theistic interpretations.`,
              audioPrompt: `John Polkinghorne is a British physicist and Anglican priest who developed one of the most rigorous theological engagements with contemporary scientific cosmology, {name}. He was formerly Professor of Mathematical Physics at Cambridge before being ordained as an Anglican priest. His 1998 book "Belief in God in an Age of Science" engages with specific questions: the relationship between divine action and natural law, the nature of evil in a created universe, and the implications of quantum mechanics for theology. Polkinghorne is careful to distinguish his views from young-earth creationism and intelligent design, positions he considers untenable. He acknowledges the strongest naturalist arguments rather than dismissing them. His work is representative of serious religious cosmology at the level of academic theology, not popular religious apologetics.`,
            }
          ],
        },

        {
          ...
          ,
            {
              word: `Albert Camus`,
              definition: `French philosopher and writer who in "The Myth of Sisyphus" (1942) argued that the universe is genuinely indifferent to human existence and that the only authentic response is to revolt by living fully despite this indifference. Used the Greek myth of Sisyphus as a metaphor for human existence: meaningless in any cosmic sense yet capable of being lived with dignity.`,
              audioPrompt: `Albert Camus was a French philosopher and writer who engaged with cosmic meaninglessness in his 1942 work "The Myth of Sisyphus," {name}. Camus argued that the universe is genuinely indifferent to human existence, and that the only authentic response to this indifference is revolt: living fully and deliberately in the face of it. He used the Greek myth of Sisyphus, who was condemned to push a boulder up a hill forever only to watch it roll back down, as a metaphor for human existence. Meaningless in any cosmic sense, yet capable of being lived with dignity and even joy. Camus concluded: one must imagine Sisyphus happy. Camus did not retreat from cosmic indifference or paper it over with comforting frameworks. He drove an ambulance during World War II while writing his great works on absurdity.`,
            },
            {
              word: `absurdism`,
              definition: `The philosophical position associated with Camus arguing that human existence is characterized by an irresolvable conflict between our desire for meaning and the universe's silence. The authentic response is not despair or denial but revolt: continuing to live with full engagement in spite of the absurdity. A variant of existentialism rather than pure nihilism.`,
              audioPrompt: `Absurdism is the philosophical position associated with Albert Camus arguing that human existence is characterized by an irresolvable conflict, {name}. We desire meaning, purpose, and clarity. The universe offers silence. This conflict — between human longing and cosmic indifference — is what Camus called the absurd. His position differs from pure nihilism. The nihilist might say the absence of meaning justifies despair or withdrawal. Camus rejected this. He argued that the authentic response to the absurd is revolt: continuing to live with full engagement, full consciousness, and even joy, in spite of the absurdity. "The Myth of Sisyphus" concludes that one must imagine Sisyphus happy. Absurdism is a variant of existentialism rather than pure nihilism. It takes cosmic meaninglessness seriously while refusing the conclusion that life cannot be lived richly.`,
            }
          ],
        },

        {
          ...
          ,
            {
              word: `wellness culture`,
              definition: `A broad ecosystem of content, products, and practices claiming to promote well-being, often borrowing vocabulary from scientific, religious, and philosophical traditions without doing the underlying intellectual work. Offers versions of cosmic meaning such as "the universe wants you to succeed" and "you are a high vibrational being" that do not represent serious engagement with any of the three meaning traditions.`,
              audioPrompt: `Wellness culture is a broad ecosystem of content, products, and practices claiming to promote well-being, {name}. It often borrows vocabulary from real intellectual traditions — from physics, from religious cosmology, from existentialism — without doing the underlying work. Claims like "the universe wants you to succeed" or "you are a high vibrational being aligning with cosmic consciousness" sound profound but typically do not engage with the actual content of scientific naturalism, religious cosmology, or philosophical nihilism. Serious scientific naturalism, serious religious cosmology, and serious philosophical nihilism all require more intellectual work than the wellness versions suggest. Real defenders of any of the three traditions would decline to endorse the specific claims. The reward of engaging with the serious traditions is cosmic meaning at full depth rather than at the marketing level.`,
            },
            {
              word: `meaning framework`,
              definition: `A structured way of thinking about what makes a human life worth living within the context of cosmic facts. Different people hold different meaning frameworks, often without having explicitly examined them. The three traditions examined in this lesson — scientific naturalism, religious cosmology, and philosophical nihilism — each constitute a meaning framework.`,
              audioPrompt: `A meaning framework is a structured way of thinking about what makes a human life worth living within the context of cosmic facts, {name}. Different people hold different meaning frameworks, often without having consciously examined them. Many adults default to whatever framework their family of origin transmitted, without ever considering alternatives. The cost is going through life with a meaning framework they never chose. The three traditions examined in this lesson each constitute a serious meaning framework. Scientific naturalism locates meaning in human construction over a naturalistic foundation. Religious cosmology locates meaning partly in transcendent sources beyond what science can investigate. Philosophical nihilism examines what living well means in the face of cosmic meaninglessness. Engaging with alternatives seriously, while still respecting what you already believe, is one of the most valuable intellectual exercises available.`,
            }
          ],
        },
