      ...
      screens: [
        {
          id: `l06-welcome`,
          type: `welcome`,
          guideText: `{name}, everything you can touch, see, taste, or smell, this screen, the air, your own body, a distant star, is made of atoms. They are the building blocks of all matter. But here's what's astonishing: there are only about a hundred kinds of atoms, the elements, and yet from this small set, arranged and combined in different ways, comes the entire dazzling variety of the physical world. Gold, water, diamond, oxygen, salt, DNA, all just different arrangements of the same handful of building blocks. Today we go inside the atom to understand it, and we'll discover the single most important idea in all of chemistry: that nearly everything about how an element behaves, whether it's a reactive metal, an inert gas, or a life-giving element, comes down to one thing, the arrangement of its electrons. We'll meet the parts of the atom (protons, neutrons, electrons), see how they define each element, and learn how electrons are organized in shells around the nucleus. Then comes the key: the outermost electrons, the valence electrons, determine how an atom bonds and reacts, which is why the periodic table, that famous chart on every science classroom wall, is organized the way it is. It's not a random list; it's a map of electron arrangements, and once you see that, the whole table comes alive. By the end, you'll understand what everything is made of, and why it behaves as it does. Onward.`,
