export const ssLittleStars = [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which shows a RESPONSIBILITY at home?', guideText: 'Tap the helper!',
        items: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which shows a SCHOOL RULE?', guideText: 'Tap raising your hand!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which shows a NEIGHBORHOOD?', guideText: 'Tap the neighborhood!',
        items: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which shows a big CITY?', guideText: 'Tap the city skyline!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'How do we CELEBRATE Independence Day?', guideText: 'Tap the fireworks!',
        items: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'What do kids carry on the 4th of July?', guideText: 'Tap the flag-waving kids!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which one is George WASHINGTON?', guideText: 'Tap Washington!',
        items: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which one is Abraham LINCOLN?', guideText: 'Tap Lincoln!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which one is a BALLOT BOX?', guideText: 'Tap the ballot box!',
        items: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which shows a CHOICE?', guideText: 'Tap the two paths!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which one is a GOOD you can hold?', guideText: 'Tap the bread!',
        items: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which one is a SERVICE?', guideText: 'Tap the dentist helping!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which is a NEED?', guideText: 'Tap clean water!',
        items: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which is a WANT?', guideText: 'Tap the toy store!',
        items: [
