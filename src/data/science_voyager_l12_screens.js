      ...
      screens: [
        {
          id: `l12-welcome`,
          type: `welcome`,
          guideText: `{name}, you've learned to describe motion and to explain what changes it with Newton's laws. Now we reach one of the most powerful and beautiful ideas in all of physics: conservation. Some quantities in the universe can never be created or destroyed, only moved around or transferred from one object to another. The total amount stays exactly the same, no matter what happens. These conservation laws are physicists' deepest tools, because they let us predict the outcome of even the most complicated events, collisions, explosions, rocket launches, without tracking every messy detail. This lesson focuses on momentum: a measure of how much motion an object carries, equal to its mass times its velocity. A heavy truck rolling slowly and a small bullet flying fast can carry the same momentum. The astonishing law of conservation of momentum says that in any collision or interaction, with no outside forces, the total momentum before exactly equals the total momentum after. We'll see how this explains why a cannon recoils when it fires, how two cars behave when they crash, why a rocket gains speed as it throws fuel backward, and even how rockets and billiard balls obey the very same rule. We'll meet impulse, the link between force, time, and momentum, that explains airbags and why you bend your knees when you land. And we'll glimpse the grandest idea of all: that conservation laws, of momentum, of energy, of more, are among the deepest truths governing the entire cosmos. Onward.`,
