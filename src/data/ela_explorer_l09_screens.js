...

        {
          ...
          vocab: [
            { word: `theme`,         definition: `The big idea or lesson behind a story. What the story is REALLY about.`,
              audioPrompt: `A theme, {name}, is the big idea or lesson behind a story. What the story is REALLY about — not just what happens, but what it MEANS. Themes are usually about big life things: friendship, courage, kindness, honesty, never giving up, growing up, finding home. Themes are why some stories stick in your heart forever.` },
            { word: `deeper`,        definition: `Below the surface. Themes are DEEPER than just what happens.`,
              audioPrompt: `Deeper, {name}, means below the surface. On the surface of a story, things happen. But UNDERNEATH, there's a deeper meaning. The theme. Like an iceberg — most of it is underwater. Surface readers only see the top. Deep readers see what's underneath too. Both are part of the story. But theme is what makes a story really matter.` },
...

        {
          ...
          vocab: [
            ...
            { word: `means`,         definition: `The deeper sense of something. Theme is what a story MEANS — its message.`,
              audioPrompt: `Means, {name}, is the deeper sense of something. The theme of a story is what it MEANS. What it's really trying to teach. What it makes you think about. What it makes you feel. Smart readers always ask: what does this story MEAN? Not just what happens — but what's the deeper point?` },
            { word: `surface`,       definition: `The top layer. Plot is the SURFACE of a story. Theme is below.`,
              audioPrompt: `Surface, {name}, means the top layer. The plot of a story is the surface — what you see when you read. Themes are below the surface. You don't see them right away. You feel them. Or you figure them out by thinking. Surface readers stop at the plot. Deep readers dive for theme.` },
          ],
        },

        {
          ...
          vocab: [
            { word: `friendship`,    definition: `Being friends with someone. A common THEME in stories.`,
              audioPrompt: `Friendship, {name}, is being friends with someone. It's one of the most common themes in all of human storytelling. Why? Because friendship matters so much in real life. Stories about friendship help us understand it. They show us what good friendships look like. They show us what bad ones look like. They make us better friends ourselves.` },
...

        {
          ...
          vocab: [
            { word: `courage`,       definition: `Being brave when something is scary. A common theme in stories.`,
              audioPrompt: `Courage, {name}, is being brave when something is scary. It's another super common theme. Why? Because life requires courage. To start at a new school. To make a new friend. To stand up for what's right. Stories about courage prepare us for our own brave moments. They remind us that even small people can do big things.` },
            { word: `challenge`,     definition: `A hard thing to face. Theme of courage often involves big CHALLENGES.`,
              audioPrompt: `A challenge, {name}, is a hard thing to face. Stories with courage themes often have big challenges. A character has to do something difficult. Maybe scary. Maybe brand new. Maybe even dangerous. The challenge is what makes courage NECESSARY. Without challenges, no one would need courage. Stories give characters challenges so they can grow.` },
            { word: `grow`,          definition: `To change for the better. Through courage, characters often GROW.`,
              audioPrompt: `To grow, {name}, means to change for the better. Through courage, characters grow. They start the story one way. By the end, they're stronger. Wiser. More themselves. Growth is part of why we love courage stories. We get to watch someone become MORE. That makes us hope we can grow too.` },
          ],
        },

        {
          ...
          vocab: [
            { word: `learn`,         definition: `To find out something new. Characters LEARN in stories. Theme is often their lesson.`,
              audioPrompt: `To learn, {name}, means to find out something new. Characters in stories LEARN — about themselves, about the world, about life. By the end of the story, they often know more than they did at the start. Their learning often points right at the theme. What did they learn? Often, that's exactly what the author wants us to learn too.` },
            { word: `author`,        definition: `The person who wrote the book. The AUTHOR has a message in their theme.`,
              audioPrompt: `An author, {name}, is the person who wrote the book. Every author makes choices about what to include. What to leave out. What to highlight. Behind those choices is usually a message — what they want readers to think about. That message is the theme. Smart readers ask: what does the author want me to feel and learn?` },
...

        {
          ...
          vocab: [
            ...
            { word: `conversation`,  definition: `Talking together. Themes are great for CONVERSATIONS with family.`,
              audioPrompt: `A conversation, {name}, is talking together. Themes are great for conversations. After a book or movie, you can ask: what did YOU think it was about? Different people see different themes — even in the same story. Sharing themes makes stories richer. It also helps you understand the people you're talking with.` },
            { word: `share`,         definition: `To give or talk about with others. Stories are best when you SHARE their themes.`,
              audioPrompt: `Share, {name}, means to give or talk about with others. Stories are best when shared. And the deepest sharing is sharing themes. What did this story mean to you? What lesson stays with you? Conversations like these turn stories from solo experiences into shared treasures. Share themes with the people you love.` },
          ],
        },
