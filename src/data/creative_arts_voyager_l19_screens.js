          ...
          questions: [
              {
                ...
                options: [
                  `A public announcement of your goals, needed so other people can hold you accountable to them.`,
                  `A clear statement of what you believe and how you'll act — a prior decision to lean on under pressure.`,
                  `A legal document protecting your work, needed so no one can copy what you create.`,
                  `A list of your finished achievements, needed to prove to others that you're a real creator.`,
                ],
                correctIndex: 1,
                explanation: `A manifesto is a clear, honest statement of what you believe and how you intend to act as a creative person, written so it can guide you, and it can be private and plain-spoken. You need one because values are easy when nothing's at stake and brutally hard under pressure: easy to say "I'll always credit" until crediting makes you look less original, "I care about meaning not money" until real money is offered for something hollow. In those moments you won't reason from scratch, you'll fall back on what you decided before, so a manifesto is that prior decision made in calm. It's not a cage but a spine: revisable as you grow, but something to stand on. The distractors make it public accountability, legal protection, or a résumé.`,
              },
              {
                id: `q2`,
                type: `multiple-choice`,
                ...
                options: [
                  `By giving you rules to memorize and obey in each lesson, which you now collect into one list.`,
                  `By testing your factual knowledge so you know enough about art to have opinions worth writing.`,
                  `By having you practice values through real situations — honesty, persistence, holding both truths, and more.`,
                  `By telling you exactly what every good creator must value, which you simply copy down.`,
                ],
                correctIndex: 2,
                explanation: `By having you practice values, not just learn facts, lesson after lesson. The IP lesson built honesty (credit); the career lesson built persistence; the propaganda lesson built responsible use of power; sacred art built reverence; the brain-hype lesson built honest thinking. It continued: immersive art built substance over surface; performance art built thinking past your first reaction; film built staying awake; global fusion built holding both truths. None were handed over as rules to obey, they were values you tried on by reasoning through real situations, so the manifesto work now is choosing which are truly yours and adding your own. The distractors recast it as rules to memorize, a knowledge test, or values dictated to you.`,
              },
              {
                id: `q3`,
                type: `multiple-choice`,
                ...
                options: [
                  `They don't both hold — "yours to write" really does mean any values are equally good.`,
                  `Choosing your values is real, but some hold up better under honest reasoning than others.`,
                  `An expert must approve your manifesto, so it's only partly yours to write in the end.`,
                  `They hold only because the lesson secretly has a correct manifesto it wants you to reach.`,
                ],
                correctIndex: 1,
                explanation: `Both hold because choosing your values is real, but some values genuinely hold up better than others when you reason honestly, the way some art claims survived scrutiny and others collapsed. No one can hand you a finished manifesto, that's truly yours, AND "it's mine to choose" doesn't mean "all choices are equally good." What makes a value worth keeping is testable: you can defend it with honest reasons, you'd accept it done to you, it doesn't depend on hiding or lying. "I give credit because I'd want credit" holds up; "I take credit whenever I can get away with it" doesn't, because you can't defend it and it depends on not getting caught. The distractors flatten it to "anything goes," gatekeep it, or hide a "correct" answer.`,
              },
              {
                id: `q4`,
                type: `multiple-choice`,
                ...
                options: [
                  `Sounding noble and inspiring, so the statement motivates you whenever you reread it.`,
                  `Being short, so you can memorize the whole manifesto and recite it quickly.`,
                  `Staying general, so one statement can cover many different situations at once.`,
                  `Being specific and active — naming a value AND how you'll act on it in the hard, costly moment.`,
                ],
                correctIndex: 3,
                explanation: `Useful statements are specific and active rather than vague and pretty, each naming a value AND how you'll act, especially when it costs you. "I want to be a good person" is too vague to guide anything. "I always credit the people whose work I build on, even when staying quiet would make me look more original" tells future-you exactly what to do in the tempting moment. Aim for "I will [specific action], even when [the thing that makes it hard]." Keep it honest, yours, alive (revise as you grow), and kind to yourself. The distractors prize nobility, brevity, or generality over the specific-and-active shape that actually functions as a spine.`,
              },
              {
                id: `q5`,
                type: `multiple-choice`,
                ...
                options: [
                  `Because there are no right or wrong answers at all, so any choice is as good as another.`,
                  `Their purpose is to surface what YOU believe is right so you can write it down, not to score you.`,
                  `Because only the lesson knows the answers, and the dilemmas are designed to reveal them to you.`,
                  `Because they're meant to judge other people's choices rather than clarify your own.`,
                ],
                correctIndex: 1,
                explanation: `Their purpose isn't to judge others or make you guess a hidden correct answer, but to surface what YOU actually believe so you can write it down. Values are found by facing real choices and noticing what you genuinely think you should do, so each dilemma (credit you didn't earn, money vs. meaning, a hit that costs your respect, the urge to quit, copying vs. your voice) holds a mirror up. The evaluations model honest reasoning and note which values hold up (since "anything goes" was ruled out), but explicitly leave the choosing to you, including drawing your own lines. They work by reflection, not examination. The distractors collapse to "no right answers," "hidden answers," or "judging others."`,
              },
              {
                id: `q6`,
                type: `multiple-choice`,
                ...
                options: [
                  `Because everyone needs to live — the real line is honest work vs. work against your actual values.`,
                  `Because money always matters more than meaning, so paid work is the only sensible choice.`,
                  `Because a real artist should refuse all unglamorous paid work and suffer for the craft.`,
                  `Because any work that pays is automatically meaningful, so the dilemma doesn't really exist.`,
                ],
                correctIndex: 0,
                explanation: `Because everyone needs to live, and creative life is often funded by work that pays the bills while you develop the work you love, so honest paid work you don't adore is legitimate, not betrayal. The real line usually isn't "money vs. meaning" but "honest work vs. work against my actual values," because making something fine-but-unexciting for money differs from making something harmful or dishonest. Ask: does this merely fail to thrill me (often fine) or require me to deceive or betray what I believe (a different matter), and am I keeping enough of myself for the work that matters? The value is realistic integrity, not naive purity. The distractors over-prize money, demand purist suffering, or deny the dilemma.`,
              },
              {
                id: `q7`,
                type: `multiple-choice`,
                ...
                options: [
                  `By how long you've worked — quitting is always fine after enough time, never before.`,
                  `By how others react — if people encourage you to stop, it's healthy; if not, it's discouraged.`,
                  `Usually by the source: clarity and choice can be wise; fleeing a flash of discouragement, you regret.`,
                  `You can't tell them apart, so the safe rule is to never quit anything you've started.`,
                ],
                correctIndex: 2,
                explanation: `Usually by the source of the impulse. Real creative life is built through practice, rejection, and slow growth, so rejection isn't proof you should stop. But not all quitting is failure: healthy quitting is deciding from a clear head that something genuinely isn't for you, a real choice; discouraged quitting is abandoning something you love because a hard moment made it hurt. The tell is the source, quitting from clarity can be wise, while quitting from a flash of discouragement or one rejection is the kind you regret once the feeling passes. So ask "am I choosing from clarity, or fleeing from discouragement?" before deciding. The distractors use time, others' reactions, or a never-quit rule instead of the source of the impulse.`,
              },
              {
                id: `q8`,
                type: `multiple-choice`,
                ...
                options: [
                  `There's no line — copying the current winner is simply the smartest way to grow fast.`,
                  `Learning is forbidden; any influence from others means you've lost your own voice entirely.`,
                  `The line is whether the trend is popular enough to be worth copying this month.`,
                  `Between learning from many influences to grow your voice, and erasing your voice to clone the winner.`,
                ],
                correctIndex: 3,
                explanation: `The line is roughly between learning from many influences to grow your own voice and erasing your voice to clone whatever's winning this month. Every artist learns by studying and imitating people they admire, that's how skill is built; the problem is only when you stop developing anything of your own and just replicate the winner. The cost of pure copying is twofold: trends pass, so a copied voice keeps starting over, and a copy is rarely as compelling as the authentic thing only you could make. Developing your own voice really is slower and riskier, so it's a genuine trade. The value is authenticity held with maturity. The distractors endorse pure copying, forbid all learning, or make popularity the test.`,
              },
              {
                id: `q9`,
                type: `true-false`,
              ...
              },
              {
                id: `q10`,
                type: `inference`,
                question: `It's a few years from now. You've made something you're proud of and it's getting noticed. All the dilemmas hit at once: money for hollow work, a shallow version that would get more attention, the urge to drop credit for an influence, and copying a trend to grow faster. You're tired and tempted. How does having written a manifesto help, and what does it NOT do?`,
                options: [
                  `It removes the temptations entirely, so the choices become easy and cost you nothing.`,
                  `It means you're not deciding from scratch while tired, names each dilemma, and gives you a spine — but it doesn't make choices painless or make you perfect.`,
                  `It locks in your past decisions forever, so you must follow it even when you've genuinely grown.`,
                  `It guarantees you'll make the right choice every time, since the rules are already written down.`,
                ],
                correctIndex: 1,
                explanation: `This is the exact moment a manifesto is built for. What it does: you're not deciding from scratch while tired and tempted (the worst condition for good decisions), because you already reasoned through each dilemma in calm and decided who you wanted to be. It turns vague temptation into named situations ("oh, this is the money-vs-values choice, and I decided my line is honest work yes, harmful work no"), acting like a map. And it gives you a spine to stay upright when the wind is strong. What it does NOT do: it doesn't make the choices painless, the money and attention are real, so you pay the cost on purpose rather than drifting; it doesn't make you perfect, it's who you're aiming to be, not a stick to beat yourself with; and it doesn't lock you forever, it's a spine you can thoughtfully revise, not a cage. It doesn't win the battle, it ensures you're fighting for something you actually chose. The distractors claim it removes temptation, locks you in, or guarantees perfection.`,
              },
          ],
        },
