      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            {
              word: `supply chain`,
              definition: `The chain of companies and processes that produce a final product. Ethical concerns about supply chains include labor practices, environmental impact, and treatment of workers at every stage — not just the final seller.`,
              audioPrompt: `A supply chain is the chain of companies and processes that produce a final product, {name}. Ethical concerns about supply chains include labor practices, environmental impact, and treatment of workers at every stage, not just at the final seller. A clothing brand's supply chain might include cotton farmers, textile manufacturers, garment workers, and shipping companies across multiple countries. Each step can involve its own ethical considerations: fair wages, safe conditions, environmental practices. Knowing about supply chains changes how you evaluate the ethics of a purchase. The company you buy from is only the visible end of a chain that produced the item you're holding.`,
            },
            {
              word: `use of proceeds`,
              definition: `What a company does with its profits: reinvest in growth, compensate executives, pay dividends, fund lobbying, or other purposes. One of three ethical dimensions of financial decisions alongside production and externalities.`,
              audioPrompt: `Use of proceeds refers to what a company does with its profits, {name}. Does it reinvest in innovation and growth? Does it compensate executives at ratios of hundreds to one versus workers? Does it pay dividends to shareholders? Does it fund lobbying to fight regulation of its own harmful products? Use of proceeds is one of three ethical dimensions to consider when evaluating financial decisions, alongside production practices and externalities. The same financial return can come from companies that use their profits very differently. Some investors consider use of proceeds when choosing investments. Most don't because the information is difficult to obtain and assess.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `Nobel laureate economist who argued in 1970 that the social responsibility of business is to increase its profits within the law. His framework anchors Position 1 in ethical investing debates.`,
              audioPrompt: `Milton Friedman is a Nobel laureate economist who argued in 1970 that the social responsibility of business is to increase its profits, {name}. Within the boundaries of law and basic ethical custom, companies and investors should optimize for financial returns. If society wants different outcomes, it should change laws and regulations rather than rely on investor decisions. This framework is the classic foundation for Position 1 in ethical investing debates. It argues that mixing ethical considerations into investment decisions often produces worse returns and worse ethical outcomes than political action would. Friedman's essay remains one of the most cited and most debated pieces in business ethics, more than 50 years after publication.`,
            },
            {
              word: `political action`,
              definition: `Using voting, advocacy, and civic engagement to change laws and regulations. The maximize-returns position argues this is more effective than investor screening for addressing corporate harm, because it creates binding rules rather than voluntary choices.`,
              audioPrompt: `Political action refers to using voting, advocacy, and civic engagement to change laws and regulations, {name}. The maximize-returns position in ethical investing argues that political action is more effective than investor screening for addressing corporate harm. Laws and regulations create binding requirements that apply to all companies, not just those whose investors chose to screen them. Individual investor decisions, even collectively, change company behavior less reliably than enforceable regulation. In this view, the most ethical thing an investor can do is maximize returns while also being an active citizen who votes, advocates, and supports policies that address the harms their investments may fund. Different ethical positions disagree about whether this separation between investor and citizen is coherent or convenient.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `ESG ratings`,
              definition: `Scores assigned to companies by rating agencies measuring their Environmental, Social, and Governance performance. Major problem: different rating agencies often disagree significantly about the same companies, making ESG screening methodologically difficult.`,
              audioPrompt: `ESG ratings are scores assigned to companies by rating agencies measuring their Environmental, Social, and Governance performance, {name}. Investors use these ratings to identify companies that meet their values criteria. A major problem with ESG ratings is that different rating agencies often disagree significantly about the same companies. Research by MIT Sloan and others finds that the correlation between major ESG rating providers is surprisingly low, sometimes near zero. A company rated as excellent by one agency might be rated as poor by another. This inconsistency makes it hard for investors to know which ratings to trust. The methodological problems don't invalidate ESG as an approach, but they require investors to be sophisticated about which ratings they use and how.`,
            },
            {
              word: `values-aligned investing`,
              definition: `Investing in ways that reflect your personal values about ethics, environment, and social impact, alongside financial return goals. ESG investing is the most common form. Involves accepting some tradeoffs in exchange for principled alignment.`,
              audioPrompt: `Values-aligned investing is investing in ways that reflect your personal values about ethics, environment, and social impact alongside financial return goals, {name}. ESG investing is the most common form of values-aligned investing. The approach rejects the idea that investing should focus purely on financial returns without regard to how those returns are generated. Investors who choose values-aligned approaches accept that they may give up some returns in exchange for greater alignment between their investments and their principles. The empirical research on whether this tradeoff is significant is mixed: some studies show modest underperformance, others show comparable returns. The key point is that pure-returns investing is itself a value choice, not a neutral default, which removes the special status it sometimes claims.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `sin stocks`,
              definition: `Stocks in industries considered harmful or unethical: tobacco, weapons, gambling, alcohol, certain fossil fuels. Research shows sin stocks sometimes outperform precisely because ethical screens by some investors lower valuations, creating bargains for investors who don't care.`,
              audioPrompt: `Sin stocks are stocks in industries considered harmful or unethical: tobacco, weapons, gambling, alcohol, and certain fossil fuel companies, {name}. Research in academic finance documents that sin stocks sometimes outperform the broader market over multi-decade periods. The mechanism: ethical screens by some investors lower demand for these stocks, reducing their valuations. Lower valuations make them cheaper relative to their earnings, which can produce higher returns for investors who aren't deterred by the ethical concerns. This creates a genuine tension for the ESG and minimum-harm positions: accepting ethical alignment may mean forgoing the return premium that can come from unfashionable industries. This is one of the real return tradeoffs in values-aligned investing.`,
            },
            {
              word: `consumer activism`,
              definition: `Using purchasing choices to express values and influence company behavior. Boycotts, buycotts (deliberately supporting ethical companies), and conscious consumption. One tool alongside investing, political action, and giving.`,
              audioPrompt: `Consumer activism is using purchasing choices to express values and influence company behavior, {name}. It includes boycotts of companies whose practices you oppose, buycotts that deliberately support companies whose practices align with your values, and conscious consumption that considers the ethical dimensions of every significant purchase. Consumer activism is one tool alongside values-aligned investing, political action, and direct giving for shaping the economy toward outcomes you prefer. Its effectiveness is debated: individual purchasing decisions rarely move large companies, but collective shifts in consumer preferences have driven real changes in corporate practices. Consumer activism requires more effort than passive investing but is available to everyone with any spending power.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `empirical versus value questions`,
              definition: `Empirical questions can be resolved by evidence: what are actual ESG returns? Value questions can only be resolved by what you think matters: should investors prioritize returns or ethics? Tax policy and ethical investing both mix both types.`,
              audioPrompt: `Empirical versus value questions is a crucial distinction in ethical debates about money, {name}. Empirical questions can be resolved by evidence: what are the actual returns of ESG funds compared to unscreened funds? Value questions can only be resolved by deciding what you think matters: should investors prioritize financial returns or ethical considerations? Ethical investing debates mix both types. The empirical facts about ESG returns are relevant but don't determine the right answer, because the right answer also depends on what you think the purpose of investing is. Being clear about which type of question you're arguing will make your thinking clearer and your conversations more productive.`,
            },
            {
              word: `capital`,
              definition: `Money and assets available for investment. When investors direct capital toward or away from companies, they influence those companies' ability to fund operations and growth. The debate over whether individual capital allocation changes behavior is central to the ethics of investing.`,
              audioPrompt: `Capital refers to money and assets available for investment, {name}. When investors direct capital toward companies by buying their shares, they make it easier for those companies to raise money for growth. When investors divest, they in theory reduce capital available to those companies. The debate over whether individual capital allocation actually changes company behavior is central to the ethics of investing. Critics of ESG and minimum-harm approaches argue that capital markets are liquid enough that someone else always provides the capital a divesting investor withdraws. Supporters argue that collective capital withdrawal can raise companies' cost of capital over time, changing their incentives. The empirical evidence on this is mixed and depends on the scale and coordination of the divestment.`,
            },
          ],
        },
