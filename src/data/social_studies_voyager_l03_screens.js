      ...
      screens: [
        {
          id: `l03-welcome`,
          type: `welcome`,
          guideText: `{name}, you've seen how the Constitution divides power to keep government from becoming a tyrant. But here's a harder problem the founders also worried about: what protects you from the government when it acts within its powers, and what protects you from the majority, from everyone else, when most people want something that crushes a few? Imagine a town where 90 percent of people vote to silence the other 10 percent, to search their homes, ban their religion, or deny them a fair trial. That's not tyranny by a king. It's tyranny by the majority, and a democracy can do it just as easily as a dictator can. The deepest insight of the American rights tradition is that some things should be off-limits to government and to majorities entirely, no matter how many people want them. This lesson is about those protections, and the long, unfinished fight to make them real. We'll draw a crucial distinction between two kinds of protections people often confuse: civil liberties, the freedoms government cannot take from you (speech, religion, privacy, fair trials), and civil rights, your protection from discrimination, your right to be treated equally. We'll trace the Bill of Rights and the Fourteenth Amendment, the documents that anchor these protections. We'll see that rights on paper mean nothing without the struggle to enforce them, and that nearly every right you take for granted was won by people who were denied it and fought back, abolitionists, suffragists, the Civil Rights Movement, and many others. And because rights constantly collide with each other and with other goods like security and order, we'll end with a real debate about where the lines should fall. These aren't settled questions. They're live ones, and they're yours. Onward.`,
...

        {
          ...
          vocab: [
            ...
            { word: `the Civil Rights Movement`,
