      ...
      screens: [
        {
          id: `l18-welcome`,
          type: `welcome`,
          guideText: `{name}, across this entire band, you've been taking in information and building your understanding of social studies through lessons that present carefully researched and organized content. But the process of how that understanding was built, how historians evaluate evidence, how social scientists distinguish good data from bad, how economists build and test arguments, how political scientists assess claims, is itself a crucial skill set that you need to develop for yourself. We live in a world saturated with information, much of it inaccurate, distorted, or deliberately misleading. The skills to navigate that information landscape, to evaluate sources critically, to distinguish evidence from assertion, to understand how arguments are constructed and how they can fail, are not just academic skills. They are survival skills for living thoughtfully in the twenty-first century. Research in social studies involves a particular set of challenges because the subjects it examines, history, economies, political systems, social structures, are complex, contested, and value-laden. Unlike laboratory science, social scientists cannot run controlled experiments on societies; they cannot go back in time to ask people what they actually thought or experienced; they cannot hold all variables constant while changing one. This means that social studies research requires special attention to how questions are framed, how evidence is gathered and interpreted, and how the values and perspectives of researchers shape what they see and how they report it. This lesson builds the skills you need to engage with social studies research honestly and rigorously. We'll examine the difference between primary and secondary sources, how to evaluate source credibility, how to construct and evaluate evidence-based arguments, how to recognize common logical fallacies, and how to engage with contested social questions in ways that are honest about uncertainty and disagreement. The source evaluation exercises will put these skills to work on real sources. By the end, you'll be a more critical and rigorous consumer of the information you encounter. Onward.`,
...

        {
          ...
          vocab: [
            ...
            { word: `source bias and perspective`,
...

        {
          ...
          vocab: [
            { word: `Claim-Evidence-Reasoning (CER)`,
            ...
            { word: `types of evidence in social studies`,
...

        {
          ...
          vocab: [
            ...
            { word: `presentism in historical analysis`,
...

        {
          ...
          vocab: [
            ...
            { word: `contested knowledge in social studies`,
