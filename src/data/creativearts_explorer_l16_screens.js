  ...
  lessons: [
    {
      ...
      screens: [
        ...
        // ── 6. INTERACTIVE — Drag-match ─────────────────────────────────────
        {
          ...
          config: {
            buckets: [
              { id: 'best',           label: `🎨 This is what public art does at its best`, color: '#34D399' },
              { id: 'misunderstands', label: `🤔 A common misunderstanding about street art`, color: '#94A3B8' },
            ],
            items: [
              {
                id:            'l16-g1',
        ...
        // ── 7. QUIZ ──────────────────────────────────────────────────────────
        {
          ...
          questions: [
            ...
            // Q1 — MC (replaced: was location-recall)
            {
              id:           'l16-q1',
              format:       'mc',
            ...
            // Q5 — Fill-blank (fresh)
            {
              ...
              options:      ['public', 'street', 'mural', 'graffiti'],
              correctIndex: 0,
