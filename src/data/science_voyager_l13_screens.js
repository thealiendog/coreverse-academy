      ...
      screens: [
        {
          id: `l13-welcome`,
          type: `welcome`,
          guideText: `{name}, last lesson you met conservation through momentum. Now we reach the single most important and far-reaching idea in all of physics: energy, and its conservation. Energy is the thread that runs through everything, every motion, every meal, every star, every machine, every living cell. And the law of conservation of energy is perhaps the deepest truth science has ever found: energy can never be created or destroyed, only transformed from one form into another. The total amount of energy in the universe has stayed exactly the same since the beginning of time. This lesson builds that idea from the ground up. We start with work, the physicist's precise meaning: force applied over a distance, the way energy gets transferred. Then energy itself, beginning with the two great families of mechanical energy: kinetic energy (the energy of motion) and potential energy (stored energy, waiting to be released). We'll watch energy flow between these forms in a falling ball, a swinging pendulum, a roller coaster, always transforming, never lost. We'll meet power, the rate at which energy is used. We'll trace energy through its many forms, chemical, thermal, electrical, light, nuclear, and see how every device you own is really an energy converter. And we'll face the great puzzle: if energy is never lost, why does a bouncing ball eventually stop? The answer reveals where energy "goes," and one of the deepest truths about the direction of time itself. Onward.`,
