  ...
  lessons: [
    {
      ...
      screens: [
...

        {
          ...
          paragraphs: [
            `The **color wheel** organizes colors by their relationships. **Primary colors** — red, yellow, and blue — cannot be made by mixing other colors. They are the source of all other colors. **Secondary colors** — orange (red + yellow), green (yellow + blue), and purple (blue + red) — are made by mixing two primaries. **Tertiary colors** fill the gaps between primaries and secondaries: red-orange, yellow-orange, yellow-green, blue-green, blue-purple, red-purple. Every color in existence lives somewhere on or inside this wheel. Understanding where a color sits tells you its relationships — and relationships are everything in color.`,
          ],
...

        {
          ...
          type: `magazine`,
          section: 4,
          headline: `Value: Light, Dark, Tint, and Shade`,
          paragraphs: [
