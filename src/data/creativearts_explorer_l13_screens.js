      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            { word: `oculus`, definition: `A circular opening at the top of a dome — most famously in the Pantheon in Rome — which connects the interior to the sky and creates a symbolic link between the human and the infinite.`, audioPrompt: `Walk into the Pantheon in Rome, {name}, and look up: there's a perfect circle of open sky at the top of the dome, 30 feet across, open to rain and sun and night. That's the oculus — the eye of the building. It's been there for nearly 2,000 years. The light it admits moves across the interior throughout the day, turning the building into a sundial. It connects the human scale of the room to the infinite scale of the sky. Architecture rarely makes its meaning so direct or so beautiful.` },
          ],
        },
