          ...
          questions: [
            {
              ...
              options: [
                `What physical things are made of and how they behave — the same work as physics, just an older name for it.`,
                `Supernatural forces science can't measure, like energy fields, auras, and the afterlife.`,
                `What it means for anything to exist, and what reality is underneath appearances — the questions beneath even science.`,
                `How we ought to live and what makes actions right or wrong.`,
              ],
              correctIndex: 2,
            ...
            },
            {
              ...
              options: [
                `The gap between what scientists have discovered and what they haven't yet — it shrinks until science explains everything.`,
                `That nothing is real and you can't know anything, so reality is whatever each person wants it to be.`,
                `The gap between how the world seems and how it actually is — real, but it doesn't mean "nothing is real."`,
                `The difference between what you believe as a child and as an adult, which closes as you grow up.`,
              ],
              correctIndex: 2,
            ...
            },
            {
              ...
              options: [
                `Three words for the same idea — that only matter is real — so choosing between them is just personal taste.`,
                `Three competing answers to what's ultimately real: matter (materialism), mind (idealism), or both (dualism).`,
                `Three attitudes to life: chasing possessions, thinking positive, and seeing two sides to everything.`,
                `Three stages every civilization passes through, ending in materialism as the proven final answer.`,
              ],
              correctIndex: 1,
            ...
            },
            {
              ...
              options: [
                `Because the answer is actually obvious — it's idealism — and doubters just haven't thought hard enough.`,
                `Because science settled it for materialism long ago; the "debate" only continues to keep philosophers busy.`,
                `Because the question is meaningless, so "settled" and "unsettled" are equally pointless to say.`,
                `Because it genuinely isn't settled — materialism hasn't explained felt experience — so claiming certainty is overselling.`,
              ],
              correctIndex: 3,
            ...
            },
            {
              ...
              options: [
                `Everyone already carries unexamined answers about reality, absorbed from upbringing and treated as obvious fact.`,
                `Everyone has taken a philosophy class, so the basic ideas are common knowledge.`,
                `Deep down everyone secretly believes the same thing, and philosophy just helps put it into words.`,
                `Metaphysical beliefs are instincts you're born with and can't change, so examining them is pointless.`,
              ],
              correctIndex: 0,
            ...
            },
            {
              ...
              options: [
                `Because dropping philosophers' names in conversation makes you sound smart and impresses people.`,
                `Because it trains you to sit with real mystery yet keep your footing — neither swallowing nor dismissing big claims.`,
                `Because thinking hard gives you the one correct answer, so you're never confused by a big question again.`,
                `Because the safe move is to reject all big claims and trust nothing, which keeps you from being fooled.`,
              ],
              correctIndex: 1,
            ...
            },
            {
              ...
              options: [
                `That science is fake and explains nothing, so any brain claim can be dismissed.`,
                `That brains are just complicated and unmapped — once neuroscience finishes, the puzzle vanishes.`,
                `Explaining why physical processes produce inner felt experience at all — which keeps idealism and dualism alive.`,
                `Deciding which philosopher to trust, since they all sound equally convincing.`,
              ],
              correctIndex: 2,
            ...
            },
            {
              ...
              options: [
                `It's just materialism in spiritual words — "process and interdependence" means physical matter in motion.`,
                `It's the claim that nothing is real and life is an illusion, so the right response is to stop caring about a world that doesn't exist.`,
                `It's a fourth answer naming "energy" as the fundamental stuff instead of matter, mind, or both.`,
                `It questions the shared assumption that reality must bottom out in fixed "stuff" at all — challenging the framing, not adding an answer.`,
              ],
              correctIndex: 3,
