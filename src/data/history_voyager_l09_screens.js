  ...
  lessons: [
    {
      ...
      screens: [
...

        {
          ...
          vocab: [
            {
              word: `the Holocaust in scale and structure`,
...

        {
          ...
          vocab: [
            {
              word: `Tier A: academic scholarship + primary documents`,
...

        {
          ...
          vocab: [
            {
              word: `Tier B: survivor testimony, memoir, serious journalism`,
...

        {
          ...
          vocab: [
            {
              word: `Tier C: Holocaust denial as phenomenon`,
...

        {
          ...
          paragraphs: [
            ...
            `One last framing. Engaging the Holocaust at this level of source seriousness at 12 builds foundation for sustained civic engagement across decades. Holocaust memory is itself politically contested in current debates (Holocaust comparisons in current politics, memorial policies, history education debates, free speech and denial law debates). The framework you build today shapes how you'll engage these debates as they continue to develop. The resources from L08's introduction (USHMM, Yad Vashem, USC Shoah Foundation IWitness, Aegis Trust, local Holocaust education centers, 988 Suicide and Crisis Lifeline, Crisis Text Line, school counselor, trusted adult) apply throughout this lesson as well.`,
          ],
          image: `/voyager-assets/history/l09-s5-why-source.webp`,
          imageCaption: `Source-critical reading for Holocaust matters because: scale of evidence (how to navigate, not whether exists); sustained denial project (needed for online discourse); ongoing political stakes (Holocaust memory shapes current political life). Three tiers not equivalent; require different reading strategies; have different epistemic status. Resources continue from L08.`,
          vocab: [
            {
              word: `why source evaluation specifically here`,
