...

        {
          ...
          vocab: [
            ...
            { word: `library`,        definition: `A place full of books, often free to use. LIBRARIES are research treasure houses.`,
              audioPrompt: `A library, {name}, is a place full of books, often free to use. Libraries are research treasure houses. Public libraries have thousands of books and a librarian who helps you find the right one. Best of all, library cards usually cost nothing. Libraries are one of the most amazing inventions ever.` },
...

        {
          ...
          vocab: [
            ...
            { word: `plagiarism`,     definition: `Copying someone else's words and pretending they're yours. NOT okay.`,
              audioPrompt: `Plagiarism, {name}, is copying someone else's words and pretending they're yours. It's not okay. Authors, scientists, and journalists who plagiarize get in serious trouble. Even just one or two sentences copied without crediting the author is plagiarism. Real researchers always either rewrite in their own words or put quotation marks and credit the author.` },
          ],
        },

        {
          ...
          vocab: [
            { word: `journey`,        definition: `A long trip. You've completed a LEARNING JOURNEY through ELA.`,
              audioPrompt: `A journey, {name}, is a long trip. You've completed a learning journey through ELA Explorer. Twenty lessons. From fluency to research. From reading skills to writing skills to mechanics. Every lesson built on the ones before. That's what makes it a journey, each step matters. Now you stand at the destination.` },
            { word: `whole world`,    definition: `Everything that exists to learn. The WHOLE WORLD of knowledge is yours.`,
              audioPrompt: `The whole world, {name}, means everything that exists to learn. The whole world of knowledge is yours to explore. Every book ever written. Every science ever discovered. Every culture ever created. Every art ever made. All of it. Open to you. You have the skills to find your way through any of it. That's a beautiful gift.` },
