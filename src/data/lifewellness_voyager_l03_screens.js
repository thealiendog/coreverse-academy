      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `Walter Cannon's 1915 description of the body's acute response to threat through sympathetic nervous system activation. The HPA axis releases cortisol, norepinephrine and epinephrine (adrenaline) release, heart rate and blood pressure rise, blood flow shifts to muscles, digestion slows, and glucose mobilizes for energy. The text identifies this model as incomplete because it does not explain freeze, dissociation, or shutdown responses.`,
              audioPrompt: `Fight or flight is Walter Cannon's 1915 description of the body's acute physiological response to threat, {name}. Terra here — Cannon at Harvard described how the body activates under threat through specific, well-mapped physiology. The sympathetic nervous system activates, releasing norepinephrine and epinephrine, also called adrenaline. The HPA axis — hypothalamus-pituitary-adrenal — activates, releasing cortisol. Heart rate and blood pressure rise. Blood flow shifts away from digestion and toward muscles. Glucose mobilizes for energy. The bronchi dilate for more oxygen. The entire system prepares for physical action. This response served humans well for evolutionary threats: predators, fights, escape from danger. It works less well for modern threats that don't resolve through physical action — tests, social conflict, ongoing relationship stress, financial pressure. The body can't fight or flee from these, so it activates and doesn't get the physical resolution that normally ends activation. The text identifies the key limit of this framework: it doesn't explain why some stress responses involve freezing, dissociation, and shutdown rather than activation. Stephen Porges's polyvagal theory, developed starting in 1994, added the third response that fills this gap.`,
            },
            {
              word: `HPA axis`,
              definition: `The hypothalamus-pituitary-adrenal axis, a key component of the stress response system. When the HPA axis activates under threat, it triggers the release of cortisol, the primary stress hormone. Persistent HPA axis activation from chronic stress is associated with metabolic disruption, immune suppression, and hippocampal atrophy — the physiological signatures of allostatic load described by Bruce McEwen.`,
              audioPrompt: `The HPA axis stands for the hypothalamus-pituitary-adrenal axis, a key component of the stress response system, {name}. Terra here — when the body perceives a threat, activation travels through this pathway. The hypothalamus signals the pituitary gland, which signals the adrenal glands to release cortisol, the primary stress hormone. Cortisol serves important functions in the acute stress response: it mobilizes glucose for energy, modulates the immune response, and supports the body's ability to sustain action. In the short term, appropriate cortisol release is adaptive. The problem identified in the allostatic load framework — Bruce McEwen's work at Rockefeller University from the 1990s onward — is what happens when the HPA axis remains persistently activated from chronic stress without sufficient recovery. Persistent elevated cortisol produces metabolic disruption, immune suppression, and hippocampal atrophy. The hippocampus, a brain structure important for memory and learning, has receptors for cortisol, and sustained high cortisol levels damage it over time. This is one of the specific physiological mechanisms by which chronic stress produces long-term harm, and why early stress patterns matter for the stress system you will have across your entire adult life.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `The branch of the autonomic nervous system responsible for the fight-or-flight activation state. When activated by threat, it releases norepinephrine and epinephrine, raises heart rate and blood pressure, shifts blood flow to muscles, slows digestion, and mobilizes glucose. In polyvagal theory, sympathetic activation is the middle of three autonomic states, sitting between ventral vagal engagement and dorsal vagal shutdown.`,
              audioPrompt: `The sympathetic nervous system is the branch of the autonomic nervous system responsible for fight-or-flight activation, {name}. Terra here — when the body perceives a threat, the sympathetic nervous system is the primary driver of the acute stress response. It releases norepinephrine and epinephrine, also called adrenaline. Heart rate and blood pressure rise. Blood flow shifts from digestive organs toward muscles — priorities shift from maintenance to action. Digestion slows. Glucose mobilizes for energy. The bronchi dilate for more oxygen. This is the physiology Walter Cannon described in 1915 and Hans Selye extended through his general adaptation syndrome. In polyvagal theory, the sympathetic activation state sits in the middle of three autonomic states: above dorsal vagal shutdown and below ventral vagal social engagement. The text describes the hierarchy as a ladder the autonomic system moves down under increasing stress. Safety supports the calm, connected ventral vagal state. Manageable threat activates the sympathetic system. Overwhelming threat or threat that cannot be escaped activates dorsal vagal shutdown. Recovery from stress moves back up this hierarchy. Understanding where sympathetic activation sits in this framework helps clarify both when it is appropriate and what recovery looks like.`,
            },
            {
              word: `parasympathetic system`,
              definition: `The "rest and digest" branch of the autonomic nervous system, counterpart to the sympathetic fight-or-flight system. Slow breathing — especially extended exhales of 6–8 seconds — activates the parasympathetic system through vagus nerve stimulation, helping the body return to baseline after activation. The text identifies parasympathetic activation as a key recovery mechanism following acute stress.`,
              audioPrompt: `The parasympathetic nervous system is the "rest and digest" counterpart to the sympathetic fight-or-flight system, {name}. Terra here — the autonomic nervous system has two primary branches, and they work in approximate opposition. When the sympathetic system activates for fight-or-flight, heart rate rises, digestion slows, energy mobilizes. When the parasympathetic system activates, heart rate slows, digestion resumes, the body recovers and restores. The text identifies a specific, practical way to activate the parasympathetic system deliberately: slow breathing with an extended exhale — 4 seconds in, 6 to 8 seconds out. The longer exhale specifically stimulates the vagus nerve, a major parasympathetic nerve, which signals the heart to slow and the body to shift toward recovery. This is why breathing practices appear across all three stress frameworks in this lesson: they work with the actual physiology of recovery. Physical movement also helps complete the activation cycle — the body was prepared for physical action, and giving it some helps discharge that preparation. Social connection, sleep, and time in nature also support parasympathetic recovery. The key insight is that the body is designed to activate and recover; the goal is not to avoid activation but to ensure complete recovery between activations.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `ACEs study`,
              definition: `The Adverse Childhood Experiences study conducted by Felitti and Anda in 1998 that demonstrated childhood adversity — including abuse, neglect, and household dysfunction — produces lifelong health effects across many domains. It is foundational empirical support for the allostatic load model, showing that early stress patterns shape adult cardiovascular, metabolic, immune, and mental health outcomes across decades.`,
              audioPrompt: `The ACEs study — Adverse Childhood Experiences — was conducted by Felitti and Anda and published in 1998, {name}. Terra here — it is one of the most influential public health findings of recent decades. The study examined the relationship between childhood adversity and adult health outcomes across a large sample. Adverse childhood experiences included abuse, neglect, and household dysfunction such as domestic violence, parental substance use, or parental mental illness. The researchers found a clear, graded relationship: the more adverse experiences in childhood, the worse the adult health outcomes across many domains. Cardiovascular disease. Cancer. Depression. Substance use. Multiple physical and mental health conditions. The magnitude of the effects was larger than most researchers expected, and multiple subsequent studies have replicated and extended the findings across different populations and countries. The study is foundational empirical support for Bruce McEwen's allostatic load model. It demonstrates that early stress patterns are not just a childhood issue; they shape the stress system that operates across the rest of a person's life. This is one of the reasons the text identifies adolescence as a particularly important period: the stress patterns established now influence the allostatic load accumulated across decades.`,
            },
            {
              word: `allostasis`,
              definition: `The body's process of maintaining stability through change — adjusting physiological set points to meet different demands. Unlike homeostasis, which implies returning to a single fixed normal, allostasis recognizes that the body operates in appropriately different states for different situations. Allostatic load is what accumulates when the body is forced to maintain elevated states too long without recovery.`,
              audioPrompt: `Allostasis is the body's process of maintaining stability through change, {name}. Terra here — it is worth understanding the word itself because it clarifies what allostatic load means. Traditional biology described health as homeostasis: returning to a single fixed normal set point. Allostasis recognizes something more accurate: the body doesn't have one normal state. It has appropriate states for different demands. When you are running, your heart rate should be elevated. When you are sleeping, it should be slow. When you are facing a threat, cortisol should increase. When the threat has passed, cortisol should return to baseline. All of these are allostatic adjustments — the body maintaining appropriate function through changing conditions. The system works well when activation happens appropriately and recovery happens completely. Allostatic load is what happens when the system is forced to maintain elevated states for too long or too often. The wear accumulates because the body is spending resources maintaining states that it was designed to use briefly and then exit. The concept reframes what chronic stress actually is: not just too much stress, but insufficient recovery that prevents the body from returning to its appropriate baseline states between activations.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `dorsal vagal`,
              definition: `The third autonomic state in polyvagal theory — shutdown, freezing, dissociation, and conservation. Activated by overwhelming threat or threat that cannot be escaped. In this state heart rate may slow in a maladaptive way, and the system conserves energy by withdrawing from action. The text identifies dorsal vagal as what the fight-or-flight model could not explain: why some stress responses involve shutdown rather than activation.`,
              audioPrompt: `Dorsal vagal is the third autonomic state in polyvagal theory — the shutdown state, {name}. Terra here — this is the state Stephen Porges identified that the older fight-or-flight model couldn't explain. When a threat is overwhelming, or when fight or flight isn't possible and hasn't worked, the autonomic system can shift into dorsal vagal: freezing, immobilization, dissociation, and conservation of energy. Heart rate may slow, but in a maladaptive way — not the healthy slow of rest, but the withdrawal of a system that has decided action won't help. The body is essentially going quiet to survive. The text identifies this as why many people experience stress responses that the fight-or-flight model doesn't account for: feeling frozen rather than activated, going numb, dissociating from a situation, shutting down emotionally. Under older frameworks, these responses were often pathologized or misunderstood as weakness or failure. Polyvagal theory reframes them as appropriate adaptive responses to specific situations — particularly situations involving overwhelm or inescapable threat. Many people who experienced overwhelming stress, especially in childhood, can get stuck cycling between sympathetic activation and dorsal vagal shutdown, missing the ventral vagal engagement state that should be baseline. Understanding the three states helps target appropriate intervention.`,
            },
            {
              word: `ventral vagal`,
              definition: `The baseline safety and social engagement state in polyvagal theory. Characterized by calm, connected functioning — heart rate variable, breathing relaxed, facial expression engaged, able to interact with others. This is the state healthy stress recovery aims to return to. The text describes it as the top of the autonomic hierarchy, accessible when the nervous system registers safety.`,
              audioPrompt: `Ventral vagal is the baseline safety and social engagement state in polyvagal theory, {name}. Terra here — in Stephen Porges's framework, this is the state the autonomic nervous system occupies when it registers that the current situation is safe. Heart rate is variable and relaxed. Breathing is easy. Facial expression is engaged and expressive. The person is calm and capable of real connection with others. This is the state from which learning, social bonding, creativity, and genuine wellbeing are most accessible. The text describes the three autonomic states as forming a hierarchy the system moves down under increasing stress: from ventral vagal at the top, to sympathetic activation in the middle, to dorsal vagal shutdown at the bottom. Safety supports ventral vagal; manageable threat activates sympathetic; overwhelming threat activates dorsal vagal. Recovery from stress moves back up this hierarchy. This framing has a practical implication: many stress recovery practices work partly by creating conditions that signal safety to the nervous system. Social connection with safe people supports a shift toward ventral vagal. Slow breathing with extended exhales signals safety. Time in calm, non-threatening environments supports it. The goal of stress recovery, in this framework, is not just the absence of activation but the return to a state of genuine engagement and connection.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `state regulation`,
              definition: `The process of influencing which autonomic state you are in — moving between ventral vagal engagement, sympathetic activation, and dorsal vagal shutdown. In polyvagal theory, different situations call for different interventions: an activation state needs practices that promote recovery, while a shutdown state may need different approaches including safe social connection (co-regulation) to shift back toward engagement.`,
              audioPrompt: `State regulation is the process of influencing which autonomic state you are in, {name}. Terra here — the text introduces this as a practical implication of polyvagal theory. In Porges's framework, the autonomic nervous system operates in three states: ventral vagal engagement, sympathetic activation, and dorsal vagal shutdown. Different situations call for different interventions, because the starting state matters. If you are in an activation state — sympathetic, fight-or-flight — the right practices are those that support recovery: slow breathing with extended exhales to activate the parasympathetic system via the vagus nerve, physical movement to complete the activation cycle, sleep, time in nature. If you are in a shutdown state — dorsal vagal, frozen, dissociated — self-regulation alone may not be enough, and safe social connection — what the text calls co-regulation through safe relationships — can help shift state when internal practices aren't working. The text also notes that many people who experienced overwhelming stress, especially in childhood, cycle between activation and shutdown without easily accessing the ventral vagal engagement state that should be baseline. Awareness of which state you are in at a given moment helps you target the appropriate intervention, rather than applying the same practice regardless of where you are starting from.`,
            },
            {
              word: `co-regulation`,
              definition: `The process of shifting nervous system state through connection with another calm, safe person, rather than through self-regulation alone. Mentioned in the text as particularly relevant when a person is in a shutdown (dorsal vagal) state where internal self-regulation practices may not be sufficient. Safe relationships and social connection are identified as resources that buffer against allostatic load and support recovery.`,
              audioPrompt: `Co-regulation is the process of shifting nervous system state through connection with another calm, safe person, {name}. Terra here — the text introduces this in the context of polyvagal theory's practical implications. While self-regulation practices like slow breathing, physical movement, and sleep are important, some states are harder to shift from the inside alone. Specifically, when a person is in a dorsal vagal shutdown state — frozen, dissociated, or numb — the very nature of that state can make internal self-regulation practices difficult to access or execute. Research and clinical practice in trauma-informed care have found that safe relational connection with another person who is themselves in a regulated state can help shift the nervous system out of shutdown in ways that self-directed practices alone cannot. This is co-regulation. The autonomic system is fundamentally social — it reads signals of safety from the faces, voices, and presence of other people. Safe relationships are not just emotionally important; they have direct physiological effects on the stress system. The text identifies social connection as a recovery resource that reduces allostatic load and supports return to ventral vagal engagement. Building and maintaining safe relationships is therefore not separate from stress physiology but directly connected to it.`,
            },
          ],
        },
