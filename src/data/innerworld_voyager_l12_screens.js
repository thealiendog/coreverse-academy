  ...
  lessons: [
    {
      ...
      screens: [
...

        {
          ...
          paragraphs: [
            `Advaita Vedanta, which we met in Lesson 9, has yet another framing. The relevant term is ahamkara, often translated "the I-maker." It is the mental function that takes the basic experience of awareness and adds the conviction "this awareness belongs to me, a separate individual." For Advaita, ahamkara is what generates the sense of separate selfhood. Without it, awareness would simply be aware, without dividing itself into subject and object.`,
