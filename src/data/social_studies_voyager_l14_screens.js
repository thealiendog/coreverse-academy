      ...
      screens: [
        {
          id: `l14-welcome`,
          type: `welcome`,
          guideText: `{name}, from 1945 to 1991, the world was organized around a single dominant fact: the rivalry between two superpowers, the United States and the Soviet Union, and the ideological contest between capitalism and communism that they represented. The Cold War, so named because the two superpowers never directly fought each other in open combat, shaped everything: which governments rose and fell, which wars were fought and by whom, which economic models were promoted or suppressed, which alliances structured international security, and which ideas about freedom, equality, and the future of humanity competed for global allegiance. If you want to understand why the world looks the way it does today, from the shape of Europe's borders to the nature of China's government to the political legacies of Latin America, the Middle East, and Asia, the Cold War is an essential lens. The Cold War was not only about superpower competition. It was lived on the ground by hundreds of millions of people: Cubans living through a revolution and a missile crisis, Koreans divided by a war that technically never ended, Vietnamese dying in a proxy conflict that killed millions, Chileans experiencing a CIA-backed coup that ended their democracy, East Germans living under surveillance in a totalitarian state, and Soviet citizens living with the promises and failures of a revolutionary ideology. Understanding the Cold War requires understanding it both as a global strategic competition and as a lived human experience with vastly different consequences depending on where you were. This lesson maps the Cold War systematically: its origins, its ideological contest, its key crises, its effects on the developing world, and how it ended. Five case studies will bring it from abstract history to concrete human reality. And because the Cold War's legacies are very much still with us, understanding it is not just about knowing history, it's about understanding the world you're inhabiting. Onward.`,
...

        {
          ...
          vocab: [
            ...
            { word: `mutually assured destruction (MAD)`,
...

        {
          ...
          vocab: [
            ...
            { word: `communist appeal in the developing world`,
...

        {
          ...
          vocab: [
            ...
            { word: `Cold War coups and interventions`,
            ...
            { word: `arms race and nuclear risk`,
...

        {
          ...
          vocab: [
            ...
            { word: `the fall of the Berlin Wall`,
...

        {
          ...
          vocab: [
            ...
            { word: `Cold War at the human level`,
