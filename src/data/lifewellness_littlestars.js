export const lifewellnessLittleStars = [
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'What does your body NEED at night?', guideText: 'Tap what your body needs at bedtime!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'What makes your body STRONGER?', guideText: 'Tap what makes your body strong!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'What gets GERMS off your hands?', guideText: 'Tap what cleans germs away!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'What keeps your TEETH healthy?', guideText: 'Tap what keeps teeth healthy!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which is the BEST drink for your body?', guideText: 'Tap the best drink!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which one is RESTING?', guideText: 'Tap resting quietly!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Where does your body LOVE to be?', guideText: 'Tap a kid in nature!',
        items: [
