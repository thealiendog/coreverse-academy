      ...
      screens: [
        {
          id: `l04-welcome`,
          type: `welcome`,
          guideText: `{name}. We have asked what is real, how we know, and how to reason well. Now we turn from how we think to how we live, with one of the boldest ideas in all of philosophy. Here it is, plainly: the universe did not come with an instruction manual. Nowhere is it written, in the stars or the atoms, what your life is supposed to mean or what you are for. To some people that sounds frightening. But a group of thinkers called existentialists saw something else in it — something freeing. If meaning is not handed to you from outside, then you are not stuck with a script someone else wrote; you get to author your own life, and that freedom comes with real responsibility for what you make of it. This is not a gloomy lesson, even though it touches big, heavy things. It is, at its heart, one of the most empowering ideas you will ever meet: that a meaningful life is not found lying around, ready-made — it is built, by you, through your choices and what you care about. And one honest note up front: if these big questions ever sit heavy, that is normal, and talking with people you trust is part of how humans carry them. Let's explore what it means to create your own meaning.`,
...

        {
          ...
          vocab: [
            {
              word: `the absurd, and why existentialism isn't nihilism`,
...

        {
          ...
          vocab: [
            {
              word: `radical freedom, bad faith, and authenticity`,
...

        {
          ...
          vocab: [
            {
              word: `how to actually create meaning`,
...

        {
          ...
          vocab: [
            {
              word: `your life is genuinely yours to shape`,
          ...
          questions: [
            {
              ...
              options: [
                `Random`,
                `It means that, unlike a manufactured object whose purpose (its essence) exists in the maker's mind before the object does, a human being exists first — simply finding themselves here, alive and aware — and only afterward, through living and choosing, creates their essence: who they are, what they stand for, what their life means. A knife's essence (cutting) comes before the knife, because the knifemaker designs it for that purpose; Sartre's radical claim is that for humans it is reversed, since no one designed you for a fixed purpose, so you arrive without a built-in "what you are for" and make yourself through your choices. It is the heart of existentialism because everything else follows from it: if you are not born with a predetermined purpose, then meaning is not discovered like a hidden fact but created through how you live, which makes you both genuinely free (not trapped in a script someone else wrote) and genuinely responsible (you cannot fully blame your nature or design for who you become). Those two edges, freedom and responsibility, are inseparable — to be free to author your life just is to be responsible for the life you author — and that combination is what the whole philosophy is built on.`,
                `It means your purpose was decided before you were born`,
                `Random`,
              ],
              correctIndex: 1,
            ...
            },
            {
              ...
              options: [
                `Random`,
                `The absurd, as Camus named it, is the gap between our deep human hunger for meaning, purpose, and answers and a universe that stays silent, offering no built-in cosmic answer to "what is it all for?" Both nihilism and existentialism start from the same true observation — that the universe hands us no pre-made meaning — but they draw opposite conclusions. Nihilism concludes that since there is no built-in, cosmic meaning, then nothing matters at all and there is no point to anything. Existentialism firmly rejects that conclusion, making the key move that "the universe doesn't hand you meaning" does NOT lead to "therefore nothing matters" but to something completely different: "therefore meaning is yours to create." On this view the absence of a cosmic instruction manual is not proof that nothing counts; it is an open space in which you get to decide what counts, through what you love, build, and commit to. Camus captured the spirit with the myth of Sisyphus, concluding not "give up" but "imagine Sisyphus happy," because meaning and even joy can be found in how we meet our life. So existentialism shares nihilism's honesty about the silent universe but is its opposite in conclusion: not collapse into "nothing matters," but rise into "then I will decide what matters, and live for it."`,
                `The absurd means life is a joke and nothing is serious`,
                `Random`,
              ],
              correctIndex: 1,
            ...
            },
            {
              ...
              options: [
                `Random`,
                `Bad faith is Sartre's term for lying to yourself that you have no choice, in order to escape the discomfort that comes with freedom and responsibility. Because existentialists hold that we are far freer than we usually admit — that in almost every situation, even constrained ones, we are actually choosing — they see a constant temptation to hide from that freedom by pretending it is not there, telling ourselves things like "I had to," "I had no option," or "that's just how I am." These claims feel true and relieve us of responsibility, but Sartre argues they are usually self-deceptions: you almost always have options, even if they are hard ones, and pretending otherwise is a way of dodging ownership of your choices. Bad faith matters because it is the main way people avoid the responsibility that is the inseparable twin of their freedom, and naming it is useful precisely because it lets you catch yourself doing it — noticing when you are saying "I have no choice" to escape the harder truth that you do have a choice and are responsible for it. The opposite of bad faith is honestly owning your freedom and the choices you actually make.`,
                `Being dishonest in business deals`,
                `Random`,
              ],
              correctIndex: 1,
            ...
            },
            {
              ...
              options: [
                `Random`,
                `Because responsibility is the inseparable twin of freedom, and the very thing that makes it weighty is also what makes change possible. If you are genuinely choosing far more than you usually admit, then you own your choices in a deep way and cannot fully offload them onto circumstances, other people, or "that's just who I am" — which can feel heavy. But the same fact is the source of your power: if you are continually making yourself through your choices, then different choices make a different self, so you are not stuck being whoever you have been. The responsibility you cannot escape is exactly what gives you the ability to change, grow, and become someone you would rather be, because nothing outside you has permanently fixed who you are. This reframes responsibility from a pure burden into a doorway: blaming your nature, your past, or your circumstances might feel comforting, but it also traps you, since if those things fully determined you, you could never change; owning your choices is heavier but liberating, because it means your future is genuinely open to being shaped by what you decide and do next. Power and responsibility, in this view, are two names for the same thing.`,
                `It isn't — responsibility is purely a burden to minimize`,
                `Random`,
              ],
              correctIndex: 1,
            ...
            },
            {
              ...
              options: [
                `Random`,
                `To live authentically is to live according to values you have genuinely chosen and examined, rather than just absorbing a script handed to you by your crowd, your culture, or what is expected, and then to own those choices honestly. Its opposite is living on autopilot — doing and believing things only because "that's what everyone does" or "that's what I'm supposed to do," without ever asking whether you actually endorse them — which connects directly to the examined-beliefs idea from the first lesson: authenticity is examining the script you were handed, deciding what you genuinely value, and living from that. Crucially, it does NOT mean "do whatever you feel like and ignore everyone else," because your freedom always meets other people's freedom, and the most serious existentialists tied authentic freedom tightly to responsibility toward others. So authenticity is not selfishness or impulsiveness dressed up in philosophy; "being myself" is never an excuse to dodge how your choices affect the people around you. It means choosing your life consciously and owning it — living from values you have actually reflected on and endorsed, while still taking responsibility for your effect on others — which, especially in the years when crowd-pressure intensifies, is one of the most protective and freeing ideas a person can carry.`,
                `It means always doing exactly what you feel like, ignoring everyone`,
                `Random`,
              ],
              correctIndex: 1,
            ...
            },
            {
              ...
              options: [
                `Random`,
                `Meaning is created not as a one-time grand discovery of "my one true purpose" but as an ongoing practice woven from several real strands: caring deeply about people and connecting with them, committing to work, craft, or causes you find worth doing and pouring yourself into them, responding to hardship with courage and growth rather than only bitterness, and living by values you have genuinely chosen rather than a borrowed script. Viktor Frankl, who survived the Nazi concentration camps, grounded this powerfully: he observed that those most able to endure extreme suffering often still had a sense of meaning — someone to return to, unfinished work, a reason to hold on — and concluded that meaning is not mainly about what you get from life but about what you give and how you respond to what life gives you, and that even when circumstances cannot be controlled, you retain the freedom to choose your attitude toward them. Crucially, none of this requires the universe to first certify that you matter: the meaning is real precisely because you are really living it — really caring, committing, and connecting. And the lesson adds an honest human note: because these are big questions, if they feel heavy that is normal, and meaning is something humans build together, so connecting with people you trust is itself part of how meaning gets made.`,
                `By waiting until the universe reveals your one true purpose`,
                `Random`,
              ],
              correctIndex: 1,
            ...
            },
            {
              ...
              options: [
                `Random`,
                `Because it rests on a hidden, unjustified leap: from "there is no pre-given, cosmic, built-in meaning" to "therefore there is no meaning at all." The first part is a true observation that existentialists fully accept — the universe really does not come with a built-in purpose stamped on it. But the leap to "so nothing matters" assumes that the only meaning that could count as real is cosmic, objective meaning handed down from outside, and that assumption is exactly what the existentialists reject. Their reply is that created meaning can be entirely real without cosmic certification: when you genuinely love someone, commit to work you care about, or connect deeply with others, that meaning is really there — you are really living it — and it does not become fake just because the universe did not pre-approve it. So nihilism mistakes "not handed to us from outside" for "not real," which is a confusion, not a logical necessity. In fact, the nihilist position tends to collapse the moment a person genuinely loves or cares about something, because the lived reality of that caring is itself the counterexample. The honest takeaway is that the silent universe is real, but the jump to "nothing matters" is an unsupported inference, and recognizing that gap is exactly the clear thinking the band keeps training.`,
                `It does follow — nihilism is simply correct`,
                `Random`,
              ],
              correctIndex: 1,
            ...
            },
            {
              ...
              options: [
                `Random`,
                `Because its deepest claim is genuinely hopeful: that your life is yours to shape, that meaning is not a prize the universe withholds but something you are free and able to create, and that this remains true even in hard circumstances you cannot control. Although existentialism honestly faces heavy things — the silent universe, the absurd, mortality, the weight of responsibility — it consistently turns each one toward empowerment rather than despair: the lack of a built-in purpose becomes the freedom to author your own life; the silence of the universe becomes open space for you to decide what matters; the weight of responsibility becomes the very power to change and grow; and even suffering, in Frankl's hard-won view, leaves you the freedom to choose your response and find meaning in what you give. This is the precise opposite of nihilism's "nothing matters," which existentialism explicitly rejects. The lesson also adds an honest, caring note rather than pretending these questions are weightless: because they are some of the biggest a person ever faces, it is completely normal for them to feel heavy sometimes, and meaning is something humans build together in connection with people who matter, so reaching toward trusted others is part of how the philosophy is actually lived. Empowerment, not bleakness, is the genuine heart of the view.`,
                `Because it tells you to ignore all the heavy questions`,
                `Random`,
              ],
              correctIndex: 1,
