      ...
      screens: [
        {
          id: `l04-welcome`,
          type: `welcome`,
          guideText: `{name}, nine people — unelected, serving for life — can strike down any law passed by Congress or any state. That power, judicial review, was not written in the Constitution. The Supreme Court claimed it. Since then it has shaped American life more than most elections ever have. How it interprets the Constitution, and whether that interpretation is legitimate, is one of the live debates in American democracy. This lesson gives you the cases and the stakes.`,
