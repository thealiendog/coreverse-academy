      ...
      screens: [
        ...
        // ── SECTION 1 ─────────────────────────────────────────────────────────
        {
          ...
          vocab: [
            ...
            { word: `society`,
              definition: `A large group of people living together in an organized way, sharing rules and institutions.`,
              audioPrompt: `A society is a large group of people living together in an organized way, {name}. A society shares rules, institutions, and usually a culture — a common language, history, or set of values. Government exists because societies need coordination. Without some shared system for making decisions, large societies fall apart. A neighborhood of twenty people might manage without formal rules. A country of three hundred million cannot.` },
          ],
        },
        ...
        // ── SECTION 5 ─────────────────────────────────────────────────────────
        {
          ...
          vocab: [
            ...
            { word: `responsibility`,
              definition: `Something you are expected to do as part of being in a group or community.`,
              audioPrompt: `A responsibility is something you are expected to do as part of being in a group or community, {name}. Citizens have responsibilities to their country, just like you have responsibilities at school and at home. Following the law, treating others fairly, and — once you're old enough — voting and paying taxes are all civic responsibilities. Rights and responsibilities go together. The more rights a society gives you, the more it expects from you in return.` },
          ],
        },

        // ── INTERACTIVE GAME (parked for review per Caro May 22) ──────────────
        {
          id: `l01-game`,
          type: `interactive`,
          format: `drag-identify`,
          guideText: `Sort each scenario into the right type of government, {name}. Read carefully — some are tricky.`,
          buckets: [
          ...
          items: [
            { id: `l01-g1`, image: `l01-game-1.webp`, label: `Citizens vote in fair elections every four years to choose their leaders`,
            ...
            { id: `l01-g3`, image: `l01-game-3.webp`, label: `A free press can criticize the government and reporters aren't jailed`,
              matchPhrase: `Democracy. A free press is one of the clearest signs a country is actually democratic.`, correctMatch: `democracy` },
            { id: `l01-g4`, image: `l01-game-4.webp`, label: `Power passes from a queen to her firstborn child when she dies`,
              matchPhrase: `Monarchy. Inheriting the throne is the classic feature.`, correctMatch: `monarchy` },
            { id: `l01-g5`, image: `l01-game-5.webp`, label: `A royal family has ruled the country for over 500 years`,
              matchPhrase: `Monarchy. Long-lasting royal dynasties are how monarchies hold power across generations.`, correctMatch: `monarchy` },
            { id: `l01-g6`, image: `l01-game-6.webp`, label: `The king is the head of state, but Parliament makes the laws`,
              matchPhrase: `Monarchy. This is how the UK works — the monarch is a symbol, and Parliament actually rules.`, correctMatch: `monarchy` },
            { id: `l01-g7`, image: `l01-game-7.webp`, label: `One leader controls the military, the news, and the police`,
              matchPhrase: `Dictatorship. All major powers concentrated in one person is the danger sign.`, correctMatch: `dictatorship` },
            { id: `l01-g8`, image: `l01-game-8.webp`, label: `People who criticize the government get jailed or sent into exile`,
              matchPhrase: `Dictatorship. Punishing critics is one of the clearest warning signs.`, correctMatch: `dictatorship` },
            ...
            { id: `l01-g10`, image: `l01-game-10.webp`, label: `Anyone can run for office, and elections are checked by independent watchers`,
              matchPhrase: `Democracy. Open elections with independent oversight are real, not theater.`, correctMatch: `democracy` },
          ],
        },
