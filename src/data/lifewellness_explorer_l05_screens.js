  ...
  lessons: [
    {
      ...
      screens: [
...

        {
          ...
          type: `magazine`,
          section: 2,
          headline: `Sleep cycles and why they matter`,
          paragraphs: [
            `Sleep comes in **cycles of about 90 minutes** each, containing different stages. **Light sleep** transitions you between waking and deeper sleep. **Deep sleep** (slow-wave sleep) is when physical restoration happens — muscle repair, bone growth, and immune function. **REM sleep** (Rapid Eye Movement) is when dreams occur and emotional and memory processing happen. You need multiple complete cycles per night. Cutting sleep short cuts off the **later cycles**, which are disproportionately REM-heavy. That means you lose more emotional processing and memory consolidation than you might expect — even from what feels like a small reduction in sleep time.`,
          ],
...

        {
          ...
          type: `magazine`,
          section: 3,
          headline: `How much sleep kids need`,
          paragraphs: [
