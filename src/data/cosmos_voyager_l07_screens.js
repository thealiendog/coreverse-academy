      ...
      screens: [
...

        {
          ...
          ,
            {
              word: `Vera Rubin`,
              definition: `American astronomer who, with collaborator Kent Ford in the 1970s, measured the rotation curves of dozens of spiral galaxies and found stars at the outer edges moving much faster than visible matter alone predicts. Her work is now considered foundational to modern cosmology and is one of the primary observational lines of evidence for dark matter.`,
              audioPrompt: `Vera Rubin is an American astronomer whose work in the 1970s transformed cosmology, {name}. Working with her collaborator Kent Ford, Rubin studied the rotation of spiral galaxies by measuring how fast stars at different distances from the galactic center were moving. Newtonian gravity predicted that stars at the outer edges should move slower than those closer in. The data showed the opposite. Stars near the edges of galaxies moved much faster than the visible matter could account for. Rubin and Ford's observations of dozens of galaxies all showed the same pattern. This consistent discrepancy between prediction and observation is now one of the foundational lines of evidence for dark matter. Rubin's work was undervalued for decades but is now recognized as among the most important observational work of the 20th century.`,
            },
            {
              word: `Fritz Zwicky`,
              definition: `Swiss astronomer who in 1933 measured the motion of galaxies in the Coma cluster and found they required about 400 times more mass than the visible galaxies could account for. He coined the term 'dunkle Materie,' German for dark matter. His work was largely ignored for decades.`,
              audioPrompt: `Fritz Zwicky is the Swiss astronomer who first introduced the concept of dark matter, {name}. In 1933, Zwicky observed the Coma galaxy cluster and measured how fast the galaxies were moving. He then used the laws of physics to calculate how much mass would be needed to gravitationally hold the cluster together. The answer was startling: the cluster needed about 400 times more mass than the visible galaxies could account for. Zwicky called the missing component dunkle Materie, which is German for dark matter. For decades, almost no one followed up on his work. It was not until the 1970s, when Vera Rubin and Kent Ford produced systematic observations of galaxy rotation curves, that the evidence for dark matter became overwhelming. Zwicky is now recognized as the originator of the idea.`,
            }
          ],
        },

        {
          ...
          ,
            {
              word: `Bullet Cluster`,
              definition: `Two galaxy clusters that collided, observed in detail starting in 2004. The hot gas bunched up in the middle while the gravitational mass passed through largely unaffected. Gravitational lensing maps show most mass is where the galaxies passed through, not where the gas piled up. This is hard to explain without dark matter as a real substance.`,
              audioPrompt: `The Bullet Cluster is one of the most striking pieces of evidence for dark matter as a real substance, {name}. Starting in 2004, astronomers observed two galaxy clusters that had collided with each other. The hot gas, which is most of the normal matter in clusters, got slowed down by the collision and bunched up in the middle. The galaxies and dark matter passed through largely unaffected. Gravitational lensing maps reveal where most of the mass actually is. It is not where the hot gas piled up. It is in the regions where the galaxies passed through. This spatial separation between visible matter and gravitational mass is very hard to explain with modified-gravity theories alone. Simple MOND-based explanations struggle to reproduce these observations. The Bullet Cluster is widely cited as compelling evidence that dark matter is a real substance that does not interact strongly with normal matter.`,
            },
            {
              word: `cosmic microwave background`,
              definition: `Faint thermal radiation left over from the early universe, providing an independent line of evidence for dark matter. Tiny temperature variations in the CMB encode information about matter density in the early universe. The patterns are consistent with a universe whose total matter content is about six times the visible matter.`,
              audioPrompt: `The cosmic microwave background, or CMB, provides an independent line of evidence for dark matter, {name}. The CMB is faint thermal radiation left over from the early universe, from a time about 380,000 years after the Big Bang when the universe cooled enough for atoms to form. Tiny temperature variations in the CMB encode information about the density of matter in the early universe. The patterns we observe are consistent with a universe whose total matter content is about six times the visible matter. This CMB data is completely independent of galaxy rotation curves. Yet it points to the same conclusion: there is a large amount of matter that does not emit light. Multiple independent lines of evidence converging on the same answer is a strong signal that the conclusion is robust.`,
            }
          ],
        },

        {
          ...
          ,
            {
              word: `accelerating expansion`,
              definition: `Discovery made in 1998 by two independent teams of astronomers studying distant supernovae. The expansion of the universe is not slowing down due to gravity, as expected, but is speeding up. Whatever is causing this acceleration accounts for about 68% of all the energy in the universe and is called dark energy.`,
              audioPrompt: `The accelerating expansion of the universe is one of the most unexpected discoveries in the history of cosmology, {name}. In 1998, two competing teams of astronomers were studying distant supernovae to measure how the expansion rate was changing over time. Both teams assumed the expansion was slowing down due to gravity. The data showed the opposite. The expansion of the universe is speeding up. Something is pushing the universe apart faster and faster. That something accounts for about 68% of all the energy in the universe and is called dark energy. The two teams were led by Saul Perlmutter and by Brian Schmidt and Adam Riess. Both arrived at the same conclusion independently, which significantly increased confidence in the result. They shared the 2011 Nobel Prize in Physics.`,
            },
            {
              word: `vacuum energy`,
              definition: `Energy predicted by quantum field theory to be present in empty space. The calculated value disagrees with the observed dark energy density by 120 orders of magnitude. This discrepancy is sometimes called the worst prediction in physics and is one of the biggest open problems in fundamental physics.`,
              audioPrompt: `Vacuum energy is the energy that quantum field theory predicts should be present in empty space, {name}. According to quantum mechanics, even a perfect vacuum is not truly empty; quantum fluctuations give space an intrinsic energy density. This is called vacuum energy. The simplest mathematical description of dark energy, the cosmological constant, treats it as a property of empty space with a constant energy density. The problem is that quantum field theory's calculated value for this vacuum energy disagrees with the observed dark energy density by 120 orders of magnitude. This discrepancy is sometimes called the worst prediction in physics. Reconciling what quantum field theory predicts about empty space with what we actually observe as dark energy is one of the biggest open problems in all of fundamental physics.`,
            }
          ],
        },

        {
          ...
          ,
            {
              word: `WIMPs`,
              definition: `Weakly Interacting Massive Particles — the most popular dark matter particle candidates. These would be particles outside the Standard Model that interact with normal matter primarily through gravity. Massive experiments including LUX and XENON1T have searched for them without definitive detection. Simplest WIMP models have been increasingly disfavored.`,
              audioPrompt: `WIMPs, or Weakly Interacting Massive Particles, are the most popular dark matter particle candidates, {name}. The idea is that dark matter consists of one or more new types of particles outside the Standard Model of physics that interact with normal matter primarily through gravity. Massive underground experiments have been searching for WIMPs for decades. The LUX experiment and the XENON1T experiment use enormous tanks of ultra-pure liquid xenon, buried deep underground to shield from cosmic rays, hoping to catch a rare interaction with a passing dark matter particle. So far, none of these experiments have detected anything definitive. The simplest WIMP models have been increasingly disfavored by these null results. Other particle candidates, particularly axions, remain under investigation.`,
            },
            {
              word: `axions`,
              definition: `Lightweight dark matter particle candidates that have not been ruled out by current experiments. Originally proposed to solve a different problem in particle physics, they are now one of the most studied alternatives to WIMPs. Various experiments are actively searching for them.`,
              audioPrompt: `Axions are dark matter particle candidates that remain under active investigation, {name}. They are much lighter particles than WIMPs and interact with ordinary matter extremely weakly. Axions were originally proposed to solve a different problem in particle physics, having nothing to do with dark matter. The fact that they also make good dark matter candidates is part of why physicists find them appealing. Unlike WIMPs, whose simplest models have been increasingly disfavored by null detection results from LUX and XENON1T and their successors, axions have not been ruled out. Dedicated experiments searching specifically for axions, including the ADMX experiment, are currently running. Whether axions are the explanation for dark matter remains genuinely open.`,
            }
          ],
        },

        {
          ...
          ,
            {
              word: `dark matter`,
              definition: `Whatever is producing gravitational effects in galaxies and clusters that cannot be explained by visible matter. The label is a placeholder: it means 'whatever is responsible for these effects.' Multiple independent lines of evidence point to it; its actual nature remains unknown. Discovering what it is would be one of the biggest scientific breakthroughs of this century.`,
              audioPrompt: `Dark matter is a placeholder label for whatever is producing gravitational effects that visible matter cannot explain, {name}. The term does not point to a specific physical entity we understand. It means: whatever is responsible for galaxy rotation curves, gravitational lensing anomalies, CMB patterns, and the Bullet Cluster observations. Multiple independent lines of evidence all point to the same conclusion: something is gravitating that we cannot see. What that something actually is remains essentially unknown. It may be new particles, modified gravity, or something requiring fundamentally new physics. Discovering what dark matter actually is would be one of the biggest scientific breakthroughs of this century. Many physicists believe we will know within a few decades. Some think it may take much longer.`,
            },
            {
              word: `primordial black holes`,
              definition: `Black holes that could have formed in the early universe from density fluctuations, before any stars existed. They are one candidate component of dark matter under the 'new physics' position. Their contribution to the dark matter budget is constrained but not fully ruled out.`,
              audioPrompt: `Primordial black holes are black holes that may have formed in the very early universe from density fluctuations, long before any stars existed, {name}. Unlike black holes that form from collapsing stars, primordial black holes could have formed directly from regions of the early universe that were dense enough to collapse. Some physicists have suggested they could make up part or all of the dark matter. The idea has received renewed attention in recent years. However, observations have constrained how many primordial black holes of various masses can exist without contradicting other things we observe. Their contribution to the dark matter budget is limited but not fully ruled out for all mass ranges. They represent one possible component of the dark matter budget under the position that dark matter may be a combination of different things.`,
            }
          ],
        },
