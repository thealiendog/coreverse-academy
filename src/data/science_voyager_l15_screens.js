      ...
      screens: [
        {
          id: `l15-welcome`,
          type: `welcome`,
          guideText: `{name}, last lesson energy flowed through wires as electricity. Now we meet a completely different way energy travels: as waves. Waves are one of the most profound and unifying ideas in physics, because nearly everything you sense about the world reaches you as a wave. Every sound you've ever heard arrived as a wave rippling through the air. Every color you've ever seen arrived as a wave of light. The warmth of the Sun, the signal to your phone, the image on every screen, the X-ray at the doctor, all are waves. This lesson reveals what a wave actually is, and the astonishing truth that sound and light, which seem so different, are both waves obeying the same deep rules. We'll start with the anatomy of a wave: its wavelength, frequency, and amplitude, the simple properties that determine everything about it. We'll see how a wave carries energy from place to place without carrying matter along with it, a subtle, beautiful idea. We'll explore sound: a wave of vibrating air, why pitch is frequency and loudness is amplitude, and why sound needs a medium and can't travel through empty space. Then light, and one of the great revelations of physics: that visible light is just a tiny slice of a vast electromagnetic spectrum, from radio waves to microwaves to infrared, ultraviolet, X-rays, and gamma rays, all the same kind of wave, differing only in wavelength. And unlike sound, light needs no medium at all; it crosses the empty vacuum of space, which is how the Sun's energy and the light of distant stars reach us. By the end, you'll understand the rippling, invisible language in which the universe speaks to your senses. Onward.`,
