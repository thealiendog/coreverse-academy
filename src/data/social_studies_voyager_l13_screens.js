      ...
      screens: [
        {
          id: `l13-welcome`,
          type: `welcome`,
          guideText: `{name}, in 1945 the world had fewer than sixty independent nations. By 1980 it had more than one hundred fifty. That transformation, perhaps the most sweeping political change of the twentieth century, was decolonization: the process by which vast colonial empires built over centuries by European powers came apart, and new sovereign nations emerged from them. At its peak in the mid-twentieth century, about a third of the world's population lived under colonial rule. Those people were not citizens of their own nations; they were subjects of empires that extracted their resources, suppressed their cultures, and decided their futures from distant capitals. The collapse of that system reshaped the political map, the global economy, and the meaning of sovereignty itself. But decolonization was not a single event or a clean story. It happened in different ways in different places: sometimes through negotiated transfers of power, sometimes through violent anti-colonial revolts, sometimes through wars that lasted years and cost hundreds of thousands of lives. The new nations that emerged faced extraordinary challenges: borders drawn by colonial powers that ignored ethnic and cultural realities, institutions designed for extraction not governance, economies built around commodity exports rather than diversified development, and legacies of violence and division that colonial rule had created or deepened. Some new nations built stable democracies; others fell into authoritarian rule or civil conflict. The promises of independence were not always fulfilled. Understanding decolonization is essential for understanding today's world: why global inequality looks the way it does, why borders in Africa, Asia, and the Middle East have the shapes they do, why some formerly colonized nations developed rapidly while others remain poor, and why the legacies of empire remain live and contested topics in global politics. Latin America decolonized earlier, mostly in the early nineteenth century, giving us a longer lens on what independence does and doesn't automatically deliver. This lesson maps the major patterns of decolonization, the variety of paths nations took, the promises that were made, and the legacies that followed. Five real cases will make the patterns concrete. Onward.`,
...

        {
          ...
          vocab: [
            ...
            { word: `the UN and decolonization`,
...

        {
          ...
          vocab: [
            ...
            { word: `the legacy of how independence came`,
...

        {
          ...
          vocab: [
            ...
            { word: `connecting history to present`,
