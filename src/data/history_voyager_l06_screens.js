      ...
      screens: [
        {
          id: `l06-welcome`,
          type: `welcome`,
          guideText: `{name}, revolutions are the moments when political orders collapse and new ones emerge. They happen for reasons — and serious thinkers disagree about what those reasons are. Marx saw class conflict. Tocqueville saw rising expectations. Skocpol saw state breakdown. Colonial revolutions needed different frameworks entirely. This lesson gives you the theories before we examine the cases.`,
...

        {
          ...
          vocab: [
            ...
            {
              word: `popular mobilization`,
              definition: `The third distinguishing feature of a revolution: substantial sections of the population acting collectively to make the transformation happen, beyond elite factions. This distinguishes revolution from a coup, which can be executed by a small group.`,
              audioPrompt: `Popular mobilization is the third and distinguishing feature of a revolution, {name}, the one that most clearly separates revolution from coup. A coup d'état is a sudden change in who holds state power, usually executed by a small elite faction, often military, without fundamental change in how society is organized. The entire transformation can happen in a single night with a handful of actors; the population wakes up to new rulers but the same underlying social structure. Most "revolutions" reported in news media across the 20th century were actually coups of this kind. Latin America saw dozens of coups across the Cold War, often US-supported, rarely producing fundamental transformation. Revolution requires something more: substantial sections of the population acting collectively to make the transformation happen. The French Revolution saw peasant uprisings across France, urban working people storming the Bastille, and the mobilization of millions who gave the transformation its popular character. The Russian Revolution of 1917 began with bread riots in Petrograd in which thousands of ordinary people participated before any organized political faction had seized the opportunity. The Haitian Revolution began with an organized uprising of hundreds of thousands of enslaved Africans across the northern plains of Saint-Domingue. Without popular mobilization, revolutions don't happen or don't hold. This is also what makes revolutions more transformative than coups: the mobilized population creates new social facts, new power relationships, and new claims that a mere leadership change doesn't.`,
            },
            {
              word: `coup d'état`,
              definition: `A sudden change in who holds state power, usually executed by an elite faction (often military), without fundamental change in how society is organized. Distinguishable from revolution by the absence of broader social transformation and popular mobilization.`,
              audioPrompt: `A coup d'état is the most common form of sudden political change and the one most often mistakenly called a revolution, {name}. The French term means literally a blow against the state: it is a sudden seizure of state power by an elite faction, typically the military, without the broader social transformation and popular mobilization that distinguish a genuine revolution. In a coup, the leadership changes but the underlying economic structure, class relationships, and social organization remain substantially intact. The same institutions continue to function; the same military and bureaucratic hierarchy remains in place; ordinary people's lives change little beyond who holds formal power. Latin America provides dozens of examples across the 20th century: military coups overthrew elected governments in Argentina, Brazil, Chile, Uruguay, Bolivia, Guatemala, and elsewhere, often with US support during the Cold War, rarely producing fundamental social transformation. The Chilean military coup of 1973, which overthrew the democratically elected government of Salvador Allende, is a characteristic example: it produced a change in who ruled and a reversal of Allende's socialist programs, but it was not a revolution in the full sense because it was executed from above by military elites rather than through popular mobilization. Understanding the distinction matters because it changes how you analyze what's happening and what's possible. Coups are reversible in ways that genuine revolutions rarely are; the social transformations that accompany genuine revolutions create new facts on the ground that simple leadership changes cannot easily undo.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `In Marxist theory, the development among members of an exploited class of awareness of their shared interests as a class and of their position within the capitalist system. A precondition for organized revolutionary action in the classical Marxist sequence.`,
              audioPrompt: `Class consciousness is a central concept in the Marxist theory of revolution, {name}. In classical Marxist analysis, it isn't enough for a class to be objectively exploited; the members of that class must also develop awareness of their shared interests as a class and of their structural position within the capitalist system. Marx famously distinguished between a class "in itself" (a group that objectively shares an economic position) and a class "for itself" (a group that has developed consciousness of its shared interests and acts collectively on the basis of them). The development of class consciousness is what transforms economic position into revolutionary potential. Workers in early industrial capitalism might experience exploitation without yet understanding it as a systemic feature of capitalism; as experience, organization, and political education develop, workers become conscious of their shared interests and begin to act collectively. The Marxist historical prediction was that industrial capitalism would inevitably produce class consciousness among the proletariat, and that class consciousness would eventually produce revolutionary action. This prediction has been substantially challenged by the actual history of advanced capitalist countries: workers in the United States, United Kingdom, and France did develop labor organizations and political parties but generally did not produce revolutionary transformation. Antonio Gramsci's work on cultural hegemony, the idea that dominant classes maintain power partly by shaping what workers consider natural or common sense, is partly an attempt to explain why class consciousness doesn't automatically develop as the classical theory predicted.`,
            },
            {
              word: `productive forces`,
              definition: `In Marxist theory, the technology, tools, and organization of production available to a society at a given historical moment. When productive forces develop beyond what existing property arrangements (relations of production) can accommodate, the resulting contradiction produces revolutionary pressure.`,
              audioPrompt: `Productive forces is the Marxist term for the technology, tools, and organization of production available to a society at a given historical moment, {name}. In Marx's framework, productive forces are the material foundation on which social relations are built. The classical Marxist sequence works like this: a given mode of production (feudalism, capitalism) combines specific productive forces with specific relations of production (property arrangements and class structure) in ways that are initially mutually reinforcing. But productive forces tend to develop: technology improves, new forms of organization emerge, new capacities become possible. Over time, the existing relations of production become constraints on further development of productive forces rather than supports for it. The old ruling class, whose power is embedded in the existing relations of production, resists the transformation those new productive forces require. This is the contradiction that eventually produces revolutionary transformation. Marx applied this framework to explain past transitions: slave-based agriculture's productive forces were eventually surpassed by feudal organization, which was eventually surpassed by capitalist industrial production. He predicted the same dynamic would produce a transition from capitalist to socialist modes of production as industrial capitalism's productive forces expanded beyond what private ownership of the means of production could contain. The predictions have been mixed: the specific revolutions that occurred in the 20th century didn't match the classical model's predictions about where and how they would occur, which is why modern Marxist theory of revolution has substantially evolved beyond the classical formulation.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `J-curve theory`,
              definition: `James C. Davies's 1962 formalization of Tocqueville's insight: revolutions tend to occur when a sustained period of improving conditions is followed by a sharp reversal. The improving period raises expectations; the reversal creates an unbearable gap between expectations and reality.`,
              audioPrompt: `The J-curve theory is political scientist James C. Davies's 1962 formalization of Tocqueville's insight about revolutionary timing, {name}. The name comes from the shape of the curve on a graph: overall conditions improve over time (the upward curve of the J) and then sharply reverse (the hook at the bottom of the J). The improving period raises people's expectations and aspirations; they begin to believe better conditions are the normal state of affairs and that further improvement is coming. When conditions then sharply reverse, the gap between those raised expectations and the actual deteriorating reality becomes psychologically unbearable in ways that uniform misery doesn't produce. Tocqueville showed in The Old Regime and the Revolution in 1856 that France was substantially better off in 1789 than it had been 50 years earlier; literacy had risen, the economy had grown, Enlightenment ideas circulated, and the Bourbon regime had attempted reforms. The reforms raised expectations beyond what the regime could deliver; the gap between rising expectations and continuing inequalities produced explosive discontent. Davies applied this framework to multiple historical cases and argued it had predictive power. The Arab Spring fit the J-curve pattern: Arab countries had been generally improving for decades in literacy, life expectancy, urbanization, and economic conditions before the 2008 global financial crisis and subsequent food price shocks created sharp reversals. The theory has limits: many societies fit the J-curve pattern without producing revolutions, which suggests additional factors (state capacity, organizational capacity, international context) are required to complete the explanation.`,
            },
            {
              word: `Old Regime`,
              definition: `The pre-revolutionary French social and political order, characterized by hereditary monarchy, aristocratic privilege, and the three-estate system (clergy, nobility, commoners). Tocqueville's "The Old Regime and the Revolution" (1856) analyzed why France's improving conditions under this system still produced revolution.`,
              audioPrompt: `The Old Regime is the term for France's pre-revolutionary social and political order, {name}, and Tocqueville's analysis of why it produced revolution despite substantial improvements is one of the most important insights in revolutionary theory. The Ancien Régime, as the French call it, was characterized by hereditary monarchy, aristocratic privilege, and the three-estate system that divided French society into clergy (First Estate), nobility (Second Estate), and everyone else (Third Estate). The nobility and clergy were exempt from most taxation, placing the fiscal burden on commoners. The monarchy ruled by divine right without representative institutions that could check its power. By the 1780s this system was under strain from war debts accumulated through France's participation in European conflicts including support for the American Revolution against Britain. What makes Tocqueville's analysis counterintuitive and important is that the Old Regime was not uniformly stagnant or worsening in the decades before 1789. The French economy had grown substantially. Literacy had risen. Enlightenment ideas circulated in salons, coffeehouses, and publications. Louis XVI's government had actually attempted reforms: Turgot, Necker, and Calonne all tried to modernize the tax system and address fiscal imbalances. But the reforms were blocked by aristocratic resistance in the parlements, which refused to allow taxation of the nobility. And the reforms, even when attempted, raised expectations among commoners beyond what the regime could deliver. The gap between the improving conditions, the circulating ideas about liberty and equality, and the continuing reality of aristocratic privilege and royal absolutism produced the explosive discontent that erupted in 1789.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `fiscal crisis`,
              definition: `A state's inability to raise sufficient revenue to meet its obligations, often a trigger for state breakdown. France in 1789 faced fiscal crisis from war debts; the monarchy couldn't reform the tax system against aristocratic resistance, producing the crisis that led to the calling of the Estates-General.`,
              audioPrompt: `Fiscal crisis is one of the key mechanisms through which state breakdown occurs in revolutionary situations, {name}. A state that cannot raise sufficient revenue to meet its obligations loses the capacity to pay its military, fund its administration, and maintain the basic functions of government. This is not just a financial problem; it is a political and military problem. States that cannot pay soldiers face desertions; states that cannot fund administration lose capacity to govern; states that cannot meet creditors lose international credit and eventually sovereignty. France in 1789 faced an acute fiscal crisis. The monarchy had accumulated massive debts from supporting the American Revolution against Britain from 1778 to 1783, added to earlier war debts. The existing French tax system exempted the nobility and clergy, placing the entire burden on commoners who had less capacity to pay. Every minister who tried to reform the tax system to extract revenue from the privileged orders was blocked by the aristocratic parlements. Louis XVI's government tried Turgot, Necker, and Calonne in succession; each attempted reform was blocked or reversed. By 1788, the state was functionally bankrupt and the calling of the Estates-General for May 1789 (the first time since 1614) was an act of desperation, an attempt to find some way to extract revenue from the privileged orders that the parlements had blocked. The Estates-General created the political opening that became the Revolution. Without the fiscal crisis, the Estates-General would not have been called; without the Estates-General, the Third Estate's claim to represent the nation and the subsequent revolutionary dynamics would have had no obvious trigger.`,
            },
            {
              word: `state capacity`,
              definition: `A state's ability to exercise control through military force, extract revenue through taxation, and administer its territory through bureaucracy. In Skocpolian theory, the level of these capacities independently determines whether revolutionary movements can succeed in seizing power.`,
              audioPrompt: `State capacity is the central independent variable in Skocpolian revolutionary theory, {name}. Theda Skocpol's core insight was that state military capacity, fiscal capacity, and administrative capacity all matter independently of the underlying class structure and the level of popular grievances. Even when class conflict is intense and popular grievances are acute, a state with sufficient capacity to manage both can suppress revolutionary movements and prevent their success. This is why the 1905 Russian Revolution, which occurred in a context with similar class structure and similar popular grievances to 1917, failed: the tsarist state retained enough capacity to manage the crisis. By 1917, three years of catastrophic World War I had destroyed that capacity. Military capacity was gone: soldiers were deserting, refusing orders, and eventually joining the revolutionary forces. Fiscal capacity was gone: massive war expenditures had produced hyperinflation and state bankruptcy. Administrative capacity was gone: transportation had collapsed, food distribution had broken down, the bureaucracy could not manage basic functions. When bread riots broke out in Petrograd in February 1917, the state had no capacity to suppress them. The military units ordered to fire on crowds refused. Within days the tsar had abdicated. The lesson Skocpol drew: revolutions succeed not primarily because they are strong but primarily because the states they face have broken down. This has important implications for analyzing current situations: a strong repressive state can contain intense popular grievances for a long time; when the state weakens (through war, economic crisis, elite fragmentation, international pressure), revolutionary openings appear even where they seemed impossible.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `racialized dehumanization`,
              definition: `The colonial process of denying full personhood to colonized peoples through racial categorization, legal exclusion, and cultural denigration. Frantz Fanon argued this is structurally different from class exploitation and requires its own theoretical framework.`,
              audioPrompt: `Racialized dehumanization is the concept Frantz Fanon introduced to describe what distinguishes colonial situations from European class societies, {name}. In standard European class analysis, including Marxist theory, workers are exploited: they produce more value than they receive in wages, and this surplus is appropriated by capital. But in colonial situations, the colonized face something additional and different: the systematic denial of their full humanity through racial categorization. The colonial state doesn't just exploit the colonized economically; it defines them as less-than-human in legal, cultural, and epistemological categories that place them outside the community of persons who can claim rights, political agency, and moral consideration. European Enlightenment declarations about universal rights to liberty and equality were written and implemented by people who simultaneously enslaved Africans, dispossessed indigenous peoples, and colonized Asia. The contradiction wasn't accidental; the Enlightenment's universalism was practically applied only to those classified as fully human under the racial hierarchies that European colonialism developed. Fanon, writing from his experience as a Black psychiatrist in Algeria under French colonial rule and as a member of the Algerian liberation struggle, argued that revolutionary change in colonial situations therefore requires not just economic transformation but the recovery of personhood that colonization denied. The colonized must reclaim their own humanity against a system that systematically denied it. This is why, Fanon argued controversially, anti-colonial violence has a dimension the European theorists didn't account for: it is not just instrumental but involves the recovery of agency and personhood that dehumanization had taken.`,
            },
            {
              word: `Toussaint Louverture`,
              definition: `The dominant military and political leader of the Haitian Revolution (1791-1804), a formerly enslaved man who rose through exceptional military and political skill, negotiated with French, Spanish, and British powers, and established Haitian self-governance before being captured by the French in 1802.`,
              audioPrompt: `Toussaint Louverture is the central figure of the Haitian Revolution and one of the most remarkable political and military leaders in modern history, {name}. Born into slavery in Saint-Domingue, the French colony that is now Haiti, Louverture rose through exceptional military and political skill to become the dominant leader of the revolutionary forces. What makes his story historically significant extends beyond his personal story. The Haitian Revolution began in August 1791 when a coordinated uprising of enslaved people across the northern plains of Saint-Domingue erupted. Within months tens of thousands of formerly enslaved people had taken up arms. The revolution unfolded across 13 years against not one but three European powers: France, Spain, and Britain, all of whom sent armies to either suppress the revolution or exploit it for their own imperial purposes. Louverture navigated this complex international situation with extraordinary political sophistication, at different times aligning with Spain against France, then with France against Spain and Britain, then asserting Haitian autonomy against France's attempt to restore slavery under Napoleon. He read European Enlightenment texts and turned their language of liberty and equality against the European powers who had reserved those rights for themselves. He promulgated a constitution in 1801 that abolished slavery and proclaimed Haitian self-governance. Napoleon sent an expedition of 20,000 soldiers to restore French control and reimpose slavery. When Louverture agreed to negotiate, he was captured through treachery, transported to France, and imprisoned in a mountain fortress where he died in 1803. Jean-Jacques Dessalines led the final phase, defeating the French expedition and declaring Haitian independence on January 1, 1804.`,
            },
          ],
        },
