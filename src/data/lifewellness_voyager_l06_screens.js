      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `Social shame or negative judgment associated with having a mental health condition, which the text identifies as a real obstacle to help-seeking that worsens outcomes. Research is clear that stigma causes people to delay seeking treatment, and that this delay makes conditions worse. The text frames stigma as the irrational thing — not the help-seeking — comparing mental health conditions to medical conditions like diabetes that are not treated as moral failings.`,
              audioPrompt: `Mental health stigma is the social shame and negative judgment associated with having a mental health condition, and the text identifies it as one of the primary obstacles to people getting help, {name}. Terra here — the text makes a specific argument about stigma. Research is clear that stigma causes people to delay seeking treatment. People fear being seen as weak, broken, or "crazy." They fear judgment from family, peers, and even healthcare providers. They internalize the idea that having a mental health struggle is a character flaw rather than a medical condition. This delay produces worse outcomes: conditions that would be more treatable early become entrenched; opportunities for intervention at the most important developmental windows are missed. The text frames this carefully: stigma is the irrational thing, not the help-seeking. We do not treat diabetes or asthma as moral failings, and mental health conditions involve similar neurobiological processes with similar medical status. The comparison is important because it targets exactly the wrong reasoning stigma is built on. Part of mental health literacy, the text argues, is being able to name stigma as the obstacle and recognize help-seeking as what changes outcomes — the harder thing and the right thing.`,
            },
            {
              word: `adolescent mental health onset`,
              definition: `The developmental pattern in which many mental health conditions first emerge during early adolescence. The text cites this as a key reason mental health literacy matters at age 11–12: catching conditions early and getting professional help during adolescence dramatically improves outcomes, while untreated conditions that persist through this period often become harder to address in adulthood.`,
              audioPrompt: `Adolescent mental health onset refers to the developmental pattern in which many mental health conditions first emerge during early adolescence, {name}. Terra here — the text makes this specific and direct: depression and anxiety disorders often have their first onset in early adolescence. This is not because adolescence causes these conditions but because the neurobiological and developmental changes of this period create conditions under which underlying vulnerabilities may become active. For 11 and 12 year olds, this timing has a practical implication. If you develop real mental health literacy now — knowing what clinical conditions look like, knowing the difference between ordinary struggles and conditions needing professional help, knowing when and how to seek that help — you are learning it at exactly the window when that knowledge is most needed. Catching conditions early and getting professional help dramatically improves outcomes. Conditions left untreated through adolescence often persist into adulthood and become harder to treat. NIMH data show roughly 1 in 5 adolescents experiences a diagnosable mental health condition each year and roughly 1 in 3 will experience one by age 18. Those are not small numbers. This is not about pathologizing normal teenage moodiness; it is about recognizing the difference between normal struggles and clinical patterns that need real help, at the age when that recognition matters most.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `functional impact`,
              definition: `One of the key markers researchers and clinicians use to distinguish clinical conditions from ordinary struggles — whether symptoms are severe enough to interfere with daily functioning in areas like school, relationships, activities, and self-care. The text identifies duration, severity, and functional impact as the three markers clinicians look for when assessing whether a mental health concern rises to the level of a clinical condition.`,
              audioPrompt: `Functional impact is one of the key markers that researchers and clinicians use to distinguish clinical conditions from ordinary struggles, {name}. Terra here — the text identifies three markers: duration, severity, and functional impact. Functional impact asks: is this interfering with daily life? Is the person still able to go to school, maintain relationships, participate in activities, take care of themselves? Or are these areas breaking down? A person experiencing ordinary sadness after a loss may have difficult days but continues to function. A person with clinical depression may find that functioning in these areas has become significantly impaired — school attendance drops, relationships withdraw, activities stop, self-care deteriorates. The difference in functional impact is one of the clearest signals that a concern has crossed from ordinary struggle into clinical territory. The text is careful to note that this isn't binary. Functional impact exists on a spectrum. But when functioning is significantly interfered with — grades are slipping, friendships are eroding, previously enjoyed activities have stopped — that is the signal to pursue professional evaluation rather than waiting to see if ordinary supports resolve it.`,
            },
            {
              word: `help-seeking script`,
              definition: `A simple, concrete way to start the conversation about getting mental health support. The text offers: "I've been struggling with [specific things]. Can we talk about whether I should see someone?" The text notes that most caring adults will respond well to this, and that the few who don't are wrong — other adults are available. Knowing the script in advance reduces the activation energy needed to ask for help.`,
              audioPrompt: `A help-seeking script is a simple, concrete way to start the conversation about getting mental health support, {name}. Terra here — the text offers a specific one: "I've been struggling with [specific things]. Can we talk about whether I should see someone?" This is worth having in advance because the activation energy needed to ask for help is often the actual barrier. Knowing what to say reduces that barrier. The text makes several supporting points about using it. Most adults who care about you will respond well to this kind of specific, direct statement. The few who don't are wrong — other adults are available. You don't need to have already diagnosed yourself; you just need to say what you've been experiencing and ask whether it warrants seeing someone. The professional then does the actual assessment. The text also names why asking is often harder than it should be: mental health stigma, fear of judgment, and the fact that the conditions themselves can affect the thinking you'd use to recognize and act on them. Shame about needing help is itself something that mental health conditions can produce. Asking anyway — with a script like this, for yourself or for someone you care about — is what changes outcomes. The text puts it directly: asking for help is often the harder thing, and it's what matters.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `A therapy approach developed largely by Aaron Beck starting in the 1960s that works by examining and changing patterns of thinking and behavior that maintain mental health conditions. CBT has strong research evidence across depression, anxiety disorders, OCD, eating disorders, and PTSD. In practice it involves regular sessions, specific skills taught and practiced, and work between sessions — not just talking, but structured techniques applied collaboratively with a trained therapist.`,
              audioPrompt: `Cognitive behavioral therapy, commonly called CBT, is a therapy approach developed largely by Aaron Beck starting in the 1960s, {name}. Terra here — the text identifies it as having strong research evidence across multiple conditions: depression, anxiety disorders, OCD, eating disorders, and PTSD. CBT works through a specific mechanism. It identifies the connections between thoughts, feelings, and behaviors — and targets the patterns of thinking and behavior that maintain mental health conditions. The "cognitive" part refers to thoughts: identifying thought patterns that are distorted, catastrophic, or self-undermining, and learning to examine and change them. The "behavioral" part refers to actions: identifying behaviors that maintain conditions (like avoidance in anxiety) and gradually changing them through structured practice. What therapy actually looks like in practice matters to understand. Regular sessions, usually weekly. Structured conversation with specific goals. Skills being taught and practiced inside sessions. Work assigned for between sessions. Gradual change over months. Not just venting. Not just nodding. Not magic. The therapist is trained in specific techniques and using them in collaboration with you. The text notes that different therapists have different styles; finding one that fits matters. Therapy that doesn't seem to be helping after a reasonable time — 3 to 4 months — is worth reassessing.`,
            },
            {
              word: `panic attacks`,
              definition: `Sudden episodes of intense fear accompanied by physical symptoms — racing heart, shortness of breath, feeling of dying or losing control — typically lasting around 10 to 20 minutes. The text identifies panic attacks as one of the specific anxiety warning signs that warrant professional evaluation, distinguishing them from ordinary anxiety by their sudden onset, physical intensity, and episodic nature.`,
              audioPrompt: `Panic attacks are sudden episodes of intense fear accompanied by physical symptoms, {name}. Terra here — the text names them specifically as one of the warning signs of anxiety disorders that warrant professional evaluation. The physical symptoms are characteristic: racing heart, shortness of breath, feeling of dying, feeling of losing control, sometimes dizziness, sweating, or trembling. The episodes are sudden and typically peak within a few minutes, usually lasting around 10 to 20 minutes before subsiding. They feel physically and psychologically overwhelming in a way that is distinctly different from ordinary worry. In the case of Sam in the lesson, she had two panic attacks in the previous month — sudden racing heart, shortness of breath, feeling like she was going to die, lasting about 15 minutes each. The text identifies this as one of several specific warning signs that together strongly suggest a clinical anxiety disorder rather than ordinary teenage anxiety. The practical implication: panic attacks are not "just anxiety being intense." They are a specific clinical symptom that, combined with other patterns like persistent worry, avoidance, and physical symptoms throughout daily life, signals that professional evaluation is warranted. CBT has strong evidence for treating anxiety disorders including those with panic attacks, but treatment requires recognizing the condition as clinical first.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `hypervigilance`,
              definition: `A state of heightened alertness and sensitivity to threat, often experienced after significant distressing events. The text lists hypervigilance as one of the trauma-spectrum warning signs — along with flashbacks, nightmares, intrusive memories, and avoidance of reminders — that suggests a person's response to significant experiences has persisted in ways that warrant professional evaluation.`,
              audioPrompt: `Hypervigilance is a state of heightened alertness and sensitivity to potential threat, {name}. Terra here — the text lists it as one of the trauma-spectrum warning signs. After significant distressing experiences, some people remain in a state where the nervous system is continuously scanning for danger even when the immediate threat has passed. This shows up as constantly being on edge, startling easily, having difficulty relaxing, reading neutral situations as potentially threatening, or finding it difficult to feel safe even in objectively safe environments. The text notes something important about trauma responses: "the response isn't determined by the size of the event but by your experience of it." This means that what qualifies as a significant enough experience to produce trauma responses is not determined from the outside by whether it looks like a "big" event, but from the inside by whether the person's nervous system responded in ways that have persisted. Hypervigilance alongside flashbacks, nightmares or intrusive memories, avoidance of reminders, and changes in mood or self-perception after significant experiences are the trauma-spectrum warning signs the text names. Together, when these patterns are persistent — weeks or months after the experience — they warrant talking to a trusted adult and seeking professional evaluation. Trauma-focused therapies have strong evidence for helping people whose nervous systems have remained in this kind of sustained alert state.`,
            },
            {
              word: `intrusive thoughts`,
              definition: `Unwanted, involuntary thoughts that feel impossible to dismiss and cause significant distress. The text identifies intrusive thoughts as a core feature of OCD-spectrum concerns — especially when accompanied by compulsive behaviors performed to relieve the anxiety they generate and significant time spent on these patterns. Intrusive thoughts are experienced as ego-dystonic: the person recognizes they don't want the thoughts and that they don't reflect their values, but feels unable to stop them.`,
              audioPrompt: `Intrusive thoughts are unwanted, involuntary thoughts that feel impossible to dismiss and cause significant distress, {name}. Terra here — the text identifies them as a core feature of OCD-spectrum concerns. The clinical pattern is specific: intrusive thoughts appear without the person choosing them; they are experienced as foreign and unwanted, not as thoughts the person wants to have; and despite the person recognizing this — knowing the thoughts don't make sense, knowing they don't reflect their values — they feel unable to dismiss them. The anxiety generated by the intrusive thoughts then drives compulsive behaviors performed to relieve that anxiety: washing, checking, counting, mental rituals, other repetitive actions. These compulsions provide temporary relief but reinforce the cycle — the brain learns that the ritual reduced the anxiety, making it more likely to compel the ritual next time. Significant time spent on these patterns and distress when prevented from performing the compulsions are the other markers the text names. The key distinguishing feature from ordinary "I keep thinking about something" is the involuntary quality, the significant distress, and the compulsive response cycle. CBT, specifically a version called Exposure and Response Prevention, has the strongest evidence for OCD-spectrum conditions and targets exactly this cycle. But treatment requires recognizing the pattern as clinical, which this lesson aims to support.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `mental health literacy`,
              definition: `The knowledge and skills needed to distinguish ordinary struggles from clinical conditions, recognize warning signs that suggest professional evaluation, understand what professional help looks like and how to access it, and know crisis resources in advance. The text argues that mental health literacy at age 12 is one of the highest-leverage forms of self-knowledge available, given that adolescence is when many conditions first emerge.`,
              audioPrompt: `Mental health literacy is the knowledge and skills needed to navigate mental health — your own and others' — with accuracy and effectiveness, {name}. Terra here — the text defines what this literacy includes. Knowing the difference between ordinary struggles and clinical conditions, so neither is over-medicalized nor dismissed. Recognizing warning signs that suggest professional evaluation: the patterns of persistence, severity, and functional impact that distinguish clinical conditions from normal difficult feelings. Understanding what professional help actually looks like — therapy types, how sessions work, what to expect, how medications are decided — so that seeking help is less intimidating. Knowing crisis resources in advance: 988 Suicide and Crisis Lifeline available 24/7 by call or text, emergency rooms for immediate danger, school counselors as accessible first contacts. The text makes a specific claim about timing: mental health literacy at 12 is one of the highest-leverage forms of self-knowledge available. Adolescence is when many conditions first emerge; recognizing them and getting help early dramatically improves outcomes. The text goes further: "This lesson and its companion topics across the band may save your life or someone you care about." That is not hyperbole. Mental health literacy is what allows a person to recognize a clinical condition in themselves or a friend and act on it rather than waiting, minimizing, or being stopped by stigma.`,
            },
            {
              word: `prolonged grief disorder`,
              definition: `A clinical condition that can develop when ordinary grief after a significant loss does not resolve over time but instead persists in ways that severely impair functioning. The text mentions this as one possible complication of grief, distinguishing it from the ordinary grieving process. Warning signs that grief may be complicating include sadness worsening over time rather than fluctuating, loss of hope, significant deterioration in functioning, and thoughts of self-harm.`,
              audioPrompt: `Prolonged grief disorder is a clinical condition that can develop when ordinary grief after a significant loss does not resolve over time but instead persists in ways that severely impair functioning, {name}. Terra here — the text mentions it in the context of distinguishing Jordan's ordinary grief from clinical depression. The key point is that ordinary grief and prolonged grief disorder are not the same as clinical depression, but prolonged grief disorder is itself a recognizable clinical condition that benefits from professional attention. Ordinary grief fluctuates — sad moments alongside normal mood and engagement; it is centered on the specific loss; it gradually changes over time even if not linearly. The text offers specific signals to watch for that would suggest grief may be complicating into something requiring professional evaluation: is the sadness changing and lifting at all, or getting worse over time? Is functioning deteriorating rather than being preserved? Is hope present? Are there thoughts of self-harm? If any of these appear, that shifts the assessment from "ordinary grief, respond with grief support" toward "this warrants seeing a professional who can assess whether prolonged grief disorder or depression is developing." The lesson's broader point about grief applies here: grief is real, deserves real engagement, and has no fixed timeline — but it also can sometimes evolve into something clinical that needs more than ordinary grief support.`,
            },
          ],
        },
