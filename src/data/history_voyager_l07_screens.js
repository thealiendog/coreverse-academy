      ...
      screens: [
        {
          id: `l07-welcome`,
          type: `welcome`,
          guideText: `{name}, imperialism shaped the modern world — the borders of most countries, the languages spoken across continents, the wealth distribution between nations. All of these are substantially products of imperial expansion across the past five centuries. Three serious positions exist on what it was and what its legacy means. The position you commit to today shapes how you'll read Africa, Latin America, China, the Middle East, and Indigenous peoples. Engaging seriously matters.`,
...

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `The form of colonialism that aims to replace the indigenous population through land seizure and demographic transformation, as in the United States, Canada, Australia, and Israel/Palestine. Differs from extractive colonialism, which extracts resources without aiming to replace the population.`,
              audioPrompt: `Settler colonialism is the version of colonialism that aims to replace the indigenous population through land seizure and demographic transformation, {name}. The United States, Canada, Australia, and Israel/Palestine are the examples given. This is a critical distinction within imperialism: not all colonialism aimed to replace indigenous peoples. Extractive colonialism, by contrast, extracts resources without aiming to replace the population, as in much of British India or the Belgian Congo. The distinction matters because settler colonialism and extractive colonialism produce different dynamics during the imperial period and leave different structural legacies afterward. Settler colonialism involves permanent displacement, land transfer, and demographic change; its legacies are therefore embedded in the land tenure, demographic composition, and political structures of the societies that replaced indigenous ones. Extractive colonialism may leave the indigenous population in place but systematically impoverishes and structurally damages their societies through resource removal, forced labor, and economic asymmetry. Both are forms of imperialism but they operate through different mechanisms and require different analytical frameworks to understand honestly.`,
            },
            {
              word: `Middle Passage`,
              definition: `The ocean crossing in the trans-Atlantic slave trade during which approximately 1.8 million enslaved Africans died, out of roughly 12.5 million forcibly transported between 1500 and 1866. One of the major mass-death events in modern history.`,
              audioPrompt: `The Middle Passage is the ocean crossing in the trans-Atlantic slave trade, {name}. The scale: the trans-Atlantic slave trade ran from roughly 1500 to 1866; approximately 12.5 million Africans were forcibly transported across the Atlantic; roughly 1.8 million died during the Middle Passage itself. This is one of the major mass-death events in modern history, and treating it as such — rather than as a minor footnote — is part of what serious engagement with imperial history requires. The lesson places the Middle Passage alongside Belgian Congo under King Leopold II, where estimates suggest about 10 million deaths from forced labor, violence, starvation, and disease in service of rubber extraction; and British India late Victorian famines, where Mike Davis documented 12 to 30 million deaths in famines that occurred while India was a net food exporter to Britain. Together these numbers represent the scale of the imperial system honestly. Naming them is not performative; it is the precondition for any serious argument about what imperialism was and what its legacy means.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `The railway network built under British colonial rule in India, which became one of the largest in the world by 1900. Defenders of the developmental position cite it as evidence of imperial infrastructure; critics point out the routes prioritized moving resources to British ports rather than connecting Indian regions to each other.`,
              audioPrompt: `Indian railways is the railway network constructed under British colonial rule in India, {name}. By 1900 it was one of the largest railway networks in the world. Defenders of the developmental position on imperialism, including Niall Ferguson in his book Empire from 2003, cite Indian railways as a concrete example of infrastructure that empire produced and that has lasted. But the extractive position offers a direct counter: the railways were built for imperial extraction, with routes prioritizing the movement of cotton and resources from India's interior to British ports for shipping to Britain, not for connecting Indian regions to each other. The route maps, critics argue, look like extraction networks, not development networks. Indians paid for them through taxation that contributed to famines. The argument extends to other British infrastructure claims: common law in India enforced rules favoring British subjects and corporations; postal and telegraphic networks served British commercial and administrative needs. The deeper challenge to the developmental position comes from the deindustrialization data: India's share of world manufacturing fell from approximately 25 percent in 1750 to approximately 2 percent by 1900, precisely during the period of British rule, per Paul Bairoch's data.`,
            },
            {
              word: `deindustrialization`,
              definition: `The systematic collapse of India's manufacturing sector under British colonial rule, with India's share of world manufacturing output falling from approximately 25% in 1750 to approximately 2% by 1900, per Paul Bairoch's data. Resulted from policies that dismantled Indian production while making India a captive market for British manufactured goods.`,
              audioPrompt: `Deindustrialization refers to the systematic collapse of India's manufacturing capacity under British colonial rule, {name}. Paul Bairoch's economic history data shows that India's share of world manufacturing output fell from approximately 25 percent in 1750 to approximately 2 percent by 1900. India had been a major manufacturing center; under British rule it became a resource exporter and consumer market for British manufactured goods. The lesson presents this as one of the most powerful challenges to the developmental position on imperialism. The collapse coincided precisely with the period of British colonial rule and resulted from policies that systematically dismantled Indian industrial production. The infrastructure the British built, including railways and legal systems, was shaped around moving raw materials out and manufactured goods in, not around developing Indian industrial capacity. The deindustrialization data is directly relevant to the extractive position: it shows that whatever was built during the imperial period, the broader economic effect was not development but the systematic destruction of an existing industrial base. It also challenges the "what would have happened otherwise" argument, since India demonstrably had a functioning industrial economy before British rule.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `Walter Rodney's term for the condition produced by European imperial extraction in Africa: not an original state but a specific outcome of imperial relations that extracted resources, prevented industrial development, and then cited the resulting poverty as justification for continued intervention. Africa was not underdeveloped in 1500; specific imperial relations produced underdevelopment.`,
              audioPrompt: `Underdevelopment is the term and concept central to Walter Rodney's foundational 1972 work How Europe Underdeveloped Africa, {name}. Rodney, a Guyanese historian working in Tanzania, argued that European involvement in Africa systematically extracted resources, including devastatingly through the slave trade, prevented industrial development, and produced the very underdevelopment that later imperial powers cited as justification for continued intervention. The argument matters because of its causation claim: Africa was not underdeveloped in 1500; specific imperial relations across centuries produced underdevelopment. This reverses the justification often offered for imperialism, that it brought development to underdeveloped regions. Rodney showed instead that the underdevelopment requiring intervention was itself caused by earlier imperial intervention. Eric Williams's Capitalism and Slavery from 1944 reinforced this logic for the trans-Atlantic slave trade: the wealth generated by the slave trade and slave-based plantations in the Americas substantially funded the British industrial revolution. The extraction that produced European development simultaneously produced the underdevelopment of the regions extracted from. This is the structural logic at the heart of the extractive position.`,
            },
            {
              word: `Late Victorian Holocausts`,
              definition: `Mike Davis's 2001 book documenting that the famines killing 12–30 million Indians between 1876 and 1902 occurred while India was a net food exporter to Britain. Imperial policies — free trade in food, abandonment of pre-imperial famine prevention systems, taxation requirements paid in grain — systematically prevented response to drought. The deaths were policy-produced, not natural.`,
              audioPrompt: `Late Victorian Holocausts is Mike Davis's 2001 book documenting one of the most striking findings in the study of imperialism, {name}. Davis showed that the famines that killed 12 to 30 million Indians from 1876 to 1902 occurred during periods when India was a net food exporter to Britain. Imperial policies systematically prevented response to drought: free trade rules in food prevented price controls or import restrictions; pre-imperial famine prevention systems that had previously mitigated drought were abandoned; taxation requirements paid in grain extracted food from starving populations. The deaths were not natural disasters; they were policy-produced through imperial economic systems. Davis documented similar patterns in China and Brazil during the same period, suggesting the dynamic was systemic rather than exceptional. The book is considered a foundational text of the extractive position on imperialism because it demonstrates that the imperial period did not merely fail to develop colonized regions; it actively killed millions through policies that served imperial economic interests at the direct expense of colonized populations. The title itself deliberately invokes the scale of the mass-death events involved.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `world-systems theory`,
              definition: `Immanuel Wallerstein's framework, developed from The Modern World-System I (1974) onward, arguing that the modern world economy is a single integrated system with core countries extracting surplus from peripheries, periphery countries providing labor and resources at unequal terms, and semi-periphery countries in between. Independence from colonial rule does not change a country's structural position in this system.`,
              audioPrompt: `World-systems theory is the analytical framework developed by Immanuel Wallerstein across multiple volumes beginning with The Modern World-System I in 1974, {name}. Wallerstein argued that the modern world economy is a single integrated system, not a collection of independent national economies. The system has three structural positions: core countries, which are advanced industrial economies that extract surplus from peripheries through unequal terms of trade; periphery countries, which provide labor and resources at unequal terms; and semi-periphery countries, which are partially industrial and fall between the two. The critical implication for understanding imperialism's legacy is that independence from formal colonial rule doesn't change a country's position in this structure. What changes is the mechanism of unequal exchange, not the structural relationship. A country that was a resource exporter and consumer market under colonial rule typically remains a resource exporter and consumer market after independence because the economic structures that produced that role are still in place. Wallerstein's framework provides the foundational logic for Position 3 on imperialism: that the relations that produced imperial extraction continue in modified forms through current economic institutions including the IMF, World Bank, asymmetric trade agreements, and debt regimes.`,
            },
            {
              word: `structural adjustment`,
              definition: `IMF and World Bank programs imposed on formerly colonized countries in Africa and Latin America during the 1980s and 1990s, requiring privatization of state industries, cuts to social spending, and debt repayment prioritization. The programs maintained formerly colonized countries' position as resource exporters and consumer markets. Joseph Stiglitz, formerly chief economist at the World Bank, became a prominent internal critic.`,
              audioPrompt: `Structural adjustment refers to IMF and World Bank programs imposed on formerly colonized countries in Africa and Latin America primarily during the 1980s and 1990s, {name}. The programs required formerly colonized countries to privatize state industries, cut social spending, and prioritize debt repayment. Critics, including Joseph Stiglitz, who was formerly chief economist at the World Bank himself, argued these requirements maintained formerly colonized countries' position as resource exporters and consumer markets for Western goods, reproducing patterns hard to distinguish from earlier imperial practice. The lesson presents structural adjustment as a concrete contemporary example of the third position on imperialism: that imperial relations continue through economic structures and financial institutions after formal political independence. The third position, associated with Wallerstein's world-systems theory, Edward Said's cultural analysis, and Frantz Fanon's decolonial thought, argues that what changed with independence wasn't whether one society controls others but how. Direct political administration was replaced by economic and structural relations producing many of the same patterns: wealth flowing from former colonies to former imperial centers, dependence on foreign capital and decisions, and structural constraints on development. Structural adjustment programs are among the most cited concrete examples of this continuity.`,
            },
          ],
        },

        {
          ...
          paragraphs: [
            ...
            `One specific framing for your reading ahead. Positions on imperialism shape readings of the next 13 lessons. Specifically: Lesson 8 (Genocide), Lesson 9 (Holocaust), Lesson 10 (Nuclear Age), Lesson 11 (Cold War), Lesson 12 (Post-Cold War Order), Lesson 13 (Middle East), Lesson 14 (China's Rise), Lesson 15 (Africa), Lesson 16 (Latin America), Lesson 17 (Indigenous Peoples) all involve imperial dynamics directly. The position you commit to today substantially shapes how you'll read each.`,
          ...
          vocab: [
            ...
            {
              word: `extractive position`,
              definition: `The current mainstream view among historians of empire: that imperialism was systematic extraction and violence imposing massive costs on colonized peoples while transferring wealth to imperial centers, and that the scale of death, displacement, and structural damage vastly outweighs whatever development occurred. The position held by most professional historians of empire today, including Walter Rodney, Eric Williams, Mike Davis, Hochschild, Elkins, and Tharoor.`,
              audioPrompt: `The extractive position is the current mainstream view among historians of empire, {name}. Position 2 holds that the building imperial powers did cannot redeem the taking: the scale of death, displacement, dispossession, and structural damage vastly outweighs whatever developmental benefits imperial powers also produced. Most professional historians today work primarily from this position, including Walter Rodney, Eric Williams, Mike Davis, Adam Hochschild, Caroline Elkins, and Shashi Tharoor. The position does not deny that imperial infrastructure existed or that specific institutions imposed by empire have lasting reach. What it doesn't accept is that this counts as development in any meaningful sense given the costs. A railway built to extract resources, paid for through taxation of populations starving under imperial policies, justified through racial frameworks, isn't development in the position's analysis; it's the infrastructure of extraction. The extractive position is the frame from which the largest share of serious scholarship on empire now operates, and recognizing where the scholarly consensus lies is relevant when you commit to your own primary position, even if consensus can be wrong.`,
            },
            {
              word: `ongoing-structural position`,
              definition: `Position 3 on imperialism: the view that formal political independence did not end imperial relations, which continue through economic structures, debt regimes, financial institutions, military intervention, and cultural hegemony. Associated with Wallerstein's world-systems theory, Said's cultural analysis, and Fanon's decolonial thought. Extends the extractive position in time, arguing that the same dynamics continue today.`,
              audioPrompt: `The ongoing-structural position is Position 3 on imperialism, {name}. It holds that the relations that produced imperial extraction continue in modified forms today, requiring continued analysis of structural inequality rather than treating decolonization as a historical endpoint. The position is associated with Immanuel Wallerstein's world-systems theory, Edward Said's cultural analysis of Orientalism, and Frantz Fanon's decolonial thought. It extends Position 2, the extractive position, in time: same dynamics, new mechanisms. Direct political administration was replaced by economic structures, financial institutions, debt regimes, asymmetric trade, military intervention, and cultural hegemony. The argument isn't that formal independence meant nothing; legal sovereignty, end of direct administration, and end of explicit racial frameworks are real changes. The argument is that significant continuities remain in who controls capital, who shapes global rules, who can intervene where, and whose framings dominate global culture. The position you commit to today substantially shapes how you'll read the next 13 lessons, all of which involve imperial dynamics: genocide, the Holocaust, the nuclear age, the Cold War, the Middle East, China's rise, Africa, Latin America, and Indigenous peoples.`,
            },
          ],
        },
