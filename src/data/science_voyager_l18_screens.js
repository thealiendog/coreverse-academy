      ...
      screens: [
        {
          id: `l18-welcome`,
          type: `welcome`,
          guideText: `{name}, pull far enough back from Earth's problems and a staggering perspective opens up: the universe is 13.8 billion years old, contains more than two trillion galaxies, and emerged from a singularity we call the Big Bang. Stellar evolution, black holes, dark matter, dark energy — these aren't science fiction. They're the best-supported models we have for what the universe actually is. This lesson gives you the real cosmology.`,
