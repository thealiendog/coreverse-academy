  ...
  lessons: [
    {
      ...
      screens: [
...

        {
          ...
          vocab: [
            {
              word: `attention economy (Harris, Center for Humane Technology)`,
...

        {
          ...
          vocab: [
            {
              word: `cognitive resource model of attention`,
...

        {
          ...
          vocab: [
            {
              word: `attention economy and environmental capture`,
...

        {
          ...
          paragraphs: [
            ...
            `Defenders include researchers studying how various biological factors affect cognitive function. Sleep researchers (covered in L02) documenting the dramatic effects of sleep loss on attention and executive function. Exercise researchers documenting cognitive benefits of regular movement (covered in L05). Nutritional cognitive researchers studying how blood sugar regulation, hydration, and broader nutritional state affect focus. Stress researchers (covered in L03) documenting how chronic stress affects attention and executive function.`,
...

        {
          ...
          vocab: [
            {
              word: `integrating the three attention frameworks`,
