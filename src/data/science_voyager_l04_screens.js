      ...
      screens: [
        {
          id: `l04-welcome`,
          type: `welcome`,
          guideText: `{name}, there's one idea in biology so powerful that a famous scientist said nothing in biology makes sense without it. That idea is evolution. In the last lessons you saw how DNA codes for proteins and how we can now edit genes. Today you learn the grand theory that ties all of life together, how the staggering diversity of living things, from bacteria to blue whales to you, arose, all related, all descended from common ancestors over billions of years. But here's the crucial thing, and why this lesson is built as a source evaluation: evolution isn't a guess or a hunch. The word "theory" in science doesn't mean a wild idea; it means a well-tested explanation supported by mountains of evidence from many independent fields. So today you'll do what scientists actually do: examine the evidence yourself. You'll look at fossils that capture change over time, at the matching bones in a bat's wing and a whale's flipper and your own arm, at DNA that reveals relationships, at creatures we've watched evolve in real time, and at the engine that drives it all, natural selection. We'll separate the science from the common misconceptions, because evolution is one of the most misunderstood ideas there is. By the end, you'll understand not just what evolution claims, but why the evidence for it is so overwhelming. You'll think like a scientist weighing the case. Onward.`,
