      ...
      screens: [
        {
          id: `l05-welcome`,
          type: `welcome`,
          guideText: `{name}, you've learned where government's authority comes from, how the Constitution divides power, how rights protect us, and how the Supreme Court interprets it all. But there's a huge piece missing: how do real people actually choose who governs? The Constitution sets up the offices, but it says almost nothing about how citizens organize, argue, campaign, and vote to fill them. That messy, noisy, deeply human arena, parties, elections, campaigns, is where democracy actually happens day to day, and it's the part you'll soon step into yourself as a voter. Here's something that might surprise you: the founders didn't plan for political parties at all. Several of them, including George Washington, warned against them. Yet parties appeared almost immediately and have dominated American politics ever since, because, it turns out, they're nearly impossible to avoid. This lesson explores why. We'll see what political parties are and the real jobs they do, organizing competition, simplifying choices, holding power accountable. We'll examine why the United States has essentially two dominant parties when many democracies have many, and how the rules of an election quietly shape that outcome. We'll walk through how elections actually work, from primaries to campaigns to the unusual way America picks its president. And because nearly everything about this system is genuinely debated, whether two parties is healthy, whether money corrupts elections, whether the system represents people well, we'll end with a real debate among competing views. This isn't abstract. In a few years you'll register, choose, and vote, and the better you understand this system, the more powerful your voice within it becomes. Onward.`,
...

        {
          ...
          vocab: [
            ...
            { word: `the inevitability of parties`,
...

        {
          ...
          vocab: [
            { word: `primary vs. general election`,
