          ...
          questions: [
            {
              ...
              options: [
                `They mean the same thing — both just describe a logically correct argument, so one word would do.`,
                `Valid = the conclusion follows IF the premises are true; sound = valid AND the premises are actually true.`,
                `Valid = the argument sounds convincing; sound = it's delivered confidently — both about how it comes across.`,
                `Valid = the premises are true; sound = the conclusion follows — just swapped labels for the same thing.`,
              ],
              correctIndex: 1,
            ...
            },
            {
              ...
              options: [
                `Deduction is for smart, educated people; induction is the rough guessing everyone else falls back on.`,
                `Deduction means reasoning slowly and carefully; induction means reasoning fast on instinct.`,
                `No real difference between them — both just mean "good logical thinking," dressed up in technical-sounding words to seem deeper.`,
                `Deduction (rules→specifics) is airtight; induction (observations→generalizations) is strong but never certain — so don't expect proof from it.`,
              ],
              correctIndex: 3,
            ...
            },
            {
              ...
              options: [
                `It's any criticism aimed at a person, so it's only a fallacy in the cases where the criticism you make turns out to be false.`,
                `It's attacking an argument too aggressively and hurting feelings — a fallacy because rudeness is unfair.`,
                `Attacking the person instead of their argument — a fallacy even when the personal jab is true, because it changes the subject.`,
                `It's flattering the speaker so people accept their claim out of admiration rather than reason.`,
              ],
              correctIndex: 2,
            ...
            },
            {
              ...
              options: [
                `Presenting only two options when more exist — you escape by rejecting the frame and naming the middle ground.`,
                `When someone lies about the facts — you escape by fact-checking until you catch the lie it rests on.`,
                `Being handed two bad options — you escape by always picking the first one before you get pressured.`,
                `When a choice is genuinely hard because both cost something — you escape by flipping a coin.`,
              ],
              correctIndex: 0,
            ...
            },
            {
              ...
              options: [
                `It's not a fallacy at all — that many people simply can't be wrong, so widespread popularity is strong proof that it really works.`,
                `It's a fallacy only if the sales number is faked; if ten million really bought it, then it works.`,
                `It's an ad hominem, insulting the buyers as gullible; stop insulting them and the argument holds.`,
                `The bandwagon fallacy — popularity spreads through marketing and pressure, not proof; the missing thing is evidence it actually works.`,
              ],
              correctIndex: 3,
            ...
            },
            {
              ...
              options: [
                `Worrying about consequences is always a slippery slope fallacy, since no one can ever really predict what the future will hold.`,
                `It's a fallacy when each step is just asserted to scare you; it's legitimate when each link is actually likely and evidence-backed.`,
                `It's a fallacy whenever the ending sounds extreme — scary endings are fallacies, mild ones are fine.`,
                `It's never a fallacy if the person genuinely feels worried — sincere fear is its own justification.`,
              ],
              correctIndex: 1,
            ...
            },
            {
              ...
              options: [
                `Because fallacies aren't real categories — accusing anyone of one is always meaningless point-scoring.`,
                `Because learning them makes you too paranoid to trust any argument, paralyzing you into believing nothing.`,
                `Because the names get used as a club to dismiss arguments you dislike instead of actually engaging them.`,
                `Because memorizing fallacy names wastes time you could spend learning real facts, making you less informed.`,
              ],
              correctIndex: 2,
            ...
            },
            {
              ...
              options: [
                `Building the strongest, fairest version of a view you disagree with before responding to it.`,
                `Pretending to agree with everyone to avoid conflict and keep the peace.`,
                `Restating an opponent's view in the harshest terms so the audience sees how wrong it is.`,
                `Refusing to engage weak arguments and debating only recognized experts.`,
              ],
              correctIndex: 0,
