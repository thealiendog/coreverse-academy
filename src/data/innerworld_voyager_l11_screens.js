  ...
  lessons: [
    {
      ...
      screens: [
...

        {
          ...
          paragraphs: [
            `In a moment you will read a 5-sentence passage by Richard Schwartz, the founder of Internal Family Systems. The passage is from his book No Bad Parts, published in 2021. Your job is to annotate what each sentence is doing. This is the same skill you practiced with Hume in Lesson 2 and with the Brewer paper in Lesson 7. Reading a primary therapy text closely is a different exercise than reading either, but the basic moves are the same.`,
