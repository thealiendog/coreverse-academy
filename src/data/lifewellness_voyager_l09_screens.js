      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            {
              word: `constructed emotion`,
              definition: `Lisa Feldman Barrett's theory that emotions are not fixed biological responses universal across people, but concepts the brain uses to make sense of bodily signals in context. The same bodily state can be experienced as different emotions (fear, excitement, anger, arousal) depending on how it is interpreted.`,
              audioPrompt: `Constructed emotion theory is Lisa Feldman Barrett's argument that emotions are not fixed biological responses universal across people, {name}. Barrett, at Northeastern University, has done some of the most influential work on this topic. Her theory argues that what we call emotions are concepts the brain uses to make sense of bodily signals in context. The same bodily state — elevated heart rate, sweating, focused attention — might be experienced as fear, anxiety, excitement, anger, or arousal depending on context and interpretation. This isn't to say emotions aren't real; it's to say they're more constructed and more interpretable than the older basic emotions framework suggested. The practical implication is significant: if emotions are constructed, then how we name and interpret bodily signals shapes what we experience. Calling a racing heart before a presentation "anxiety" produces a different experience than calling it "anticipation" or "excitement," even when the bodily state is similar. The experience differs based on interpretation. This matters because it means emotional experience isn't just something that happens to you; interpretation is part of what produces the experience, and interpretation is something that can be developed.`,
            },
            {
              word: `cognitive appraisal`,
              definition: `The interpretive process through which the brain makes sense of bodily signals and context to produce an emotional experience. Appraisal is the step between what the body does and what is experienced as emotion — meaning how a person interprets a situation shapes which emotion results.`,
              audioPrompt: `Cognitive appraisal is the interpretive process through which the brain makes sense of bodily signals and context to produce an emotional experience, {name}. The constructed emotion framework treats appraisal as a core step in how emotions arise: the same bodily state gets interpreted differently depending on context and learned categories, producing different emotional experiences. The practical implication is that appraisal is where emotion regulation can intervene. James Gross at Stanford included cognitive change, also called reappraisal, as one of the key strategies in his process model of emotion regulation. Reappraisal works by changing the interpretation — changing how you appraise a situation — which changes what emotion that situation produces. A kid told to do an unwanted presentation can reappraise from "this is going to be terrible" to "this is a chance to practice talking in front of people, which I'll need across my life." The bodily activation stays similar; the experience differs. For eleven and twelve year olds specifically, the capacity for sophisticated appraisal is still building; learning that interpretation is part of how emotions are constructed is itself one of the most useful early steps in developing mature emotion regulation.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `reappraisal`,
              definition: `An emotion regulation strategy involving changing how a situation is interpreted, which changes the emotion it produces. Research consistently shows reappraisal produces better long-term outcomes than suppression: less negative emotion, better relationships, less depressive symptomatology, and better physical health.`,
              audioPrompt: `Reappraisal is an emotion regulation strategy involving changing how you interpret a situation, which changes the emotion the situation produces, {name}. James Gross included cognitive change and reappraisal as one of the key strategies in his process model. Research consistently shows reappraisal produces better long-term outcomes than suppression: less negative emotion, better relationships, less depressive symptomatology, better physical health. An example from the lesson: a kid told to do an unwanted presentation can reappraise from "this is going to be terrible" to "this is a chance to practice talking in front of people, which I'll need across my life." The bodily activation stays similar — some elevated heart rate, some focused attention. The experience differs: apprehension instead of dread, or engagement instead of avoidance. Reappraisal works early in the process of emotion generation, before the emotion is fully formed. This makes it generally more efficient than suppression, which intervenes after emotion is already present and tries to push it down — at which point the underlying state is already running and the physiological arousal often increases. The lesson frames reappraisal as a learnable skill rather than a fixed trait.`,
            },
            {
              word: `affect labeling`,
              definition: `The practice of naming an emotion specifically rather than vaguely — saying "I'm feeling angry about this" rather than "I feel bad." Matthew Lieberman's research has shown that affect labeling produces measurable reduction in amygdala activation, making it one of the simplest research-supported emotion regulation interventions.`,
              audioPrompt: `Affect labeling is the practice of naming an emotion specifically rather than vaguely, {name}. Matthew Lieberman's research has shown that affect labeling produces measurable reduction in amygdala activation — the brain region involved in emotional reactivity. The mechanism operates through language and prefrontal brain regions that down-regulate the amygdala when emotions are named specifically. Saying "I'm feeling angry about this specific thing" reduces emotional intensity more than vague awareness of feeling bad. The intervention is simple but the effect is real and documented. Marc Brackett's RULER framework at Yale includes labeling as one of its five explicit emotional intelligence skills: Recognize, Understand, Label, Express, Regulate. The lesson notes that most adolescents have been taught to describe emotions vaguely ("I feel bad," "I feel weird," "I don't know"). Learning specific naming — distinguishing frustration from anger from humiliation, distinguishing sadness from grief from disappointment — is a discrete learnable skill. Each level of specificity gives the brain more to work with when regulating. Affect labeling is particularly useful in combination with other strategies; naming what is present is often the first step toward reappraisal or structured reflection.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `Susan David's framework emphasizing the capacity to pause and examine whether emotional content is accurate information about the current situation or noise from earlier patterns. The key practice is asking "what is this feeling telling me?" before deciding whether to act on, work with, or regulate an emotion.`,
              audioPrompt: `Emotional agility is Susan David's framework for working with emotions skillfully, {name}. The central practice is pausing to examine whether emotional content is information about the current situation or noise from earlier patterns, before deciding how to respond. The key question in the framework is: what is this feeling telling me? Sometimes the answer reveals real information. Anxiety is pointing to a genuine threat. Anger is signaling that something genuinely unfair is happening. Discomfort is picking up a real problem in a relationship. In these cases, suppressing or reappraising the emotion away would lose data the emotion was conveying. Sometimes the answer reveals patterns from the past that aren't fitting the current situation. Panic during a routine school presentation. Sadness driven by depression that outlasts its current cause. Anxiety about a possibility that careful thought identifies as irrational. The skill of emotional agility is being able to tell the difference — taking emotions seriously enough to examine what they're communicating, rather than either dismissing all difficult emotions as overreaction or treating all emotional intensity as accurate and requiring response.`,
            },
            {
              word: `disproportionate emotion`,
              definition: `An emotional response that is inaccurate or larger than what the situation actually warrants. Panic at a routine school presentation, catastrophic interpretation of a minor social slight, or sadness driven by depression rather than current circumstances are examples. Recognizing disproportionate emotion is part of distinguishing useful emotional information from noise.`,
              audioPrompt: `Disproportionate emotion is an emotional response that is inaccurate or larger than what the situation actually warrants, {name}. The lesson distinguishes this from accurate emotional information. Panic during a routine school presentation is disproportionate; the bodily activation and fear are real, but they exceed what the actual threat level of the situation justifies. Anxiety about an irrational possibility is inaccurate; the emotion is pointing at something that careful thought identifies as not a real threat. Sadness driven by depression rather than current circumstances can outlast its original cause; the intensity of the feeling exceeds what current circumstances explain. In these cases, the emotion isn't pointing to something that needs response; it's noise that's interfering with appropriate response. Adolescent emotions can be particularly intense and can feel definitive. Sometimes they're accurate: a relationship really is unhealthy; an environment really is hostile; a decision really is wrong. Sometimes a small social slight feels catastrophic; an academic setback feels permanent; a fight with a parent feels terminal. Building the skill of recognizing disproportionate emotion — and knowing that requires practice and often outside perspective — is one of the more sophisticated aspects of mature emotional regulation.`,
            },
          ],
        },

        {
          ...
          vocab: [
            {
              word: `social emotional dynamics`,
            ...
            {
              word: `emotional contagion`,
              definition: `The documented spread of emotions through social networks. Research by Christakis and Fowler showed measurable effects of happiness, depression, and other emotional states across multiple degrees of social separation. Close friend groups develop emotional climates that pull individuals toward those shared states.`,
              audioPrompt: `Emotional contagion is the documented spread of emotions through social networks, {name}. Christakis and Fowler's research showed that happiness, depression, and other emotional states spread measurably through social connections, with effects documented across multiple degrees of separation — not just direct friends, but friends of friends. Close friend groups develop emotional climates: anxious, depressed, dramatic, or calm. These climates pull individuals toward the shared state. For adolescents, the social dimension of emotion is particularly intense. Adolescent social networks involve high emotional reactivity and high mutual influence. A friend group going through a dramatic phase pulls members toward dramatic emotional patterns. A friend group with stable supportive dynamics produces a different emotional climate than one without. The peers someone spends time with don't just provide company; they shape emotional life through contagion. The practical implication from this research is that recognizing which friend group emotional climates are consistently affecting your own state — and having some awareness of which influences are operating on you — is a real emotional skill. It doesn't mean abandoning friendships. It means understanding that social connections shape emotional life through mechanisms that operate partly outside awareness.`,
            },
            {
              word: `co-rumination`,
              definition: `A pattern documented by Amanda Rose and others, particularly in adolescent girls' friendships, where friend groups bond through repeatedly discussing problems. The dynamic deepens negative emotional states for everyone involved without producing resolution. It feels like closeness because of the mutual sharing, but functions as mutual reinforcement of negative emotional patterns.`,
              audioPrompt: `Co-rumination is a specific social-emotional pattern documented by Amanda Rose and others, {name}. It occurs when friend groups bond through repeatedly discussing problems, distress, and difficulties together. The dynamic deepens negative emotional states for everyone involved without producing resolution. The friendship can feel meaningfully close because of the depth of mutual sharing of difficulty. The emotional cost is real: research has found depressive and anxious symptoms increasing for all members involved. Co-rumination is particularly documented in adolescent girls' friendships, though the pattern is not exclusive to them. The pattern isn't malicious; it emerges from genuine connection taking a problematic form. The diagnostic signs the lesson describes are specific: mood worsening after spending time together; needing to have struggles to share in order to fit in; some members exaggerating difficulties to participate; exhaustion after interactions rather than restoration. Some friend groups develop competitive negative emotion — who is struggling most, who deserves the most concern — which functions as mutual reinforcement of negative patterns. Distinguishing co-rumination from real mutual support is a sophisticated emotional skill. Real support involves listening, helping someone navigate, and moving toward resolution. Co-rumination stays with the problem and goes in circles.`,
            },
          ],
        },

        {
          ...
          paragraphs: [
            ...
            `One reminder about escalation. If emotions are consistently overwhelming, regulation strategies aren't working, social dynamics feel impossible to navigate, or any of the mental health warning signs from Lesson 6 are present, that warrants talking to a trusted adult and possibly a professional. Emotional regulation is a skill that can be built, but if the situation is beyond skill-building (clinical mental health conditions, severe stressors, trauma), professional support is what works.`,
          ...
          vocab: [
            ...
            {
              word: `rumination`,
              definition: `Repetitive, passive focus on negative emotional content without productive engagement. Susan Nolen-Hoeksema's research established rumination as a major risk factor for depression and anxiety, particularly in adolescents. Rumination feels productive — it can be mistaken for "processing" — but typically deepens difficult states rather than resolving them.`,
              audioPrompt: `Rumination is repetitive, passive focus on negative emotional content without productive engagement, {name}. Susan Nolen-Hoeksema's research established rumination as a major risk factor for depression and anxiety, particularly in adolescents and women. The characteristic pattern: dwelling on what's wrong, asking why repeatedly without arriving anywhere, replaying difficult events across hours or days. Rumination feels productive — "I'm processing this," "I'm working through what happened" — but typically isn't. It deepens the difficult state rather than resolving it. The lesson makes a critical distinction between rumination and reflection. Reflection has structure: it examines a specific question, leads somewhere, and arrives at understanding or a decision. Rumination is circular: it doesn't reach conclusions and intensifies the difficult emotion rather than working through it. Most adolescents who think they are processing their feelings are ruminating. Teaching the difference is itself a high-leverage skill. One diagnostic question: after extended thinking about the situation, has anything actually concluded? Has a new understanding been reached? If not, the thinking is probably rumination. If the answer is yes, and the engagement led to a specific insight or decision, that is reflection. One practical marker: reflection can end. Rumination doesn't want to.`,
            },
            {
              word: `pop framings`,
              definition: `Simplified, widely circulated emotion-related advice that lacks the nuance of research-based frameworks. Examples include "control your emotions" (often code for suppression), "process your feelings" (often code for rumination), and "be authentic" (often code for expression without regulation). The lesson frames these as absorbed defaults that produce worse outcomes than integrated research-based approaches.`,
              audioPrompt: `Pop framings are simplified, widely circulated emotion-related advice that lack the nuance of research-based frameworks, {name}. The lesson identifies three of the most common. "Control your emotions" is often code for suppression — pushing down emotions after they've been generated — which research consistently shows has predictable costs: physical symptoms, unexpected emotional leakage, relational distance, disconnection from internal experience. "Process your feelings" is often code for rumination — repetitive dwelling that feels productive but deepens difficult states rather than resolving them. "Be authentic" is often code for unfiltered emotional expression in all contexts, which produces its own problems including relational damage and emotional contagion. Most adults around adolescents absorbed these framings without sophisticated distinctions. The research-based picture is more sophisticated than any of them used alone and produces better outcomes. It integrates reappraisal, affect labeling, distinguishing reflection from rumination, recognizing information versus noise, and managing social-emotional contagion. The advantage of learning this at twelve is that patterns established during adolescence often persist into adulthood. Adults who developed sophisticated regulation patterns in adolescence generally have better long-term mental health and relationships than adults who absorbed pop framings without examining them.`,
            },
          ],
        },
