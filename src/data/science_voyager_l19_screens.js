      ...
      screens: [
        {
          id: `l19-welcome`,
          type: `welcome`,
          guideText: `{name}, across eighteen lessons you've learned an astonishing amount of science, from cells to circuits, from atoms to galaxies. But now we turn to something even more important than any single fact: how science itself actually works, and how to think like a scientist. Because here's the deepest truth of all, the specific facts of science may change as we learn more, but the way of thinking, the method of asking questions and weighing evidence honestly, is the most powerful tool humanity has ever invented for understanding reality. This lesson is about that tool, and about using it wisely. We'll explore what science really is: not a collection of facts to memorize, but a process, a way of asking questions about the world and testing answers against evidence. We'll learn the rhythm of that process, observation, question, hypothesis, experiment, evidence, and the crucial idea that in science, claims must be testable and falsifiable, capable of being proven wrong. We'll see why science is self-correcting: it expects to be questioned, revises itself when evidence demands, and grows stronger through doubt rather than weaker. We'll sharpen the skill that matters most in a world flooded with information, evaluating evidence and sources: telling strong evidence from weak, distinguishing correlation from causation, recognizing bias, and spotting the difference between real science and claims merely dressed up to look scientific. And finally, because knowledge is power, we'll confront the ethics of science: that the question "can we?" is never the same as "should we?", that scientists bear responsibility for how their discoveries are used, and that doing science honestly, refusing to fake data, fairly reporting what you find, is itself a moral act. By the end, you'll hold not just facts, but the way of thinking that produced them all. Onward.`,
