      ...
      screens: [
        {
          id: `l02-welcome`,
          type: `welcome`,
          guideText: `{name}, last lesson you saw the big ideas behind government, consent, rights, legitimacy, divided power. But ideas alone don't run a country. Someone has to turn them into an actual working machine: who gets which powers, how they're checked, what happens when they clash. That machine is a constitution, and the people who designed the U.S. Constitution in 1787 faced a terrifying problem. They had just fought a revolution to escape one tyrant, a king. The last thing they wanted was to accidentally build another. But they also knew a government too weak to function, like their first attempt, the Articles of Confederation, would collapse into chaos. They needed power without tyranny. Their solution was one of the most ingenious pieces of political engineering ever devised, and you live inside it every day. This lesson takes you under the hood. We'll see how they split power two different ways at once: vertically, between the national government and the states (federalism), and horizontally, among three branches that must share it (separation of powers). We'll trace how checks and balances let each branch block the others, so no single person or group can seize control. We'll watch the machine actually run, how a bill becomes a law, how a president can be stopped, how the courts can strike down both. And because the design only matters when it's tested, we'll become constitutional analysts, working through real cases where these mechanisms collided, sometimes preventing tyranny, sometimes producing gridlock, always revealing the genius and the friction built into the system on purpose. By the end, the structure that shapes every law you live under will make sense, not as a list of rules to memorize, but as a machine you can read. Onward.`,
