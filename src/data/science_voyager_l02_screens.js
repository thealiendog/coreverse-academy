      ...
      screens: [
        {
          id: `l02-welcome`,
          type: `welcome`,
          guideText: `{name}, inside almost every one of your cells is a molecule about two meters long, coiled so tightly it fits in a space far smaller than a speck of dust. That molecule is DNA, and written along it, in a four-letter chemical alphabet, is the complete instruction set for building and running you. But here's the question that took science decades to answer: how does a string of chemical letters become a living, breathing body? How does code become flesh? Today you learn the answer, one of the deepest ideas in all of biology. The secret is that DNA doesn't build your body directly. Instead, it holds the recipes for proteins, the molecular machines and building blocks that actually do almost everything in your cells. The flow of information goes in one famous direction: DNA is transcribed into a messenger molecule called RNA, and RNA is translated into protein. This is sometimes called the central dogma of molecular biology, and it's the bridge between the silent code and the living you. We'll trace exactly how a gene gets read, copied, and turned into a working protein, see why a single typo in the code can change everything, and understand how the same DNA can build a brain cell and a skin cell. By the end, you'll understand how the book of life is actually read. Onward.`,
