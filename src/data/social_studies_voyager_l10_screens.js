      ...
      screens: [
        {
          id: `l10-welcome`,
          type: `welcome`,
          guideText: `{name}, the last three lessons gave you the tools to read national economies. But no economy exists in isolation. Every country trades, borrows, invests, and competes with every other, and the rules and realities of that interaction shape who gets wealthy and who gets left behind, which industries flourish and which collapse, which workers benefit and which suffer. This is international economics, and it's where macroeconomics meets the real politics of a connected world. Why does trade happen at all? What does it mean for a country to have a "comparative advantage," and why do economists say free trade makes everyone better off in theory, while so many workers and communities feel the opposite in practice? What is globalization, exactly, and has it been a rising tide that lifts all boats, or a system that enriches some while devastating others? And what is "development," the puzzle of why some countries stay poor while others grow rich, and whether rich countries' policies help or hinder the process? These questions sit at the intersection of economics, politics, and justice, and they have no clean answers. Reasonable, thoughtful people disagree fiercely. Latin America has been at the center of many of these debates, experiencing firsthand the promises and costs of open markets, commodity dependence, and integration into a global economy shaped largely by others. This lesson maps these ideas clearly. We'll trace comparative advantage and the logic of trade, the rise and contested consequences of globalization, and the puzzle of development. And because every one of these topics generates genuine debate, we'll end with a real debate among competing philosophies of how countries should engage with the global economy. By the end, the global economic stories you'll hear for the rest of your life will have real structure. Onward.`,
...

        {
          ...
          vocab: [
            ...
            { word: `concentrated costs, diffuse gains`,
...

        {
          ...
          vocab: [
            ...
            { word: `the legacy of colonialism`,
