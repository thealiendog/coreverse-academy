      ...
      screens: [
        {
          id: `l01-welcome`,
          type: `welcome`,
          guideText: `{name}, here's a question worth sitting with: why does anyone have the right to tell you what to do? A teacher, a police officer, a president, a law, by what authority do they give orders that you're expected to obey? You didn't sign anything agreeing to it. You were just born into a country with rules already running. For most of human history, the answer was simple and brutal: power. Whoever had the strongest army, the oldest bloodline, or the blessing of the gods ruled, and everyone else obeyed or suffered. But starting a few centuries ago, a handful of thinkers asked a more dangerous question, not "who has power?" but "who has the right to power, and why?" That question is the foundation of political philosophy, and the answers people gave to it built the modern world, including every government you'll ever live under or help shape. This lesson is about those foundations. We'll ask where government comes from and why it exists at all, imagining what life would be like with no government whatsoever. We'll meet the revolutionary idea of the social contract, that legitimate government rests on the consent of the governed, not the will of a king. We'll trace the thinkers who built these ideas, Hobbes, Locke, Rousseau, Montesquieu, and others whose arguments are literally written into constitutions today. We'll explore what makes a government legitimate, and what happens when people decide it isn't. And because the deepest questions here have no single answer, we'll end with a real debate among competing visions of what government should be. These aren't dusty old ideas. They're the operating system of your world, and once you see them, you can't unsee them. Onward.`,
