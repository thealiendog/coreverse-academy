      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `Deliberate practice is the kind of practice that actually builds skill. It means working at the edge of what you can do, on the specific things you are not yet good at, with honest feedback about what went wrong, and then doing it again. Drawing the same easy thing you already draw well a hundred times is comfortable repetition; it feels productive but builds little. Drawing the hard thing you keep getting wrong, noticing exactly why, and trying again is deliberate practice; it is uncomfortable and focused, and it is where growth lives. The lesson names deliberate practice as the answer to the myth of the natural: skill is not handed out at birth but built through this kind of effortful, feedback-driven work.`,
              audioPrompt: `Deliberate practice is the kind of practice that actually builds skill, {name}, and it is different from just doing something a lot. The lesson defines it precisely: working at the edge of what you can do, on the specific things you are not yet good at, with honest feedback about what went wrong, and then doing it again. Here is the contrast. Drawing the same easy character you already draw really well a hundred times is comfortable repetition. It feels productive because it feels good. But it builds very little, because you are not working at your edge. Drawing the hard thing you keep getting wrong, studying exactly why it keeps going wrong, noticing the specific error, and trying again: that is deliberate practice. It is uncomfortable. It is focused. It is where growth actually lives. The lesson uses this to give you a test for how you spend your practice time. Are you doing the easy comfortable thing that feels like practice? Or are you doing the hard targeted thing that feels clumsy and frustrating, the thing that is the actual building process? Deliberate practice is the answer to the myth of the natural: skill is not a gift. It is built through exactly this kind of effortful, feedback-driven work.`,
            },
            {
              word: `working edge`,
              definition: `Working at the edge is the core of deliberate practice: the edge of what you can do is where skill gets built. Comfortable repetition of things you already do well builds little; the growth happens when you are working on the specific things you are not yet good at, where the work is difficult and clumsy and requires real effort. The lesson connects this to how you should think about struggling: if skill is built, then struggling at your edge is not a sign you lack talent, it is literally the feeling of getting better. The clumsy part is the building part.`,
              audioPrompt: `Working at the edge means working at the point where what you are trying to do is just beyond what you can currently do reliably, {name}. That edge is where skill gets built. It is not comfortable. It is not the thing you already do well. It is the hard thing, the thing you keep getting wrong, the thing you have been avoiding because it is frustrating. Drawing the same easy character you already draw is behind your edge. Drawing hands, which you keep getting wrong, and studying exactly why: that is at your edge. The lesson uses this concept to explain why deliberate practice works and comfortable repetition does not. Growth requires working at your edge, not behind it. The lesson also connects this to how you think about struggling. If skill were a fixed gift, then struggling would mean you do not have it and should quit. But if skill is built through working at your edge, then struggling is not a warning sign. It is the feeling of working at your edge. It is the process of getting better. The clumsy part is the building part. That is the most freeing reframe in the whole lesson.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `portfolio`,
              definition: `A portfolio is the collection of your best creative work, and the lesson calls it the single most important thing you build in a creative career. It is proof, not promises: it says "here is what I can actually do," which is worth more than any résumé of claims. A good portfolio is not your entire output but your strongest pieces, chosen carefully, that show what you want to be hired or known for. Five excellent pieces showing a clear strength beat fifty random ones. You can start a portfolio right now, at any age, with no one's permission, including work from your own projects, free causes, or imaginary clients. The portfolio is also what breaks the chicken-and-egg problem of not being able to get work without experience: you make the work first, and the portfolio becomes your proof.`,
              audioPrompt: `A portfolio is the collection of your best creative work, and the lesson calls it the single most important thing you build in a creative career, {name}. It is proof, not promises. In creative fields, the people hiring an illustrator, booking a musician, or commissioning a designer want to see what you have actually made, not a résumé full of claims about how good you are. A portfolio says "here is what I can actually do." That is worth more than any amount of "trust me, I am talented." A good portfolio is not your entire output. It is your strongest pieces, chosen carefully, that show what you want to be hired or known for. Five excellent pieces showing a clear strength beat fifty random pieces. A portfolio also solves the problem that stops a lot of people: "I cannot get work without experience, but I cannot get experience without work." The way through is to make the work before anyone hires you, on your own projects, for free causes you believe in, or for imaginary clients, and let those pieces become your proof. You can start a portfolio right now, at whatever age you are, with no permission from anyone. You do not have to wait to be chosen to start building the thing that gets you chosen.`,
            },
            {
              word: `curating`,
              definition: `Curating is the skill of choosing what to include in a portfolio and what to leave out. The lesson names it as a skill in its own right: choosing what to show and what to cut tells people as much about your taste and judgment as the work itself does. A viewer judges you partly by your weakest included piece, so cutting good-enough work that does not show your clearest strength is a professional act, not a loss. Five excellent pieces chosen carefully beat fifty pieces of varying quality. Curating is not about hiding weaknesses; it is about presenting your best and most focused self.`,
              audioPrompt: `Curating is the skill of choosing what to include in a portfolio and what to leave out, {name}. The lesson names it as a real skill in its own right, not just housekeeping. Here is why it matters. A viewer judges you partly by your weakest included piece. If you include fifty pieces of varying quality, they will notice the weakest ones. They will wonder about your judgment. But if you include only five excellent pieces that all point clearly toward what you want to be known for, you are telling a story about your taste, your focus, and your ability to recognize quality. Choosing what to leave out reveals that you know the difference between your best work and your less-than-best work, which is exactly the kind of judgment that makes a collaborator trustworthy. Curating is not about hiding weaknesses. Every creator has weaknesses. It is about presenting your strongest, most focused self. The discipline is: show your best, on-target work, and cut the rest, even the pieces that are good-enough but off-focus, even the pieces you worked hard on but that do not show the thing you want to be known for.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `mentor`,
              definition: `A mentor is someone further along in a creative path who shares what they know with someone coming up. The lesson names mentorship as one of the specific, powerful relationships that shape creative lives enormously. You seek a mentor by genuinely engaging with someone whose work you admire, being thoughtful, doing the work, and being worth helping, rather than by demanding their time. And as you grow, you become a mentor to others, which both feels good and strengthens the whole creative community you are part of. Creative careers are not solo missions; they are built inside communities, and mentorship is one of the key threads.`,
              audioPrompt: `A mentor is someone further along in a creative path who shares what they know with someone coming up, {name}. The lesson names mentorship as a specific and powerful kind of relationship that shapes creative lives enormously. You do not get a mentor by demanding one. You seek mentors by genuinely engaging with the work of people you admire. By being thoughtful, not transactional. By doing the work yourself and being someone worth helping. Not by sending a message that leads with "introduce me to people and promote my work." The connection grows from real engagement over time. And as you grow, the relationship runs the other way: you become a mentor to people coming up behind you. That is not just generosity, though it is that too. It strengthens the whole web of community you are part of. Creative careers are not solo missions. The people who thrive built real, generous relationships over years, and mentorship is one of the key threads of those relationships. Find the people whose work you genuinely admire, engage with it honestly, be someone worth helping, and the mentorship often grows from that.`,
            },
            {
              word: `creative network`,
              definition: `A creative network is the community of people who know your work and care about the same things you do, built through genuine relationship over time. Most real creative opportunities come through this network: the job, commission, or collaboration usually comes from someone who already knew your work and thought of you. The people who build strong creative networks are not the ones aggressively asking everyone for favors; they are the ones genuinely interested in others' work, who help when they can, share what they know, and show up consistently. A reputation as someone talented and good to work with is worth more than raw talent alone, because people choose collaborators they trust and enjoy.`,
              audioPrompt: `A creative network is the community of people who know your work and care about the same things you do, {name}. Most real creative opportunities flow through it. The job, the commission, the band invitation, the collaboration: these usually come from someone who already knew your work and thought of you when the opportunity appeared. A teacher. A peer whose project you once helped with. Someone whose work you admired and genuinely engaged with. The lesson calls this not unfair "who you know" corruption but simply how humans work: people bring opportunities to people they know, trust, and like. Building a creative network is not about collecting contacts or aggressively asking everyone for favors. The people with the strongest creative networks are usually the ones who are genuinely interested in others' work, who help when they can, who share what they know, who show up consistently and are kind. A reputation as someone talented and good to work with is worth more than raw talent alone, because when people choose collaborators they are choosing for trust and reliability and enjoyment as much as skill. The creative network grows from being that kind of person over time.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `work from worth`,
              definition: `Separating your work from your worth is the healthy way to handle rejection. A rejected piece of work is information about that piece, in that moment, for that person: it is not a verdict on you as a human being. Skilled creatives learn to ask "what can I learn from this?" instead of "what is wrong with me?", take whatever is useful in the feedback, let go of the rest, and send the work out again. This is not pretending rejection does not hurt; it hurts, and that is allowed. It is refusing to let the hurt make the decision for you. The skill of separating your work from your worth is what lets you learn from feedback without taking it as a verdict on your value as a person.`,
              audioPrompt: `Separating your work from your worth is the healthy way to handle rejection, {name}. A rejected piece of work is information about that piece, in that moment, for that person. It is not a verdict on you as a human being. It is not a verdict on your talent. It is not a verdict on whether you should keep going. It is one piece of information about one piece of work, in one context. Skilled creatives learn to make that separation. They ask "what can I learn from this?" instead of "what is wrong with me?" They take whatever is useful in the feedback, let it inform the next version of the work, and let go of the rest. Then they send the work out again. This is not pretending rejection does not hurt. It hurts. That is allowed. The lesson acknowledges that clearly. Separating your work from your worth is not about pretending the sting does not happen. It is about refusing to let the sting make the decision for you. The hurt is real; the hurt does not get to decide whether you keep making things. That is the skill, and it is learnable.`,
            },
            {
              word: `rejection pile`,
              definition: `The rejection pile is the hidden collection of rejections, auditions that went nowhere, manuscripts turned down, pitches ignored, and work that flopped that every working creative has accumulated. The lesson uses this image to normalize rejection: the difference between people who make it and people who quit is usually not talent but that the ones who made it kept going through a level of rejection that would have stopped most people. When rejection comes, understanding that every creative you admire has a rejection pile changes what the rejection means: it is the normal cost of doing the work, not proof you should stop.`,
              audioPrompt: `The rejection pile is the hidden collection of no's that every working creative has accumulated, {name}. Auditions that went nowhere. Manuscripts turned down. Pitches ignored. Work that flopped. Songs that never got picked up. Proposals that came back with silence. Every working artist, writer, musician, and filmmaker you can name has one. The pile is real; it is just hidden, because the stories people tell are about the yes, not the pile of no's that came before it. The lesson uses the image of the rejection pile to normalize something people often take personally. The difference between people who make it and people who quit is usually not talent. It is that the ones who made it kept going through a level of rejection that would have stopped most people. When rejection comes, and it will, knowing about the pile changes what it means. It is not evidence you should stop. It is the normal cost of doing the work. It is the texture of a creative career. Everyone working at this level has a pile. You are not the exception; you are part of the same story.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `discovery myth`,
              definition: `The discovery myth is the popular but mostly false idea that creative careers happen by being "discovered": that you make beautiful work in your room and one day someone famous knocks on your door. The lesson says this almost never happens. Real creative careers are built deliberately through skill, a body of work, real relationships, and stubborn persistence through rejection. The discovery myth is dangerous because it makes talented people wait passively for permission instead of doing the controllable things that careers are actually made of: deliberate practice, a real portfolio, generous relationships, and keeping going through rejection.`,
              audioPrompt: `The discovery myth is the popular but mostly false idea that creative careers happen by being discovered, {name}. You make beautiful work in your room, and one day someone famous knocks on your door and tells the world about you, and everything changes. The lesson says this almost never happens. And believing it leads to a very specific and costly mistake: waiting. Waiting to be seen. Waiting for permission. Waiting for someone to declare you real. The discovery myth is what makes talented people passive instead of building the things careers are actually made of. Real creative careers are built deliberately. Skill built through deliberate practice. A portfolio of proof. Relationships built through generosity over time. Persistence through a great deal of rejection. Those are the controllable things. You cannot control whether you go viral or get lucky. But you can control every one of those, starting right now, at whatever age you are, with no permission from anyone. The discovery myth keeps people from doing that. The lesson's quietly radical point is that once you know the myth is a myth, you are free to start building the real thing.`,
            },
            {
              word: `controllable things`,
              definition: `The controllable things are the four building blocks of a creative career that are entirely within your control: deliberate practice (building skill at your edge), a real portfolio (proof you can start now, with no permission), generous relationships (built over time by being talented and good to work with), and persistence through rejection (staying in the long game long enough for the slow building to add up). You cannot control whether you go viral or get lucky, but you can control all of these, and the lesson says they are exactly what creative careers are actually made of. The controllable things are the answer to the discovery myth.`,
              audioPrompt: `The controllable things are the four building blocks of a creative career that are entirely within your control, {name}. The lesson names them clearly. Deliberate practice: you control whether you work at your edge on your weaknesses, with feedback, rather than comfortable repetition. A real portfolio: you control whether you make work and curate it into proof, starting now, with no permission needed. Generous relationships: you control whether you show up for other people, help when you can, treat collaborators well, and build the kind of creative network that opportunities flow through. Persistence through rejection: you control whether you separate your work from your worth, learn what you can, and keep going rather than quitting. You cannot control whether you go viral. You cannot control whether you get lucky. You cannot control whether someone influential notices you at the right moment. But you can control all four of those things, and the lesson says they are exactly what creative careers are actually made of. The discovery myth makes talented people focus on what they cannot control and neglect what they can. The lesson flips that. Start with what is yours to build. That is available to you, starting now.`,
            },
          ],
        },
