      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            {
              word: `left and right`,
              definition: `Political vocabulary originating from the French Revolution's National Assembly of 1789, where supporters of the king sat on the right and supporters of revolutionary change on the left. Now used globally, though what the terms mean has shifted substantially across two and a half centuries.`,
              audioPrompt: `Left and right as political vocabulary has a specific historical origin that most people using the terms don't know, {name}. In the National Assembly of 1789, during the French Revolution, supporters of the king sat on the right side of the chamber, and supporters of revolutionary change sat on the left. This geographic accident in a specific chamber in Paris produced vocabulary that is now used globally across every language and political system to describe ideological positions. But what "left" and "right" mean has shifted substantially across two and a half centuries. In 1789, the "right" meant defenders of monarchy and aristocracy; today's conservatives don't generally defend monarchy and aristocracy. The "left" in 1789 meant broadly liberal and republican; today's left is often opposed to classical liberalism's emphasis on market freedoms. The vocabulary has been stretched so far from its origins that it now covers genuinely different things in different countries and different eras. In the contemporary US, "left" typically means social democratic or socialist; "right" typically means a fusion of religious conservatism, market capitalism, and nationalism. In France, the alignment is different. In Brazil, different again. Recognizing that the vocabulary is borrowed from a specific historical moment and has drifted over time matters for reading political history without confusion.`,
            },
            {
              word: `political ideology`,
              definition: `A coherent set of beliefs about how society should be organized, what government should do, what counts as freedom and equality, and how change should happen. Everyone has one, explicitly or not; the question is whether it is examined or absorbed unconsciously.`,
              audioPrompt: `Political ideology is something everyone has, whether they think of themselves as ideological or not, {name}. A political ideology is a coherent set of beliefs about how society should be organized, what government should do, what counts as freedom and equality, and how change should happen. People often think of ideology as something other people have: "they're so ideological." In practice, everyone has some implicit framework for thinking about politics, and the question is whether the framework is examined or absorbed unconsciously. The political system you grew up in shapes your default assumptions. The country and family you were born into give you a starting framework. News media, textbooks, and social networks reinforce specific ideological frameworks without usually labeling them as such. Recognizing this doesn't mean all positions are equally good or that having a political ideology is wrong. It means the honest position is examining what you actually believe and why, rather than treating your own framework as obvious common sense while treating others' as ideology. The five serious traditions covered in this lesson (conservative, classical liberal, social democratic, socialist, anarchist) are each coherent frameworks that reasonable people have developed and defended over generations. Engaging each on its own terms is the work of political literacy, which is different from political commitment. Most adults around you have absorbed one framework from their political tradition and never seriously engaged the others; building explicit framework now changes how you'll read political life across decades.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `Burkean caution`,
              definition: `Edmund Burke's methodological principle: approach social change prudently, attentively to specific local conditions, recognizing that unintended consequences of large-scale redesign often dwarf intended benefits. Not that everything inherited is good, but that how you change matters as much as what you change.`,
              audioPrompt: `Burkean caution is the methodological core of the conservative tradition, {name}, and it is more sophisticated than simply defending the status quo. Edmund Burke's argument in his 1790 Reflections on the Revolution in France was not that inherited institutions are always good or that nothing should change. Burke himself supported the American Revolution as a prudent restoration of inherited English liberties against royal overreach, and he supported Catholic emancipation in Ireland. His claim was about how to approach change: prudently, attentive to specific local conditions, recognizing that the unintended consequences of large-scale redesign often dwarf the intended benefits. Societies are organic and complex, embedded in tradition that accumulated wisdom over generations. That wisdom is often not explicit; it's encoded in practices, institutions, and customs that reformers dismiss as mere tradition without understanding what they do. The French Revolution's collapse into the Terror within a few years of its idealistic beginning is Burke's central example: abstract principles about liberty and reason, applied through comprehensive revolutionary redesign, produced mass executions and eventually Napoleon. The 20th-century record of large-scale revolutionary redesign (Soviet, Chinese, Cambodian) provides additional evidence for the Burkean caution. Critics point out that the same caution was used to defend slavery, segregation, the exclusion of women from political life, and many other unjust arrangements that reformers correctly sought to change. The question is whether Burkean caution is a genuine insight about how change works or a rationalization for defending privilege.`,
            },
            {
              word: `transcendent moral order`,
              definition: `Russell Kirk's first core conservative commitment in "The Conservative Mind" (1953): the belief that there is a moral order that transcends individual preference and political majority, often grounded in religious tradition or natural law, which society must respect.`,
              audioPrompt: `Transcendent moral order is the first of the core conservative commitments that Russell Kirk identified in The Conservative Mind from 1953, {name}. Kirk's work revived and codified the conservative tradition for postwar America, identifying what he saw as the core principles that distinguished genuine conservatism from mere resistance to change. The commitment to transcendent moral order means that conservatives generally believe there is a moral reality that exists independently of what any individual prefers or any political majority votes for. This moral order is often grounded in religious tradition (the natural law tradition in Catholic thought; Protestant concepts of divine authority; Jewish concepts of covenant) but can also be argued on philosophical grounds. It stands in contrast to the position that morality is constructed by human agreement or that whatever the majority wants is right. For conservatives in this tradition, governments that ignore or undermine this moral order (by, for example, treating human life as a resource to be maximized, or reducing all human relationships to market transactions) commit a kind of fundamental error that produces long-term civilizational damage. This commitment has substantive political implications: it grounds conservative resistance to certain kinds of social change on moral rather than merely pragmatic grounds, and it provides resources for criticizing even market capitalism when it undermines family, community, and religious life. Critics argue that "transcendent moral order" often serves as a way to dress up specific religious commitments as universal moral requirements that others are obliged to follow.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `harm principle`,
              definition: `John Stuart Mill's formulation in "On Liberty" (1859): the only legitimate basis for society to restrict individual liberty is to prevent direct harm to others. Personal conduct that doesn't harm others should be free from state and social interference.`,
              audioPrompt: `The harm principle is John Stuart Mill's most influential formulation in On Liberty from 1859, {name}, and it remains the foundational statement of liberal political philosophy. Mill argued that individuals should be free to live as they choose unless their actions directly harm others. The only freedom which deserves the name is that of pursuing our own good in our own way, so long as we do not attempt to deprive others of theirs. This formulation establishes individual liberty as the default: the burden of proof falls on anyone who wants to restrict what a person does. Government's legitimate role is preventing direct harm to others, including assault, theft, fraud, and genuine violations of others' rights. Beyond this, society's interference with individual liberty is rarely justified. Mill applied this to speech, religion, association, and personal conduct: heretical ideas should not be suppressed by state power even if majorities find them offensive; unconventional lifestyles should not be regulated even if most people disapprove; experiments in living produce knowledge no central authority could generate. The harm principle has been enormously influential in establishing constitutional protections for speech, religion, and personal liberty in liberal democracies. It is also contested. What counts as harm is not always obvious: does pollution count as harm? Does economic harm from competition? Does offense? Does the long-term harm to society from certain lifestyles? The contests around where exactly harm begins and ends continue in constitutional law and political philosophy.`,
            },
            {
              word: `natural rights`,
              definition: `John Locke's concept in "Two Treatises of Government" (1689): individuals possess rights to life, liberty, and property that exist prior to and independently of government, and that no legitimate government can violate. Governments derive authority from the consent of the governed.`,
              audioPrompt: `Natural rights are the foundational concept of classical liberalism, {name}, developed most influentially by John Locke in Two Treatises of Government from 1689. Locke argued that individuals possess rights to life, liberty, and property that exist prior to and independently of any government or social agreement. These rights are natural: they belong to persons simply because they are persons, not because any government granted them. No legitimate government can violate them. Governments derive their authority from the consent of the governed, not from divine right or tradition alone; when a government systematically violates natural rights, revolution against it is legitimate. Locke wrote in the context of English conflicts over royal authority, and his arguments directly influenced the American Revolution's Declaration of Independence (Jefferson's "life, liberty, and the pursuit of happiness" echoes Locke's formulation). The natural-rights tradition is the foundation for constitutional guarantees of individual rights, the rule of law, limitations on government power, and the idea that rights are not privileges granted by authorities but protections individuals possess against authority. Robert Nozick's Anarchy, State, and Utopia from 1974 extends this tradition: because individuals have rights to property they legitimately acquired through their own labor and voluntary exchange, taxing them to redistribute to others treats them as means to others' ends rather than as persons with rights. Critics of natural rights theory argue that the content of "natural rights" is contested, historically used to protect property while ignoring social conditions that produce poverty, and compatible with substantial unfreedoms including slavery and women's exclusion from political life.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `mutual aid`,
              definition: `Peter Kropotkin's concept in "Mutual Aid" (1902): cooperation, not only competition, is fundamental to evolution and to human social organization. Anarchist alternative to social-Darwinist claims that struggle and competition are the only natural principles.`,
              audioPrompt: `Mutual aid is one of Peter Kropotkin's central concepts from his 1902 book of the same name, {name}, and it challenges one of the most common misuses of evolutionary biology in political theory. Social-Darwinist thinkers of the late 19th century argued that evolutionary competition (survival of the fittest) validated competitive capitalist economics and made cooperation seem unnatural or inefficient. Kropotkin, a Russian prince who became an anarchist and a naturalist, argued the opposite through extensive observation of animal behavior and human societies. Cooperation, not only competition, is fundamental to evolution and to human social organization. Species that cooperate tend to survive better than species that only compete. Human societies have historically organized themselves around mutual aid, collective provision, and cooperative labor in ways that the competitive individualist model misrepresents. Kropotkin's work provided empirical grounding for the anarchist claim that complex societies can organize themselves without coercive central authority; the cooperation required for social life emerges from below rather than being imposed from above. This idea has had substantial practical influence. During the COVID-19 pandemic, mutual aid networks organized in cities around the world to provide food, medicine, and support for people who fell through gaps in formal systems; these networks explicitly drew on anarchist organizational principles including horizontal structure, direct action, and collective responsibility without hierarchical authority. The anarchist tradition, including Kropotkin's mutual aid concept, has influenced many contemporary social movements through similar principles.`,
            },
            {
              word: `New Deal coalition`,
              definition: `Franklin Roosevelt's broad political coalition in 1930s-40s America that built the US welfare state through programs including Social Security, labor protections, and public investment. A foundational reference point for contemporary US social democracy.`,
              audioPrompt: `The New Deal coalition is one of the foundational reference points for contemporary US social democracy, {name}. Franklin Roosevelt came to power in 1933 in the depths of the Great Depression, when a quarter of the American workforce was unemployed and the capitalist economy had been in crisis for four years without recovering. Roosevelt's New Deal involved substantial use of democratic government to address market failures that the market itself wasn't correcting. Social Security provided retirement income for the elderly. The Wagner Act protected workers' rights to organize unions and bargain collectively. The Securities and Exchange Commission regulated financial markets. Public works programs put millions of unemployed people to work building infrastructure. The Federal Deposit Insurance Corporation protected bank deposits. These programs were politically controversial at the time, challenged by conservatives as socialism or unconstitutional government interference. Most of them are now accepted by all major political parties as permanent features of American life. John Maynard Keynes's economic theory that capitalist economies are not self-correcting and require government action to maintain demand (developed in his General Theory from 1936) provided intellectual foundation for New Deal-style intervention. Social democracy in the US traces through the New Deal coalition alongside the philosophical foundations of John Rawls and the European welfare state tradition. Contemporary "liberal" in US usage means something close to this tradition: using democratic government actively to provide public goods, regulate markets, protect civil rights, and ensure economic security through programs like Medicare, Social Security, and public education.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `A political tradition (associated with Alasdair MacIntyre, Michael Sandel, and others) that emphasizes the embeddedness of individuals in communities and traditions, critiquing both liberal individualism and socialist collectivism for failing to take seriously how communities constitute who we are.`,
              audioPrompt: `Communitarianism is a political tradition that draws from multiple ideological sources and doesn't fit cleanly on the left-right line, {name}. Associated with thinkers including Alasdair MacIntyre and Michael Sandel, communitarianism emphasizes the embeddedness of individuals in communities and traditions. The core critique is that both liberal individualism and socialist collectivism miss something fundamental about what humans are: we are constituted by our communities, traditions, and relationships, not abstract individuals who then choose to join communities. Sandel's critique of Rawls argues that the veil-of-ignorance thought experiment assumes a self that could exist without particular attachments; but real selves are always already embedded in specific families, communities, religious traditions, and historical contexts that are partly constitutive of who they are. You can't actually reason from behind the veil of ignorance because the reasoning self is already formed by commitments it would be giving up. MacIntyre's work, particularly After Virtue from 1981, argues that modern liberal moral philosophy has fragmented into incoherence because it cut itself off from the traditional practices and communities that gave virtues their meaning. Communitarianism's political prescriptions include support for family, local community, civic associations, and religious life as alternatives to both the market and the state; some form of national solidarity as a condition for social democracy; and skepticism toward both pure market solutions and central state solutions that ignore the communities that give life meaning. The tradition has been adopted by both conservatives (emphasizing family and religion) and some on the left (emphasizing civic solidarity as a condition for redistribution).`,
            },
            {
              word: `ideological polarization`,
              definition: `The intensification of ideological conflict in many countries, in which political opponents are seen as not merely wrong but as threats, common ground shrinks, and political discourse is increasingly shaped by caricatures of the other side rather than serious engagement.`,
              audioPrompt: `Ideological polarization is the specific political context your generation is growing up in, {name}, and it makes building serious framework on what ideological traditions actually argue more important than usual. Polarization doesn't just mean that people disagree; disagreement is normal in democratic politics. Polarization means that political opponents are seen as not merely wrong but as enemies or threats, that common ground shrinks, that political identity becomes more important than specific policy positions, and that political discourse is increasingly shaped by caricatures of the other side rather than serious engagement with what they actually argue. The caricature patterns are consistent. Conservatives are caricatured as racists defending privilege. Social democrats and socialists are caricatured as wanting Soviet-style communism. Libertarians are caricatured as wanting no government at all. Anarchists are caricatured as wanting chaos. Each caricature contains an element that some members of each tradition might recognize, vastly distorted and presented as if it describes the whole. Social media platforms optimized for engagement amplify polarization because outrage and tribal confirmation drive more engagement than nuanced engagement with opposing views. Your generation specifically encounters political content through these platforms in ways that intensify tribal identification rather than building analytical framework. The most effective protection against polarization's cognitive damage is exactly what this lesson provides: framework on what the various traditions actually argue in their most serious forms, from their own foundational texts, rather than from opponents' characterizations.`,
            },
          ],
        },
