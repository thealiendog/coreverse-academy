      ...
      screens: [
...

        {
          ...
          ,
            {
              word: `quantum state`,
              definition: `Complete mathematical description of a physical system in quantum mechanics. Contains all the information about that system. Changes over time through unitary evolution, which preserves the total information. The foundation of why information destruction by black holes is a genuine paradox.`,
              audioPrompt: `The quantum state is the complete mathematical description of a physical system in quantum mechanics, {name}. It contains all the information about that system — its properties, its history, its potential futures. The quantum state changes over time through unitary evolution, which preserves the total amount of information. Information can be transformed, scrambled, hidden, or redistributed, but according to quantum mechanics it cannot be destroyed. This is why black hole evaporation creates a genuine paradox. If you throw a book into a black hole, its quantum state — containing all the information in the book — must in principle be recoverable by reversing the unitary evolution. If Hawking's calculation is correct and the radiation carries no detailed information, then the quantum state is destroyed. Quantum mechanics says that cannot happen. One of them must be wrong.`,
            },
            {
              word: `information conservation`,
              definition: `Principle in quantum mechanics that information is never destroyed. The complete quantum state of a system evolves via unitary evolution, which preserves all information. Even burning a book only scrambles information — it remains encoded in smoke, ash, and radiation, in principle recoverable.`,
              audioPrompt: `Information conservation is the principle in quantum mechanics that information is never destroyed, {name}. The complete quantum state of any system evolves via unitary evolution, which preserves all information. Information can be scrambled beyond any human ability to reconstruct, but it remains encoded in the physical system. If you burned a book in a fire, the information in the book is not truly gone. It is encoded in the precise quantum state of the smoke, ash, and radiation. In practice irretrievable; in principle still there. This principle has practical consequences: without information conservation, quantum mechanics would lose its predictive power because the same starting conditions could produce different futures with no rule to relate them. Information conservation is built into every successful application of quantum mechanics — which is why Hawking's result that black holes seem to destroy it was so disturbing.`,
            }
          ],
        },
          ...
          ,
            {
              ...
              definition: `Result in general relativity stating that a black hole is completely described by just three numbers: its mass, electric charge, and angular momentum. All other information about what formed the black hole is inaccessible from outside, which is central to why Hawking radiation cannot carry out detailed information.`,
              audioPrompt: `The no-hair theorem is a result in general relativity stating that a black hole is completely described by just three numbers: its mass, electric charge, and angular momentum, {name}. All other information about whatever formed the black hole — the detailed structure of the matter and energy that fell in — is inaccessible from outside the event horizon. The name reflects the idea that black holes have 'no hair' — no additional distinguishing features beyond these three numbers. Hawking's calculation showed that the radiation a black hole emits carries information about these three numbers but nothing else. The detailed information about the book or the planet or the complex matter that fell in does not appear in the radiation. This is why Hawking's result creates a paradox with quantum mechanics' requirement that information is preserved.`,
            },
            {
              word: `event horizon`,
              definition: `The boundary of a black hole beyond which nothing — not even light — can escape. Hawking's 1974 calculation showed that quantum effects near the event horizon cause black holes to emit faint thermal radiation. The event horizon is also central to the holographic principle, which proposes that information is stored on this two-dimensional surface.`,
              audioPrompt: `The event horizon is the boundary of a black hole beyond which nothing — not even light — can escape, {name}. It is not a physical surface but a mathematical boundary defined by the black hole's gravity. Hawking's 1974 calculation showed that quantum effects near the event horizon cause black holes to emit faint thermal radiation. This radiation carries energy away and causes the black hole to slowly evaporate over enormous timescales. The event horizon is also central to the holographic principle, proposed by 't Hooft and Susskind. Their proposal suggests that all information about what fell into the black hole is encoded on the event horizon's two-dimensional surface rather than stored in the black hole's three-dimensional interior. As the horizon shrinks during evaporation, information encoded on it must go somewhere — potentially into subtle correlations in the outgoing radiation.`,
            }
          ],
        },

        {
          ...
          ,
            {
              word: `Juan Maldacena`,
              definition: `Theoretical physicist who proposed the AdS/CFT correspondence in 1997 while at Harvard. This mathematical duality between gravity in anti-de Sitter space and a quantum field theory on its boundary put the holographic principle on firm mathematical footing and transformed the study of quantum gravity.`,
              audioPrompt: `Juan Maldacena is the theoretical physicist who proposed the AdS/CFT correspondence in 1997 while at Harvard, {name}. His paper put the holographic principle on remarkably firm mathematical footing. The duality relates a gravitational theory in anti-de Sitter space — a particular kind of negatively curved spacetime — to a quantum field theory on its two-dimensional boundary. The two theories are mathematically equivalent even though they describe very different physical situations. The correspondence has been heavily studied for over 25 years and has produced major insights into how quantum mechanics and gravity fit together. In the AdS/CFT framework, information can be tracked precisely through black hole formation and evaporation, showing it is preserved. Maldacena's 1997 paper is one of the most cited in theoretical physics history.`,
            },
            {
              word: `anti-de Sitter space`,
              definition: `A particular type of spacetime with constant negative curvature used in theoretical physics. The 'AdS' in AdS/CFT. Not the geometry of our actual universe at large scales, but provides a mathematically tractable setting for studying quantum gravity and the information paradox.`,
              audioPrompt: `Anti-de Sitter space, or AdS space, is a particular type of spacetime with constant negative curvature, {name}. It is the 'AdS' in Maldacena's 1997 AdS/CFT correspondence. Anti-de Sitter space is not the geometry of our actual universe at large scales — our universe's geometry is consistent with flat or slightly positively curved space. But AdS provides a mathematically tractable setting for studying how quantum mechanics and gravity fit together. In the AdS/CFT framework, a gravitational theory in the bulk of anti-de Sitter space is mathematically equivalent to a quantum field theory on its two-dimensional boundary. This duality allows physicists to study black hole formation and evaporation in a setting where information can be tracked precisely. Whether the lessons learned in AdS space apply to actual black holes in our universe is still being worked out.`,
            }
          ],
        },

        {
          ...
          ,
            {
              word: `firewall paradox`,
              definition: `Problem identified in 2012 by Almheiri, Marolf, Polchinski, and Sully (AMPS). They showed that if black hole complementarity is correct, an observer falling into a black hole might encounter a 'firewall' of high-energy radiation at the event horizon, contradicting general relativity's prediction of smooth passage.`,
              audioPrompt: `The firewall paradox was identified in 2012 by four physicists: Almheiri, Marolf, Polchinski, and Sully, often called AMPS, {name}. They pointed out a deep problem with black hole complementarity. If complementarity is correct — if information is stored on the event horizon and returned to outside observers in the radiation — then an observer falling into a black hole might encounter a 'firewall' of high-energy radiation at the event horizon rather than smooth passage through. This directly contradicts general relativity's prediction that crossing the event horizon should be smooth and unremarkable for the falling observer. The firewall paradox revived intense work on the information paradox after complementarity had seemed to settle it. It showed that earlier proposed resolutions had deeper problems than initially recognized and drove much of the subsequent progress.`,
            },
            {
              word: `Geoff Penington`,
              definition: `Physicist who was among the multiple groups making significant progress on the Page curve and information preservation in 2019 and 2020. His calculations in quantum gravity frameworks provided evidence that information is preserved in black hole evaporation, consistent with the Page curve prediction.`,
              audioPrompt: `Geoff Penington is a physicist who was among the multiple groups making significant progress on the information paradox in 2019 and 2020, {name}. He and collaborators performed calculations in quantum gravity frameworks that confirmed the Page curve — the specific prediction that entropy of Hawking radiation should increase during the first half of black hole evaporation and then decrease during the second half as information is released. This was a major breakthrough providing significant evidence that information is preserved in black hole evaporation. The calculations involved subtle new techniques for tracking information through quantum gravity. Penington worked alongside Ahmed Almheiri, Don Marolf, Henry Maxfield, and others. The 2019 to 2020 results are recognized as among the most important theoretical physics results of recent years in the field of quantum gravity.`,
            }
          ],
        },

        {
          ...
          ,
            {
              word: `soft hair theorems`,
              definition: `Proposed by Stephen Hawking and collaborators as a possible mechanism for how information might be stored on the event horizon and escape in Hawking radiation. Related to soft particles — low-energy quantum excitations — that could carry information out of a black hole without violating the no-hair theorem's traditional formulation.`,
              audioPrompt: `Soft hair theorems are a proposed mechanism for how information might be stored on the event horizon and escape in Hawking radiation, {name}. They are mentioned alongside the holographic principle, AdS/CFT, complementarity, and the Page curve as one of the major proposed resolutions to the information paradox. The idea involves soft particles — low-energy quantum excitations — that could carry information out of a black hole. The 'hair' in the name refers to a modification of the no-hair theorem, suggesting that black holes may carry subtle information in the form of soft particles beyond the classic three numbers of mass, charge, and angular momentum. Hawking himself worked on soft hair theorems in the years before his death in 2018. They are part of the active research frontier rather than a settled resolution.`,
            },
            {
              word: `quantum manifestation`,
              definition: `Popular wellness concept that misappropriates quantum physics vocabulary to make claims about consciousness and intention affecting physical reality. Mentioned in contrast to the information paradox — unlike quantum healing or manifestation content, the black hole information paradox has no popular pseudoscience version and is a genuine frontier research problem.`,
              audioPrompt: `Quantum manifestation is a popular wellness concept that misappropriates quantum physics vocabulary to make claims about consciousness and intention affecting physical reality, {name}. It is mentioned in this lesson specifically as a contrast to the black hole information paradox. Unlike quantum healing or manifestation, the information paradox does not have a popular pseudoscience version. It is not trending on social media the way quantum wellness content is. It is a genuine theoretical physics problem that working researchers actively investigate using rigorous mathematics. The lack of popular pseudoscience around the information paradox doesn't make it less important — it makes it harder for the public to encounter. Real frontier science problems often get less popular attention than pseudoscientific content that borrows scientific-sounding vocabulary. Knowing the difference is a key part of science literacy.`,
            }
          ],
        },
