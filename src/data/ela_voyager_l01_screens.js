  ...
  lessons: [
    {
      ...
      screens: [
...

        {
          ...
          paragraphs: [
              `Rhetoric means the art of persuasion through language: choosing words and structure to move an audience to think, feel, or do something. It is not a dirty trick. The ancient Greeks, especially Aristotle around 350 BCE, studied it as a serious discipline, because a free society, where people argue and vote, runs on persuasion.`,
              `And it is everywhere. Every speech, ad, charity appeal, review, or post designed to move you uses rhetoric, whether the author knows the names or not. The question is never "is this persuasive?" but "what techniques is it using, and are they honest?"`,
              `Reading rhetoric is power, not trivia. Most people are persuaded like a fish in water, surrounded by it and never noticing, feeling moved but unable to say why. Once you can name the moves, you step onto the bank: still moved by great writing, but able to see the machinery producing the pull.`,
            ],
...

        {
          ...
          paragraphs: [
              `Aristotle gave the most useful map of persuasion ever made. He said a persuader reaches you through three appeals. Ethos is the appeal to credibility and character: you believe a message partly because of who is saying it, and whether they seem trustworthy.`,
              `Pathos is the appeal to emotion: it moves you by making you feel fear, hope, anger, pity, or pride. Emotion is not a cheap trick by itself, because many things truly are sad or inspiring, and feeling them is part of understanding them. It becomes a problem only when it is used to bypass thinking.`,
              `Logos is the appeal to logic and evidence: facts, reasons, statistics, and sound argument. The strongest persuasion blends all three: a trustworthy speaker, making a well-reasoned case, that also moves you to care. Spotting which appeal is doing the work is the foundation of reading persuasion clearly.`,
            ],
...

        {
          ...
          paragraphs: [
              `Naming a technique is easy; spotting it live is the real skill. Martin Luther King Jr.'s 1963 "I Have a Dream" speech blends all three appeals. Ethos: he speaks as a moral leader grounded in shared ideals. Logos: he points to the gap between the nation's promises and its treatment of Black Americans. Pathos: the soaring, repeated phrase lets a crowd feel a future, not just hear about it.`,
              `Even a humble charity ad does the same. It leads with pathos, slow music and one shivering dog, because a single sufferer moves us more than a statistic. But notice the ethos, a calm, trustworthy narrator, and the logos slipped underneath, the number of animals saved, the small monthly cost.`,
              `The point is not to rank these as good or bad, but to read them with precision. Ask, moment by moment: is this line building credibility, stirring emotion, or giving a reason? Reading rhetoric well means tracking that braid as it moves, the way a musician hears the separate instruments inside a song.`,
            ],
...

        {
          ...
          paragraphs: [
              `Here is the heart of the lesson. The same techniques can be used honestly or manipulatively, and the difference is not which appeal, but how. Honest persuasion respects you as a thinker and would survive your knowing exactly how it works. Manipulation bypasses your thinking and falls apart the moment you see it clearly. The test: would this still persuade me if I fully understood what it was doing?`,
              `Watch the appeals turn manipulative. Ethos is faked when credibility is borrowed, an actor in a white coat playing a doctor. Pathos is manipulated when emotion is cranked up to drown out thought, fear used to rush you before you can ask a question. Logos is faked through a sourceless statistic or a "because" that does not actually follow.`,
              `So the goal is never to stop being persuadable, which would be foolish, since many true things deserve to persuade you. The goal is to become persuadable on purpose: you feel the pull, then you ask who is speaking, whether the emotion is honest, and whether the reasons hold up. That makes you nearly impossible to manipulate and still open to a good argument.`,
            ],
...

        {
          ...
          paragraphs: [
              `Pull it together. Rhetoric is the ancient, everyday art of persuasion, and reading it is power because most people feel the pull without seeing the machinery. Aristotle's three appeals, ethos, pathos, and logos, are the core map, and the strongest persuasion blends all three.`,
              `You watched them work in real texts, from King's masterful blend to a charity ad's careful balance, and reached the heart of it: the same techniques serve honest persuasion or manipulation, the difference being whether they respect or bypass your thinking.`,
              `Now the source-evaluation screen hands you five persuasive passages. For each, read it twice: which appeal is doing the work, and is it being used honestly or manipulatively? Your job is not to reject persuasion but to read it. Persuadable on purpose, fooled by no one.`,
            ],
