  ...
  lessons: [
    {
      ...
      screens: [
        ...
        // ── 2. MAGAZINE — §1 ────────────────────────────────────────────────
        {
          ...
          section: 1,
          content: {
            heading: `Ancient and Medieval Art`,
            body: `Ancient Egyptian art followed **strict conventions for 3,000 years** — figures shown from multiple angles simultaneously (head in profile, eyes and shoulders facing forward), hierarchy of scale (important figures drawn larger than lesser ones), and flat, symbolic representation. This wasn't a failure to observe reality — it was a deliberate system designed to communicate specific meanings clearly and consistently. Ancient Greek art moved toward **idealising the human body**, pursuing mathematical proportions. Medieval European art was primarily **religious** — illuminated manuscripts, stained glass, and altarpieces designed to teach Bible stories to largely illiterate populations through images. Each style served its society's specific needs and beliefs — not one is more or less "correct" than another.`,
            image:   '/explorer-assets/creative-arts/l17-magazine-1.png',
            caption: `Ancient Egyptian conventions weren't mistakes — they were a deliberate system serving specific cultural purposes`,
          },
        },
        ...
        // ── 6. INTERACTIVE — Drag-match ─────────────────────────────────────
        {
          ...
          config: {
            buckets: [
              { id: 'works',         label: `🎨 This is how art movements actually work`, color: '#34D399' },
              { id: 'misunderstands', label: `🤔 A common misunderstanding about art history`, color: '#94A3B8' },
            ],
            items: [
              {
                id:            'l17-g1',
        ...
        // ── 8. REAL-WORLD ────────────────────────────────────────────────────
        {
          ...
          content: {
            ...
            realWorldConnection: `Art history is not just a list of past styles — it's a live conversation that contemporary artists are actively continuing. Every artist today is responding to, building on, or deliberately rejecting what came before. When you understand the history, you understand the conversation — and you can see where each new work fits within it. Art history is the context that makes contemporary art legible, and the story that shows why making things has always mattered to human beings.`,
          },
        },
