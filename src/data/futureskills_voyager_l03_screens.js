      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            {
              word: `active recall`,
              definition: `Practice of forcing yourself to retrieve information from memory without looking at your notes or textbook. Builds stronger long-term memory than passive review. Practical methods include flashcards, practice tests, and explaining concepts in your own words without referring to the source.`,
              audioPrompt: `Active recall is the practice of forcing yourself to retrieve information from memory without looking at your notes or textbook, {name}. It is the practical application of the testing effect. Instead of re-reading a chapter to study, you close the book and try to write down or say out loud what you remember. Instead of reviewing your notes, you use flashcards that force you to produce the answer before flipping to check. Instead of highlighting, you close the text and explain the concept in your own words. Each attempt at retrieval, whether successful or not, strengthens the memory trace for that information. The method feels harder than re-reading because you encounter your own gaps. That difficulty is the signal it is working. Students who use active recall consistently report that material they retrieved imperfectly during study feels much more available on the actual test. The discomfort during studying is not a sign of weak knowledge; it is the mechanism that builds strong knowledge.`,
            },
            {
              word: `spaced repetition`,
              definition: `Study method that involves reviewing material at increasing intervals over time rather than all at once. Based on Hermann Ebbinghaus's discovery of the forgetting curve in the 1880s. Produces dramatically better long-term retention than cramming. Tools like Anki automate the scheduling.`,
              audioPrompt: `Spaced repetition is a study method that involves reviewing material at increasing intervals over time rather than all at once, {name}. The German psychologist Hermann Ebbinghaus discovered in the 1880s that we forget most of what we learn within days unless we review it. Modern research has refined this: reviewing material one day after learning, then three days later, then one week later, then two weeks later, and so on produces dramatically better long-term retention than reviewing once or cramming. The opposite, studying intensively the night before a test, produces short-term performance on that test but almost no long-term retention. The information disappears within a week. Spaced repetition is the method with the strongest evidence base in all of learning science for producing durable memory. Tools like Anki use this principle to schedule reviews automatically. The method requires more planning than cramming but produces dramatically better results for any knowledge you actually want to keep.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `growth mindset`,
              definition: `Belief, studied by Stanford psychologist Carol Dweck, that abilities can grow with effort. People with growth mindset persist through difficulty, learn more from feedback, and develop higher abilities than those who believe abilities are fixed. The effect is real but requires genuine belief and actual effort, not just positive self-talk.`,
              audioPrompt: `Growth mindset is a concept developed by Stanford psychologist Carol Dweck, {name}. Dweck has spent her career studying how people's beliefs about ability affect their actual ability. People who believe abilities can grow with effort have a growth mindset. People who believe abilities are fixed have a fixed mindset. Those with growth mindset tend to persist through difficulty rather than giving up, learn more from feedback because it points to where growth is possible, and ultimately develop higher abilities over time. The effect is real and has been replicated across many contexts. But pop versions of growth mindset oversimplify it. Growth mindset isn't a magic incantation or positive self-talk. It's the genuine belief that effort matters, applied through actual effort on the actual difficult thing. Saying "I have a growth mindset" while avoiding challenge doesn't produce growth. Combining belief in the possibility of growth with deliberate practice on weaknesses does.`,
            },
            {
              word: `elaboration`,
              definition: `Study technique of connecting new information to things you already know, creating more retrieval paths and stronger memory. Related to dual coding, which combines verbal and visual representations. Both strengthen learning by building multiple connections to new material rather than storing it in isolation.`,
              audioPrompt: `Elaboration is a study technique of connecting new information to things you already know, {name}. When you learn something new and actively link it to existing knowledge, you create more retrieval paths to that information. More paths mean it's easier to find and use later. For example, when learning a new math concept, noticing how it relates to an older one you already understand creates a connection that strengthens both. Dual coding is a related strategy: combining verbal information with visual information. Diagrams, sketches, and mental imagery alongside words produce stronger learning than words alone. The brain stores information in multiple systems, and engaging more of them creates more robust memory. Both elaboration and dual coding have been replicated across many contexts in learning science research. Together, they describe why explaining something to someone else is such effective studying: you have to connect the new idea to language and prior knowledge simultaneously, and that process builds the memory.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `illusion of knowing`,
              definition: `The common experience of feeling like you understand material after passive review when you actually cannot recall or use it independently. The brain interprets familiarity as understanding. The feeling of knowing after re-reading notes is often an illusion of knowing, not real learning. Active recall breaks the illusion by forcing actual retrieval.`,
              audioPrompt: `The illusion of knowing is the common experience of feeling like you understand material when you actually cannot recall or use it independently, {name}. It is one of the most consistent patterns in learning research. When you re-read your notes or highlight a textbook, the information becomes familiar. Familiarity feels like knowing. Your brain doesn't easily distinguish "I recognize this" from "I can recall this on a test." So students feel confident after passive review and are then surprised by poor test performance. The illusion of knowing explains why intuitive study methods are so persistent even when they don't work: they produce a feeling of productivity that seems like real learning. Active recall breaks the illusion by forcing actual retrieval. When you can't produce the answer without looking, you know the illusion was an illusion. This is uncomfortable but useful. Students who regularly use active recall develop more accurate assessments of what they actually know, which lets them direct their study time more efficiently.`,
            },
            {
              word: `feedback on methods`,
              definition: `Information about whether your study methods are actually working, which most students rarely receive. Students typically study, take a test, get a grade, and move on without comparing what different methods would have produced. Explicit knowledge of learning science provides feedback on method quality that personal experience doesn't reliably supply.`,
              audioPrompt: `Feedback on methods is information about whether your study strategies are actually producing learning, {name}. Most students rarely get it. The typical pattern is to study, take a test, get a grade, and move on to the next unit. You don't compare what would have happened with different study methods because you only experience the one you used. You can't update on which methods work. This means students can spend years using ineffective approaches simply because they have no way to discover they're ineffective. Passive review, for example, produces enough short-term familiarity that tests taken right after studying often go adequately. But the forgetting that happens afterward is invisible. Explicit knowledge of learning science fills this gap. Knowing from the research literature that spaced repetition outperforms cramming lets you choose better methods than personal experience alone would suggest. Metacognition also helps: checking whether you could actually recall material without looking provides its own form of feedback on whether your current study session is producing real learning.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `learning by attempting`,
              definition: `Approach to skill acquisition where you work on real projects or problems that are too hard, using difficulty as the guide to what you need to learn next. Used by Aria to teach herself programming by building small projects and looking up specific syntax when stuck. Contrasted with following structured lectures before attempting application.`,
              audioPrompt: `Learning by attempting is an approach to skill acquisition where you work on real projects or tasks that are beyond your current ability, using the difficulty itself as the guide to what you need to learn next, {name}. It is the approach Aria used to teach herself programming. Rather than following a lecture course that taught concepts before application, she picked small projects each week — a to-do app, a number guessing game, a calculator — and tried to build them from scratch. When she got stuck, she looked up the specific syntax or concept she needed. The projects were too hard at first. Each one taught her what she didn't yet know. She supplemented with textbook chapters on the specific topics each project required. Six months later, she had built a functioning website. This is deliberate practice in a self-directed form: real output, immediate feedback from whether the code works, and targeted learning driven by actual gaps. The contrast is following lectures that you can follow without being able to build anything. Learning by attempting feels harder and produces more failure, which is exactly why it works.`,
            },
            {
              word: `immediate feedback`,
              definition: `Information received quickly after an attempt that tells you whether you succeeded and where you went wrong. Critical component of deliberate practice and of effective learning more generally. Marcus's conversation sessions with a tutor provided immediate feedback; solo app practice did not. Immediate feedback allows rapid correction and more efficient learning.`,
              audioPrompt: `Immediate feedback is information received quickly after an attempt that tells you whether you succeeded and where you went wrong, {name}. It is a critical component of deliberate practice and of effective learning generally. Without feedback, you can practice the wrong thing repeatedly without knowing it. Marcus's case illustrates the difference clearly. He spent six months using a language app and felt like he was learning, but couldn't hold a real conversation. The app provided some feedback on vocabulary recall but not on the fluency and comprehension that real conversation requires. When he added conversation sessions with a tutor over video call, he got immediate feedback on whether he was actually communicating. The errors were visible in real time. He could correct them in the same session. This is what accelerated his actual Spanish ability. Maya's experience with practice tests provided similar immediate feedback: when she worked old test problems without looking at the textbook first, she immediately discovered which concepts she couldn't actually apply. That discovery directed her toward the specific gaps she needed to address.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `domain-general principles`,
              definition: `Learning principles that work across many different subjects and skill areas rather than being specific to one domain. Active recall, spaced repetition, deliberate practice, and immediate feedback are domain-general: they apply to academic subjects, languages, technical skills, sports, and creative practice alike. The specific tactics differ across domains but the underlying principles are consistent.`,
              audioPrompt: `Domain-general principles are learning principles that work across many different subjects and skill areas, not just in one specific domain, {name}. The principles in this lesson — active recall, spaced repetition, deliberate practice, immediate feedback, learning by attempting — are domain-general. Maya used them for calculus. Marcus used them for Spanish. Aria used them for programming. The specific tactics differed: Maya used old practice tests, Marcus used conversation sessions with a tutor, Aria built small projects. But the underlying principles driving each approach were the same: retrieve actively, get immediate feedback, practice at the edge of current ability, space out the review. This matters because it means you only need to learn these principles once. Once you understand them, you can apply them to almost anything you want to learn for the rest of your life. Academic subjects, musical instruments, programming languages, physical skills, social skills — the research literature shows consistent results across all of these. Domain-general principles are among the highest-leverage things you can understand.`,
            },
            {
              word: `sustained engagement`,
              definition: `Consistent application of effective learning methods over time. The principles of active recall, spaced repetition, and deliberate practice produce dramatic improvements over typical approaches, but they require sustained engagement to realize those gains. Knowing the principles without applying them consistently produces no benefit.`,
              audioPrompt: `Sustained engagement means consistent application of effective learning methods over time, {name}. The principles in this lesson are well-established and they produce real results, but they are not magic. They don't replace effort. Knowing about active recall doesn't help you if you don't actually do the retrieval practice. Knowing about spaced repetition doesn't help you if you cram the night before every test anyway. The kids who become exceptional learners typically combine knowledge of these principles with sustained engagement over time. Applying them inconsistently is much better than not applying them at all, because any active recall is better than only passive review. But the dramatic improvements described in the research — Maya's D to B+ in six weeks, Aria going from unable to build anything to building a functioning website in six months — came from consistent application over weeks and months, not from a single session of trying something new. Sustained engagement is the bridge between knowing what works and actually getting the results.`,
            },
          ],
        },
