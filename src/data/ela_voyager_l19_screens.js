      ...
      screens: [
        {
          id: `l19-welcome`,
          type: `welcome`,
          guideText: `{name}, you've spent this whole course learning to read words with depth. But you swim every day in an ocean of messages that aren't just words: images, video, ads, thumbnails, music, design. The average person sees thousands of these media messages a day, and almost none of them are neutral. Someone made every one of them, on purpose, to make you feel something, believe something, want something, or do something. Media literacy is the skill of "reading" these messages as carefully as you read a text: seeing the choices behind them, the techniques they use, and the purposes they serve. Here's the core idea: all media is constructed. A photo isn't reality, it's a single frame, chosen from thousands, cropped and lit and timed by a person making decisions. An ad isn't information, it's persuasion engineered down to the color of a button. Even a news report makes choices, what to show, what to leave out, which words to use, that shape how you see an event. None of this means media is evil or that you should trust nothing. It means you should be the one in control of the messages, instead of letting them quietly control you. Today you learn to decode them. Onward.`,
