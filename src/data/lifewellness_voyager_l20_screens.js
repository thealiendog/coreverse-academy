      ...
      screens: [
        {
          id: `l20-welcome`,
          type: `welcome`,
          guideText: `{name}, twenty lessons in — sleep, stress, nutrition, movement, mental health, habits, attention, emotions, relationships, family, energy, money, screens, body image, grief, meaning, practice. You now have a framework for your own wellness. This final lesson asks you to synthesize it into a personal philosophy: not what wellness culture says you should be, but what you actually want to build.`,
