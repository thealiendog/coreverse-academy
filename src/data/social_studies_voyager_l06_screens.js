      ...
      screens: [
        {
          id: `l06-welcome`,
          type: `welcome`,
          guideText: `{name}, so far we've stayed inside one country, looking at how the United States governs itself. But no nation exists alone. Every country shares a planet with nearly two hundred others, and how a nation acts toward the rest of the world, whom it trades with, allies with, fights, helps, or ignores, is called its foreign policy. For the United States, one of the most powerful countries on Earth, those choices ripple across the entire globe, shaping war and peace, prosperity and poverty, for billions of people, including in your own family's heritage and across Latin America. Foreign policy is where a country's deepest values and hardest tradeoffs collide. Should a nation act mainly in its own self-interest, or also for the good of the world? Should it stay out of others' affairs, or get involved? When, if ever, is war justified? These questions have no easy answers, and reasonable, thoughtful people disagree fiercely. This lesson maps that terrain. We'll define what foreign policy is and the core goals nearly every country pursues, security, prosperity, and influence. We'll trace the great pendulum of American foreign policy across history, swinging between isolationism, staying out, and internationalism, engaging deeply with the world. We'll examine the real tools nations use, diplomacy, trade, alliances, aid, and force, and the genuine moral weight behind choosing among them. And because foreign policy is one of the most contested areas of all, where values like self-interest, human rights, peace, and power pull against each other, we'll end with a real debate among competing philosophies of how a powerful nation should act in the world. These aren't distant questions. They shape the world you're inheriting. Onward.`,
