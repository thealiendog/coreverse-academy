  ...
  lessons: [
    {
      ...
      screens: [
...

        {
          ...
          vocab: [
            {
              word: `copyright, idea vs. expression, and the public domain`,
...

        {
          ...
          vocab: [
            {
              word: `fair use and the copyright myths`,
...

        {
          ...
          vocab: [
            {
              word: `trademark, patent, and Creative Commons`,
...

        {
          ...
          vocab: [
            {
              word: `legal vs. fair vs. right, sampling, and the central tension`,
...

        {
          ...
          vocab: [
            {
              word: `carrying the shape of copyright, not memorizing the law`,
          ...
          questions: [
            {
              ...
              question: `What is copyright, and what is the key thing it does and does not protect?`,
              options: [
                `Random`,
                `Copyright is a rule that gives the creator of an original work (a song, story, drawing, photo, video) the automatic right to control who copies, shares, sells, or builds on it, usually for a long time; in most countries you do not have to file anything, because protection happens the moment you fix the work in some form. The key thing to understand is what it protects and does not protect: copyright protects the specific expression, not the underlying idea. You cannot copyright the idea of "a boy who discovers he is a wizard," but you can copyright the specific book you wrote telling that story, the exact words, characters, and details. Anyone can use the free idea; no one can copy your particular protected expression. This idea-versus-expression split is the single most useful copyright concept, because almost every real "did they steal this?" argument comes down to whether someone copied the protected expression or just used the free idea.`,
                `Just protects everything`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Copyright automatically protects original expression, not the underlying idea. The idea-versus-expression split is the most useful concept, since most "did they steal it?" arguments turn on which was copied.`,
            },
            {
              id: `q2`,
              type: `multiple-choice`,
              question: `What is the "public domain," and why does it exist?`,
              options: [
                `Random`,
                `The public domain is the body of creative works whose copyright has expired, usually many decades after the creator's death, so that no one owns them anymore and anyone can use them freely. This is why you can freely perform Beethoven, retell Greek myths, or print and stage a Shakespeare play, those works are old enough that they belong to everyone now. The public domain exists because copyright was never meant to last forever; it is meant to reward creators for a long but limited time and then return the work to the shared culture so future creators can freely build on it. It is a kind of growing treasure chest of human creativity that everyone is allowed to reach into, and it gets bigger every year as older works age out of copyright. Knowing what is in the public domain, and what is not yet, is part of using creative work fairly.`,
                `Just old stuff`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `The public domain holds works whose copyright has expired, free for anyone to use. It exists because copyright is meant to be long but limited, then return work to shared culture for others to build on.`,
            },
            {
              id: `q3`,
              type: `multiple-choice`,
              question: `What is "fair use," and why is it a gray zone rather than a clear rule?`,
              options: [
                `Random`,
                `Fair use is the principle that you are sometimes allowed to use a piece of someone else's copyrighted work without permission, for purposes like commenting, criticizing, teaching, news reporting, or making something genuinely new, which is why a reviewer can show a short clip, a teacher can quote a poem, and a parody can borrow from what it mocks. It is a gray zone on purpose, not a clear line: there is no rule like "ten seconds of any song" or "legal if you credit it" (those are myths). Instead courts weigh several questions together, whether you transformed the work into something new or just copied it, how much you used, and whether you hurt the creator's ability to make money, so the answer depends on the specific facts and even experts often cannot be certain in advance. Fair use exists because copyright is supposed to encourage creativity, not lock culture in a vault, and sometimes using existing work is how new creativity happens.`,
                `Just free use`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Fair use allows some unpermitted use for purposes like comment, teaching, or transformation, but it is weighed case by case (transformation, amount, market harm). There is no magic percentage or "credit makes it legal" rule.`,
            },
            {
              id: `q4`,
              type: `multiple-choice`,
              question: `How do copyright, trademark, and patent differ?`,
              options: [
                `Random`,
                `They protect different things and people constantly mix them up. Copyright is for creative expression, songs, art, writing, photos, video, and protects the specific way something is expressed. Trademark is for brand identity, the names, logos, and symbols that identify who made something (like a shoe's swoosh or a brand name), and exists mainly to protect customers from fakes and protect a business's reputation, not to protect art; securing a company's name and logo is trademark work. Patent is for inventions, new machines, processes, or devices, granted for a limited time in exchange for the inventor explaining publicly how the invention works, and is mostly about technology, not art. The quick way to keep them straight: copyright equals creative expression, trademark equals brand identity, patent equals inventions. Just knowing which is which already puts you ahead of most adults, who use these words wrongly all the time.`,
                `Just legal words`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Copyright protects creative expression, trademark protects brand identity (names, logos), patent protects inventions. Keeping them straight already puts you ahead of most people.`,
            },
            {
              id: `q5`,
              type: `multiple-choice`,
              question: `What are the three "zones" of using other people's creative work?`,
              options: [
                `Random`,
                `There are three zones, not two. First, fully protected work: most creative work you encounter is under copyright, so the default is that you need permission (or a genuine fair-use justification) to use it. Second, the public domain: works old enough that copyright has expired belong to everyone and are free for anyone to use however they like (Beethoven, Shakespeare, Greek myths). Third, deliberately licensed work: some creators choose to share their work in advance under a license like Creative Commons, which says "you may use this freely as long as you follow these conditions," such as crediting the creator or not selling it, so lots of music, images, and writing online are genuinely free to use within the stated rules. Knowing which of the three zones a given work is in, protected, public domain, or licensed for sharing, is most of what it takes to use other people's work fairly.`,
                `Just yours or theirs`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Three zones: fully protected (ask permission), public domain (free for anyone), and deliberately licensed like Creative Commons (free within the creator's rules). Knowing the zone is most of using work fairly.`,
            },
            {
              id: `q6`,
              type: `multiple-choice`,
              question: `Why does the lesson insist that "legal," "fair," and "right" are three different things?`,
              options: [
                `Random`,
                `Because they genuinely do not always agree, and confusing them leads to bad thinking. Something can be legal but feel unfair, like a giant company using a tiny artist's publicly posted work in a way the law allows. Something can be illegal but feel harmless, like a kid making a meme from a movie still. Something can be technically allowed but still be wrong to do, like copying a struggling friend's idea just because you can. The law is one tool for sorting creative conflicts, but it is not the same as your conscience, and a whole-person education means being able to hold all three at once: what is legal (the rules), what is fair (does it treat people justly), and what you actually think is right (your own judgment). A thoughtful person notices when these come apart, instead of assuming that "legal" automatically means "okay" or that "I feel it's fair" automatically means "it's allowed."`,
                `Just the same thing`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Legal, fair, and right can come apart: legal-but-unfair, illegal-but-harmless, allowed-but-wrong. The law is not your conscience, so a thoughtful person holds all three rather than collapsing them into one.`,
            },
            {
              id: `q7`,
              type: `multiple-choice`,
              question: `What does the example of music sampling show about the central tension in copyright?`,
              options: [
                `Random`,
                `Sampling, taking a piece of an older recording and building something new on top of it, helped create some of the most important music ever made, especially in hip-hop; early on the rules were unclear, then lawsuits made sampling expensive and risky, which changed how music got made. The deep question it raises has no clean answer: was sampling "stealing," or was it a new art form that transformed old work into something genuinely new, exactly the creativity copyright is supposed to encourage? Reasonable people still disagree, and the law landed in a complicated place. Sampling shows the central tension of the whole field: copyright protecting creators is genuinely good (it is how artists get paid and respected), but locking everything down too tightly is genuinely bad (it can freeze culture, let powerful companies bully small creators, and stop the remixing and building-on that creativity has always depended on). A wise person holds that tension rather than picking a slogan.`,
                `Just stealing`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Sampling sits exactly on the tension between protecting creators and freeing culture to remix and build. It shows why "it's all theft" and "information should be free" are both too simple; the wise position holds the tension.`,
            },
            {
              id: `q8`,
              type: `multiple-choice`,
              question: `Why is "we can't tell you for sure whether your use is fair" a sign of a TRUSTWORTHY copyright source, not a weak one?`,
              options: [
                `Random`,
                `Because fair use genuinely is decided case by case on the specific facts, so honesty requires admitting that no one can promise you a simple yes or no in advance. A source that refuses to oversell certainty the law does not actually have is being accurate, while a source that confidently declares "this is definitely fine" or "you'll definitely be sued" is claiming a precision that does not exist, which is the tell of both the myths and the scares. This connects to the bigger pattern from earlier lessons: on genuinely complex topics, real expertise sounds a little uncertain, and confident simplicity is the warning sign. An official copyright office saying "it depends on the facts, and for a serious use you should consult an expert" gives you the accurate framework plus an honest signal about when to get real help, which is far more valuable than a confident stranger online handing you a clean rule that happens to be false.`,
                `Just being unsure`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Fair use really is case-by-case, so honest sources admit they cannot promise a verdict. Confident certainty in either direction is the tell of a myth or a scare; careful uncertainty is the mark of accuracy.`,
            },
            {
              id: `q9`,
              type: `true-false`,
              ...
              correctAnswer: false,
              explanation: `False, and this is one of the most widespread myths there is. Crediting the creator and writing "no copyright infringement intended" are common online, but neither one gives you permission to use someone's work; using copyrighted work without permission is still using it without permission, credit or not, and that phrase has no legal power at all. The myth feels true because crediting is polite and respectful and people assume that being fair automatically makes something legal, but, as this lesson stressed, legal and fair are different things. What actually lets you use someone else's work is one of a few real things: the work is in the public domain, the creator has released it under a license like Creative Commons that permits your use, your use genuinely qualifies as fair use (transformative, limited, not harming their market), or you simply asked and got permission. Credit is something you should do as a matter of honesty and respect, and it does matter, but it is not a magic key that turns unauthorized use into authorized use. Believing this myth is exactly how well-meaning people accidentally cross real lines.`,
            },
            {
              id: `q10`,
              type: `inference`,
              question: `Imagine you are 14 and you make a YouTube video reviewing a movie you love. You include several short clips from the film to talk about specific scenes, you add your own commentary throughout, and you credit the film. A friend says "you're going to get sued, you used their clips." Another friend says "no, you credited it and it's a review, so it's automatically 100% legal." Using this lesson, what is the most accurate and thoughtful thing to say?`,
              options: [
                `"Just delete it"`,
                `Several things, held together, because both friends are partly right and partly wrong and the honest answer lives in between. First, the friend who says "you credited it, so it's automatically 100% legal" is wrong about the credit part: crediting the film is good and respectful, but credit by itself never makes a use legal, that is one of the most common myths. So you should not feel safe just because you named the movie. Second, that same friend is actually pointing at something real with the "it's a review" part: criticism and commentary are exactly the kinds of purposes fair use is designed to protect, and a review that includes short clips and adds your own genuine commentary about specific scenes leans toward fair use, because you are transforming the clips into something new (your analysis) rather than just reposting the movie for people to watch instead of paying for it. Third, the friend who says "you'll get sued" is overstating the danger in the scare direction: for a genuine review with short clips and real commentary, that catastrophic certainty is not how it usually works, and being terrified into never making thoughtful, transformative work is its own kind of loss. Fourth, the accurate thing to say is the careful middle: "Crediting it doesn't make it legal on its own, but a real review with short clips and my own commentary is the kind of transformative, critical use that fair use is meant to protect, so it leans okay, though fair use is decided case by case and isn't a guarantee." Fifth, the smart, self-protecting moves follow from the actual fair-use factors: keep the clips short rather than showing big chunks of the film, make sure your commentary genuinely adds something so the work is transformative, and do not structure the video so people could watch the whole movie through your clips instead of paying for it, because that would hurt the creator's market and weigh against you. Sixth, the honest limit, which is exactly what a trustworthy source would admit: you are not certain, nobody can be fully certain in advance because fair use turns on the specific facts, the law differs by country, and platforms like YouTube also have their own automated systems that are separate from the law. So if this were high-stakes, you would slow down and ask someone who really knows. The deepest takeaway is that you can confidently reject both friends' simple certainties, the "credit makes it legal" myth and the "you'll definitely get sued" scare, and replace them with the accurate, slightly uncertain, genuinely useful real picture: this is probably the kind of use fair use protects, here is how to make it stronger, and here is the honest limit of what anyone can promise.`,
                `"Random"`,
                `"Just maybe"`,
              ],
              correctIndex: 1,
              explanation: `Applied copyright literacy. The move is to reject both simple certainties, the "credit makes it legal" myth and the "you'll get sued" scare, and land on the accurate middle: a real review with short clips and genuine commentary is the transformative, critical use fair use is meant to protect, so it leans okay, while honestly admitting fair use is case-by-case and not guaranteed. The self-protecting moves (short clips, real added commentary, do not replace the market) come straight from the actual fair-use factors.`,
            },
          ],
        },
