      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            {
              word: `idea expression`,
              definition: `The idea-expression split is the single most useful concept in copyright. Copyright protects the specific expression of a work, the exact words, characters, and details, but not the underlying idea. You cannot copyright the idea of "a boy who discovers he is a wizard," but you can copyright the specific book you wrote telling that story. Anyone can write a story about a young wizard; no one can copy your particular sentences and characters. Almost every real argument about "did they steal this?" comes down to whether someone copied the protected expression or just used the free underlying idea.`,
              audioPrompt: `The idea-expression split is the single most useful concept in copyright, {name}. Copyright protects the specific expression of a work, but not the underlying idea. Here is how it works in plain terms. You cannot copyright the idea of "a boy who discovers he is a wizard." That idea is free. Anyone can write a story about a young wizard. But you can copyright the specific book you wrote telling that story, the exact words, the particular characters, the specific details and scenes you created. No one can copy your particular sentences and characters. That is the split. Idea: free for everyone. Expression: owned by the maker. Almost every real argument about "did they steal this?" comes down to this distinction. Did someone copy the protected expression, the actual words, the specific creative choices? Or did they just use the free underlying idea and make their own original expression from it? Understanding that split is what lets you think clearly about copying and creativity, instead of just having a gut reaction.`,
            },
            {
              word: `original work`,
              definition: `Original work is the phrase copyright uses to describe what gets protected: a work that you created and that shows at least some spark of your own creativity, whether a song, story, drawing, photo, or video. In most countries copyright protection happens automatically the moment you make an original work and fix it in some form, like writing it down or saving the file. You do not have to file anything or add a circled C. The doodle you drew yesterday is already protected by copyright as an original work that you made.`,
              audioPrompt: `Original work is the phrase copyright uses to describe what gets protected, {name}. Copyright protects original works: songs, stories, drawings, photos, videos, anything you created that shows at least some spark of your own creativity. In most countries the protection happens automatically, the moment you make the original work and fix it in some form. Writing it down. Saving the file. That is all it takes. You do not have to file anything. You do not have to register anywhere. You do not have to add a circled C. In most countries the protection is there the moment you fix the work in any form. So the doodle you drew yesterday is already protected by copyright as an original work that you made. The drawing no one has seen yet. The rough draft you have not shared. The song you just recorded on your phone. These are all original works, and they are already protected as yours. That is the first thing to understand about copyright: you already have it, for the work you have already made.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `fair use`,
              definition: `Fair use is the part of copyright law that allows you to sometimes use a piece of someone else's copyrighted work without permission, for certain purposes: commenting on it, criticizing it, teaching with it, reporting news, or making something genuinely new from it. A movie reviewer can show a short clip; a teacher can quote a poem; a parody can borrow from the original it mocks. Fair use exists because copyright is supposed to encourage creativity, not lock culture in a vault. The crucial thing to understand: fair use is a gray zone on purpose, weighed case by case, not a clear line with a fixed rule. Courts weigh transformation, amount used, and market harm. There is no magic percentage and no "credit makes it legal" rule.`,
              audioPrompt: `Fair use is the part of copyright law that says you are sometimes allowed to use someone else's copyrighted work without permission, {name}. It exists for certain purposes: commenting on a work, criticizing it, teaching with it, reporting news, or making something genuinely new out of it. This is why a movie reviewer can show a short clip to discuss a specific scene. Why a teacher can quote a poem in class. Why a parody song can borrow from the original it is mocking. Fair use exists because copyright is supposed to encourage creativity, not lock culture in a vault, and sometimes using existing work is exactly how new creativity happens. But here is the most important thing to understand about fair use: it is a gray zone on purpose, not a clear line. There is no rule like "you can use ten seconds of any song." No rule like "credit the artist and you are fine." No magic percentage. Instead, courts weigh several questions together when they look at a case. Are you transforming the work into something new and different, or just copying it? Are you using a little or a lot? Are you hurting the original creator's ability to make money? Because it is weighed case by case, even experts often cannot be certain in advance. The confident one-line rules you see online are almost always myths.`,
            },
            {
              word: `transformation`,
              definition: `Transformation is one of the key questions courts weigh when deciding fair use. Are you transforming the work into something genuinely new and different, with its own meaning and purpose, or are you just copying it? A short clip in a thoughtful review that adds real commentary and analysis is transformative; it creates new meaning around the original. Reposting someone's whole song so people do not need to buy it is not transformative; it just replaces the original. Transformation is not the only factor courts weigh, but it is one of the most important ones, and it is the part of the fair-use test that is most directly about whether new creativity is happening.`,
              audioPrompt: `Transformation is one of the key questions courts weigh when deciding whether a use of copyrighted work qualifies as fair use, {name}. The question is: are you transforming the work into something genuinely new and different, with its own meaning and purpose? Or are you just copying it? A short clip in a thoughtful review that adds real commentary around it is transformative. The review creates new meaning, new analysis, new value; it does not just reproduce the original. Reposting someone's whole song so that people do not need to buy it is not transformative. It just replaces the original in the market. The same basic content, no new meaning added. Courts do not weigh only transformation; they also weigh how much of the original was used and whether the use hurts the creator's ability to earn. But transformation is one of the most important questions in the mix, because it goes to the heart of what fair use is for: allowing new creativity to build on existing work, not just allowing free copying of existing work.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `trademark`,
              definition: `A trademark protects the names, logos, and symbols that identify who made something, so customers are not fooled by fakes. The swoosh on a shoe, a brand name, a logo: these are trademarks. Trademarks exist mostly to protect customers from fakes and to protect a business's reputation, not to protect art. Securing the name and logo for a brand or company is trademark work, which is different from the copyright that protects actual creative content. The quick way to keep it straight: copyright is for creative expression (songs, art, writing), trademark is for brand identity (names, logos), and patent is for inventions.`,
              audioPrompt: `A trademark protects the names, logos, and symbols that identify who made something, {name}. Its purpose is to make sure customers are not fooled by fakes. When you see a swoosh on a shoe, that swoosh is a trademark. When you see a brand name on a product, that name is protected by trademark law. When a company has a distinctive logo, that logo is a trademark. Trademarks exist mostly to protect customers from being deceived, and to protect a business's reputation in the marketplace. They are not about protecting art; they are about identifying who made something. This is different from copyright. Securing the name and logo for a brand or company is trademark work. The copyright that protects the actual creative content of the lessons or the design of a product is different from the trademark that protects the brand name and logo under which those things are sold. The quick way to keep the three straight: copyright is for creative expression like songs, art, and writing. Trademark is for brand identity, the names and logos that say who made something. Patent is for inventions, machines, and processes.`,
            },
            {
              word: `patent`,
              definition: `A patent protects inventions, new machines, processes, or devices, for a limited time, in exchange for the inventor explaining publicly how the invention works. Patents are mostly about technology and inventions, not art, so they matter less for a creative career. Knowing the word keeps you from mixing it up with copyright or trademark. The quick way to keep the three straight: copyright is for creative expression (songs, art, writing), trademark is for brand identity (names, logos), and patent is for inventions (machines, processes).`,
              audioPrompt: `A patent protects inventions, {name}: new machines, processes, or devices. It works differently from copyright and trademark. A patent gives an inventor protection for a limited time, in exchange for explaining publicly how the invention works. That trade-off is built into the design of patent law: the inventor gets a period of exclusive protection, and in return the public gets to learn exactly how the invention works so that, when the patent expires, anyone can build on it. Patents are mostly about technology and inventions, not art, so they matter less directly for a creative career. But knowing the word matters because people often confuse copyright, trademark, and patent, using them as if they mean the same thing. They do not. The quick way to keep all three straight: copyright is for creative expression, the songs, the art, the writing. Trademark is for brand identity, the names and logos that identify who made something. Patent is for inventions, the new machines and processes. Three different tools for three different kinds of protection.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `music sampling`,
              definition: `Music sampling is the practice of taking a piece of an older recording and building something new on top of it. The lesson uses it as a real, rich example of the central tension in copyright between protecting creators and allowing new creativity. Hip-hop was built partly on sampling, and some of the most important music ever made was created this way. Early on the rules were unclear; then lawsuits made sampling expensive and risky, which changed how music got made. Was sampling "stealing," or was it a new art form that transformed old work into something genuinely new, exactly the kind of creativity copyright is supposed to encourage? Reasonable people still disagree, and the law landed in a complicated place.`,
              audioPrompt: `Music sampling is the practice of taking a piece of an older recording and building something new on top of it, {name}, and the lesson uses it as a real, rich example of the deepest tension in copyright. Hip-hop was built partly on sampling. Artists would take a drum break or a bass line or a vocal hook from an older recording and use it as the foundation for a new track, a new song, a new artistic statement. Some of the most important music ever made was created this way. Early on, the legal rules around this were unclear. Then lawsuits arrived and made sampling expensive and legally risky, which changed how music got made. Artists had to clear samples in advance, pay licensing fees, or avoid sampling altogether. Was what those early hip-hop artists did "stealing"? Or was it a new art form that genuinely transformed old work into something new, the exact kind of creativity copyright law is supposed to encourage? Reasonable people still disagree, and the courts landed in a complicated place that did not fully satisfy either side. The lesson holds this up as an example of why the question of legal, fair, and right is not always the same question.`,
            },
            {
              word: `protect creators`,
              definition: `Protecting creators is one side of the central tension in copyright: copyright protecting creators is genuinely good, because it is how artists get paid and respected, how a songwriter earns royalties, how your own future work could support you. The lesson holds this alongside the other side: locking everything down too tightly is genuinely bad, because it can freeze culture, let powerful companies bully small creators, and stop the remixing and building-on that creativity has always depended on. A wise person holds the tension and supports both creators' right to be paid and culture's need to remix, learn, quote, and build, rather than cheering only for one slogan.`,
              audioPrompt: `Protecting creators is one side of the central tension in copyright, {name}, and it is a real and important side. Copyright that protects creators is genuinely good. It is how a songwriter earns royalties when their song is streamed or used in a film. It is how an artist can make a living from their work over time. It is how your own future creative work could support you. The rights you learned about in Lesson 7, the royalties, the ownership, the ability to control who uses your work, all of that depends on creators being protected. The lesson fully acknowledges this. But it puts it alongside the other side of the tension: locking everything down too tightly is also genuinely bad. It can freeze culture. It can let powerful companies bully small creators with legal threats they cannot afford to fight. It can stop the remixing, the quoting, the building-on, that creativity has always depended on. Hip-hop built on sampling. Writers build on older stories. Artists reference other art. A wise person does not cheer only for "protect everything" or only for "information wants to be free." They hold the tension.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `three zones`,
              definition: `The three zones are the framework the lesson gives you for sorting whether a piece of creative work is free to use. Zone one: fully protected work, where you need to ask permission before using it. Zone two: the public domain, where copyright has expired and anyone can freely use the work (Beethoven, Greek myths, Shakespeare). Zone three: work the creator has deliberately licensed for sharing, like a Creative Commons license, where the work is free to use within the rules the creator set (usually: credit them, or do not sell it). Knowing which zone a work is in is most of using other people's work fairly.`,
              audioPrompt: `The three zones are the framework the lesson gives you for sorting whether a piece of creative work is free to use, {name}. Zone one is fully protected work. Copyright is active, the creator controls it, and you need to ask permission before using it. Zone two is the public domain. Copyright has expired, and anyone can freely use the work. This is why you can freely perform Beethoven, retell Greek myths, or print a Shakespeare play; those works are old enough that no one owns them anymore. Zone three is work the creator has deliberately licensed for sharing, like a Creative Commons license. The creator said in advance: you may use my work freely, as long as you follow these conditions. Maybe the condition is crediting them. Maybe the condition is not selling it commercially. Within those stated rules, the work is genuinely free to use. Three zones, not two. Fully protected. Public domain. Deliberately licensed. Knowing which zone a work is in is most of using other people's creative work fairly. It replaces vague guessing with a real, practical question you can actually answer.`,
            },
            {
              word: `idea split`,
              definition: `The idea split is shorthand for the idea-versus-expression distinction that is the single most useful concept in copyright. Copyright protects the specific expression of a work, the exact words, characters, and creative details, but not the underlying idea. The underlying idea is free for everyone. Anyone can write a story about a young wizard; no one can copy the exact sentences, characters, and details of a specific book about a young wizard. Almost every real argument about "did they steal this?" comes down to whether someone copied the protected expression or just used the free underlying idea. The idea split is the lens the lesson gives you for thinking clearly about copying and creativity.`,
              audioPrompt: `The idea split is shorthand for the idea-versus-expression distinction that the lesson calls the single most useful concept in copyright, {name}. Here is how the split works. Ideas are free. Anyone can use them. You cannot copyright the idea of a story about a boy who discovers he is a wizard. That idea belongs to everyone. What you can copyright is the specific expression: the exact words you wrote, the particular characters you created, the specific scenes and details of your book. That expression belongs to you. Anyone can write a story about a young wizard. No one can copy your particular sentences and characters. The idea is free; the expression is owned. This distinction does a lot of work. Almost every real argument about "did they steal my idea?" or "is that copying?" comes down to this split. Did someone copy the protected expression, the actual creative choices, the specific words? Or did they just use the free underlying idea and create their own original expression from it? Understanding the idea split is what lets you think clearly about those questions instead of just having a gut reaction.`,
            },
          ],
        },
