      ...
      screens: [
        {
          id: `l15-welcome`,
          type: `welcome`,
          guideText: `{name}, we've met Jung twice already in this band: when we looked at the shadow self in L03, and when we looked at the ego in L12. Today we go deeper into Jung's most ambitious claim. He didn't just say you have a personal unconscious full of forgotten memories. He said beneath that lies something shared across all humans: a collective unconscious full of patterns called archetypes. The hero. The wise old one. The trickster. The great mother. These show up in myths, dreams, stories, and inner life across every culture. Whether you accept Jung's framework or not, his claim is one of the most influential ideas in modern psychology. Today you'll read Jung directly, in his own words, and analyze them closely.`,
...

        {
          ...
          paragraphs: [
            ...
            `Reading Jung directly is different from reading a popular summary of his ideas. The popular versions often flatten his thought into simple slogans. The real Jung is more careful, more conditional, and more interesting. As you read, notice the difference between what Jung actually says and what's been said in his name. This is the same skill you developed with Hume in L02, Brewer in L07, and Schwartz in L11. Real primary source reading is a real intellectual practice you can carry with you.`,
          ],
