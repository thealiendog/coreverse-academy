export const socialleadershipLittleStars = [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which shows TAKING TURNS?', guideText: 'Tap the kids taking turns on the slide!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which one is LISTENING well?', guideText: 'Tap the great listener!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'When you need HELP, what do you do?', guideText: 'Tap asking for help!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which shows GOOD MANNERS?', guideText: 'Tap please and thank you!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'When a friend is SAD, what can you do?', guideText: 'Tap helping a sad friend!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'What does a real LEADER do?', guideText: 'Tap a leader helping others!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: false, hideLabels: true, instruction: 'Which shows TEAMWORK?', guideText: 'Tap kids working together!',
        items: [
