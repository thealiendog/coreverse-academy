export const frontierLittleStars = [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: true, hideLabels: true, instruction: 'Which shows a rule that keeps us SAFE?', guideText: 'Tap holding a hand to cross!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: true, hideLabels: true, instruction: 'Which one is FAIR?', guideText: 'Tap the fair sharing!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: true, hideLabels: true, instruction: 'Which one shows being DIFFERENT?', guideText: 'Tap the different kids!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: true, hideLabels: true, instruction: 'Which one shows being GOOD?', guideText: 'Tap the helping friend!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: true, hideLabels: true, instruction: 'Which one shows FIGHTING?', guideText: 'Tap the kids fighting over a toy!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: true, hideLabels: true, instruction: 'Which shows MAGIC in nature?', guideText: 'Tap the rainbow!',
        items: [
  ...
  },
  {
    ...
    gameSequence: [
      ...
      { type: 'tap-right', readOptions: true, hideLabels: true, instruction: 'Which one shows changing the world for the BETTER?', guideText: 'Tap the kid imagining a better world!',
        items: [
