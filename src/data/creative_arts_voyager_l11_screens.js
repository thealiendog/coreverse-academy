          ...
          questions: [
            {
              ...
              question: `Why do humans across every culture make sacred art?`,
              options: [
                `Random`,
                `Because the sacred, by definition, points at things that are hard or impossible to say in plain words, the infinite, the holy, the mystery of existence, the feeling that there is something greater than ourselves, and ordinary language strains at these edges while art steps in where words run out. A vast cathedral makes you feel small and lifted at once in a way a sentence cannot; a repeating pattern can suggest infinity better than the word "infinity"; music can carry a feeling of the sacred straight into the body. The universality is striking: in every known human culture, across every continent and era, people poured their greatest skill and resources into making the holy visible, so sacred art was not a side hobby but, for most of history, the main event of human creativity. It uses art's power to reach the feeling-mind before the reasoning-mind (as in Lesson 10), not to manipulate but to open, creating experiences of awe, peace, or transcendence that connect people to whatever they hold sacred.`,
                `Just for decoration`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Sacred art exists because art can gesture toward what cannot be said in plain words, and the sacred is the ultimate unsayable thing. Its universality across all cultures shows how deep this human reaching goes.`,
            },
            {
              id: `q2`,
              type: `multiple-choice`,
              question: `How do different traditions reach for the sacred differently, and what is the right attitude toward those differences?`,
              options: [
                `Random`,
                `Different traditions answer the same deep question in profoundly different, equally serious ways. Christian cathedrals of medieval Europe reach upward with soaring stone, stained glass, and overwhelming scale, a building that argues in stone and light that there is something greater than you. Islamic sacred art, since many traditions avoid depicting living figures in religious art, developed breathtaking geometric patterns and calligraphy that suggest the infinite and the unity of all things rather than picturing the holy. Buddhist mandalas map a sacred order as meditation aids, with sand versions swept away to teach impermanence. Hindu temples teem with carved figures and stories; Indigenous traditions weave the sacred into ceremony, song, dance, body, and land. The right attitude is respect without ranking: none of these is "more advanced" than another, they are different languages for the same deep human reaching, and learning them with respect reveals how varied and ingenious human creativity is.`,
                `Just different buildings`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Cathedrals reach up, Islamic geometry suggests the infinite, mandalas map order and impermanence, temples teem with life, Indigenous sacred is woven into land, different languages for the same reaching, none ranked above another.`,
            },
            {
              id: `q3`,
              type: `multiple-choice`,
              question: `What is the difference between appreciation and appropriation of sacred art?`,
              options: [
                `Random`,
                `Appreciation is engaging respectfully with another culture's sacred art, learning its meaning, honoring its context, often with the welcome of people from that tradition, while being honest that it is not your own. Appropriation is taking sacred things out of their context and using them as fashion, decoration, or product, stripped of meaning and often without the consent of the people they belong to, like wearing a sacred ceremonial item as a costume or a company printing a sacred symbol on swimwear to look exotic. The core distinction: appreciation honors the meaning and the people; appropriation takes the look and discards both. The line is not always perfectly clear and reasonable people debate specific cases, but the principle is real, and the testimony of people from the tradition itself is especially important evidence. Respectful engagement does not require sharing the belief, you can be moved by sacred art that is not yours, but it does require learning the meaning, following the rules of sacred spaces, and never treating a sacred object as mere decoration.`,
                `Just liking it`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Appreciation honors meaning, context, and people (often with their welcome); appropriation takes the look and discards the meaning and people. The community's own testimony is key evidence, and respect does not require sharing the belief.`,
            },
            {
              id: `q4`,
              type: `multiple-choice`,
              question: `What is the difference between a genuine sacred tradition (Tier C-cultural) and wellness pseudoscience that borrows sacred imagery (Tier C-pseudoscience)?`,
              options: [
                `Random`,
                `A genuine sacred tradition, like Buddhist mandala practice or Islamic sacred geometry, engages the sacred through meaning, ritual, and centuries of practice; it makes claims about meaning and the holy, not testable claims about physics, so it is Tier C-cultural, legitimate and serious, and not the kind of thing you test in a lab because it is not trying to be a lab experiment. Wellness pseudoscience takes the look and vocabulary of sacred traditions and bolts scientific-sounding claims onto them to sell products, for example a "sacred energy disk" that "raises your vibration" or "heals your energy field", a falsifiable physics-and-health claim presented as fact with no evidence, using sacred imagery as decoration, which is Tier C-pseudoscience. The crucial move is to keep them apart: respect for the genuine tradition (no demand to "prove it" because it makes no testable claim) and healthy skepticism toward the product's specific physics-style claims. Conflating them does double harm, disrespecting the real tradition by reducing it to a product, and fooling the customer with unsupported claims.`,
                `Just both spiritual`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `A real tradition makes claims about meaning and the holy (not testable physics), deserving respect; wellness pseudoscience bolts falsifiable, unsupported physics-style claims onto sacred imagery to sell products, deserving skepticism. Conflating them harms both.`,
            },
            {
              id: `q5`,
              type: `multiple-choice`,
              ...
              options: [
                `Random`,
                `Because skepticism is aimed at the company's specific testable claim, not at the sacred or the tradition. When a Buddhist monk makes a sand mandala as a meditation practice, that is a profound spiritual tradition making claims about meaning, and the right response is respect, not "prove it works," because there is no false factual claim to challenge. But when a company sells a "mandala energy disk" claiming it will measurably heal your body and "raise your vibration to 528 Hz," that is a product making a falsifiable physics-and-health claim with no evidence, and being skeptical of that specific claim protects people from being fooled. In fact, the skepticism protects the religion too: the company is exploiting sacred imagery as marketing, cheapening a profound tradition into a $50 product, so pushing back on the fake claim defends both the customer and the genuine tradition being borrowed. Telling the real tradition apart from the product is respect for both, not disrespect for either.`,
                `Just because`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Skepticism targets the company's false, testable health claim, not the sacred. It actually defends the tradition (from being cheapened into a product) and the customer (from fake science), so it is respect for both, not disrespect.`,
            },
            {
              id: `q6`,
              type: `multiple-choice`,
              question: `What does respectful engagement with sacred art that is not your own actually require?`,
              options: [
                `Random`,
                `It requires a posture of respect and humility, treating the object, space, or song as something precious to real people and often central to how they understand their whole lives, not as a pretty thing to consume or a curiosity to gawk at. Concretely, it requires learning enough to understand what something means before judging it, following the actual rules of sacred spaces (covering your head or removing shoes where asked, not photographing where forbidden, staying quiet during ceremony), and never treating a sacred object as mere decoration or costume. Importantly, respectful engagement does not require you to share the belief, you can stand in awe inside a mosque, temple, or cathedral, appreciate the craft and the human reaching, and be genuinely moved, all while being honest that it is not your own tradition. What it rules out is carelessness and appropriation, stripping sacred things of their meaning and using them as fashion or product. Respect honors both the meaning and the people, even, and especially, when the tradition is not your own.`,
                `Just be quiet`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Respect and humility: learn the meaning before judging, follow the rules of sacred spaces, never treat sacred objects as decoration. It does not require sharing the belief, you can be moved without converting, but it rules out careless appropriation.`,
            },
            {
              id: `q7`,
              type: `multiple-choice`,
              question: `Why is a traveler who follows the rules, says "this isn't my tradition but it moved me," and gets one small detail wrong still engaging respectfully?`,
              options: [
                `Random`,
                `Because the posture is humble and honoring rather than careless or extractive, which is what actually distinguishes appreciation from appropriation. The traveler follows the rules of the sacred spaces (covering up, removing shoes, staying quiet during prayer), openly acknowledges "this is not my tradition," expresses genuine awe without claiming to own or fully understand it, and is willing to be corrected. Getting a small factual detail slightly wrong while sincerely trying to be respectful and open to learning does not ruin the engagement, because respect is about intent and conduct, not perfect knowledge, and demanding flawless expertise before anyone is allowed to appreciate another tradition would make respectful cross-cultural engagement impossible. This is the opposite of stripping a sacred symbol for a swimsuit: the traveler honors the meaning and the people and stays humble. The right response is to trust the respectful intent while gently valuing accuracy, the same grace you would want extended to your own honest, imperfect attempts at respect.`,
                `Just trying`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Respect is about humble, honoring intent and conduct (following the rules, acknowledging it is not yours, being correctable), not flawless expertise. A small honest error does not ruin sincere appreciation, the opposite of extractive appropriation.`,
            },
            {
              id: `q8`,
              type: `multiple-choice`,
              ...
              options: [
                `Random`,
                `Because respect for the sacred and clear thinking about claims are not enemies, even though it can feel like you must choose one. You can be genuinely moved by the holy in art, honor that billions of people find profound meaning in their traditions, and refuse to judge anyone's faith, while at the same time thinking clearly enough to spot a company exploiting sacred imagery to sell you a product with a fake health claim. These are not in conflict because they are aimed at different things: reverence is the right response to genuine traditions that make claims about meaning, and skepticism is the right response to false, testable claims that borrow sacred imagery for profit. The immature responses are the two collapses, either being so reverent that you believe every spiritual-sounding sales pitch, or being so skeptical that you sneer at all faith as superstition. The mature position holds both: it honors what deserves honor and is fooled by no one, which is exactly the thoughtful, respectful person this whole band is trying to help you become.`,
                `Just balance`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Reverence (the right response to genuine traditions) and skepticism (the right response to false sales claims) aim at different things, so they do not conflict. The mature position honors what deserves honor and is fooled by no one.`,
            },
            {
              id: `q9`,
              type: `true-false`,
              ...
              correctAnswer: false,
              explanation: `False, and untangling this is the central skill of the lesson. Being skeptical of a company's specific, testable, unsupported claim, that a metal disk measurably heals your body and "raises your vibration", does not require believing anything about whether religious or sacred traditions are true, because they are completely different kinds of things. A genuine tradition like Buddhist mandala practice makes claims about meaning, devotion, and the holy, not testable physics claims, so it is engaged with respect, not lab tests; the company's product, by contrast, makes a falsifiable physical-and-health claim with no evidence, dressed in borrowed sacred imagery, so it is rightly met with skepticism. You can hold deep respect for the sacred, refuse to judge anyone's faith, be genuinely moved standing inside a mosque or temple or cathedral, AND see clearly that a $50 "energy disk" with a fake science claim is pseudoscience using sacred decoration as marketing. In fact, the skepticism protects the tradition as much as the customer, because it refuses to let a profound, centuries-old practice be cheapened into a product with a marketing slogan. Reverence for genuine traditions and skepticism toward false commercial claims are not opposites; holding both at once is exactly the mature, respectful clarity this lesson is building.`,
            },
            {
              id: `q10`,
              type: `inference`,
              question: `Imagine you are 13 and a relative you love starts spending a lot of money on "sacred geometry healing crystals" and "chakra-aligned mandala disks," telling you they cure illness by "fixing your energy frequency." You deeply respect this relative and you do not want to insult their spiritual beliefs, but you also have this lesson's framework. What do you actually think and do?`,
              options: [
                `"Just agree"`,
                `Several things, held together with care, because this is exactly where the lesson's hardest skill, respect and skepticism at once, has to work in a real relationship you cherish. First, separate two completely different things that are getting tangled, because that separation is the whole key: your relative's genuine spirituality, their sense of the sacred, their faith or felt connection to something greater, is a real claim about meaning that deserves your full respect and is not yours to judge; but the specific claim that a purchased crystal or disk "cures illness by fixing your energy frequency" is a testable, physical, health claim, and that specific claim has no scientific support, exactly the Tier C-pseudoscience pattern. So you do not have to choose between "respect their spirituality" and "doubt the product"; those are aimed at different things. Second, locate where the real concern is, and notice it is not their spirituality at all, it is two practical harms: money being spent on products that do not deliver the physical healing claimed, and, far more seriously, the risk that "these cure illness" could lead them to delay or skip real medical care for a real condition, which is where this stops being harmless and becomes genuinely dangerous, the same danger line from the sound-healing lesson. Third, decide what NOT to do: do not mock their beliefs, do not call them stupid, do not lump their genuine sense of the sacred together with the company's sales pitch, because that would be both hurtful and inaccurate, and it would make them defensive and stop listening. Fourth, decide what to actually say, gently and from love: you can honor the spiritual part sincerely ("I love that this practice is meaningful to you, and I'm not questioning your beliefs") while raising the specific factual concern ("I just worry about the company selling these, because the claim that they cure illness isn't backed by evidence, and I'd never want you to skip a doctor for something a company promised"). That sentence respects the sacred and questions the product at the same time, which is the entire lesson in action. Fifth, watch for the line that matters most: if the crystals are a comforting part of their spiritual practice alongside real medical care, the main harm is money, which is their choice to make; but if they start refusing actual treatment for a real illness because they believe the disk will heal it, that is serious enough to gently but persistently raise, and to bring in other family members or, where appropriate, encourage real medical advice. Sixth, hold the deepest takeaway: respecting someone's faith and protecting them from a company's fake health claim are not in conflict, they are both forms of love, and being the person who can honor a relative's sacred practice while clearly seeing the pseudoscience being sold to them is exactly the mature, respectful clarity this lesson is for. You honor what deserves honor, you stay skeptical of the false claim, and you never confuse the two, all while keeping the relationship warm.`,
                `"Random"`,
                `"Just maybe"`,
              ],
              correctIndex: 1,
              explanation: `Applied "reverence and clear sight" in a loved relationship. The move is to separate the relative's genuine spirituality (a meaning claim deserving full respect, not yours to judge) from the product's specific, testable, unsupported health claim (Tier C-pseudoscience), honor the first sincerely while gently raising the second, and watch the real danger line, money is their choice, but skipping real medical care for a "healing" product is serious enough to raise persistently. Respecting faith and protecting someone from fake health claims are both forms of love, not opposites.`,
            },
          ],
        },
