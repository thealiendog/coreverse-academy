      ...
      screens: [
        {
          id: `l16-welcome`,
          type: `welcome`,
          guideText: `{name}, we've journeyed through physics, the fundamental laws of motion, force, energy, electricity, and waves. Now we turn those laws loose on something extraordinary: the planet beneath your feet. Earth is not a static ball of rock. It's a living, breathing, endlessly interacting system, the only world we know of where rock, water, air, and life all meet and shape one another. Earth science is the study of how these great systems work and, above all, how they interact, because the deepest truth of our planet is that nothing happens in isolation. This lesson introduces the four great Earth systems, often called spheres. The geosphere: the solid Earth, its rock, mountains, and the slow churning of its interior that drives plate tectonics. The hydrosphere: all of Earth's water, oceans, rivers, ice, and the endless water cycle. The atmosphere: the blanket of air and the engine of weather and climate. And the biosphere: all living things, which both depend on and dramatically reshape the others. We'll see how these four systems are deeply coupled, how a volcano (geosphere) can change the climate (atmosphere), how the ocean (hydrosphere) shapes the weather, how life (biosphere) put the oxygen in our air. We'll trace the great cycles, water, carbon, rock, that move matter endlessly between the spheres, and we'll learn that Earth, uniquely, runs on two energy sources: sunlight from above and heat from within. By the end, you'll see your planet not as scenery, but as a magnificent, interconnected system, every part shaping every other. Onward.`,
