          ...
          questions: [
            {
              ...
              options: [
                `Whatever you sincerely and strongly believe — the strength of your conviction is what makes it knowledge.`,
                `Justified true belief: you believe it, it's actually true, AND you have a good reason for believing it.`,
                `Any claim that turns out true, however you got there — so a lucky guess that's right counts as knowing.`,
                `Whatever a recognized authority or textbook has confirmed, regardless of your own reasons.`,
              ],
              correctIndex: 1,
            ...
            },
            {
              ...
              options: [
                `Because almost everything you "know" came from other people, yet you usually absorb it without noticing you're trusting a source.`,
                `Because testimony is the least trustworthy source, so you should only believe what you've personally seen.`,
                `Because expert testimony is always reliable, so once an authority states it there's no need to check.`,
                `Because testimony only counts as real knowledge in courtrooms under oath, and everywhere else what people tell you is just unreliable gossip.`,
              ],
              correctIndex: 0,
            ...
            },
            {
              ...
              options: [
                `When other people let feelings distort their thinking, while you can just notice it and switch it off.`,
                `A tendency to change your mind too easily, believing whatever the last person happened to tell you instead of holding firm.`,
                `The tendency to notice evidence that fits what you already think and ignore what doesn't — and it doesn't feel like bias from inside.`,
                `A problem only for people who don't read widely; enough information makes it disappear on its own.`,
              ],
              correctIndex: 2,
            ...
            },
            {
              ...
              options: [
                `It doesn't protect you and can make it worse — a sharp mind builds better arguments for what it already wants to believe.`,
                `It does protect you — smart people have trained themselves to be objective and reason past these traps.`,
                `Intelligence makes no difference; the traps are purely emotional, so just trust your gut instead of thinking.`,
                `Nothing helps but gathering more facts — anyone who knows enough automatically stops making these errors.`,
              ],
              correctIndex: 0,
            ...
            },
            {
              ...
              options: [
                `Nothing's wrong with it at all — admitting we can't be certain of anything is the most humble and sophisticated position you can hold.`,
                `It's wrong because we actually can be 100% certain of most things if we just look hard enough.`,
                `The only problem is it sounds rude — it's basically correct that all beliefs are equally valid.`,
                `It flattens real differences in evidence: "nothing can be known" treats a careful expert and a random guess as equal.`,
              ],
              correctIndex: 3,
            ...
            },
            {
              ...
              options: [
                `Because anything online is automatically false, so seeing a claim everywhere online is actually decent evidence that the claim is wrong.`,
                `Because how often a claim appears depends on how shareable it is, not whether it's true — it's the same claim copied, not many confirmations.`,
                `Because you personally have bad luck online, though for most people seeing it everywhere does show it's true.`,
                `Because it hasn't been online long enough; once a claim circulates for years, that staying power proves it.`,
              ],
              correctIndex: 1,
            ...
            },
            {
              ...
              options: [
                `Because coincidences never really happen — what looks like one always has a hidden cause to hunt for.`,
                `Because one is weak, but stacking three or four striking coincidences becomes strong proof.`,
                `Because surprising coincidences are guaranteed by chance, and we remember the hits while forgetting the misses.`,
                `Because coincidences are only evidence for people trained in statistics, not for ordinary people.`,
              ],
              correctIndex: 2,
            ...
            },
            {
              ...
              options: [
                `It's weak: a claim built so nothing could ever disprove it isn't really claiming anything about reality.`,
                `It's strong precisely because nothing can disprove it — surviving every test means it's been proven.`,
                `It's weak only because it's hard to understand; explained more clearly, the weakness would disappear.`,
                `Its only weakness is that not enough people believe it yet — more supporters would make it solid.`,
              ],
              correctIndex: 0,
