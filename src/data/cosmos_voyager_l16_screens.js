      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `A key feature of real science: claims must specify outcomes in advance that can be tested. The Standard Model predicted the Higgs boson's mass before its 2012 discovery; Einstein's general relativity predicted gravitational lensing before Eddington observed it in 1919. Vague claims that fit any outcome are not specific predictions.`,
              audioPrompt: `Specific predictions are a key feature of real science, {name}. Scientific claims must specify outcomes in advance that can be tested against actual observations. The Standard Model of particle physics predicted the mass of the Higgs boson before it was discovered in 2012. Einstein's general relativity predicted gravitational lensing of starlight by the Sun before Arthur Eddington observed it in 1919. These are specific, falsifiable predictions. By contrast, a vague claim like "Mercury retrograde affects communication" doesn't make specific predictions. It gets "validated" by selectively noticing communication problems that fit while ignoring those that don't. Without a specific, testable forecast, there is nothing to confirm or refute. Specific predictions are what give empirical claims their content.`,
            },
            {
              word: `replication`,
              definition: `The requirement that scientific findings be reproduced by independent researchers. A single experiment does not settle a question. The 1989 cold fusion announcement was rejected after other labs failed to replicate it. Replication is how the scientific community filters out bad results.`,
              audioPrompt: `Replication is the requirement that scientific findings be reproduced by independent researchers, {name}. A single experiment does not settle a question in science. Multiple independent groups must find the same result before a finding is accepted. The 1989 cold fusion announcement is the classic cautionary example: it was greeted with intense excitement until other laboratories tried to replicate it and failed. The original result was rejected. Replication is how the scientific community filters out bad results that may have arisen from error, equipment problems, or statistical flukes. Pseudoscience, by contrast, typically relies on unreplicated personal testimony and avoids the scrutiny of independent testing. Recognizing whether a claim has been independently replicated is one of the most useful questions you can ask.`,
            }
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `appeals to authority`,
              definition: `A pseudoscience pattern in which endorsements from authority figures substitute for rigorous evidence. Real science is built on peer review and methodological rigor, not on who endorses a claim. The relevant test is whether the authority has relevant credentials and published peer-reviewed work in the specific field.`,
              audioPrompt: `Appeals to authority are a common pseudoscience pattern in which endorsements from authority figures substitute for rigorous evidence, {name}. Celebrity endorsements, so-called experts without actual training in the relevant field, and fringe scientists speaking outside their expertise all fit this pattern. Real science is built on peer review and methodological rigor, not on who endorses it. If someone tells you that PhD physicists support quantum healing, the relevant question is whether those physicists are publishing peer-reviewed work on quantum mechanics relevant to healing claims. According to this section, almost always they are not. Knowing that authority appeals are a pseudoscience pattern helps you ask the right follow-up question: does the authority have genuine credentials in this specific domain, and are they citing actual peer-reviewed evidence?`,
            },
            {
              word: `vague language`,
              definition: `A pseudoscience feature in which undefined terms like "energy," "vibrations," or "alignment" are used without measurable specifications. Real physics uses specific energies with specific units. Vague pseudoscientific language is not accidental; it makes claims unfalsifiable by allowing terms to mean whatever the speaker needs.`,
              audioPrompt: `Vague language is a defining feature of pseudoscience, {name}. Terms like "energy," "vibrations," and "alignment" are used without specifying what kind of energy, what measurable frequencies, or alignment with what. Real physics uses specific energies — electromagnetic, gravitational, kinetic — each with specific units that can be measured. Pseudoscience borrows the word "energy" as an undefined term that can mean whatever the speaker needs it to mean. The vagueness is not accidental. It is what makes the claims unfalsifiable. If a claim can mean anything, no observation can rule it out, and no observation can confirm it either. Recognizing vague language as a pseudoscience signal helps you identify claims that sound scientific but carry no empirical content.`,
            }
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `double-blind test`,
              definition: `An experimental design in which neither the subjects nor the evaluators know which condition each participant is in, eliminating expectation bias. The Carlson 1985 astrology study was double-blind. Considered the gold standard for testing empirical claims where expectation could influence results.`,
              audioPrompt: `A double-blind test is an experimental design in which neither the subjects nor the evaluators know which condition each participant is in, {name}. This eliminates expectation bias on both sides. The Carlson 1985 study testing astrology was double-blind: subjects provided birth data, astrologers used natal charts to try to match personality profiles, and the design was structured so that neither side could be unconsciously guided toward a preferred result. The astrologers themselves agreed before the study that this would be a fair evaluation. Double-blind methodology is considered the gold standard for testing empirical claims where expectation could influence the results. When a study is not double-blind, results may reflect the expectations of participants and evaluators rather than the underlying reality being tested.`,
            },
            {
              word: `Time Twins study`,
              definition: `A 2000s longitudinal study tracking approximately 2,000 people born within minutes of each other. If astrology's core claim that celestial positions at birth determine personality and life events were correct, time twins should show similar life patterns. The study found they did not.`,
              audioPrompt: `The Time Twins study is a 2000s longitudinal study that tracked approximately 2,000 people born within minutes of each other, {name}. Twins born at nearly the same time have nearly identical natal charts under astrological frameworks. If astrology's core claim — that celestial positions at birth determine personality and life events — were correct, these time twins should show similar life patterns. The study found that they did not. This provides independent evidence against astrology's core empirical claims, separate from the Carlson controlled testing approach. Researcher Geoffrey Dean, a former astrologer who became a skeptical researcher, has published meta-analyses of dozens of studies consistently finding that astrologers cannot match charts to personalities, life outcomes, or events at better-than-chance rates.`,
            }
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `Forer effect`,
              definition: `Another name for the Barnum effect, named after psychologist Bertram Forer who demonstrated in 1948 that people accept vague, generic descriptions as personally accurate when told the descriptions were written specifically for them. Forer gave every student the same horoscope-derived text; most rated it as highly accurate.`,
              audioPrompt: `The Forer effect, also called the Barnum effect, is named after psychologist Bertram Forer who demonstrated the phenomenon in 1948, {name}. Forer gave students what they were told were personalized personality assessments and asked them to rate accuracy. Most students rated the descriptions as highly accurate. But Forer had given every student the same generic description, assembled from astrological columns. The descriptions fit nearly everyone because they were vague enough to apply to nearly everyone. "You have unrealized potential you haven't fully expressed" is true of most people. Forer's experiment is the foundational demonstration of why horoscope descriptions feel personally accurate even though they are not specifically calibrated to any individual. Recognizing the Forer effect helps you evaluate any seemingly personalized description with appropriate skepticism.`,
            },
            {
              word: `pattern recognition`,
              definition: `A deep feature of human cognition: the tendency to detect patterns in sensory data, including in random events. Astrology provides a framework for finding patterns in life events, and the framework feels satisfying even when the patterns are not statistically real. Pattern recognition is a cognitive feature, not a moral failing.`,
              audioPrompt: `Pattern recognition is a deep feature of human cognition, {name}. Humans evolved to detect patterns in their environment — faces, movements, correlations between events. This capacity is extremely useful. It is also what makes frameworks like astrology feel compelling. Astrology gives people a structure for finding patterns in life events, and that framework feels satisfying even when the patterns are not actually there in the statistical sense. Seeing apparent patterns is not a moral failing; it is how human cognition works. Knowing how it works helps you not be fooled by it. When a framework seems to produce meaningful patterns, the right question is whether those patterns survive controlled testing or whether they are the product of a powerful cognitive tendency to find what we are looking for.`,
            }
          ],
        },

        {
          ...
          vocab: [
            ...
            },
            {
              ...
              definition: `Findings that have been evaluated and approved by independent experts before publication. A key marker of credible scientific sources. The Carlson 1985 astrology study was published in Nature after peer review. Sources that claim scientific support without citing peer-reviewed evidence are a pseudoscience warning sign.`,
              audioPrompt: `Peer-reviewed evidence refers to findings that have been evaluated and approved by independent experts before publication, {name}. When a study is submitted to a journal like Nature, other scientists in the relevant field review the methodology and results before the work is published. This process filters out flawed methods, incorrect statistics, and unsupported conclusions. The Carlson 1985 astrology test was published in Nature after peer review, which is part of what makes it a credible reference. When evaluating sources that claim scientific support, one of the most important questions you can ask is whether the supporting evidence has been through peer review. Sources that use scientific vocabulary without citing peer-reviewed work are a key pseudoscience warning sign.`,
            },
            {
              word: `profit motive`,
              definition: `A structural financial incentive that can bias the claims a source makes. Pseudoscience commonly sells products, courses, or consultations; the source profits whether the claims work or not. Real scientific research is funded through grants and universities whose income does not depend on specific results being true.`,
              audioPrompt: `The profit motive is a structural financial incentive that can bias the claims a source makes, {name}. Pseudoscience commonly sells products, courses, readings, or consultations. When a source's income depends on people believing its claims, there is a structural reason to make claims that attract buyers, regardless of whether those claims are accurate. Real scientific research is funded primarily through grants, universities, and laboratories whose income does not depend on the specific results being true. Researchers who find that a treatment does not work still get paid. This structural difference matters when evaluating sources. A source that sells a course based on claims it makes has a direct financial interest in those claims being believed, not in those claims being correct. Recognizing the profit motive is one of the most practical filters available.`,
            }
          ],
        },
