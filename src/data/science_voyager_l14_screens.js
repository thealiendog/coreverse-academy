      ...
      screens: [
        {
          id: `l14-welcome`,
          type: `welcome`,
          guideText: `{name}, look around you. Almost everything that defines the modern world, the light overhead, the screen you're reading, the phone in your pocket, the hospitals, the internet, the entire glowing web of civilization, runs on one thing: electricity. It's the most useful and world-changing form of energy humans have ever learned to control. And at its heart is something beautifully simple: the flow of tiny charged particles, electrons, through a circuit. This lesson demystifies electricity completely. We'll start with electric charge itself, the fundamental property that makes electrons push and pull. Then current: the flow of charge, like water flowing through a pipe. Then voltage: the "push" or pressure that drives that flow, the electrical pressure from a battery or outlet. Then resistance: how much a material fights the flow, turning electrical energy into heat and light. We'll tie these three together with one of the most useful relationships in all of physics, Ohm's law, which connects voltage, current, and resistance. We'll learn what a circuit actually is, a complete loop for charge to flow around, and why a break anywhere stops everything. We'll see the crucial difference between series and parallel circuits, why your home is wired one way and not the other. And throughout, we'll remember that electricity is energy: it carries energy from a power plant to your device, where it transforms into light, heat, sound, and motion. By the end, the invisible force humming through every wire will make perfect sense. Onward.`,
