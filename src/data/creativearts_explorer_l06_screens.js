  ...
  lessons: [
    {
      ...
      screens: [
        ...
        // ── 5. MAGAZINE — §4 ────────────────────────────────────────────────
        {
          ...
          section: 4,
          content: {
            heading: `Using Your Voice Expressively`,
            body: `The technical side of singing — pitch, breath, resonance — is only part of what makes a performance powerful. The other part is **expression**: how you use your voice to communicate meaning and emotion. The same words sung with different **dynamics** (loud vs. soft), **phrasing** (where you breathe and pause), and **tone colour** can convey completely different feelings. A soft, breathy tone suggests intimacy. A full, resonant tone suggests strength or joy. A wavering tone can suggest grief. Skilled singers make deliberate choices about all of these elements — not just hitting the right notes, but telling the right story. Your voice is not just an instrument for making sound: it's a tool for expressing what words alone cannot say.`,
            image:   '/explorer-assets/creative-arts/l06-magazine-4.png',
            caption: `Expression — dynamics, phrasing, tone colour — is what makes singing tell a story beyond the notes`,
          },
        },
        ...
        // ── 6. INTERACTIVE — Drag-match ─────────────────────────────────────
        {
          ...
          config: {
            buckets: [
              { id: 'builds',  label: `✅ A Habit That Builds Your Voice`,    color: '#34D399' },
              { id: 'limits',  label: `⚠️ A Habit That Holds It Back`,        color: '#94A3B8' },
            ],
            items: [
              {
                id:            'l06-g1',
        ...
        // ── 7. QUIZ ──────────────────────────────────────────────────────────
        {
          ...
          questions: [
            ...
            // Q3 — MC (replaced: was list-recall "name expressive elements")
            {
              id:           'l06-q3',
              format:       'mc',
            ...
            // Q5 — Fill-blank (fresh)
            {
              ...
              options:      ['belly', 'chest', 'throat', 'shoulders'],
              correctIndex: 0,
