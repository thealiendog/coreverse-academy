  ...
  lessons: [
    {
      ...
      screens: [
...

        {
          ...
          type: `magazine`,
          section: 1,
          headline: `What a Portfolio Is and Isn't`,
          paragraphs: [
            `A portfolio is **not** everything you've ever made — it's a **selection**. The selection itself is a creative and critical act: which pieces best represent who you are? Which show your range? Which show your development over time? A portfolio can be **physical** (a binder or box of original work), **digital** (a website, PDF, or online gallery), or both. Different contexts call for different portfolios: an art school application portfolio looks different from a professional design portfolio, which looks different from a social media creative presence. What all portfolios share is intentionality — every piece is there because it **earns its place**, not because it exists.`,
          ],
          image: `/explorer-assets/creative-arts/l19-magazine-1.png`,
          imageCaption: `A portfolio is a selection, not an archive — every piece earns its place or it doesn't belong there`,
          vocab: [
            { word: `portfolio`, definition: `A curated collection of an artist's best work — a selective representation of who they are and what they can do, not an archive of everything they've ever made.`, audioPrompt: `A portfolio is not everything, {name} — it's the best things, chosen with care. The selection itself is a creative act: which pieces represent you most truly? Which show range? Which show where you're going, not just where you've been? A portfolio tells a story about the kind of artist you are, and every piece either serves that story or doesn't. If it doesn't, it doesn't belong there — no matter how much work went into it.` },
            { word: `selection`, definition: `The act of choosing which works to include in a portfolio — one of the most important creative and critical skills in building an effective body of work presentation.`, audioPrompt: `Selection is harder than making, {name} — because it requires looking at your own work honestly and asking: is this my best? Is this earning its place? The instinct is to include everything, especially work that cost you something to make. But a strong selection communicates more clearly than a comprehensive one. Ten excellent pieces outperform thirty good ones every time. Curating your own work is a skill as important as making it.` },
            { word: `intentionality`, definition: `The quality of every choice in a portfolio being made deliberately and with purpose — showing the viewer that nothing was included by accident or for sentimental reasons alone.`, audioPrompt: `Intentionality is what separates a portfolio from a folder, {name}. When every piece is chosen for a reason — this shows range, this shows growth, this is my strongest work in this medium — the portfolio communicates more than any individual piece could alone. A viewer reading an intentional portfolio feels the artist's awareness: of what they do well, of who they're becoming, of what story they want their work to tell. That awareness itself is part of what you're presenting.` },
          ],
        },

        {
          ...
          type: `magazine`,
          section: 2,
          headline: `Curating: Choosing What to Include`,
          paragraphs: [
            `**Curating** is the art of selection, and it's one of the hardest skills in building a portfolio. Every piece should earn its place. Ask of each potential piece: *Is this my best work, or just my most comfortable work? Does it show something the other pieces don't? Does it represent where I'm going, not just where I've been?* A portfolio of **10 excellent pieces** is far stronger than 30 mediocre ones. Quality over quantity, always. The instinct to include everything — because every piece feels personally significant — is understandable but almost always works against a strong portfolio. And **updating regularly** — removing older work as you improve — is not erasing your history; it's having the confidence to show only your best current self.`,
          ],
          image: `/explorer-assets/creative-arts/l19-magazine-2.png`,
          imageCaption: `10 excellent pieces beats 30 mediocre ones — curating is the hardest and most important skill in portfolio building`,
          vocab: [
            { word: `curate`, definition: `To carefully select and arrange works for presentation — applying critical judgment to decide what belongs and what doesn't, based on quality and the story the portfolio tells.`, audioPrompt: `To curate your portfolio, {name}, is to be your own editor — and editors are ruthless in the best way. They ask: is this the best version of this idea? Is this piece doing something no other piece in this collection does? Does this belong? The instinct to include more is almost always wrong. The instinct to show only what you're most proud of is almost always right. Curating takes courage — the courage to say "not this one," even when it cost you something.` },
            { word: `representation`, definition: `What a portfolio shows about an artist — the range, quality, and nature of their work — which should be honest, selective, and forward-looking rather than comprehensive.`, audioPrompt: `Your portfolio represents you, {name} — not everything you've ever made, but who you are as an artist right now, at your best. That's both exciting and demanding. It means showing the work you're most proud of, not the work that's most comfortable. It means letting your current best speak rather than padding it with older work that no longer reflects where you are. The portfolio is the version of you that goes into the room before you do.` },
            { word: `range`, definition: `The variety of subjects, styles, mediums, or approaches demonstrated across a portfolio — showing the breadth and adaptability of an artist's skills.`, audioPrompt: `Range in a portfolio says: I can do more than one thing, {name}. A collection of ten pieces all made in the same style with the same subject raises the question of what else the artist can do. Range shows versatility — different mediums, different moods, different scales, different subjects — without sacrificing quality. The balance between range and consistency is one of portfolio building's central challenges. Enough variety to show breadth. Enough coherence to show a point of view.` },
          ],
        },

        {
          ...
          imageCaption: `An artist statement gives viewers a lens — specific and honest, not vague or defensive`,
          vocab: [
            { word: `artist statement`, definition: `A short piece of writing that explains who an artist is, what they make, why they make it, and what questions their work explores — giving viewers a lens through which to understand the work.`, audioPrompt: `An artist statement is not a sales pitch, {name} — it's an honest account of who you are and what your work is doing. What questions are you exploring? What materials do you use and why? Where does your work come from? The hardest part is specificity: "I love to express myself through art" says nothing. "I make large-scale drawings exploring the relationship between memory and place" says something. Be specific, be honest, and trust the reader with the real thing.` },
            { word: `self-examination`, definition: `Honest, rigorous looking inward — required to write a genuine artist statement, and essential to developing as a creative with an authentic point of view.`, audioPrompt: `Writing an artist statement requires self-examination, {name} — looking honestly at what you actually make and why, rather than what you think you should say. What subjects keep returning in your work? What are you trying to figure out? What do you hope a viewer feels or thinks after seeing it? These questions are harder than they look. But the process of answering them — even imperfectly — teaches you something about your own work that you might not have known before you tried to articulate it.` },
            { word: `lens`, definition: `A way of seeing — in the context of an artist statement, the perspective or frame the statement provides to help viewers understand and engage more deeply with the work.`, audioPrompt: `A great artist statement gives viewers a lens, {name} — a way of looking at the work that helps them see more than they would have on their own. It doesn't explain the work away or tell the viewer what to think. It says: here is where I'm coming from, here is the question I'm asking. With that, the viewer enters the work with more to bring to it. The lens makes the encounter between the viewer and the work richer. That's all a statement has to do.` },
          ],
        },

        {
          ...
          paragraphs: [
            `Great work **poorly documented** is invisible — especially for digital portfolios. Key principles: photograph artwork in **good, even light** without shadows falling across it. For flat work, shoot **straight on** rather than at an angle — any tilt distorts the proportions. Edit photos to **accurate colour** — what you show should look like the original. For three-dimensional work, photograph from multiple angles. For performance or process-based work, **video documentation** matters. Consider **scanning** flat work rather than photographing, for maximum accuracy. The documentation quality communicates as much about your professionalism as the work itself. A great piece presented poorly tells the viewer: *I don't care enough about this to show it properly.* Documentation is part of the creative practice.`,
          ],
          image: `/explorer-assets/creative-arts/l19-magazine-4.png`,
          imageCaption: `Documentation quality communicates professionalism — great work presented poorly tells viewers you don't care`,
          vocab: [
            { word: `documentation`, definition: `The process of photographing, scanning, or recording your artwork to create an accurate digital or print record — which is as important as the work itself for a portfolio.`, audioPrompt: `Great work poorly documented is almost invisible, {name} — especially online, where the image is all the viewer has. A painting photographed with harsh shadows falling across it, or a drawing scanned at low resolution, communicates: I don't care enough about this to show it well. Documentation quality is part of the work. It says as much about your professionalism and pride in what you've made as the work itself does.` },
            { word: `accuracy`, definition: `How faithfully a photograph or scan represents the original work — preserving the true colors, proportions, and details so the viewer sees what was actually made.`, audioPrompt: `Color accuracy matters in documentation, {name} — if a painting looks orange on screen but is actually red in person, the viewer is seeing a different work than you made. Shooting in consistent good light, editing to match the original, shooting straight-on to avoid distortion: these are the decisions that create accuracy. A viewer who eventually sees the original should feel like the documentation prepared them correctly. Accuracy is respect for the work — and for the viewer.` },
            { word: `professionalism`, definition: `The quality of presenting your work with care, consistency, and attention to detail — which communicates that you take both your work and your audience seriously.`, audioPrompt: `Professionalism in a portfolio doesn't mean formal or corporate, {name} — it means consistent, considered, and clearly cared-for. Consistent image quality. Accurate color. A clear layout. Work presented in a way that says: I made this carefully, and I'm presenting it carefully too. Even if you're twelve years old and this is your first portfolio, you can bring professionalism to it. The habit of presenting your work well is one you'll use your whole creative life.` },
          ],
        },
