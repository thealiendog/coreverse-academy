      ...
      screens: [
        {
          id: `l10-welcome`,
          type: `welcome`,
          guideText: `{name}. Last lesson we asked how to reason through the hardest choices medicine creates. Today we turn to one of the deepest questions about knowledge itself, and one of the most useful you will ever think about: what actually makes science work? You have used science your whole life. It is behind the medicine that heals you, the screen you are reading this on, the understanding of the stars I love so much. But here is the question almost nobody stops to ask: WHY does it work so well, and what makes it different from all the other things that claim to explain the world? Astrology claims to explain your life. A confident person online claims to explain what's "really" going on. A advertisement claims its product is "scientifically proven." So what separates real science from a convincing impostor wearing its clothes? That question matters more than almost anything else in this band, because you live in a world overflowing with claims — some genuinely backed by careful evidence, and some that have simply borrowed the words "study," "proven," and "expert" to sound trustworthy while being nothing of the kind. Learning to tell the difference is one of the most protective skills a thinking person can have. So today is not a science class about facts. It is about science itself: how it builds knowledge, why it is so trustworthy, why "science changed its mind" is a strength rather than an embarrassment, and — honestly — where its real limits lie. Let's understand the most powerful knowledge-machine humans have ever built.`,
