      ...
      screens: [
        {
          id: `l08-welcome`,
          type: `welcome`,
          guideText: `{name}, why does a fire feel hot? Why does an instant cold pack turn icy when you snap it? Why does anything happen at all, why do some reactions burst into flame while others need constant heating to go, and some never go no matter what? Behind all of these lies one of the deepest sets of ideas in all of science: thermodynamics, the study of energy and how it flows. In the last lessons you learned what matter is made of and how to count it. Now we ask what drives matter to change. The central insight is that every chemical reaction is also an energy story. Reactions either release energy to their surroundings (which we feel as heat or see as light) or absorb energy from them (which feels cold). Behind this is the energy stored in chemical bonds: breaking bonds takes energy, forming bonds releases it, and the balance between the two decides whether a reaction warms or cools the world around it. We'll also meet a profound idea called entropy, the universe's relentless tendency toward disorder and spreading-out, which, along with energy, governs which way change naturally flows. By the end you'll understand why fire is hot, why ice melts, why your body needs constant fuel, and the astonishing fact that the same laws of energy govern a candle flame, a living cell, and the fate of the entire universe. Onward.`,
