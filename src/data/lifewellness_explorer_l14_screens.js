  ...
  lessons: [
    {
      ...
      screens: [
...

        {
          ...
          type: `magazine`,
          section: 2,
          headline: `Blood: what it carries`,
          paragraphs: [
            `Blood is a complex fluid doing remarkable work. **Red blood cells** carry oxygen throughout your body using haemoglobin — what gives blood its red colour. **White blood cells** carry out immune function. **Platelets** enable clotting when you bleed. **Plasma** (the liquid base) carries nutrients, hormones, waste products, and proteins. Your body produces approximately **2 million new red blood cells every second** in your bone marrow — replacing the ones that reach the end of their roughly 120-day lifespan. Your blood is a constantly renewed system.`,
          ],
...

        {
          ...
          type: `magazine`,
          section: 4,
          headline: `Building a strong heart now`,
          paragraphs: [
            `Heart health is built through habits that compound over time. **Aerobic exercise** (running, swimming, cycling, dancing) strengthens the heart muscle and improves its efficiency — making each beat do more work with less effort. **An eating pattern rich in vegetables, fruits, whole grains, fish, nuts, and olive oil** protects blood vessels. **Avoiding smoking and secondhand smoke** is non-negotiable. **Managing stress** through breathing, movement, and connection protects against chronic inflammation. **Consistent sleep** gives your heart the recovery time it needs. The habits you build right now are genuinely building the heart you'll have for life.`,
          ],
