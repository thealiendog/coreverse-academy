  ...
  lessons: [
    {
      ...
      screens: [
...

        {
          ...
          vocab: [
            { word: `self-knowledge`, definition: `Understanding of your own feelings, values, and inner life — which making art can develop, because the process of creating forces you to examine what you actually think and feel.`, audioPrompt: `Making art teaches you things about yourself you didn't know before you started, {name}. When you try to write a poem about a feeling, you discover what you actually feel — not the simple version, but the complicated real one. When you paint something you love, you find out which details matter most to you and why. Art is a way of knowing from the inside out. It's one of the most honest forms of self-examination there is.` },
            { word: `discovery`, definition: `The experience of finding out something new through the act of making — what creation offers beyond expression, revealing things the artist didn't know they knew or felt.`, audioPrompt: `Creation is discovery, {name} — not just expression of something you already know, but exploration of something you don't yet understand. Artists consistently describe making work as a way of finding out: what do I think? What do I actually feel? What matters to me and why? The work teaches them things the thinking alone couldn't reach. That's one of the most beautiful and least talked about things about making: you go in with one understanding and come out with another.` },
            { word: `authentic`, definition: `True to your own experience, feelings, and perspective — neither performed for an audience nor shaped by what you think you're supposed to say.`, audioPrompt: `Authentic work rings differently, {name} — there's a quality to art made from real experience and genuine feeling that an audience recognizes even when they can't name it. It doesn't perform. It doesn't say what it's supposed to say. It says what's actually true for the person who made it. That quality is available to anyone willing to look honestly at their own life and make from what's actually there. Authenticity isn't a style. It's a commitment to telling the truth.` },
          ],
        },

        {
          ...
          vocab: [
            { word: `specificity`, definition: `The quality of being particular and precise — using your exact, specific experience rather than generalizing — which, in art, paradoxically creates the most universal resonance.`, audioPrompt: `The more specific you are, {name}, the more universal your work becomes. Not "loss" but this particular loss. Not "a community" but this street, these people, this specific thing they said. Specificity is the difference between art that describes and art that creates a felt experience. The reader who has never been to your neighborhood will recognize the truth of a specific, honest portrait of it — because the specificity makes it real, and real things connect across distance.` },
            { word: `raw material`, definition: `The source material an artist draws from — which, for many of the greatest artists, is their own experience, identity, history, and perspective.`, audioPrompt: `Your life is your raw material, {name} — everything you've experienced, everyone you've come from, every place you've belonged to or longed for. Frida Kahlo used her pain and her Mexican identity. Basquiat used his experience of being Black and young in a white art world. Langston Hughes used the sound and spirit of Harlem. What's particular to you — your culture, your family, your specific joys and difficulties — is not a limitation on what you can make. It's the richest material you have.` },
            { word: `universality`, definition: `The quality of art that speaks to shared human experience — often reached, paradoxically, through highly specific and personal expression rather than through generality.`, audioPrompt: `What reaches the most people, {name}, is almost never the most general statement — it's the most specific, honest one. The poem written about one particular grandmother in one particular kitchen connects to people who never met her, in kitchens completely unlike the one described, because the feeling underneath the specifics is one they recognize. That's universality: not the broadest statement, but the most true one. Specificity and universality aren't opposites. The most specific thing you can say is often the most universal thing anyone has ever heard.` },
          ],
        },

        {
          ...
          vocab: [
            { word: `artistic voice`, definition: `The distinctive way an artist sees and expresses things — the combination of choices, subjects, and sensibilities that makes their work recognizably theirs.`, audioPrompt: `Artistic voice is what makes Van Gogh's paintings impossible to mistake for anyone else's, {name} — or Basquiat's, or Kahlo's. It's not just style: it's the combination of what you're drawn to, how you use your medium, what you keep returning to, and how your way of seeing shapes everything you make. Voice isn't found. It emerges from making — slowly, through many works, through trying things and finding what feels most true. You're developing yours right now, in everything you create.` },
            { word: `emerge`, definition: `To develop gradually through a process — used to describe how artistic voice develops naturally through sustained making rather than being consciously chosen or designed.`, audioPrompt: `Voice emerges, {name} — it isn't decided. You can't sit down and choose what your artistic voice will be. But you can make things, consistently and honestly, and notice what keeps appearing. Which subjects you return to. What choices feel inevitable rather than effortful. What seems most truly yours rather than borrowed from an artist you admire. These patterns are your voice developing. Making is the only way to let it emerge — and it takes more time than most people expect.` },
            { word: `imitation`, definition: `Creating work in the style of another artist — a legitimate and valuable learning tool, but something that must eventually give way to developing your own original voice.`, audioPrompt: `Every artist begins by imitating, {name} — copying the artists you love is how you learn their techniques, internalize their decisions, understand how they solved problems you'll face. There's no shame in it; it's how all creative disciplines are learned. The important thing is knowing that imitation is a stage, not a destination. At some point, you stop trying to paint like your favorite artist and start finding what only you would paint. The imitation was never the point — it was the path.` },
          ],
        },

        {
          ...
          vocab: [
            { word: `connection`, definition: `The meeting point between an artwork and a viewer — where something true in the work is recognized as something true in the viewer's own experience.`, audioPrompt: `Connection is what happens when a work reaches you, {name} — when you read a poem and feel "yes, exactly that," when you see a painting and something in it mirrors something in you. That moment of recognition is what art lives for. The artist made something from their own experience, honest and specific. You encounter it and find something of yours inside it. That's connection — two people's inner lives briefly meeting through what one of them made.` },
            { word: `resonance`, definition: `The quality of art that continues to affect and stay with a viewer after they've finished experiencing it — a deep emotional or intellectual impact that echoes beyond the moment of encounter.`, audioPrompt: `Resonance is what stays, {name} — the quality of a work that follows you after you've left it. You finish reading the poem and you're still in it. You walk away from the painting and it's still with you three days later. Resonance happens when a work touches something deep and real — when the truth in it matches something the viewer has been carrying without having words for it. The most resonant works feel like they've always been there, waiting to be found.` },
            { word: `gift`, definition: `Art understood as something given to others — the idea that making something true from your own experience, and sharing it, offers other people a meeting place for their own feelings.`, audioPrompt: `Making something true is a gift, {name} — even if that's not how it started. When you write honestly about your experience, you give other people permission to feel what they've been feeling alone. The person who reads your poem and thinks "I didn't know anyone else felt this way" — you've given them something. Your most personal work is your most universal gift. What you think is too small or too specific to matter to anyone else is often exactly what reaches people most deeply.` },
          ],
        },
