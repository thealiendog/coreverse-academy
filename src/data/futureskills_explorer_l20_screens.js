  ...
  lessons: [
    {
      ...
      screens: [

        {
          id: `l20-welcome`,
          type: `welcome`,
          guideText: `{name}. This is our final lesson together — and I saved the best for last. We've covered coding, AI, cybersecurity, robotics, game design. But everything we've talked about started the same way: with someone who looked at the world and thought, there has to be a better way. That's innovation. And it's not just for famous inventors or tech billionaires. It's a skill — one you can develop starting right now. Let's close this out strong. Here we go.`,
...

        {
          ...
          type: `magazine`,
          section: 2,
          headline: `Invention vs innovation`,
          paragraphs: [
            `**Invention** is creating something that didn't exist before — a new device, a new material, a new formula. **Innovation** is taking what exists and applying it in a way that creates new value. The wheel was an invention. Attaching it to a cart to carry goods was innovation. A vacuum designer built over five thousand prototypes before finding a design that worked — that relentless iteration is innovation in action. Isaac Newton built on centuries of earlier mathematics. Thomas Edison's laboratory worked as a team of inventors, not a lone genius. Great ideas almost always come from **collaboration** and many **failed attempts**.`,
          ],
...

        {
          ...
          type: `magazine`,
          section: 3,
          headline: `The innovator's mindset`,
          paragraphs: [
...

        {
          ...
          type: `magazine`,
          section: 4,
          headline: `The problems waiting for you`,
          paragraphs: [
            `The world in 2025 has no shortage of problems that need innovative solutions: climate change, diseases, food security, access to clean water, mental health support at scale. Many of the tools that will be used to address these problems haven't been invented yet — and some of the people who will build them are in school right now. The skills you've built across these twenty lessons — critical thinking, digital literacy, creativity, data reasoning, and understanding technology — are exactly the foundation that innovators need. The question isn't whether the world needs new ideas. It's whether you're ready to start building them.`,
          ],
...

        {
          ...
          buckets: [
            {
              id: `innovator`,
              label: `💡 Innovator's Mindset`,
              color: `#34D399`,
            },
            {
              id: `not-mindset`,
              label: `🚧 Not the Right Mindset`,
              color: `#F59E0B`,
            },
          ],
          items: [
...

        {
          id: `l20-realworld`,
          type: `real-world`,
          guideText: `Innovators work in every field — medicine, education, energy, food, transport, and more. The skills that make someone a great innovator — curiosity, persistence, cross-field thinking, and comfort with failure — are the same skills you've been building across all twenty Future Skills lessons.`,
          ...
          creativePrompt: `Think of one problem you've noticed in your school, home, or community — something that could work better. Write down: What is the problem? Who does it affect? What already exists that might be part of a solution? What new combination or approach could you try?`,
        },
