  ...
  lessons: [
    {
      ...
      screens: [
        ...
        // ── 2. MAGAZINE — §1 ────────────────────────────────────────────────
        {
          ...
          section: 1,
          content: {
            heading: `The journey begins: mouth to stomach`,
            body: `Digestion starts in your **mouth** — not your stomach. Chewing breaks food into smaller pieces, and saliva begins chemically breaking down carbohydrates with enzymes. Chewing more thoroughly is one of the simplest ways to improve digestion. Food travels down the **oesophagus** (a muscular tube) to the **stomach**, which churns food with hydrochloric acid and digestive enzymes into a liquid called **chyme**. The stomach also kills most bacteria in food. This initial process takes around 2–4 hours — and it's already well underway by the time you finish eating.`,
            image:   '/explorer-assets/wellness/l13-magazine-1.png',
            caption: `Digestion starts in your mouth — chewing and saliva are doing real work before food reaches the stomach`,
          },
        },
        ...
        // ── 6. INTERACTIVE — Drag-match ─────────────────────────────────────
        {
          ...
          config: {
            buckets: [
              { id: 'supports', label: `🌱 Supports Healthy Digestion`,  color: '#34D399' },
              { id: 'disrupts', label: `😬 Can Disrupt Digestion`,       color: '#F87171' },
            ],
            items: [
              {
                id:            'l13-g1',
        ...
        // ── 7. QUIZ ──────────────────────────────────────────────────────────
        {
          ...
          questions: [
            ...
            // Q5 — Fill-blank (fresh)
            {
              ...
              options:      ['villi', 'cilia', 'enzymes', 'glands'],
              correctIndex: 0,
        ...
        // ── 8. REAL-WORLD ────────────────────────────────────────────────────
        {
          ...
          type: 'real-world',
          content: {
            scenario:    `Gut Health Day`,
            description: `Today, try eating one meal slowly — put down anything you're doing, take your time, chew properly. Notice if it feels different. Then try adding one fermented food (yogurt, kefir, or sauerkraut) sometime this week.`,
