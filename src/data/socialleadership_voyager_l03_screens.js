  ...
  lessons: [
    {
      ...
      screens: [
...

        {
          ...
          paragraphs: [
            `Trust in groups operates differently from one-on-one trust. Groups develop "trust climate" — the general expectation about whether vulnerability is safe. Amy Edmondson's research on psychological safety (covered in Lesson 10 of the Future Skills Voyager band) is closely related: psychologically safe groups are ones where people trust that taking interpersonal risks (asking questions, admitting mistakes, raising concerns) won't be punished.`,
