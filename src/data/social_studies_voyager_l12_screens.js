      ...
      screens: [
        {
          id: `l12-welcome`,
          type: `welcome`,
          guideText: `{name}, you understand how individual governments are built and how they act. Now comes one of the deepest questions in all of political life: how do sovereign nations, with no global government above them and no court that can compel them, manage to cooperate at all? And why, despite centuries of effort, does violent conflict persist? International relations is the study of how states interact, through diplomacy, treaties, alliances, war, and international institutions, and the theories that try to explain why they do what they do. This is where some of the oldest, deepest debates in politics live. Realists argue that nations always pursue their own power and security in a world where no one can fully be trusted, and that cooperation is always fragile. Liberals argue that shared interests, institutions, and interdependence can produce lasting peace and cooperation. Constructivists argue that ideas, identities, and norms matter as much as material power, and that what states want and value can change over time. None of these theories explains everything, but each captures something real. You've already seen foreign policy, the decisions individual governments make about how to act in the world. International relations asks the broader questions underneath those decisions: what are the forces that shape how nations relate, what makes war more or less likely, what makes cooperation possible or impossible, and what role institutions like the United Nations play? Latin America has been deeply affected by international relations, through colonial empires, Cold War proxy conflicts, U.S. interventions, regional integration efforts, and the ongoing challenges of sovereignty in a world where powerful nations make decisions that reach everywhere. This lesson maps the key ideas: the nature of the international system, the tools nations use to manage it, the causes and character of conflict, and the role of institutions and norms. And because international relations theory generates some of the most fundamental disagreements in political thought, we'll end with a real debate among competing visions of how nations can, should, or inevitably will relate to each other. Onward.`,
