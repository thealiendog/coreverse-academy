  ...
  lessons: [
    {
      ...
      screens: [
        ...
        // ── 6. INTERACTIVE — Drag-match ─────────────────────────────────────
        {
          ...
          config: {
            buckets: [
              { id: 'calm',    label: `🌿 Helps Your Body Find Calm`,  color: '#34D399' },
              { id: 'on-edge', label: `⚡ Keeps Your Body on Edge`,    color: '#F87171' },
            ],
            items: [
              {
                id:            'l07-g1',
        ...
        // ── 7. QUIZ ──────────────────────────────────────────────────────────
        {
          ...
          questions: [
            ...
            // Q5 — Fill-blank (fresh)
            {
              ...
              options:      ['same', 'different', 'longest', 'shortest'],
              correctIndex: 0,
        ...
        // ── 8. REAL-WORLD ────────────────────────────────────────────────────
        {
          ...
          type: 'real-world',
          content: {
            scenario:    `Breathing Practice`,
            description: `Try box breathing right now before you put this down — four rounds, about 90 seconds. Notice how you feel before and after. Then try it once tomorrow morning before school.`,
            ...
            realWorldConnection: `Box breathing is used by Navy SEALs, surgeons, athletes, and first responders — people whose jobs require staying calm under extreme pressure. The same tool available to them is available to you, right now, with no equipment required.`,
          },
        },
