      ...
      screens: [
        {
          id: `l10-welcome`,
          type: `welcome`,
          guideText: `{name}, welcome to physics, the most fundamental science of all, the study of matter, motion, energy, and the basic laws that govern the entire universe. Everything you've learned so far, from cells to atoms to reactions, ultimately rests on physics. And we begin where physics itself began: with motion. How do things move? It seems simple, you walk, a ball falls, a car drives, but describing motion precisely, mathematically, was one of humanity's greatest intellectual breakthroughs, the foundation Galileo and Newton built modern science upon. This is kinematics: the science of describing motion exactly, without yet worrying about what causes it. We'll learn the precise language: position (where something is), displacement (how far and in what direction it moved), speed and velocity (how fast, and velocity includes direction), and acceleration (how quickly velocity changes). You'll discover the crucial difference between speed and velocity, why a car going around a curve at constant speed is still accelerating, and the beautiful, surprising truth Galileo uncovered: that all objects fall at the same rate regardless of their weight, a hammer and a feather hit the ground together when there's no air. We'll learn to read graphs of motion and to predict exactly where a moving object will be and when. By the end, you'll be able to describe any motion with the precision and power of mathematics, the language in which the laws of the universe are written. Onward.`,
