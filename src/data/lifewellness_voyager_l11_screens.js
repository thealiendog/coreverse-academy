      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            {
              word: `autonomy development`,
              definition: `The normal developmental process through which adolescents separate from family identity to develop their own. The process involves disagreement, pushing back, identity experimentation, and renegotiation of childhood patterns. Parents who interpret this as personal rejection are often wrong; it is developmental work that must happen for adolescents to become functional adults.`,
              audioPrompt: `Autonomy development is the normal developmental process through which adolescents separate from family identity to develop their own, {name}. Across cultures and history, adolescents have needed to go through this separation process. The process involves disagreement, pushing back on what was accepted in childhood, identity experimentation, and renegotiation of patterns that were settled earlier. Parents who interpret this as personal rejection are often wrong. A parent saying "you're becoming someone I don't recognize" is often describing their own difficulty with their child's individuation, not an accurate assessment of what's happening with the child. The developmental work has to happen for adolescents to become functional adults. Adolescents whose autonomy development is suppressed — who learn to avoid conflict by agreeing with whatever parents say, or who are overcontrolled to the point of not developing distinct identity — emerge with less developed sense of self and more difficulty navigating adult relationships. The lesson frames this as a reason that some conflict during adolescence is not just normal but functional: it is the mechanism by which the autonomy development happens. The skill isn't avoiding the conflict but navigating it in ways that serve the developmental work without unnecessary damage to the relationship.`,
            },
            {
              word: `limbic reactivity`,
              definition: `The emotional reactivity driven by the limbic system, which often increases during adolescent brain reorganization before the prefrontal cortex's executive control catches up. The pattern is biological rather than a character failure, producing a period of intense emotional experience with less-than-adult capacity to regulate it.`,
              audioPrompt: `Limbic reactivity refers to the emotional reactivity driven by the limbic system, which increases during adolescent brain reorganization in ways that executive control does not yet match, {name}. The adolescent brain is dramatically reorganizing, particularly the prefrontal cortex involved in executive function, impulse control, and long-term planning, and the limbic system involved in emotional reactivity. The reorganization happens at different rates: emotional reactivity often increases before executive control catches up. This produces a period of intense emotional experience with less-than-adult capacity to regulate it. The pattern isn't failure; it's biology. Adolescent emotional intensity during this period is partly a reflection of this mismatch — more reactive limbic responses that the prefrontal system isn't fully equipped to manage yet. The lesson uses this as a reframing: understanding the biological basis of emotional intensity during adolescence shifts the explanation from "something is wrong with me" or "something is wrong with them" to "this is a specific developmental process with a specific biological substrate." That reframing doesn't eliminate the difficulty, but it changes what kind of response it warrants.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `authoritative parenting`,
              definition: `The parenting style combining high warmth with high demandingness: warm, responsive parents who also have clear expectations and structure. Research consistently shows authoritative parenting produces the best outcomes across measures — better mental health, better academic outcomes, better relationships, and better adolescent autonomy development.`,
              audioPrompt: `Authoritative parenting combines high warmth with high demandingness, and research consistently shows it produces the best outcomes across measures, {name}. Warm, responsive parents who also have clear expectations and structure. The combination matters: warmth without structure produces its own problems; structure without warmth produces different problems. Authoritative parents discuss expectations rather than just imposing them, respect adolescent emerging autonomy while maintaining standards, and adjust as kids develop. Research shows this style produces better mental health, better academic outcomes, better relationships, and better adolescent autonomy development compared to the other styles. What this implies for adolescents who don't have authoritative parents: recognizing the style you're navigating shifts your understanding from "what's wrong with me or them?" to "this is a specific pattern with specific dynamics." Parents operate from their own patterns, often unconsciously, often inherited from their own families. Recognizing the style doesn't change the parents, but it changes what interventions make sense. Some parents are open to feedback about what works ("I'd like to be able to discuss expectations rather than just receive them"); others are not. Recognizing the pattern is the first step toward navigating it skillfully regardless.`,
            },
            {
              word: `overcontrolling parenting`,
              definition: `A parenting pattern in which involvement intensifies into control — tracking location, reading communications, scheduling most of a child's time, making decisions about friends and activities. Research has identified this pattern as producing specific harms in adolescents even when motivated by genuine love: increased anxiety, decreased self-efficacy, identity development problems, and a damaged parent-child relationship.`,
              audioPrompt: `Overcontrolling parenting is a pattern in which parental involvement intensifies into control, and research has identified specific harms it produces in adolescents, {name}. Constant location tracking. Reading texts and social media. Scheduling nearly every hour of a child's time. Making decisions about friends, activities, and style. The pattern is often motivated by genuine love — the parent usually does love the child. Love and overcontrol can coexist; the love doesn't make the overcontrol healthy. Research identifies the specific harms: increased anxiety, decreased self-efficacy, identity development problems, damaged parent-child relationship. The "I'm doing it because I love you, you'll thank me later" framing is how the pattern maintains itself; it makes the kid feel guilty for noticing harm. The lesson frames the anxiety produced by overcontrolling parenting as information, not ingratitude: the "can't breathe" feeling is pointing to something real. Adolescents need a developmentally appropriate amount of autonomy to develop normally; not getting it produces real costs. The appropriate responses involve specific conversation about specific autonomy, possibly with outside facilitation (school counselor, family therapy), while maintaining the relationship. If the controlling behavior escalates significantly or affects mental health seriously, professional support is warranted.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `triangulation`,
              definition: `A family systems pattern in which two family members in conflict draw in a third — often a child — to manage the tension between them. This puts the third person in an impossible position, taking on the emotional burden of a conflict that is not theirs to resolve.`,
              audioPrompt: `Triangulation is a family systems pattern in which two family members in conflict draw in a third to manage the tension between them, {name}. Often the third person is a child. The dynamic puts the child in an impossible position: carrying emotional burden for a conflict that belongs to the other two people, unable to satisfy both parties fully, and often being asked to take sides or absorb stress that the adults haven't found a way to manage between themselves. Murray Bowen's family systems theory identified triangulation as one of the core patterns in family dynamics. It operates largely unconsciously: the two people in conflict don't usually intend to harm the third by including them. But the effect on the third person is real. Children triangulated into parental conflict often develop parentification patterns — taking on emotional support and mediation roles beyond what's appropriate for their age. Recognizing triangulation as a systemic pattern shifts the understanding from "I'm the problem" or "I need to fix this" to "this is a pattern happening to me that I didn't cause and can't fix by trying harder." The appropriate response involves naming the pattern (with a trusted adult, counselor, or therapist), reducing participation in the triangle where possible, and recognizing that the conflict belongs to the other parties.`,
            },
            {
              word: `intergenerational patterns`,
              definition: `Family patterns that reproduce across generations: the family a child grows up in was shaped by patterns from the parents' own families of origin, and those patterns will influence any future families the child creates. Recognizing intergenerational patterns is itself a significant insight within family systems theory.`,
              audioPrompt: `Intergenerational patterns are family patterns that reproduce across generations, {name}. Family systems theory, developed by Murray Bowen and elaborated by subsequent family therapists, treats this transmission as one of the core mechanisms of family dynamics. The family you grew up in was shaped by patterns from your parents' own families of origin — what was discussable and undiscussable, how conflict was handled, who played which roles, what relationship to authority and emotion was modeled. Your parents often operate from these patterns unconsciously, having absorbed them without examining them. The same is true of their parents. And your patterns, unless examined and changed, will shape future families if you create them. This is not determinism. Patterns can be recognized, examined, and changed — particularly with deliberate attention and sometimes with professional support. But recognizing them as patterns, rather than as just the way things are, is a significant shift. It means that some of what feels personal in your family may actually be patterns operating across multiple people across multiple generations. It means that understanding your family requires understanding where they came from. And it means that the work of examining these patterns during adolescence is not just about navigating your current family better — it's about interrupting patterns that would otherwise reproduce.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `family loyalty framing`,
              definition: `The cultural expectation that children should remain loyal to family regardless of what happens within it. The lesson identifies this framing as one that can be weaponized to prevent children from seeking help they need. Family loyalty has appropriate places, but requiring children to protect adult harm is not one of them.`,
              audioPrompt: `The family loyalty framing is the cultural expectation that children should remain loyal to their family no matter what, {name}. It appears in many cultures and many families: "you don't tell outsiders what happens in this family," "family comes first always," "we handle things ourselves." The lesson identifies this framing as something that can be weaponized — used intentionally or unintentionally to prevent children from seeking help they need. Family loyalty has appropriate places. Maintaining relationships through ordinary difficulty, keeping appropriate family privacy, working through conflict rather than abandoning it. These are legitimate expressions of family loyalty. It is not appropriate to require children to protect adult harm. Abuse, neglect, domestic violence, parental substance abuse affecting the household — these are situations where reaching out for outside help is not betrayal. It is appropriate response to situations that need outside support. The lesson frames this explicitly because the family loyalty framing is often the mechanism by which children in genuinely harmful family situations remain in them without help. Trusting your perception that something isn't right, and checking with a trusted adult outside the family about whether what you're experiencing is normal, is appropriate — and is not a violation of family loyalty that has any legitimate claim on you.`,
            },
            {
              word: `gaslighting`,
              definition: `A form of emotional manipulation in which someone causes another person to doubt their own perceptions, memory, or judgment. The lesson notes that adults can harm in subtle ways — including gaslighting — that warrant attention even when they don't reach the threshold for formal abuse reporting.`,
              audioPrompt: `Gaslighting is a form of emotional manipulation in which someone causes another person to doubt their own perceptions, memory, or judgment, {name}. The term comes from the 1944 film in which a husband manipulates his wife into thinking she's losing her mind. In family contexts, gaslighting can take forms like "that never happened," "you're too sensitive," "you're imagining things," or "you're being crazy." The effect is that the person on the receiving end stops trusting their own perceptions and becomes dependent on the manipulator's version of reality. The lesson notes this in the context of family situations warranting outside help: adults can harm in subtle ways, including emotional manipulation and gaslighting, that warrant attention even when they don't reach the threshold for formal abuse reporting. Recognizing gaslighting as a real pattern shifts what's happening from "I'm too sensitive" or "I'm wrong" to "something real is happening here that is affecting my ability to trust my own perceptions." Checking with a trusted adult outside the family, or with a therapist, about whether what you're experiencing is normal is appropriate and important — and is exactly the kind of outside perspective that counteracts gaslighting's specific mechanism of making you doubt yourself.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `cutting off family`,
              definition: `The option of establishing significant distance or complete separation from a family member or relationship. The lesson notes this is not the default response to ordinary family difficulty; most family relationships involve ongoing work across decades. Cutting off may be warranted when harm is severe enough that proximity is damaging, but should be a later option rather than a first response.`,
              audioPrompt: `Cutting off family is the option of establishing significant distance or complete separation from a family member or relationship, {name}. The lesson makes a specific point about this: none of the case study responses involve cutting off family, because the cases represent ordinary family difficulty rather than situations warranting that response. Some family relationships do warrant distance or cutoff — when the harm is severe enough that ongoing proximity is damaging, when safety requires it, when patterns are entrenched and professional assessment recommends it. But most family relationships involve ongoing work across decades, and cutting off is a permanent response to what is often a workable difficulty. The lesson presents the frameworks — developmental dynamics, parenting styles, family systems, safety thresholds — precisely to build the capacity to stay engaged with family relationships while navigating them skillfully, rather than either suppressing everything or cutting off. The more skillful approaches involve specific conversation about specific issues, possibly with outside facilitation, recognition of what's developmentally normal, and knowing when to seek professional support. Cutting off should be a later option considered with care and often with professional input, not the reflexive first response to family difficulty that's real but workable.`,
            },
            {
              word: `de-escalation`,
              definition: `Skills for reducing emotional intensity during conflict, preventing a disagreement from spiraling into a damaging fight. In adolescent-parent conflict, specific de-escalation practices include not matching the other person's escalation, recognizing when emotional reactivity is taking over and slowing down, and using brief acknowledgment after conflicts rather than pretending they didn't happen.`,
              audioPrompt: `De-escalation refers to skills for reducing emotional intensity during conflict to prevent a disagreement from spiraling into a damaging fight, {name}. In adolescent-parent conflict specifically, the lesson identifies specific de-escalation practices grounded in the developmental dynamics. When conflicts happen, try not to match the escalation. When a parent's tone becomes harsh, matching harshness increases the intensity. Recognizing when your own emotional reactivity — the limbic system getting ahead of the prefrontal cortex — is taking over, and deliberately slowing down, is itself a de-escalation skill. The family pattern Riley experiences in the case — fights that escalate quickly and then get pretended away — has a specific skill-building opportunity: after conflicts, instead of pretending they didn't happen, try a brief acknowledgment like "I love you, that fight was hard, can we talk about it tomorrow when we're both calmer?" This small structural change addresses both the escalation and the suppression cycle. Distinguishing specific disagreements (chores, screen time, grades, friends) from broader identity conflict getting mixed in is also a de-escalation practice: when conversations stay on specific concrete issues rather than spilling into "who you are" territory, they're easier to resolve.`,
            },
          ],
        },
