      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            {
              word: `glymphatic system`,
              definition: `A brain waste-clearance system discovered by Maiken Nedergaard in 2012 that clears metabolic waste from brain tissue primarily during deep slow-wave (N3) sleep. Because it operates mainly during deep sleep, cutting sleep short or disrupting N3 sleep reduces how effectively the brain clears waste accumulated during the day.`,
              audioPrompt: `The glymphatic system is a brain waste-clearance system discovered by Maiken Nedergaard in 2012, {name}. Terra here — during the day your brain is metabolically active, and that activity produces waste products that accumulate in brain tissue. The glymphatic system clears those metabolic waste products, and it does most of its work primarily during deep slow-wave sleep — the N3 stage. That is a specific and important finding: brain waste clearance isn't a continuous background process; it is concentrated in one particular sleep phase. This is one of the reasons cutting sleep short has consequences beyond just feeling tired. If you consistently get less deep sleep, your brain's waste-clearance function is compromised. Each cycle of the roughly 90-minute sleep structure tends to have more N3 deep sleep in the early cycles of the night, which means the first few hours of sleep are especially important for this function. Matthew Walker's research synthesis in "Why We Sleep" (2017) brought the glymphatic finding to wider attention, and while some specific claims in that book have been critiqued, the core architecture findings — including the importance of deep sleep for waste clearance — are well-established across hundreds of studies.`,
            },
            {
              word: `REM sleep`,
              definition: `Rapid Eye Movement sleep, the phase where most vivid dreaming occurs. During REM the brain is highly active while the body is paralyzed — which prevents acting out dreams. REM concentrates in the later cycles of the night, so cutting sleep short disproportionately reduces REM. Functions include memory consolidation and emotional regulation of the previous day's experiences.`,
              audioPrompt: `REM sleep stands for Rapid Eye Movement sleep — the phase where most vivid dreaming happens, {name}. Terra here — during REM your brain is highly active, producing the complex, narrative dreams most people remember. At the same time, the body is essentially paralyzed, which the text notes is actually useful because it prevents you from physically acting out the dreams your brain is generating. REM sleep is concentrated in the later cycles of the night. This has an important practical implication: if you sleep 6 hours instead of 8, you keep most of your deep N3 sleep from the early cycles, but you lose most of your REM sleep from the later cycles. So cutting sleep short doesn't reduce all sleep types proportionally; it disproportionately cuts REM. The functions REM performs include memory consolidation, where new information learned during the day gets stabilized and integrated — and emotional regulation, where REM sleep processes emotional experiences in ways that affect next-day mood and stress response. None of these functions can be reliably outsourced to other times; they happen during sleep, and specifically during REM. Understanding this makes the cost of chronic short sleep much more concrete than just "feeling tired."`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `sleep deprivation vulnerability`,
              definition: `Adolescent brains undergoing intense developmental work — including frontal lobe maturation and synaptic pruning — are more severely affected by chronic sleep loss than adult brains. According to the text, chronic sleep loss during adolescence is associated with worse academic performance, worse mood including increased depression and anxiety, worse executive function, increased risky behavior, and worse metabolic health.`,
              audioPrompt: `Sleep deprivation vulnerability refers to the heightened impact of sleep loss on adolescents compared to adults, {name}. Terra here — the text makes a specific argument about why this matters so much at your age. Adolescent brains are doing intense developmental work. That includes frontal lobe maturation, the part of the brain involved in planning, decision-making, and impulse control; and synaptic pruning, where the brain strengthens frequently-used neural connections and removes weaker ones. Both processes happen substantially during sleep. When sleep loss occurs alongside that developmental work, the effects are larger than they would be in an adult brain that has already completed most of that development. The text lists the specific associations documented in research: worse academic performance, worse mood with especially increased depression and anxiety, worse executive function, increased risky behavior, and worse metabolic health. These are not minor effects. And because adolescent brain development is happening on a particular timeline, sleep loss during this period cannot simply be made up for later — the developmental window has specific timing. This is one of the strongest reasons why the sleep habits you build now matter more than just how you feel tomorrow morning.`,
            },
            {
              word: `melatonin timing`,
              definition: `The hormone melatonin signals to the body that it is time to sleep. In adolescents, melatonin release is shifted approximately two hours later than in children or adults as a result of circadian phase delay. This biological shift — not willpower or behavior — sets the underlying timing of when adolescents feel ready to sleep, making it difficult to fall asleep early even when trying.`,
              audioPrompt: `Melatonin timing refers to when the body releases the hormone that signals it is time to sleep, {name}. Terra here — melatonin is not a sleeping pill; it is a biological signal that tells the brain and body that the time for sleep is approaching. In children and adults, melatonin release starts at a certain time in the evening. In adolescents, because of the circadian phase delay that occurs during puberty, melatonin release starts approximately two hours later. This is the biological mechanism behind why a typical adolescent body wants to fall asleep around 11pm to 1am rather than the 9 or 10pm that an earlier bedtime would require. When you try to fall asleep before your melatonin has started releasing, you are fighting against your biology, not showing weak willpower. The environment can interact with this timing. Screens emit blue-wavelength light that suppresses melatonin production, pushing the timing even later. Heavy caffeine after noon, late evening exercise, and late-day bright light can all make the biological delay worse. The biology sets the baseline; these behaviors can shift timing within that baseline. Understanding that the timing is biological rather than behavioral changes how to approach the problem — and explains why "just go to bed earlier" fails without addressing the underlying structural issues.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `orthosomnia`,
              definition: `Anxiety about achieving perfect sleep scores, often triggered by sleep tracking apps, that can itself worsen sleep. The term captures how an obsessive focus on sleep metrics can paradoxically disrupt the relaxed state needed for sleep onset. The text cites this as a reason why sleep tracker apps sometimes make sleep problems worse rather than better.`,
              audioPrompt: `Orthosomnia is anxiety about achieving perfect sleep scores that can itself worsen sleep, {name}. Terra here — the term comes from research on what happens when people use sleep tracker apps that score their sleep quality each night. For some users, checking low scores in the morning produces worry, and that worry carries into the next evening as pressure to sleep well, which activates the brain in ways that interfere with sleep onset. The irony is that the tool meant to improve sleep creates the condition that disrupts it. The text lists orthosomnia as one reason sleep tracker apps are not reliably helpful and sometimes actively harmful. More broadly, it illustrates a pattern: the wellness industry's sleep section sells products — apps, devices, supplements, teas, weighted blankets — that mostly have weak research support and in some cases produce their own problems. The practices that actually help sleep (consistent schedules, cool dark quiet environment, morning bright light, cutting late caffeine, phone outside the bedroom) are all behavioral and environmental. They don't require purchases. Recognizing this pattern helps you navigate the wellness industry's sleep products with appropriate skepticism while focusing on what the research actually supports.`,
            },
            {
              word: `caffeine half-life`,
              definition: `The time it takes for caffeine concentration in the body to fall by half — approximately 5 to 7 hours. Caffeine consumed at 3pm is still meaningfully active at 10pm. This pharmacokinetic fact, not personal tolerance, determines caffeine's impact on sleep quality, including on deep sleep even when sleep onset is not dramatically delayed.`,
              audioPrompt: `Caffeine half-life is the time it takes for caffeine concentration in the body to fall by half — approximately 5 to 7 hours, {name}. Terra here — this is a straightforward pharmacokinetic fact with a direct practical implication. If you consume caffeine at 3pm, roughly half of it is still in your system at 10pm when you are trying to fall asleep. That remaining caffeine is not inert; it is still actively blocking adenosine receptors, adenosine being the brain chemical that builds sleep pressure across the day. The text notes that many people feel they can "drink coffee at 4pm and still sleep" because they do fall asleep, but research shows sleep quality — particularly deep sleep — is reduced even when sleep onset is not dramatically delayed. The biology operates regardless of how you feel about it. The research-supported practice is cutting caffeine after early afternoon, which the text lists as one of the consistent sleep hygiene behaviors. This doesn't require willpower against the caffeine itself; it requires a structural decision about timing — not buying the afternoon coffee, not accepting the soda after noon. A small environmental change that respects the actual pharmacokinetics rather than operating on the assumption that personal tolerance overrides biology.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `blue light`,
              definition: `Short-wavelength visible light emitted substantially by smartphones, tablets, and laptops. Blue light suppresses melatonin production, delaying sleep onset. "Night mode" screen filters reduce but do not eliminate the effect. This is one of two distinct mechanisms by which screens harm sleep, the other being content stimulation that keeps the brain too activated to transition to sleep.`,
              audioPrompt: `Blue light is a short-wavelength visible light emitted substantially by smartphones, tablets, and laptops, {name}. Terra here — the text identifies two distinct mechanisms by which screens harm sleep, and blue light is the first. Blue-wavelength light suppresses melatonin production, the hormone that signals time to sleep, which delays the timing of sleep onset. So when you use a screen in the evening, you are exposing yourself to the type of light that most strongly suppresses the biological signal your brain needs to begin transitioning toward sleep. Night mode and screen filters help somewhat by shifting the color temperature away from blue toward warmer tones, but the text is clear that they don't eliminate the effect. The second mechanism is content stimulation: the content itself — social media, games, videos, messaging — activates the brain through interest, emotion, novelty, and sometimes anxiety, keeping it too activated to transition readily to sleep even when the blue light issue is partially addressed. Both mechanisms operate simultaneously during typical evening screen use. This is why stopping screens 60 to 90 minutes before intended sleep is listed as research-supported sleep hygiene: it addresses both the light suppression and the content stimulation, rather than only one of them.`,
            },
            {
              word: `conditioned arousal`,
              definition: `A learned association where the brain connects the bed with frustration and wakefulness rather than sleep, developed through repeated experience of lying awake in bed for long periods. Sleep medicine recommends getting out of bed when unable to sleep within 20–30 minutes and returning only when sleepy, specifically to prevent or reverse conditioned arousal.`,
              audioPrompt: `Conditioned arousal is a learned association where the brain connects being in bed with frustration and wakefulness rather than with sleep, {name}. Terra here — it develops through repeated experience. If you consistently lie in bed unable to fall asleep for long stretches, the brain learns to associate that specific context — being in that bed in that room — with the state of being awake and frustrated. Over time, getting into bed itself can trigger alertness rather than sleepiness, because that is what the brain has learned the situation predicts. Sleep medicine has a specific response to this: if you cannot fall asleep within roughly 20 to 30 minutes, get out of bed, go to another room, do something boring in dim light, and return only when you actually feel sleepy. This preserves the association between bed and sleep rather than bed and wakefulness. The text names this in the context of the case study about trying to force an earlier bedtime without addressing structural issues. Lying in bed awake for hours, night after night, is not a harmless neutral waiting period; it is actively teaching the brain a pattern that makes falling asleep harder over time. Understanding conditioned arousal explains why "try harder to sleep" often makes things worse, while structural changes that address the actual causes work better.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `social jet lag`,
              definition: `A biological pattern produced by large shifts between weekend and weekday sleep schedules, similar to traveling across time zones. Research finds chronic social jet lag is associated with worse mood, cognitive performance, and metabolic health. Weekend catch-up sleep partially helps but does not fully repair weekday sleep deficit and produces its own disruption through schedule variation.`,
              audioPrompt: `Social jet lag is the biological disruption produced by large weekend-to-weekday sleep schedule shifts, {name}. Terra here — when you sleep significantly later on weekends than on weekdays, your body experiences a timing mismatch similar to traveling across time zones, with the predictable consequences: Sunday-night difficulty falling asleep and Monday-morning exhaustion. The text names research showing that chronic social jet lag is associated with worse mood, worse cognitive performance, and worse metabolic health over time — these are not minor inconveniences but documented health effects of the schedule variation itself. Weekend catch-up sleep partially helps, but research finds it does not fully repair weekday sleep deficit: cognitive, metabolic, and mood effects of chronic weekday sleep deprivation are not completely reversed by sleeping extra hours on weekends. The research-informed response is to fix both sides. Increase weekday sleep by addressing structural issues — phone, screens, caffeine timing. And limit weekend variation to within about one to two hours of weekday timing. Sunday morning is identified in the text as especially important: getting bright light at a reasonable time on Sunday morning anchors circadian timing for the following week. Understanding social jet lag reframes the weekend sleep pattern from "catching up" to "creating its own disruption" — which changes what the right intervention is.`,
            },
            {
              word: `insomnia onset`,
              definition: `The specific sleep problem of being unable to fall asleep, as distinct from maintenance insomnia (inability to stay asleep) or early morning waking. The text identifies most adolescent insomnia onset as structural — caused by phone in bedroom, late screens, caffeine timing, inconsistent schedule — rather than a deficiency that supplements fix. Identifying the specific pattern helps target the right intervention.`,
              audioPrompt: `Insomnia onset is the specific sleep problem of being unable to fall asleep, {name}. Terra here — the text distinguishes it from two other patterns: maintenance insomnia, where you fall asleep but wake repeatedly during the night; and early morning waking, where you wake before intended and cannot return to sleep. Identifying which specific pattern you have matters because the causes and interventions differ. Most adolescent insomnia onset is structural. The text names the main drivers: phone in the bedroom keeping the brain in partial alertness, screens emitting blue light that suppresses melatonin, stimulating content activating the brain in the hours before intended sleep, caffeine consumed after early afternoon still active at bedtime due to the 5 to 7 hour half-life, and inconsistent schedule preventing the circadian system from settling into a reliable pattern. These are not deficiencies that melatonin gummies or supplements fix; they are structural causes that structural interventions address. The research-informed approach is to make the structural changes — phone outside the bedroom, screens off 60 to 90 minutes before sleep, caffeine cut after noon, consistent timing — and give them 2 to 3 weeks to show effect before considering anything else. If structural changes fail to resolve insomnia onset, that is the signal to seek medical evaluation.`,
            },
          ],
        },
