      ...
      screens: [
...

        {
          ...
          paragraphs: [
            ...
            `This was a real break from how Western culture had treated sound. For centuries, music was understood as something organized in time: notes following notes, a melody unfolding like a sentence. Leitner and others proposed that sound is also organized in space, and that the spatial dimension could be the primary artistic material. The technical name for this region of art is "sound art," and it sits deliberately between music, sculpture, and architecture, refusing to be fully any one of them. Museums began collecting it; the term entered serious art criticism in the 1980s and 1990s.`,
          ...
          imageCaption: `Bernhard Leitner (1938-2024), Austrian artist trained as architect: "Sound Spaces" from 1971, rooms wired with dozens of speakers sending a single tone traveling around the listener's body on precise paths. Argument: the body perceives sound spatially, not just the ears; an artist can sculpt spatial sound experience. A break from Western culture's treatment of sound as organized only in time (melody unfolding). "Sound art" sits between music, sculpture, architecture; term entered serious criticism in the 1980s-1990s; museums began collecting it. Stretches the Lesson 1 definition of art: the artwork is the designed experience itself, the shaped encounter between sound and the listening body.`,
          vocab: [
            {
              word: `sound art`,
              definition: `A field of contemporary art treating sound itself as the primary artistic material, organized in space as well as time. Sits deliberately between music, sculpture, and architecture without being fully any one. Bernhard Leitner (1938-2024), Austrian artist trained as architect, built "Sound Spaces" from 1971: rooms wired with dozens of speakers so a single tone travels around the listener's body on precise paths (up the spine, circling the head, dropping to the feet). Leitner's argument: the body perceives sound spatially, not just through the ears; the spatial dimension can be the primary artistic material. This broke from the Western tradition of treating sound as organized only in time (melody as a sentence unfolding). The term "sound art" entered serious art criticism in the 1980s-1990s; museums began collecting works. The artwork is not an object on a wall, a score, or a stage performance; it is the designed experience itself, the shaped encounter between sound and the listening body. Engaging it as art stretches the definition built in Lesson 1.`,
              audioPrompt: `Begin with the central artistic claim, {name}: sound is not only something you hear, it is something that occupies space, has form, and can be composed the way a sculptor composes stone. Bernhard Leitner, an Austrian artist who lived from 1938 to 2024 and trained as an architect, built this idea into physical rooms. His "Sound Spaces," from 1971 onward, used dozens of speakers wired so a single tone could travel around a listener's body on precise paths. Stand inside one and a sound climbs your spine, circles your head, drops to your feet. Leitner argued that the body perceives sound spatially, not just the ears, and that an artist can sculpt that spatial experience. This was a real break from how Western culture had treated sound, which was as something organized in time, notes following notes like a melody unfolding. The name for this region of art is "sound art," and it sits between music, sculpture, and architecture, refusing to be fully any one of them. Here is the question it raises for you: if a sound space has no object, no score, no performer, what exactly is the artwork? It is the designed experience itself. Holding that as art is the move this lesson asks of you.`,
            },
          ],
        },

        {
          ...
          vocab: [
            {
              word: `Deep Listening and the founders of sound art`,
...

        {
          ...
          vocab: [
            {
              word: `borrowed tradition vs. attached claim`,
...

        {
          ...
          vocab: [
            {
              word: `relaxation is real; the mechanism claim is the test`,
...

        {
          ...
          vocab: [
            {
              word: `three kinds of claim, one object`,
          ...
          questions: [
            {
              ...
              question: `What is "sound art," and what did Bernhard Leitner's "Sound Spaces" do?`,
              options: [
                `Random`,
                `Sound art is a field of contemporary art that treats sound itself as the primary artistic material, organized in space as well as time, sitting deliberately between music, sculpture, and architecture. Bernhard Leitner (1938-2024), an Austrian artist trained as an architect, built "Sound Spaces" from 1971 onward: rooms wired with dozens of speakers so a single pure tone travels around the listener's body on precise paths, up the spine, around the head, down to the feet. His argument was that the body perceives sound spatially, not just the ears, and that an artist can sculpt that spatial experience. The artwork is not an object, a score, or a stage performance; it is the designed experience itself, the shaped encounter between sound and the listening body. The term entered serious art criticism in the 1980s and 1990s and museums began collecting the work.`,
                `Just speakers`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Sound art treats sound as a material organized in space, not only in time. Leitner's spatial tone-paths are the clearest example, and naming them grounds the whole lesson's claim that sound can be a serious artistic medium.`,
            },
            {
              id: `q2`,
              type: `multiple-choice`,
              question: `What was Pauline Oliveros's "Deep Listening," and how did she distinguish hearing from listening?`,
              options: [
                `Random`,
                `Pauline Oliveros (1932-2016), an American composer and accordionist, developed "Deep Listening" after a 1988 recording session in a cistern with a 45-second reverberation time. Deep Listening is a practice of attention to the entire sonic field, including the listener's own body and the space itself. Oliveros distinguished "hearing," the physical reception of sound, from "listening," the act of giving meaning and attention to it. She founded the Deep Listening Institute and taught the practice for decades, claiming that attention to sound, trained and deepened, genuinely changes the person doing it. Crucially, she did not claim that specific frequencies cure specific diseases; her claim was about the practice of attention itself.`,
                `Just hearing`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Oliveros's distinction between passive hearing and active, meaning-giving listening is the heart of Deep Listening. Her claim is about trained attention, which is a different kind of claim from a frequency-cures-organ claim.`,
            },
            {
              id: `q3`,
              type: `multiple-choice`,
              question: `Why do La Monte Young's "Dream House" installations depend partly on the listener?`,
              options: [
                `Random`,
                `La Monte Young (born 1935), with the artist Marian Zazeela, built "Dream House" installations (ongoing since the 1960s) that fill a room with sustained, precisely tuned frequencies in "just intonation," frequency ratios calculated to many decimal places. The tones never stop and never change. But when a visitor moves through the space, the sound changes, not because the tones change, but because moving your head even a few inches shifts which frequencies your ears combine. So the listener's own movement helps make the piece; the artwork is co-produced by where you stand and how you move. Young studied Indian classical music under Pandit Pran Nath and openly credited the tradition of the sustained drone as an influence on his long tones.`,
                `Just tones`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `In "Dream House" the tones are fixed but your movement changes which frequencies combine in your ears, so the listener co-produces the work. Young's open credit to Indian classical drone tradition is also a model of honest borrowing.`,
            },
            {
              id: `q4`,
              type: `multiple-choice`,
              question: `What is the difference between a tradition's claim and a wellness company's claim about the same singing bowl?`,
              options: [
                `Random`,
                `The object can be identical; the claim attached to it differs. A Tibetan monk ringing a singing bowl in a monastery is engaged in a religious and contemplative practice transmitted for centuries; within the tradition the sound has meaning tied to attention and ritual. This is a meaning claim, Tier C-cultural in the Lesson 3 framework, engaging real human experience through practice rather than through a testable physics mechanism. A wellness company selling the same bowl with a chart of "which organ each frequency heals" has added a falsifiable, scientific-sounding physics claim that the tradition never made and that peer-reviewed research does not support, which is Tier C-pseudoscience. The bowl is the same; the attached claim is the thing you evaluate. Conflating the two either dismisses a real tradition or legitimizes a marketing claim.`,
                `Just bowls`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Same object, different claim. The tradition makes a meaning claim evaluated on its own terms; the company makes a falsifiable physics claim that fails testing. Keeping them separate is the central skill of the lesson.`,
            },
            {
              id: `q5`,
              type: `multiple-choice`,
              question: `What does the actual evidence say about a "sound bath," and where is the careful distinction?`,
              options: [
                `Random`,
                `A sound bath (lying down while someone plays gongs and singing bowls) often genuinely helps people relax, and that relaxation is real and measurable; slow, quiet, intentional listening reliably lowers stress markers for many people, supported by controlled research. The careful distinction is this: the relaxation being real does not make the specific mechanism claims true. A statement like "this gong is tuned to 432 Hz, resonates with your heart chakra, and dissolves trauma stored in your cells" bundles a supported claim (the experience is relaxing) with an unsupported one (a specific frequency targets a specific organ through a physical mechanism). The honest position is neither "it's all fake" nor "the frequencies heal you"; it is precise: the experience can help you relax, and the specific physics-style mechanism claims are not established.`,
                `Just relaxing`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `The relaxation is real; the frequency-cures-organ mechanism is not established. Holding both at once, rather than collapsing into "all fake" or "it heals you," is the precise and honest position.`,
            },
            {
              id: `q6`,
              type: `multiple-choice`,
              question: `Why does the precision about sound claims matter practically, not just for winning arguments?`,
              options: [
                `Random`,
                `Because claims escalate, and the escalation is where harm enters. If a sound bath helps someone manage everyday stress, that is a real benefit and nobody should sneer at it. The line to watch is when "this helps you relax" becomes "this cures your illness, so skip your doctor." That escalation turns an enjoyable, often genuinely helpful practice into something that can hurt people by steering them away from evidence-based treatment for serious conditions. A person who can hold the distinction can enjoy a sound bath, take the art of Oliveros and Young seriously, and still protect a family member from a dangerous health claim. The framework is not about being the person who dismisses everything; it is about engaging accurately so that real benefit is kept and real danger is caught.`,
                `Just because`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `The danger is escalation from "relax" to "skip your doctor." Precision lets you keep the real benefit of a relaxing practice while catching the genuinely dangerous medical overstatement.`,
            },
            {
              id: `q7`,
              type: `multiple-choice`,
              question: `What did Maryanne Amacher and Christine Sun Kim each contribute to sound art?`,
              options: [
                `Random`,
                `Maryanne Amacher (1938-2009) composed with sounds engineered loud and high enough that the listener's own inner ear produces additional tones that are not present in the room at all, called "otoacoustic emissions"; her audiences heard music partly generated inside their own heads, pushing the medium furthest into the body. Christine Sun Kim (born 1980), a contemporary Deaf American artist, approaches sound from the opposite direction, making drawings, performances, and installations about how sound is owned, measured, and socially controlled, asking why hearing people treat sound as theirs. Together they show the range of the medium: one composing inside the listener's physiology, the other questioning the politics and ownership of sound itself. Neither is selling a cure.`,
                `Just sound`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Amacher composed inside the listener's own ear; Christine Sun Kim interrogates who owns and controls sound. Both expand what sound art can be, and neither makes a health claim, which keeps them clearly in the art category.`,
            },
            {
              id: `q8`,
              type: `multiple-choice`,
              question: `Why is it important that La Monte Young openly credited Indian classical music?`,
              options: [
                `Random`,
                `Because it models honest borrowing. Young's sustained long tones descend directly from the drone of Indian classical music, the tanpura's continuous tone underneath a raga; Young studied the tradition under Pandit Pran Nath and was explicit about the debt. The honest artist names the borrowing rather than presenting a tradition's material as a personal invention or stapling a new scientific-sounding claim onto it. This is the same distinction the lesson draws elsewhere: borrowing a tradition with credit and an aesthetic purpose is legitimate; taking a tradition's object and attaching a falsifiable health claim it never made is the category error. Naming the source respects the Tier C-cultural tradition the work draws on.`,
                `Just music`,
                `Random`,
              ],
              correctIndex: 1,
              explanation: `Crediting the Indian classical drone tradition models honest borrowing: name the source, keep the aesthetic purpose, do not staple on a false claim. It is the ethical counterpart to the lesson's warning about pseudoscience.`,
            },
            {
              id: `q9`,
              type: `true-false`,
              ...
              correctAnswer: false,
              explanation: `False. The relaxation is real, but it does not follow that the specific frequency-heals-organ mechanism is true. Relaxation from a sound bath comes from intentional, quiet engagement and from the placebo effect, both of which are real and measurable, and neither of which requires any specific "healing frequency" claim to be true. This is the core reasoning move of the lesson: an experience can be genuinely beneficial while the scientific-sounding explanation attached to it is unsupported. Treating "it helped me relax" as proof of "this frequency repairs my cells" is exactly the error that lets Tier C-pseudoscience pass itself off as established science. The honest position keeps the real benefit and rejects the unsupported mechanism. You can enjoy the sound bath and still refuse the cell-repair claim, with no contradiction.`,
            },
            {
              id: `q10`,
              type: `inference`,
              question: `Imagine a friend invites you to a "healing sound bath" run by someone who tells the group beforehand that the gongs are tuned to frequencies that "dissolve disease and that medicine just covers up." Your friend has a real, serious health condition and is excited. You don't want to ruin the experience or insult your friend, and you also have a framework now. What do you actually do, during and after?`,
              options: [
                `"Just leave"`,
                `Several distinct moves, held together. First, separate the experience from the claim, because they are not the same thing. The sound bath itself, lying down and listening to gongs and bowls, will probably be genuinely relaxing for your friend, and that relaxation is real; there is nothing to "debunk" about enjoying an hour of quiet, intentional sound. So you can go, lie down, and enjoy the actual experience without any internal conflict, because the experience is fine. Second, locate exactly where the danger is. It is not the gongs and it is not the relaxation; it is the specific verbal claim the practitioner made, that the frequencies "dissolve disease" and that "medicine just covers up." That is a falsifiable physics-and-medicine claim with no peer-reviewed support, and worse, it is an instruction to distrust evidence-based treatment, which is the escalation from "this relaxes you" to "so skip your doctor" that turns a harmless practice into a dangerous one. Third, watch what your friend actually does with it, because that is what matters. If your friend enjoys the relaxation and keeps their medical treatment, there is no real problem and no need for a lecture; people are allowed to find a sound bath relaxing. The concern sharpens only if your friend starts talking about reducing or stopping treatment for a serious condition based on what the practitioner said. Fourth, decide how to talk to your friend, given that you care about them and lecturing rarely works. Probably not in the studio, not in front of the group, and not as "that's pseudoscience and you're being fooled," which mostly makes people defensive. Better, later and privately: ask what they got out of it (their actual experience matters and you might learn something), share that you found the relaxation real too, and then separate the two claims out loud, that the relaxing part is genuinely good and worth keeping, and that the "dissolve disease, skip medicine" part is the part that worries you because it is not supported and could be dangerous with a real condition. Fifth, hold your own limits honestly. You are a young person, not their doctor; your job is not to control their medical decisions but to be someone who engages honestly and cares. You can say the true thing once, clearly and kindly, and then respect that the choice is theirs, while staying ready to say it again if they start moving toward abandoning treatment. Sixth, keep the longer frame. The goal is not to win an argument in a yoga studio; it is to be the person in your friend's life who can enjoy the same experiences they enjoy and still tell them the truth when a claim could actually hurt them. That combination, real warmth plus real accuracy, is rarer and more useful than either being the cynic who sneers at everything or the believer who accepts everything, and it is exactly what this lesson has been training you to be.`,
                `"Random"`,
                `"Just maybe"`,
              ],
              correctIndex: 1,
              explanation: `Applied sound-claim literacy inside a real relationship. The move is to separate the genuinely relaxing experience (keep it) from the specific dangerous claim (catch it), to locate the harm precisely in the "dissolve disease, skip medicine" escalation rather than in the gongs, and to engage the friend with warmth and accuracy rather than a lecture. The capstone is not winning the argument; it is being someone who can share the experience and still tell the truth when a claim could hurt someone they love.`,
            },
          ],
        },
