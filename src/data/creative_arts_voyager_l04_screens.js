          ...
          questions: [
            {
              ...
              options: [
                `Random`,
                `Sound art is a field of contemporary art that treats sound itself as the main material, shaped in space and not only in time, sitting between music, sculpture, and architecture. Bernhard Leitner (1938-2024), an Austrian artist trained as an architect, built "Sound Spaces" from 1971 onward: rooms wired with dozens of speakers so a single pure tone travels around the listener's body on precise paths, up the spine, around the head, down to the feet. His argument was that the body perceives sound spatially, not just the ears, so an artist can compose where a sound lives and moves, the way a sculptor composes where to put a shape. The artwork is not an object, a score, or a stage performance; it is the designed experience itself, the shaped encounter between sound and the listening body. The term entered serious art criticism in the 1980s and 1990s and museums began collecting the work.`,
                `Just speakers`,
                `Random`,
              ],
              correctIndex: 1,
