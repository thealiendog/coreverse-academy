      ...
      screens: [
...

        {
          ...
          vocab: [
            ...
            {
              word: `Bernhard Leitner`,
              definition: `Bernhard Leitner (1938-2024) was an Austrian artist trained as an architect who built the central claim of sound art into physical rooms. His "Sound Spaces," from 1971 onward, used dozens of speakers wired so a single tone could travel around a listener's body on precise paths: up the spine, circling the head, dropping to the feet. Leitner's argument was that the body perceives sound spatially, not just through the ears, and that an artist can sculpt that spatial experience the way a sculptor composes where to put a shape. Sound art, the term that entered serious criticism in the 1980s and 1990s, sits between music, sculpture, and architecture without being fully any one of them. Museums began collecting sound art and art critics began taking it seriously in those decades. The artwork in a Leitner Sound Space is not an object on a wall, a score, or a stage performance; it is the designed experience itself, the shaped encounter between sound and the listening body.`,
              audioPrompt: `Bernhard Leitner was an Austrian artist who lived from 1938 to 2024 and trained as an architect, {name}. He built the central claim of sound art into physical rooms. His "Sound Spaces," from 1971 onward, used dozens of speakers wired so a single tone could travel around a listener's body on precise paths: up the spine, circling the head, dropping to the feet. Leitner's argument was that the body perceives sound spatially, not just through the ears, and that an artist can sculpt that spatial experience. This was a real break from the way most music had worked for centuries, which organized notes one after another in time, like words in a sentence. Leitner proposed that sound also has a where, not just a when. Sound art, the term that entered serious art criticism in the 1980s and 1990s, sits between music, sculpture, and architecture without being fully any one of them. If a sound space has no object on a wall, no score to read, no performer on a stage, what exactly is the artwork? It is the designed experience itself, the shaped encounter between sound and the listening body.`,
            },
            {
              word: `spatial sound`,
              definition: `Spatial sound refers to the artistic idea that sound can be organized in space, not only in time. Ordinarily music organizes sounds as a sequence in time, with notes following one another like words in a sentence. Bernhard Leitner proposed that sound also has a where, not just a when, and that an artist could compose the where: deciding that a tone lives near your left shoulder or moves across the room, the way a sculptor decides where to put a curve. His "Sound Spaces" from 1971 used dozens of speakers to realize this. Leitner argued that the body perceives sound spatially; your skin hears as much as your ears do. Making spatial sound into art rather than simply into audio engineering was the move that placed Leitner's work between music, sculpture, and architecture.`,
              audioPrompt: `Spatial sound refers to the artistic idea that sound can be organized in space, not only in time, {name}. Ordinarily music organizes sounds as a sequence in time, with notes following one another like words in a sentence. Bernhard Leitner proposed that sound also has a where, not just a when, and that an artist could compose the where: deciding that a tone lives near your left shoulder or moves across the room, the way a sculptor decides where to put a curve. His "Sound Spaces" from 1971 used dozens of speakers to realize this, sending a single tone traveling around the listener's body on precise paths. Leitner argued that the body perceives sound spatially; your skin hears as much as your ears do. Making spatial sound into art, rather than simply into audio engineering, was the move that placed Leitner's work between music, sculpture, and architecture without being fully any one of them. The artwork is the designed experience itself: the shaped encounter between sound and the listening body.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `Deep Listening`,
              definition: `Deep Listening is a practice and philosophy developed by Pauline Oliveros (1932-2016) after a 1988 recording session in a cistern with a 45-second reverberation time. Deep Listening is the practice of attending to the entire sonic field, including intended sounds, the space itself, and the listener's own body. Oliveros distinguished "hearing" (the physical reception of sound) from "listening" (giving meaning and attention to it). She founded the Deep Listening Institute and taught the practice for decades. Her claim was that attention to sound, trained and deepened, genuinely changes the person doing it. This is a claim about trained attention and practice, not a claim that specific frequencies cure specific diseases — which keeps it clearly in the art and practice category rather than in wellness pseudoscience. Deep Listening became a whole discipline with performance works, pedagogy, and published writings.`,
              audioPrompt: `Deep Listening is a practice and philosophy developed by Pauline Oliveros, an American composer and accordionist who lived from 1932 to 2016, {name}. It emerged after a 1988 recording session in a cistern with a 45-second reverberation time. Deep Listening is the practice of attending not just to intended sounds but to the entire sonic field, including the space itself and the listener's own body. Oliveros distinguished hearing, the physical reception of sound, from listening, giving meaning and attention to it. She founded the Deep Listening Institute and taught the practice for decades. Her claim was that attention to sound, trained and deepened, genuinely changes the person doing it. Notice what kind of claim this is: it's a claim about trained attention and practice, not a claim that specific frequencies cure specific diseases. This is what keeps Deep Listening clearly in the art and practice category, with a completely different kind of claim from the 432 Hz wellness marketing you'll examine later.`,
            },
            {
              word: `otoacoustic emissions`,
              definition: `Otoacoustic emissions are additional tones that the listener's own inner ear produces in response to certain sound stimuli. Maryanne Amacher (1938-2009) composed with sounds loud and high enough that the listener's own inner ear would produce additional tones that weren't physically present in the room at all. Her audiences heard music partly generated inside their own heads. This was a radical extension of the idea of sound art: the listening body itself becomes a part of the instrument and the composition. Like the other founders of sound art, Amacher was making a distinct aesthetic claim about what sound can be and do; she was not selling a cure or making claims about healing frequencies.`,
              audioPrompt: `Otoacoustic emissions are additional tones that the listener's own inner ear produces in response to certain sound stimuli, {name}. Maryanne Amacher, who lived from 1938 to 2009, composed with sounds loud and high enough that the listener's own inner ear would produce additional tones that weren't physically present in the room at all. Her audiences heard music partly generated inside their own heads. This was a radical extension of sound art: the listening body itself becomes part of the instrument and the composition. La Monte Young took a different path with the long tone: his "Dream House" installations with Marian Zazeela, ongoing since the 1960s, fill a room with sustained precisely tuned frequencies in just intonation. Move your head a few inches and the sound changes because which frequencies your ears combine shifts; the listener's own movement helps make the piece. Christine Sun Kim, born in 1980, a Deaf American artist, approaches sound from another direction entirely, making work about how sound is owned, measured, and socially controlled.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `honest borrowing`,
              definition: `Honest borrowing refers to the practice of a contemporary artist drawing on an older or non-Western tradition while openly crediting the source and not claiming the tradition's authority for assertions the tradition never made. La Monte Young is the model used in this lesson: he studied Indian classical music directly under Pandit Pran Nath and was explicit about that debt in his writings and interviews. His "Dream House" installations draw on the Indian classical drone tradition, but Young presents this as an aesthetic move, not as a claim that his sustained frequencies perform the same spiritual or healing function that the tradition claims for its practices. The honest artist names the borrowing; the trouble starts when borrowing turns into a claim the tradition never made.`,
              audioPrompt: `Honest borrowing refers to the practice of a contemporary artist drawing on an older or non-Western tradition while openly crediting the source and not claiming the tradition's authority for assertions the tradition never made, {name}. La Monte Young is the model used in this lesson: he studied Indian classical music directly under Pandit Pran Nath and was explicit about that debt. His "Dream House" installations draw on the Indian classical drone tradition, but Young presents this as an aesthetic move. He is not claiming that his sustained frequencies perform the same spiritual or healing function that the tradition claims for its practices. The honest artist names the borrowing. The trouble starts when borrowing turns into a claim the tradition never made: a wellness company selling a Tibetan singing bowl with a chart of "which organ each frequency heals" has attached a scientific-sounding claim the tradition never made. The bowl is identical; what differs is the claim attached to it.`,
            },
            {
              word: `tanpura drone`,
              definition: `The tanpura drone is the continuous sustained tone produced by the tanpura instrument underneath a raga in Indian classical music. The tanpura's unending single tone provides the sonic foundation against which the raga's melodic and rhythmic development unfolds. La Monte Young studied this tradition directly under Pandit Pran Nath and credited this as the direct ancestor of his "Dream House" installations, which fill rooms with sustained precisely tuned frequencies in just intonation. The tanpura drone is a Tier C-cultural tradition: it engages real human experience through practice, musical meaning, and contemplative attention, not through falsifiable physics claims about frequencies healing organs. Engaging it honestly means treating it as a serious musical tradition on its own terms, not reducing it to a claim about acoustic frequencies.`,
              audioPrompt: `The tanpura drone is the continuous sustained tone produced by the tanpura instrument underneath a raga in Indian classical music, {name}. The tanpura's unending tone provides the sonic foundation against which the raga's melodic and rhythmic development unfolds. La Monte Young studied this tradition directly under Pandit Pran Nath and credited this as the direct ancestor of his "Dream House" installations, which fill rooms with sustained precisely tuned frequencies in just intonation. Tibetan Buddhist practice similarly uses singing bowls and long horns within a religious and contemplative framework with centuries of transmission. These are Tier C-cultural traditions from the framework in Lesson 3: they engage real human experience through practice, musical meaning, and contemplative attention, not through falsifiable physics claims about frequencies healing organs. Engaging them honestly means treating them as serious traditions on their own terms, and naming borrowings from them when making contemporary art.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `sound bath`,
              definition: `A sound bath is a wellness practice in which participants lie down while someone plays gongs, singing bowls, or other sustained-tone instruments around them. The relaxation that a sound bath produces is real and measurable: slow, quiet, intentional listening reliably lowers stress markers for many people, as controlled research on music and relaxation confirms. The experience is genuinely beneficial for many participants. The careful distinction: the relaxation being real does not make the specific mechanism claims attached to some sound bath marketing true. When a practitioner claims that the gong is tuned to a specific frequency that resonates with a specific organ and dissolves trauma stored in cells, they are making a falsifiable physics claim that peer-reviewed research does not support. The honest and precise position is: the experience can genuinely help you relax; the specific physics-style mechanism claims are not established.`,
              audioPrompt: `A sound bath is a wellness practice in which participants lie down while someone plays gongs, singing bowls, or other sustained-tone instruments around them, {name}. The relaxation that a sound bath produces is real and measurable: slow, quiet, intentional listening reliably lowers stress markers for many people, as controlled research confirms. The experience is genuinely beneficial for many participants. The careful distinction: the relaxation being real does not make the specific mechanism claims attached to some sound bath marketing true. When a practitioner claims that the gong is tuned to 432 hertz, which resonates with your heart chakra and dissolves trauma stored in your cells, they are making a falsifiable physics claim that peer-reviewed research does not support. The honest position is: the experience can genuinely help you relax; the specific physics-style mechanism claims are not established. The danger line is escalation: when "this helps you relax" becomes "this cures your illness, so skip your doctor." That is where a genuinely helpful practice turns into something that can hurt people.`,
            },
            {
              word: `danger line`,
              definition: `The danger line is the point at which a genuine, modest benefit claim escalates into a dangerous medical claim. In the context of sound practices: "this helps you relax" is a supported, honest claim. A sound bath genuinely relaxes many people and that benefit is real. The danger line is crossed when the claim becomes "this cures your illness, so skip your doctor." That escalation turns an enjoyable and often genuinely helpful practice into something that can hurt people, because it steers them away from evidence-based medical care for serious conditions. A 12-year-old who can hold this distinction can enjoy a sound bath, take the art of Oliveros and Young seriously, and still protect a family member from a dangerous health claim.`,
              audioPrompt: `The danger line is the point at which a genuine, modest benefit claim escalates into a dangerous medical claim, {name}. In the context of sound practices: "this helps you relax" is a supported, honest claim. A sound bath genuinely relaxes many people and that benefit is real. The danger line is crossed when the claim becomes "this cures your illness, so skip your doctor." That escalation turns an enjoyable and genuinely helpful practice into something that can hurt people, because it steers them away from evidence-based medical care for serious conditions. Music therapy has substantial empirical support for specific applications: anxiety reduction, pain management as an adjunct to other care, dementia care. Those are real and well-established. Claims that go beyond these established applications into specific healing of serious disease through specific musical or sound mechanisms are not supported by research. The whole point of the framework is that a person can hold all of this at once: enjoy the sound bath, take sound art seriously, and still catch a dangerous health claim when it appears.`,
            },
          ],
        },

        {
          ...
          vocab: [
            ...
            {
              word: `aesthetic claim`,
              definition: `An aesthetic claim is the kind of claim that art makes: "experience this shaped sound," or "engage with this designed encounter." It asks you to respond to the work as an experience worth having, not to believe a factual assertion about what it will cure or what physical mechanism it operates through. Bernhard Leitner's "Sound Spaces," Pauline Oliveros's Deep Listening, La Monte Young's "Dream House," Maryanne Amacher's otoacoustic compositions, and Christine Sun Kim's installations all make aesthetic claims. None of them promises a cure. Evaluating an aesthetic claim means asking: does the designed experience do something worth doing? Is it skillful, original, affecting? You do not evaluate it by asking "did it heal anything," because it never claimed to. This is what keeps serious sound art distinct from wellness pseudoscience even when both use the same materials.`,
              audioPrompt: `An aesthetic claim is the kind of claim that art makes, {name}: experience this shaped sound; engage with this designed encounter. It asks you to respond to the work as an experience worth having, not to believe a factual assertion about what it will cure or what physical mechanism it operates through. Bernhard Leitner's "Sound Spaces," Pauline Oliveros's Deep Listening, La Monte Young's "Dream House," Maryanne Amacher's otoacoustic compositions, and Christine Sun Kim's installations all make aesthetic claims. None of them promises a cure. Evaluating an aesthetic claim means asking: does the designed experience do something worth doing? Is it skillful, original, affecting? You do not evaluate it by asking "did it heal anything," because it never claimed to. This is what keeps serious sound art distinct from wellness pseudoscience even when both use the same materials. Art's aesthetic claim, tradition's meaning claim, and pseudoscience's falsifiable physics claim are three different kinds of claim that can be attached to one identical object.`,
            },
            {
              word: `meaning claim`,
              definition: `A meaning claim is the kind of claim that a legitimate cultural or spiritual tradition makes about sound: "this is part of our practice," or "this sound carries meaning within our tradition's framework." A meaning claim is not the same as a falsifiable physics claim and should not be evaluated by the same standards. A Tibetan monk ringing a singing bowl in a monastery is engaged in a religious practice with its own internal meaning, accumulated over centuries of transmission. That tradition engages real human experience through practice, ritual, and attention. Asking "does this frequency heal a specific organ in a controlled trial?" misreads the tradition because the tradition never made that kind of claim. Meaning claims are evaluated on whether the tradition has internal coherence and depth, whether it requires genuine commitment and practice, and whether it engages real human experience. This is the Tier C-cultural category from Lesson 3.`,
              audioPrompt: `A meaning claim is the kind of claim that a legitimate cultural or spiritual tradition makes about sound, {name}: "this is part of our practice," or "this sound carries meaning within our tradition's framework." A meaning claim is not the same as a falsifiable physics claim and should not be evaluated by the same standards. A Tibetan monk ringing a singing bowl in a monastery is engaged in a religious practice with its own internal meaning, accumulated over centuries of transmission. Asking "does this frequency heal a specific organ in a controlled trial?" misreads the tradition because the tradition never made that kind of claim. Meaning claims are evaluated on whether the tradition has internal coherence and depth, whether it requires genuine commitment and practice, and whether it engages real human experience that matters to practitioners. This is the Tier C-cultural category from Lesson 3. The distinction from pseudoscience is that pseudoscience makes physics-style assertions, while tradition makes meaning-and-practice claims. Art makes aesthetic claims. Three different kinds of claim, one object.`,
            },
          ],
        },
