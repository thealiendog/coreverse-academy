  ...
  lessons: [
    {
      ...
      screens: [
        ...
        // ── 3. MAGAZINE — §2 ────────────────────────────────────────────────
        {
          ...
          section: 2,
          content: {
            heading: `The blame game and why it backfires`,
            body: `Blaming someone else for a mistake feels good in the short term — it protects your ego and takes the heat off you. But it backfires in the long term. Here's why: **when you blame someone else, you give away your power**. If it's their fault, only they can fix it. When you own it, you're in control of what happens next. Blame also destroys trust fast — people who never take responsibility for anything are seen as unreliable. The leaders who are most respected are almost always the ones who are quickest to say "that was on me" — and then focus on what they'll do differently.`,
            image:   '/explorer-assets/leadership/l10-magazine-2.png',
            caption: `Owning a mistake puts you back in control of what happens next`,
          },
        },
        ...
        // ── 4. MAGAZINE — §3 ────────────────────────────────────────────────
        {
          ...
          section: 3,
          content: {
            heading: `The power of a real apology`,
            body: `A genuine apology has three clear parts: **acknowledgment** ("I know what I did and I understand why it was wrong"), **regret** ("I'm genuinely sorry for the impact it had"), and **commitment to change** ("here's what I'll do differently"). Compare that to fake apologies: "I'm sorry *you* feel that way" — that puts the problem on the other person's feelings. "I'm sorry, *but*..." — the "but" cancels everything before it. "I'm sorry *if* I hurt you" — the "if" suggests you're not sure you did anything wrong. Real apologies take courage. They also build enormous trust.`,
            image:   '/explorer-assets/leadership/l10-magazine-3.png',
            caption: `Acknowledge, express genuine regret, and commit to change — without "buts" or "ifs"`,
          },
        },
        ...
        // ── 6. INTERACTIVE — Drag-match ─────────────────────────────────────
        {
          ...
          config: {
            buckets: [
              { id: 'owns',    label: `⚖️ Taking Responsibility`, color: '#34D399' },
              { id: 'excuses', label: `🔄 Making Excuses`,        color: '#F59E0B' },
            ],
            items: [
              {
                id:            'l10-g1',
        ...
        // ── 7. QUIZ ──────────────────────────────────────────────────────────
        {
          ...
          questions: [
            ...
            // Q4 — TF (fresh — reframed to positive)
            {
              id:           'l10-q4',
              format:       'tf',
            ...
            // Q5 — Fill-blank (fresh)
            {
              ...
              options:      ['power', 'blame', 'time', 'attention'],
              correctIndex: 0,
        ...
        // ── 8. REAL-WORLD ────────────────────────────────────────────────────
        {
          ...
          content: {
            ...
            description: `Think of one situation from the past week where something went wrong. Write down honestly: what was your role in it? Did you own it — or did you find a reason to blame something else? What would full ownership look like?`,
            ...
            realWorldConnection: `In every field — sport, business, medicine, education — the people most trusted are those who own their mistakes quickly and focus on what they can do better. Responsibility isn't about being perfect; it's about being honest and reliable.`,
          },
        },
