  ...
  lessons: [
    {
      ...
      screens: [
        ...
        // ── 3. MAGAZINE — §2 ────────────────────────────────────────────────
        {
          ...
          section: 2,
          content: {
            heading: `Why diverse groups are stronger`,
            body: `Research consistently shows that groups made up of people from different backgrounds, experiences, and ways of thinking make better decisions and come up with more creative solutions than groups where everyone is similar. The reason is straightforward: different people notice different things, have different blind spots, and bring different ideas to the same problem. A group where everyone thinks the same way keeps arriving at the same answers. A group where people think differently challenges each other — and finds better ones.`,
            image:   '/explorer-assets/leadership/l07-magazine-2.png',
            caption: `Different thinking styles find solutions that sameness misses`,
          },
        },
        ...
        // ── 5. MAGAZINE — §4 ────────────────────────────────────────────────
        {
          ...
          section: 4,
          content: {
            heading: `Curiosity as a superpower`,
            ...
            caption: `Curiosity opens doors that judgment keeps shut`,
          },
        },
        ...
        // ── 6. INTERACTIVE — Drag-match ─────────────────────────────────────
        {
          ...
          config: {
            buckets: [
              { id: 'respect',  label: `🌍 Genuine Respect`, color: '#34D399' },
              { id: 'tolerating', label: `🤷 Just Tolerating`, color: '#94A3B8' },
            ],
            items: [
              {
                id:            'l07-g1',
        ...
        // ── 7. QUIZ ──────────────────────────────────────────────────────────
        {
          ...
          questions: [
            ...
            // Q5 — Fill-blank (fresh)
            {
              ...
              options:      ['curiosity', 'caution', 'silence', 'distance'],
              correctIndex: 0,
        ...
        // ── 8. REAL-WORLD ────────────────────────────────────────────────────
        {
          ...
          type: 'real-world',
          content: {
            scenario:    `The Perspective Shift`,
            description: `Think of one belief, tradition, or habit that's very different from yours — and spend a few minutes learning about it from the perspective of someone who lives that way. Write down one thing that surprised you.`,
            ...
            realWorldConnection: `Every major field — science, medicine, business, the arts — produces its best work when people with different backgrounds and ways of thinking work together. Genuine respect for difference isn't just a nice quality — it's a competitive advantage.`,
          },
        },
