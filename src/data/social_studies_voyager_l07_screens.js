      ...
      screens: [
        {
          id: `l07-welcome`,
          type: `welcome`,
          guideText: `{name}, we've spent six lessons on power, who holds it, how it's divided, how nations use it at home and abroad. Now we turn to a force just as powerful, and far less understood: the economy. You hear about it constantly. "The economy is growing." "Inflation is up." "Unemployment fell." "We're in a recession." These phrases shape elections, decide whether your family can afford things, and ripple through billions of lives. But most people nod along without really knowing what they mean. By the end of this lesson, you will. There are two ways to look at an economy. Microeconomics zooms in on individual pieces, a single buyer, a single business, one market. Macroeconomics, our subject today, zooms way out to see the whole national economy at once: all the spending, producing, earning, and trading of an entire country, treated as one giant system. It's like the difference between studying one tree and studying the whole forest, including the weather patterns that move through it. We'll learn the vital signs economists use to measure a national economy's health, how big it is (GDP), how fast prices rise (inflation), and how many people can't find work (unemployment). We'll see why economies move in cycles, booming and then contracting, and what a recession actually is. We'll uncover the deep forces that drive it all, and why the whole system can speed up or slow down. And because understanding an economy means reading real situations, we'll become economic analysts, working through five real scenarios where these forces collide, diagnosing what's happening and why, just as economists and leaders must. This isn't abstract. It's the system that shapes whether you'll find a job, what things cost, and how your whole society fares. Let's learn to read it. Onward.`,
