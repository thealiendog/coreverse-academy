  ...
  lessons: [
    {
      ...
      screens: [
...

        {
          ...
          vocab: [
            {
              word: `what an economic system is`,
              ...
              audioPrompt: `An economic system is a society's answers to four basic questions, {name}. What gets produced: food, housing, healthcare, smartphones, weapons, art. How does it get produced: who works, how labor is organized, what tools are used. Who gets what: how the products of labor are distributed across the population. And who decides all of the above: markets, governments, communities, central planners. These questions look abstract until you see them concretely. In one society, healthcare is provided as a public good funded by taxes, like Norway, Canada, the UK. In another, healthcare is provided through private insurance markets, like the US. Same question, different answers, different systems. Capitalism, socialism, and communism are families of answers, not single fixed systems. Capitalism includes Denmark's heavily-regulated welfare capitalism and the more market-driven capitalism of the contemporary US. Socialism includes the Nordic social democracies and the democratic socialism advocated by US figures like Bernie Sanders. Communism in its 20th-century forms was substantially different from what 19th-century communists like Karl Marx envisioned.`,
            },
          ],
        },
...

        {
          ...
          vocab: [
            {
              word: `committing to a position on economic systems`,
