      ...
      screens: [
        {
          id: `l11-welcome`,
          type: `welcome`,
          guideText: `{name}, for most of this band you've been studying the United States, how it structures power, protects rights, makes economic decisions, and acts in the world. But the U.S. is one of nearly two hundred countries on Earth, each with its own way of organizing power, protecting or suppressing rights, and answering the question of who governs and how. Comparative government is the study of those different systems, and it changes everything about how you see government itself. When you study only one system, it feels like the natural or inevitable way things have to be. When you compare it to others, you begin to see it as one choice among many, with real strengths and real weaknesses. Should a democracy use a presidential system (like the U.S.) or a parliamentary one (like the UK, Canada, or most of Europe)? Should it be a federal system (dividing power between levels) or a unitary one (centralizing it)? How do authoritarian systems maintain power, and what makes democracies fragile or resilient? What can countries learn from each other? And is liberal democracy itself the right goal for every society, or does that assumption reflect Western bias? These questions matter because the form of government shapes everything else: rights, economic policy, how disputes are settled, who gets a voice, and whether the people who govern can be removed. Across Latin America, the twentieth century was a testing ground for many of these questions, with democracies turning to dictatorships, dictatorships giving way to democracies, and ongoing debates about what form of government best serves the people. This lesson maps the major government systems and the real debates between them. We'll compare presidential and parliamentary systems, federal and unitary structures, and democratic and authoritarian models. And because these comparisons generate genuine disagreement about which system works best and for whom, we'll end with a real debate. Onward.`,
